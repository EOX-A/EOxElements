...
export type EOxFormatType<F extends keyof OLFormats> = F | ({
    type: F;
} & ConstructorParameters<OLFormats[F]>[0]);
export type EOxFormat = EOxFormatType<"EsriJSON"> | EOxFormatType<"GeoJSON"> | EOxFormatType<"GML"> | EOxFormatType<"GPX"> | EOxFormatType<"IGC"> | EOxFormatType<"KML"> | EOxFormatType<"MVT"> | EOxFormatType<"OWS"> | EOxFormatType<"TopoJSON"> | EOxFormatType<"WFS"> | EOxFormatType<"WKT"> | EOxFormatType<"WMSCapabilities"> | EOxFormatType<"WMSGetFeatureInfo"> | EOxFormatType<"WMTSCapabilities"> | EOxFormatType<"Polyline"> | EOxFormatType<"IIIFInfo"> | EOxFormatType<"WKB">;
type OlSourceOption<S extends keyof OLSources> = Omit<ConstructorParameters<OLSources[S]>[0], "map" | "layer">;
type OlLayerOption<T extends keyof OLLayers> = Omit<Omit<ConstructorParameters<OLLayers[T]>[0], "properties">, "source" | "layers" | "map">;
export type EoxSource<S extends keyof OLSources> = (S extends "WMTS" ? OlSourceOption<S> : OlSourceOption<S> extends {
    format?: any;
} ? Omit<OlSourceOption<S>, "format"> & {
    format?: EOxFormat;
} : OlSourceOption<S> extends {
    source?: any;
...
export type EOxLayerType<T extends keyof OLLayers, S extends keyof OLSources = never> = (OlLayerOption<T> extends {
    sources?: any;
} ? Omit<OlLayerOption<T>, "sources"> & {
    sources?: EoxSource<S>[];
} : OlLayerOption<T>) & {
    type: T;
    zIndex?: number;
    ...
    interactions?: T extends "Vector" | "VectorTile" ? Array<import("./types").EOxInteraction> : never;
} & (S extends keyof OLSources ? SourceProperties<S> : {});
export type EOxLayerTypeGroup = Omit<EOxLayerType<"Group", keyof OLSources>, "layers"> & {
    layers: EoxLayer[];
};
export type EOxLayerTypeMapboxStyle = Omit<EOxLayerType<"MapboxStyle", keyof OLSources>, "source" | "sources">;
export type EoxLayer = EOxLayerType<"Vector", "Vector"> | EOxLayerType<"Vector", "FlatGeoBuf"> | EOxLayerType<"Vector", "Cluster"> | EOxLayerType<"VectorTile", "VectorTile"> | EOxLayerType<"WebGLTile", "GeoTIFF"> | EOxLayerType<"Tile", "OSM"> | EOxLayerType<"Tile", "WMTSCapabilities"> | EOxLayerType<"Tile", "StadiaMaps"> | EOxLayerType<"Tile", "WMTS"> | EOxLayerType<"Tile", "XYZ"> | EOxLayerType<"Tile", "TileJSON"> | EOxLayerType<"Tile", "TileArcGISRest"> | EOxLayerType<"Tile", "TileDebug"> | EOxLayerType<"Tile", "TileImage"> | EOxLayerType<"Tile", "TileWMS"> | EOxLayerType<"Tile", "UrlTile"> | EOxLayerType<"Tile", "BingMaps"> | EOxLayerType<"Image", "Image"> | EOxLayerType<"Image", "ImageCanvas"> | EOxLayerType<"Image", "ImageStatic"> | EOxLayerType<"Image", "ImageWMS"> | EOxLayerType<"Image", "Raster"> | EOxLayerType<"Image", "IIIF"> | EOxLayerType<"STAC"> | EOxLayerTypeMapboxStyle | EOxLayerTypeGroup;
export {};
