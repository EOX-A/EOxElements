import type { OLBasicLayers, OLAdvancedLayers, OLBasicSources, OLAdvancedSources, OLAdvancedFormats } from "./layers";
export type DrawOptions = Omit<import("ol/interaction/Draw").Options, "type"> & {
    id: string | number;
...
export type VectorOrVectorTileLayer = import("ol/layer").Vector | import("ol/layer").VectorTile;
export type AnyLayerWithSource = import("ol/layer/Base").default | import("ol/layer/BaseImage").default<import("ol/source/Image").default, import("ol/renderer/canvas/ImageLayer").default> | import("ol/layer/Tile").default<import("ol/source/Tile").default> | VectorOrVectorTileLayer;
...
export type SelectLayer = import("ol/layer/Vector").default | import("ol/layer/VectorTile").default | import("ol/layer/Tile").default | import("ol/layer/WebGLTile").default;
export type SelectLayerWithFeatures = InstanceType<typeof import("ol/layer/VectorTile").default> | InstanceType<typeof import("ol/layer/Vector").default>;
...
export type ClusterExplodeOptions = import("ol/interaction/Interaction").InteractionOptions & {
    id: string | number;
    layer?: EoxLayer;
    style?: import("ol/style/flat.js").FlatStyleLike;
    active?: boolean;
...
export type EOxClusterOptions = Omit<import("ol/source/Cluster").Options, "geometryFunction" | "createCluster">;
...
export type ControlDictionary = {
    ...
    ScaleLine?: ConstructorParameters<typeof import("ol/control/ScaleLine").default>[0];
    Rotate?: ConstructorParameters<typeof import("ol/control/Rotate").default>[0];
    FullScreen?: ConstructorParameters<typeof import("ol/control/FullScreen").default>[0];
    ZoomSlider?: ConstructorParameters<typeof import("ol/control/ZoomSlider").default>[0];
    Attribution?: ConstructorParameters<typeof import("ol/control/Attribution").default>[0];
    OverviewMap?: Override<ConstructorParameters<typeof import("ol/control/OverviewMap").default>[0], {
        layers?: EoxLayer[] | AnyLayer[];
    }>;
    ZoomToExtent?: ConstructorParameters<typeof import("ol/control/ZoomToExtent").default>[0];
    MousePosition?: ConstructorParameters<typeof import("ol/control/MousePosition").default>[0];
    Geolocation?: ConstructorParameters<typeof import("./controls/geo-location").default>[0];
    LoadingIndicator?: ConstructorParameters<typeof import("./controls/loading-indicator").default>[0];
};
export type AttributionLike = import("ol/source/Source").AttributionLike | string | Array<string>;
...
export type EOxAnimationOptions = import("ol/View").AnimationOptions & import("ol/View").FitOptions;
