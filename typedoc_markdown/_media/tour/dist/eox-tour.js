...
var e = globalThis, t = e.ShadowRoot && (e.ShadyCSS === void 0 || e.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, n = Symbol(), r = /* @__PURE__ */ new WeakMap(), i = class {
	...
	return a(t);
})(e) : e, { is: c, defineProperty: l, getOwnPropertyDescriptor: u, getOwnPropertyNames: d, getOwnPropertySymbols: f, getPrototypeOf: p } = Object, m = globalThis, h = m.trustedTypes, g = h ? h.emptyScript : "", _ = m.reactiveElementPolyfillSupport, v = (e, t) => e, y = {
	toAttribute(e, t) {
		switch (t) {
			case Boolean:
				e = e ? g : null;
...
var S = class extends HTMLElement {
	...
	requestUpdate(e, t, n) {
		if (e !== void 0) {
			...
			if (n ??= r.getPropertyOptions(e), !((n.hasChanged ?? b)(i, t) || n.useDefault && n.reflect && i === this._$Ej?.get(e) && !this.hasAttribute(r._$Eu(e, n)))) return;
			this.C(e, t, n);
		}
...
S.elementStyles = [], S.shadowRootOptions = { mode: "open" }, S[v("elementProperties")] = /* @__PURE__ */ new Map(), S[v("finalized")] = /* @__PURE__ */ new Map(), _?.({ ReactiveElement: S }), (m.reactiveElementVersions ??= []).push("2.1.1");
//#endregion
//#region ../../node_modules/lit-html/lit-html.js
var C = globalThis, w = C.trustedTypes, ee = w ? w.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, te = "$lit$", T = `lit$${Math.random().toFixed(9).slice(2)}$`, ne = "?" + T, re = `<${ne}>`, E = document, D = () => E.createComment(""), O = (e) => e === null || typeof e != "object" && typeof e != "function", k = Array.isArray, ie = (e) => k(e) || typeof e?.[Symbol.iterator] == "function", A = "[ 	\n\f\r]", j = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ae = /-->/g, oe = />/g, M = RegExp(`>|${A}(?:([^\\s"'>=/]+)(${A}*=${A}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`, "g"), se = /'/g, ce = /"/g, le = /^(?:script|style|textarea|title)$/i, ue = ((e) => (t, ...n) => ({
	_$litType$: e,
	strings: t,
	values: n
}))(1), N = Symbol.for("lit-noChange"), P = Symbol.for("lit-nothing"), de = /* @__PURE__ */ new WeakMap(), F = E.createTreeWalker(E, 129);
function fe(e, t) {
...
var pe = (e, t) => {
	...
	for (let t = 0; t < n; t++) {
		...
		for (; u < n.length && (o.lastIndex = u, c = o.exec(n), c !== null);) u = o.lastIndex, o === j ? c[1] === "!--" ? o = ae : c[1] === void 0 ? c[2] === void 0 ? c[3] !== void 0 && (o = M) : (le.test(c[2]) && (i = RegExp("</" + c[2], "g")), o = M) : o = oe : o === M ? c[0] === ">" ? (o = i ?? j, l = -1) : c[1] === void 0 ? l = -2 : (l = o.lastIndex - c[2].length, s = c[1], o = c[3] === void 0 ? M : c[3] === "\"" ? ce : se) : o === ce || o === se ? o = M : o === ae || o === oe ? o = j : (o = M, i = void 0);
		let d = o === M && e[t + 1].startsWith("/>") ? " " : "";
		a += o === j ? n + re : l >= 0 ? (r.push(s), n.slice(0, l) + te + n.slice(l) + T + d) : n + T + (l === -2 ? t : d);
	}
...
var me = class {
	...
	u(e) {
		...
		for (; s !== void 0;) {
			if (a === s.index) {
				let t;
				s.type === 2 ? t = new R(i, i.nextSibling, this, e) : s.type === 1 ? t = new s.ctor(i, s.name, s.strings, this, e) : s.type === 6 && (t = new ve(i, this, e)), this._$AV.push(t), s = n[++o];
			}
	...
	_$AI(e, t = this) {
		e = L(this, e, t), O(e) ? e === P || e == null || e === "" ? (this._$AH !== P && this._$AR(), this._$AH = P) : e !== this._$AH && e !== N && this._(e) : e._$litType$ === void 0 ? e.nodeType === void 0 ? ie(e) ? this.k(e) : this._(e) : this.T(e) : this.$(e);
	}
	O(e) {
	...
	$(e) {
		let { values: t, _$litType$: n } = e, r = typeof n == "number" ? this._$AC(e) : (n.el === void 0 && (n.el = I.createElement(fe(n.h, n.h[0]), this.options)), n);
	...
	_$AC(e) {
		...
		return t === void 0 && de.set(e.strings, t = new I(e)), t;
	}
	k(t) {
...
ye?.(I, R), (C.litHtmlVersions ??= []).push("3.3.1");
var be = (e, t, n) => {
...
function Ne(e) {
	...
	return e.flatMap((e) => {
		...
		return [...n ? [e] : [], ...r];
	}).filter((e) => getComputedStyle(e).pointerEvents !== "none" && Le(e));
}
function Pe(e) {
	if (!e || Ie(e)) return;
	let t = H("smoothScroll"), n = e.offsetHeight > window.innerHeight;
	e.scrollIntoView({
		behavior: !t || Fe(e) ? "auto" : "smooth",
		inline: "center",
...
function ze(e, t, n, r) {
	...
	i = {
		x: K(e, a.x, o.x - a.x, t),
		y: K(e, a.y, o.y - a.y, t),
		width: K(e, a.width, o.width - a.width, t),
		height: K(e, a.height, o.height - a.height, t)
	}, Ue(i), J("__activeStagePosition", i);
}
function Be(e) {
	if (!e) return;
	...
	J("__activeStagePosition", n), Ue(n);
}
function Ve() {
...
function He(e) {
	let t = We(e);
	document.body.appendChild(t), dt(t, (e) => {
		e.target.tagName === "path" && G("overlayClick");
	}), J("__overlaySvg", t);
}
function Ue(e) {
	...
	n.setAttribute("d", Ge(e));
}
function We(e) {
	let t = window.innerWidth, n = window.innerHeight, r = document.createElementNS("http://www.w3.org/2000/svg", "svg");
	...
	return i.setAttribute("d", Ge(e)), i.style.fill = H("overlayColor") || "rgb(0,0,0)", i.style.opacity = `${H("overlayOpacity")}`, i.style.pointerEvents = "auto", i.style.cursor = "auto", r.appendChild(i), r;
}
function Ge(e) {
	let t = window.innerWidth, n = window.innerHeight, r = H("stagePadding") || 0, i = H("stageRadius") || 0, a = e.width + r * 2, o = e.height + r * 2, s = Math.min(i, a / 2, o / 2), c = Math.floor(Math.max(s, 0)), l = e.x - r + c, u = e.y - r, d = a - c * 2, f = o - c * 2;
...
function qe() {
	let e = Y("popover");
	if (!e?.wrapper) return;
	let t = e.wrapper.getBoundingClientRect(), n = H("stagePadding") || 0, r = H("popoverOffset") || 0;
	return {
		width: t.width + n + r,
		height: t.height + n + r,
		realWidth: t.width,
...
function Xe(e, t) {
	let n = Y("popover");
	if (!n) return;
	let { align: r = "start", side: i = "bottom" } = t?.popover || {}, a = r, o = e.id === "driver-dummy-element" ? "over" : i, s = H("stagePadding") || 0, c = qe(), l = n.arrow.getBoundingClientRect(), u = e.getBoundingClientRect(), d = u.top - c.height, f = d >= 0, p = window.innerHeight - (u.bottom + c.height), m = p >= 0, h = u.left - c.width, g = h >= 0, _ = window.innerWidth - (u.right + c.width), v = _ >= 0, y = !f && !m && !g && !v, b = o;
	if (o === "top" && f ? v = g = m = !1 : o === "bottom" && m ? v = g = f = !1 : o === "left" && g ? v = f = m = !1 : o === "right" && v && (g = f = m = !1), o === "over") {
		let e = window.innerWidth / 2 - c.realWidth / 2, t = window.innerHeight / 2 - c.realHeight / 2;
		n.wrapper.style.left = `${e}px`, n.wrapper.style.right = "auto", n.wrapper.style.top = `${t}px`, n.wrapper.style.bottom = "auto";
	} else if (y) {
		let e = window.innerWidth / 2 - c?.realWidth / 2;
		n.wrapper.style.left = `${e}px`, n.wrapper.style.right = "auto", n.wrapper.style.bottom = "10px", n.wrapper.style.top = "auto";
	} else if (g) {
		let e = Math.min(h, window.innerWidth - c?.realWidth - l.width), t = Je(a, {
			elementDimensions: u,
			popoverDimensions: c,
			popoverPadding: s,
			popoverArrowDimensions: l
		});
		n.wrapper.style.left = `${e}px`, n.wrapper.style.top = `${t}px`, n.wrapper.style.bottom = "auto", n.wrapper.style.right = "auto", b = "left";
	} else if (v) {
		let e = Math.min(_, window.innerWidth - c?.realWidth - l.width), t = Je(a, {
			elementDimensions: u,
			popoverDimensions: c,
			popoverPadding: s,
			popoverArrowDimensions: l
		});
		n.wrapper.style.right = `${e}px`, n.wrapper.style.top = `${t}px`, n.wrapper.style.bottom = "auto", n.wrapper.style.left = "auto", b = "right";
	} else if (f) {
		let e = Math.min(d, window.innerHeight - c.realHeight - l.width), t = Ye(a, {
			elementDimensions: u,
			popoverDimensions: c,
			popoverPadding: s,
			popoverArrowDimensions: l
		});
		n.wrapper.style.top = `${e}px`, n.wrapper.style.left = `${t}px`, n.wrapper.style.bottom = "auto", n.wrapper.style.right = "auto", b = "top";
	} else if (m) {
		let e = Math.min(p, window.innerHeight - c?.realHeight - l.width), t = Ye(a, {
			elementDimensions: u,
			popoverDimensions: c,
			popoverPadding: s,
			popoverArrowDimensions: l
		});
		n.wrapper.style.left = `${t}px`, n.wrapper.style.bottom = `${e}px`, n.wrapper.style.top = "auto", n.wrapper.style.right = "auto", b = "bottom";
	}
	tt(y ? "over" : b, a, e), [...n.wrapper.classList].filter((e) => e.startsWith("driver-popover-side-") || e.startsWith("driver-popover-align-")).forEach((e) => n.wrapper.classList.remove(e)), n.wrapper.classList.add(`driver-popover-side-${b}`), n.wrapper.classList.add(`driver-popover-align-${a}`);
}
var X = 10, Ze = 15;
function Qe(e, t, n, r, i) {
	let a = r - n;
	return e <= n && t >= r ? i === "start" ? 20 : i === "end" ? a - Ze - X / 2 : a / 2 : (Math.min(Math.max(e, n), r) + Math.min(Math.max(t, n), r)) / 2 - n;
}
function $e(e, t) {
	let n = Ze, r = t - Ze - X;
	if (r < n) return Math.max(0, (t - X) / 2);
	let i = e - X / 2;
...
function tt(e, t, n) {
	...
	let a = n.getBoundingClientRect(), o = r.wrapper.getBoundingClientRect(), s = et(e, a, o);
	if (i.classList.add(`driver-popover-arrow-side-${s}`), s === "left" || s === "right") {
		let e = Qe(a.top, a.bottom, o.top, o.bottom, t);
		i.style.top = `${$e(e, o.height)}px`;
	} else {
		let e = Qe(a.left, a.right, o.left, o.right, t);
		i.style.left = `${$e(e, o.width)}px`;
	}
}
function nt() {
...
function at(e, t) {
	let n = H("duration") || 400, r = Date.now(), i = Y("__activeStep"), a = Y("__activeElement") || e, o = !a || a === e, s = e.id === "driver-dummy-element", c = a.id === "driver-dummy-element", l = H("animate"), u = t.onHighlightStarted || H("onHighlightStarted"), d = t?.onHighlighted || H("onHighlighted"), f = i?.onDeselected || H("onDeselected"), p = H(), m = Y();
	!o && f && f(c ? void 0 : a, i, {
		config: p,
		state: m,
		driver: U()
	...
	let h = !o && l, g = !1;
	mt(), J("previousStep", i), J("previousElement", a), J("activeStep", t), J("activeElement", e);
	let _ = () => {
		if (Y("__transitionCallback") !== _) return;
		let o = Date.now() - r, c = n - o <= n / 2;
		t.popover && c && !g && h && (ht(e, t), g = !0), H("animate") && o < n ? ze(o, n, a, e) : (Be(e), d && d(s ? void 0 : e, t, {
			config: H(),
			state: Y(),
			driver: U()
		}), J("__transitionCallback", void 0), J("__previousStep", i), J("__previousElement", a), J("__activeStep", t), J("__activeElement", e)), window.requestAnimationFrame(_);
	};
	J("__transitionCallback", _), window.requestAnimationFrame(_), Pe(e), !h && t.popover && ht(e, t), document.querySelectorAll(".driver-active-element-parent").forEach((e) => {
		e.classList.remove("driver-active-element-parent", "driver-active-element-parent-no-scroll");
	}), a.classList.remove("driver-active-element", "driver-no-interaction"), a.removeAttribute("aria-haspopup"), a.removeAttribute("aria-expanded"), a.removeAttribute("aria-controls"), (t.disableActiveInteraction ?? H("disableActiveInteraction")) && e.classList.add("driver-no-interaction");
	let v = e.parentElement;
	v && v !== document.body && (v.classList.add("driver-active-element-parent"), Me(v) && v.classList.add("driver-active-element-parent-no-scroll")), e.classList.add("driver-active-element"), e.setAttribute("aria-haspopup", "dialog"), e.setAttribute("aria-expanded", "true"), e.setAttribute("aria-controls", "driver-popover-content");
}
function ot() {
...
function ct(e) {
	(H("allowKeyboardControl") ?? !0) && (e.key === "Escape" ? G("escapePress") : e.key === "ArrowRight" ? G("arrowRightPress") : e.key === "ArrowLeft" && G("arrowLeftPress"));
}
var lt = [
	"pointerdown",
	"mousedown",
...
function dt(e, t, n) {
	...
	for (let e of lt) document.addEventListener(e, r, !0);
	ut.set(e, r);
}
function Q(e) {
	let t = ut.get(e);
	if (t) {
		for (let e of lt) document.removeEventListener(e, t, !0);
		ut.delete(e);
	}
}
function ft() {
	window.addEventListener("keyup", ct, !1), window.addEventListener("keydown", st, !1), window.addEventListener("resize", Z), window.addEventListener("scroll", Z);
}
function pt() {
	window.removeEventListener("keyup", ct), window.removeEventListener("keydown", st), window.removeEventListener("resize", Z), window.removeEventListener("scroll", Z);
}
function mt() {
	let e = Y("popover");
...
function ht(e, t) {
	let n = Y("popover");
	n && (Q(n.wrapper), n.wrapper.remove()), n = gt(), document.body.appendChild(n.wrapper);
	let { title: r, description: i, showButtons: a, disableButtons: o, showProgress: s, nextBtnText: c = H("nextBtnText") || "Next", prevBtnText: l = H("prevBtnText") || "Previous", progressText: u = H("progressText") || "{current} of {total}" } = t.popover || {};
	n.nextButton.innerHTML = c, n.previousButton.innerHTML = l, n.progress.innerHTML = u;
	let d = H("steps") || [], f = Y("activeIndex"), p = f !== void 0 && f === d.length - 1;
	p && n.nextButton.classList.add("driver-popover-done-btn"), r ? (n.title.innerHTML = r, n.title.style.display = "block") : n.title.style.display = "none", i ? (n.description.innerHTML = i, n.description.style.display = "block") : n.description.style.display = "none";
	let m = a || H("showButtons"), h = s || H("showProgress") || !1, g = m?.includes("next") || m?.includes("previous") || h;
	n.closeButton.style.display = m.includes("close") ? "block" : "none", g ? (n.footer.style.display = "flex", n.progress.style.display = h ? "block" : "none", n.nextButton.style.display = m.includes("next") ? "block" : "none", n.previousButton.style.display = m.includes("previous") ? "block" : "none") : n.footer.style.display = "none";
	let _ = o || H("disableButtons") || [];
	_?.includes("next") && (n.nextButton.disabled = !0, n.nextButton.classList.add("driver-popover-btn-disabled")), _?.includes("previous") && (n.previousButton.disabled = !0, n.previousButton.classList.add("driver-popover-btn-disabled")), _?.includes("close") && (n.closeButton.disabled = !0, n.closeButton.classList.add("driver-popover-btn-disabled"));
	let v = n.wrapper;
	...
	let y = n.arrow;
	y.className = "driver-popover-arrow", v.className = `driver-popover ${t.popover?.popoverClass || H("popoverClass") || ""}`.trim(), dt(n.wrapper, (n) => {
		let r = n.target, i = t.popover?.onNextClick || H("onNextClick"), a = t.popover?.onPrevClick || H("onPrevClick"), o = t.popover?.onCloseClick || H("onCloseClick"), s = t.popover?.onDoneClick || H("onDoneClick");
		if (r.closest(".driver-popover-next-btn")) return p && s ? s(e, t, {
			config: H(),
			state: Y(),
			driver: U()
		}) : i ? i(e, t, {
		...
		if (r.closest(".driver-popover-prev-btn")) return a ? a(e, t, {
			config: H(),
			state: Y(),
			driver: U()
		}) : G("prevClick");
		if (r.closest(".driver-popover-close-btn")) return o ? o(e, t, {
			config: H(),
			state: Y(),
			driver: U()
		}) : G("closeClick");
	}, (e) => n?.description.contains(e) || n?.title.contains(e) ? !1 : !!e.closest(".driver-popover-prev-btn, .driver-popover-next-btn, .driver-popover-close-btn")), J("popover", n);
	let b = t.popover?.onPopoverRender || H("onPopoverRender");
	b && b(n, {
		config: H(),
		state: Y(),
		driver: U()
	}), Xe(e, t), Pe(v);
	let x = Ne([v, ...e.classList.contains("driver-dummy-element") ? [] : [e]]);
...
function _t() {
	let e = Y("popover");
	e && (Q(e.wrapper), e.wrapper.parentElement?.removeChild(e.wrapper));
}
function vt(e = {}) {
	Oe(e);
	function t() {
	...
	function n() {
		let e = H("overlayClickBehavior");
		if (H("allowClose") && e === "close") {
			u();
			return;
		}
		...
		if (e === "nextStep") {
			let e = Y("activeStep"), t = Y("activeElement"), n = H("steps") || [], i = Y("activeIndex") === n.length - 1, a = e?.popover?.onDoneClick || H("onDoneClick");
			if (i && a) {
				a(t, e, {
					config: H(),
					state: Y(),
			...
			let o = e?.popover?.onNextClick || H("onNextClick");
			if (o) {
				o(t, e, {
					config: H(),
					state: Y(),
	...
	function o() {
		...
		if (e === void 0 || t === void 0 || !(H("steps") || [])[e - 1]) return;
		let r = t.popover?.onPrevClick || H("onPrevClick");
		if (r) return r(n, t, {
			config: H(),
			state: Y(),
			driver: U()
	...
	function s() {
		...
		let i = e === (H("steps") || []).length - 1, a = t.popover?.onDoneClick || H("onDoneClick");
		if (i && a) return a(n, t, {
			config: H(),
			state: Y(),
			driver: U()
		});
		let o = t.popover?.onNextClick || H("onNextClick");
		if (o) return o(n, t, {
			config: H(),
			state: Y(),
			driver: U()
	...
	function c() {
		Y("isInitialized") || (J("isInitialized", !0), document.body.classList.add("driver-active", H("animate") ? "driver-fade" : "driver-simple"), H("allowScroll") || document.body.classList.add("driver-no-scroll"), document.body.style.setProperty("--driver-animation-duration", `${H("duration") || 400}ms`), ft(), W("overlayClick", n), W("escapePress", t), W("closeClick", t), W("arrowLeftPress", o), W("arrowRightPress", s));
	}
	function l(e = 0) {
		let t = H("steps");
		if (!t) {
		...
		J("__activeOnDestroyed", document.activeElement), J("activeIndex", e);
		let n = t[e], r = t[e + 1], i = t[e - 1], a = n.popover?.doneBtnText || H("doneBtnText") || "Done", o = H("allowClose"), s = n.popover?.showProgress === void 0 ? H("showProgress") : n.popover?.showProgress, c = (n.popover?.progressText || H("progressText") || "{{current}} of {{total}}").replace("{{current}}", `${e + 1}`).replace("{{total}}", `${t.length}`), d = n.popover?.showButtons || H("showButtons"), f = [
			"next",
			"previous",
			...o ? ["close"] : []
		].filter((e) => !d?.length || d.includes(e)), p = n.popover?.onNextClick || H("onNextClick"), m = n.popover?.onPrevClick || H("onPrevClick"), h = n.popover?.onCloseClick || H("onCloseClick");
		rt({
			...n,
			popover: {
				showButtons: f,
				nextBtnText: r ? void 0 : a,
				disableButtons: [...i ? [] : ["previous"]],
				showProgress: s,
				onNextClick: p || (() => {
					r ? l(e + 1) : u();
				}),
	...
	function u(e = !0) {
		let t = Y("__activeElement"), n = Y("__activeStep"), r = Y("__activeOnDestroyed"), i = H("onDestroyStarted");
		if (e && i) {
			i(!t || t?.id === "driver-dummy-element" ? void 0 : t, n, {
				config: H(),
				state: Y(),
				driver: U()
			});
		...
		let a = n?.onDeselected || H("onDeselected"), o = H("onDestroyed");
		document.body.classList.remove("driver-active", "driver-fade", "driver-simple", "driver-no-scroll"), document.body.style.removeProperty("--driver-animation-duration"), pt(), _t(), ot(), Ke(), je();
		let s = Y();
		if (Re(), t && n) {
...
//#endregion
//#region src/helpers/default-config.js
var $ = { onPopoverRender: (e, { config: t, state: n }) => {
	if (e.wrapper.classList.add("padding"), e.previousButton && (e.previousButton.innerHTML = `
        <span style="pointer-events: none">${t.prevBtnText || "Previous"}</span>
      `, e.previousButton.style.display = t.showButtons?.includes("previous") ? "flex" : "none", e.previousButton.classList.add("small", "small-text", "transparent", "primary-text")), e.nextButton) {
		let r = t.steps[n.activeIndex], i = n.activeIndex === t.steps.length - 1 && !r.popover?.targetIframe && !r.popover?.returnToParent && (!t.totalSteps || n.activeIndex + 1 + (t.stepOffset || 0) >= t.totalSteps);
		e.nextButton.innerHTML = `
        <span style="pointer-events: none">${i ? t.doneBtnText || "Done" : t.nextBtnText || "Next"}</span>
        <i style="pointer-events: none" class="icon small">
          ${i ? "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\"><title>check</title><path d=\"M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z\" /></svg>" : "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\"><title>menu-right</title><path d=\"M10,17L15,12L10,7V17Z\" /></svg>"}
        </i>
      `, e.nextButton.style.display = t.showButtons?.includes("next") ? "flex" : "none", e.nextButton.classList.add("small", "small-text");
	}
	if (e.closeButton && (e.closeButton.innerHTML = "\n        <i style=\"pointer-events: none\" class=\"icon small\">\n          <svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\"><title>close</title><path d=\"M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z\" /></svg>\n        </i>\n      ", e.closeButton.style.display = t.showButtons?.includes("close") ? "flex" : "none", e.closeButton.classList.add("transparent", "circle", "small", "absolute", "top", "right", "small-margin")), e.progress && (e.progress.style.display = t.showProgress ? "flex" : "none", e.progress.style.alignItems = "center", e.progress.classList.add("small-text")), e.footerButtons && e.footerButtons.parentElement) {
		let t = document.createElement("nav");
		for (t.style.display = "flex", t.style.alignItems = "center", t.style.marginLeft = "auto"; e.footerButtons.firstChild;) t.appendChild(e.footerButtons.firstChild);
		e.footerButtons.parentElement.replaceChild(t, e.footerButtons), e.footerButtons = t;
	}
	if (e.title && e.title.parentElement) {
		let t = document.createElement("h6");
		t.innerHTML = e.title.innerHTML, e.title.parentElement.replaceChild(t, e.title), t.classList.add("small");
	}
} };
//#endregion
//#region src/methods/tour/show-tour.js
function yt(e) {
	if (!e.config || e.preventAutoStart) return;
	if (e.showEveryTime) {
		e.driver.drive();
		return;
	}
	let t = localStorage.getItem(e.TOUR_KEY), n = null;
	try {
		n = JSON.parse(t);
	} catch {}
	if (n === !0 || n && typeof n == "object" && n[e.id]) {
		if (typeof n == "boolean" && n === !0 && e.id) {
			localStorage.removeItem(e.TOUR_KEY), yt(e);
			return;
		}
		return;
	}
	if (e.driver.drive(), e.id) {
		let t = typeof n == "object" && n ? n : {};
		t[e.id] = !0, localStorage.setItem(e.TOUR_KEY, JSON.stringify(t));
	} else localStorage.setItem(e.TOUR_KEY, "true");
}
//#endregion
//#region src/methods/tour/initialize-driver.js
function bt(e) {
	e.driver && e.driver.destroy();
	let t = (e) => e?.targetIframe || e?.popover?.targetIframe, n = (n, r, i, a) => {
		if (!n) {
			let t = a.driver.getActiveIndex() ?? 0, n = a.config.steps[t] || {}, r = i === "movePrevious";
			if (window.parent !== window && (!r && n.popover?.returnToParent || r && n.popover?.returnToParentBackward)) {
				a.driver.destroy();
				let t = r ? n.popover?.backwardParentStepIndex : n.popover?.parentStepIndex;
		...
		let o = a.driver.getActiveIndex() ?? 0, s = a.config.steps[o] || {}, c = t(s), l = t(n), u = !1;
		if (l) {
		...
		if (u) if (l && l !== c) {
			...
			a.driver.destroy();
			let t = r;
			i === "movePrevious" && s.popover?.backwardParentStepIndex !== void 0 ? t = s.popover.backwardParentStepIndex : s.popover?.parentStepIndex !== void 0 && (t = s.popover.parentStepIndex), window.parent.postMessage({
				type: "EOX_TOUR_RESUME",
				tourId: e.id,
				stepIndex: t
			}, "*");
	...
	e.driver = vt({
		...
		...$,
		...e.config,
		steps: e.config.steps?.map((e) => {
			let n = t(e);
			return n ? {
				...e,
				get element() {
					let t = document.querySelector(n);
					return t && t.tagName.toLowerCase() === "iframe" ? n : e.element;
				}
			} : e;
		}) || [],
		onNextClick: (t, r, i) => {
			e.config.onNextClick && e.config.onNextClick(t, r, i);
			let a = i.driver.getActiveIndex() ?? 0;
			n(i.config.steps[a + 1], a + 1, "moveNext", i);
		},
		onPrevClick: (t, r, i) => {
			e.config.onPrevClick && e.config.onPrevClick(t, r, i);
			let a = i.driver.getActiveIndex() ?? 0;
			n(i.config.steps[a - 1], a - 1, "movePrevious", i);
		},
		onCloseClick: (t, n, r) => {
			e.config.onCloseClick && e.config.onCloseClick(t, n, r), r.driver.destroy(), window.parent !== window && window.parent.postMessage({
				type: "EOX_TOUR_DESTROY",
				tourId: e.id
			}, "*");
		},
		onHighlightStarted: (n, r, i) => {
			let a = t(r), o = !1;
			if (a) {
				let e = document.querySelector(a);
				e && e.tagName === "IFRAME" && (o = !0);
			}
			o ? i.driver.setConfig({
				...i.config,
				stagePadding: 0,
				stageRadius: 0
			}) : i.driver.setConfig({
				...i.config,
				stagePadding: e.config.stagePadding ?? 10,
				stageRadius: e.config.stageRadius ?? 5
			}), e.dispatchEvent(new CustomEvent("tour-highlight-started", {
				detail: {
					element: n,
					step: r,
					options: i
				...
				bubbles: !0,
				composed: !0
			})), e.config.onHighlightStarted && e.config.onHighlightStarted(n, r, i);
		},
		onHighlighted: (t, n, r) => {
			e.dispatchEvent(new CustomEvent("tour-highlighted", {
				detail: {
					element: t,
					step: n,
					options: r
				...
				bubbles: !0,
				composed: !0
			})), e.config.onHighlighted && e.config.onHighlighted(t, n, r);
		},
		onDeselected: (t, n, r) => {
			e.dispatchEvent(new CustomEvent("tour-deselected", {
				detail: {
					element: t,
					step: n,
					options: r
				...
				bubbles: !0,
				composed: !0
			})), e.config.onDeselected && e.config.onDeselected(t, n, r);
		},
		onDestroyStarted: (t, n, r) => {
			e.dispatchEvent(new CustomEvent("tour-destroy-started", {
				detail: {
					element: t,
					step: n,
					options: r
				...
				bubbles: !0,
				composed: !0
			})), e.config.onDestroyStarted && e.config.onDestroyStarted(t, n, r);
		},
		onPopoverRender: (n, r) => {
			$.onPopoverRender && $.onPopoverRender(n, r);
			let i = r.state.activeIndex ?? 0, a = r.config.steps[i], o = t(a), s = !1;
			if (o) {
				let e = document.querySelector(o);
				e && e.tagName === "IFRAME" && (s = !0);
			}
			if (s && n.wrapper && (n.wrapper.style.display = "none"), n.previousButton && (i === 0 && (a?.popover?.returnToParentBackward || window.parent !== window && a?.popover?.backwardParentStepIndex !== void 0 ? (n.previousButton.disabled = !1, n.previousButton.classList.remove("driver-popover-btn-disabled")) : n.previousButton.style.display = "none"), (n.previousButton.disabled || n.previousButton.classList.contains("driver-popover-btn-disabled")) && (n.previousButton.style.display = "none")), n.progress && (e.config.stepOffset !== void 0 || e.config.totalSteps !== void 0 || a?.popover?.stepOffset !== void 0)) {
				let t = a?.popover?.stepOffset ?? e.config.stepOffset ?? 0, o = e.config.totalSteps || r.config.steps.length, s = i + 1 + t;
				n.progress.innerText = `${s} of ${o}`;
			}
			e.config.onPopoverRender && e.config.onPopoverRender(n, r);
		}
	}), yt(e);
}
//#endregion
...
var xt = class extends V {
	...
	constructor() {
		super(), this.config = {}, this.showEveryTime = !1, this.preventAutoStart = !1, this.unstyled = !1, this.driver = null, this.TOUR_KEY = "eox-tour-shown";
	}
	connectedCallback() {
	...
	updated(e) {
		e.has("config") && this.config && bt(this);
	}
	start(e = 0) {
		let t = this.config?.steps?.[e], n = t?.targetIframe || t?.popover?.targetIframe, r = !1;
		if (n) {
			let e = document.querySelector(n);
			e && e.tagName.toLowerCase() === "iframe" && (r = !0);
		}
		if (r) {
			let t = document.querySelector(n);
			if (t && t.contentWindow) {
				let n = JSON.parse(JSON.stringify(this.config));
		...
		} else this.driver && (this.driver.isActive() ? this.driver.moveTo(e) : this.driver.drive(e));
	}
	createRenderRoot() {
		return this;
	}
...
customElements.define("eox-tour", xt);
//#endregion
export { xt as EOxTour };
