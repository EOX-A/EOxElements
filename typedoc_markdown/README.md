...
For detailed development instructions, including monorepo structure, coding standards, and testing procedures, please refer to the [Contributing Guide](_media/CONTRIBUTING.md).

AI Agents working in this repository should also consult [AGENTS.md](_media/AGENTS.md) for specific guidelines on maintaining documentation and ensuring compatibility with the MCP server.

## License

By contributing to EOxElements, you agree that your contributions will be licensed under the repository's [LICENSE](_media/LICENSE).
