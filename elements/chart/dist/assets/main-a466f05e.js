...
var xo = (i, t, e) =>
  t in i
    ? bo(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
    : (i[t] = e);
var S = (i, t, e) => (xo(i, typeof t != "symbol" ? t + "" : t, e), e);
(function () {
...
function ie(i) {
  return _t(ye(i * 2.55), 0, 255);
}
function kt(i) {
  return _t(ye(i * 255), 0, 255);
}
function pt(i) {
  return _t(ye(i / 2.55) / 100, 0, 1);
}
function Gi(i) {
  return _t(ye(i * 100), 0, 100);
}
const st = {
    0: 0,
    1: 1,
  ...
  _i = [..."0123456789ABCDEF"],
  _o = (i) => _i[i & 15],
  yo = (i) => _i[(i & 240) >> 4] + _i[i & 15],
  we = (i) => (i & 240) >> 4 === (i & 15),
  vo = (i) => we(i.r) && we(i.g) && we(i.b) && we(i.a);
function Mo(i) {
  var t = i.length,
    e;
  return (
...
const ko = (i, t) => (i < 255 ? t(i) : "");
function wo(i) {
  var t = vo(i) ? _o : yo;
  return i ? "#" + t(i.r) + t(i.g) + t(i.b) + ko(i.a, t) : void 0;
}
const So =
...
function Lo(i, t) {
  var e = Fi(i);
  (e[0] = _n(e[0] + t)), (e = zi(e)), (i.r = e[0]), (i.g = e[1]), (i.b = e[2]);
}
function Ro(i) {
  if (!i) return;
  const t = Fi(i),
...
let Se;
function Fo(i) {
  Se || ((Se = Eo()), (Se.transparent = [0, 0, 0, 0]));
...
function zo(i) {
  ...
  if (t) {
    if (t[7] !== s) {
      const a = +t[7];
      e = t[8] ? ie(a) : _t(a * 255, 0, 255);
    }
    return (
      (s = +t[1]),
      (n = +t[3]),
      (o = +t[5]),
      (s = 255 & (t[2] ? ie(s) : _t(s, 0, 255))),
      (n = 255 & (t[4] ? ie(n) : _t(n, 0, 255))),
      (o = 255 & (t[6] ? ie(o) : _t(o, 0, 255))),
      { r: s, g: n, b: o, a: e }
    );
  }
}
...
function Vo(i, t, e) {
  const s = Nt(pt(i.r)),
    ...
    o = Nt(pt(i.b));
  return {
    r: kt(ri(s + e * (Nt(pt(t.r)) - s))),
    g: kt(ri(n + e * (Nt(pt(t.g)) - n))),
    b: kt(ri(o + e * (Nt(pt(t.b)) - o))),
    a: i.a + e * (t.a - i.a),
  };
}
function Pe(i, t, e) {
  ...
  return (
    Array.isArray(i)
      ? i.length >= 3 &&
        ...
        i.length > 3 && (t.a = kt(i[3])))
      : ((t = yn(i, { r: 0, g: 0, b: 0, a: 1 })), (t.a = kt(t.a))),
    t
  );
}
function Wo(i) {
  return i.charAt(0) === "r" ? zo(i) : To(i);
}
class ue {
  constructor(t) {
...
function wt(i, t) {
  return (ts[t] || (ts[t] = Xo(t)))(i);
}
function Bi(i) {
  return i.charAt(0).toUpperCase() + i.slice(1);
}
const nt = (i) => typeof i < "u",
...
function ss(i) {
  ...
  i = le(i, t, i / 1e3) ? t : i;
  const e = Math.pow(10, Math.floor(yt(i))),
    s = i / e;
...
function wn(i, t) {
  ...
  return o < -0.5 * V && (o += z), { angle: o, distance: n };
}
function yi(i, t) {
...
const Sn = ["push", "pop", "shift", "splice", "unshift"];
function ia(i, t) {
  if (i._chartjs) {
  ...
  if (i._sorted) {
    ...
    d &&
      (n = Y(
        Math.min(
          xt(r, a.axis, c).lo,
          e ? s : xt(t, l, a.getPixelForValue(c)).lo
        ),
        0,
        s - 1
      )),
      u
        ? (o =
            Y(
              Math.max(
                xt(r, a.axis, h, !0).hi + 1,
                e ? 0 : xt(t, l, a.getPixelForValue(h), !0).hi + 1
              ),
              n,
              s
            ) - n)
...
const De = (i) => i === 0 || i === 1,
  as = (i, t, e) => -(Math.pow(2, 10 * (i -= 1)) * Math.sin(((i - t) * z) / e)),
  rs = (i, t, e) => Math.pow(2, -10 * i) * Math.sin(((i - t) * z) / e) + 1,
  ce = {
    linear: (i) => i,
    easeInQuad: (i) => i * i,
    easeOutQuad: (i) => -i * (i - 2),
    ...
    easeInElastic: (i) => (De(i) ? i : as(i, 0.075, 0.3)),
    easeOutElastic: (i) => (De(i) ? i : rs(i, 0.075, 0.3)),
    easeInOutElastic(i) {
      return De(i)
        ? i
        : i < 0.5
        ? 0.5 * as(i * 2, 0.1125, 0.45)
        : 0.5 + 0.5 * rs(i * 2 - 1, 0.1125, 0.45);
    },
    easeInBack(i) {
...
function ls(i) {
  return Tn(i) ? i : new ue(i);
}
function li(i) {
  return Tn(i) ? i : new ue(i).saturate(0.5).darken(0.1).hexString();
}
const oa = ["x", "y", "borderWidth", "radius", "tension"],
...
const Ln = {
  ...
  numeric(i, t, e) {
    ...
    if (e.length > 1) {
      ...
      (c < 1e-4 || c > 1e15) && (n = "scientific"), (o = ha(i, e));
    }
    const a = yt(Math.abs(o)),
...
function ga(i, t, e, s) {
  ...
  let l, c, h, d, u;
  for (l = 0; l < r; l++)
    if (((d = e[l]), d != null && I(d) !== !0)) a = Ge(i, n, o, a, d);
    else if (I(d))
    ...
    switch ((i.beginPath(), f)) {
      ...
      case "rectRounded":
        (c = p * 0.516),
          ...
          i.arc(e - d, s - r, c, m - V, m - N),
          i.arc(e + u, s - a, c, m - N, m),
          i.arc(e + d, s + r, c, m, m + N),
          i.arc(e - u, s + a, c, m + N, m + V),
          i.closePath();
        break;
      case "rect":
        if (!g) {
...
function zt(i, t, e, s, n, o = {}) {
  ...
  let l, c;
  for (i.save(), i.font = n.string, ba(i, o), l = 0; l < a.length; ++l)
    (c = a[l]),
      o.backdrop && _a(i, o.backdrop),
      r &&
...
function me(i, t) {
  ...
  i.arc(e + a.topLeft, s + a.topLeft, a.topLeft, -N, V, !0),
    i.lineTo(e, s + o - a.bottomLeft),
    i.arc(e + a.bottomLeft, s + o - a.bottomLeft, a.bottomLeft, V, N, !0),
    ...
    i.arc(e + n - a.topRight, s + a.topRight, a.topRight, 0, -N, !0),
    i.lineTo(e + a.topLeft, s);
}
const ya = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/,
  va = /^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/;
function Ma(i, t) {
  const e = ("" + i).match(ya);
...
function $(i, t) {
  ...
  const n = {
    ...
    lineHeight: Ma(D(i.lineHeight, t.lineHeight), e),
    size: e,
    style: s,
...
function ji(i, t = [""], e = i, s, n = () => i[0]) {
  nt(s) || (s = Bn("_fallback", i));
  const o = {
...
function Fn(i, t = { scriptable: !0, indexable: !0 }) {
  const {
...
function Pa(i, t, e) {
  ...
  let r = s[t];
  return (
    St(r) && a.isScriptable(t) && (r = Da(t, r, i, e)),
    I(r) && r.length && (r = Oa(t, r, i, a.isIndexable)),
    $i(t, r) && (r = Yt(r, n, o && o[t], a)),
    r
  );
}
function Da(i, t, e, s) {
  ...
  return (
    ...
    (t = t(o, a || s)),
    r.delete(i),
    $i(i, t) && (t = Yi(n._scopes, n, i, t)),
    t
  );
}
function Oa(i, t, e, s) {
  const { _proxy: n, _context: o, _subProxy: a, _descriptors: r } = e;
  if (nt(o.index) && s(i)) t = t[o.index % t.length];
  else if (A(t[0])) {
    const l = t,
...
const Ca = (i, t) => (i === !0 ? t : typeof i == "string" ? wt(t, i) : void 0);
function Aa(i, t, e, s, n) {
  for (const o of t) {
    const a = Ca(e, o);
    if (a) {
      i.add(a);
      const r = zn(a._fallback, e, n);
      if (nt(r) && r !== e && r !== s) return r;
    } else if (a === !1 && nt(s) && e !== s) return null;
  }
  return !1;
}
function Yi(i, t, e, s) {
  const n = t._rootScopes,
    o = zn(t._fallback, e, s),
    a = [...i, ...n],
    r = new Set();
  r.add(s);
  let l = ds(r, a, e, o || e, s);
  return l === null ||
    (nt(o) && o !== e && ((l = ds(r, a, o, l, s)), l === null))
    ? !1
    : ji(Array.from(r), [""], n, o, () => Ta(t, e, s));
}
...
function La(i, t, e, s) {
  let n;
  for (const o of t)
    if (((n = Bn(Sa(o, i), e)), nt(n))) return $i(i, n) ? Yi(e, s, i, n) : n;
}
function Bn(i, t) {
  for (const e of t) {
    if (!e) continue;
...
function Vn(i, t, e, s) {
  ...
  let r, l, c, h;
  for (r = 0, l = s; r < l; ++r)
    (c = r + e), (h = t[c]), (a[r] = { r: n.parse(wt(h, o), c) });
  return a;
}
const Ea = Number.EPSILON || 1e-14,
...
function Wa(i, t, e, s, n) {
  ...
  if (
    ...
    for (o = 0, a = i.length; o < a; ++o)
      (r = i[o]),
        (l = Fa(c, r, i[Math.min(o + 1, a - (s ? 0 : 1)) % a], t.tension)),
        (r.cp1x = l.previous.x),
        (r.cp1y = l.previous.y),
        (r.cp2x = l.next.x),
        (r.cp2y = l.next.y),
...
const ja = (i, t, e) => (i > 0 || t > 0) && (!e || !e.shadowRoot);
function $a(i, t) {
  const e = i.touches,
    s = e && e.length ? e[0] : i,
...
function $n(i) {
  return i === "angle"
    ? { between: ge, compare: Jo, normalize: et }
    : { between: bt, compare: (t, e) => t - e, normalize: (t) => t };
}
function ps({ start: i, end: t, count: e, loop: s, style: n }) {
  return {
    start: i % e,
    end: t % e,
    loop: s && (t - i + 1) % e === 0,
...
function Yn(i, t, e) {
  ...
  const { property: s, start: n, end: o } = e,
    a = t.length,
    { compare: r, between: l, normalize: c } = $n(s),
    { start: h, end: d, loop: u, style: f } = Ja(i, t, e),
    g = [];
  let p = !1,
    m = null,
    b,
    ...
    (x = t[w % a]),
      !x.skip &&
        ...
        b !== y &&
          ...
          m !== null &&
            k() &&
            (g.push(ps({ start: m, end: w, loop: u, count: a, style: f })),
            (m = null)),
          (P = w),
          (y = b)));
  return (
    m !== null && g.push(ps({ start: m, end: d, loop: u, count: a, style: f })),
    g
  );
}
function Xn(i, t) {
...
function er(i, t) {
  ...
  if (!n) return [];
  const o = !!i._loop,
    { start: a, end: r } = Qa(e, n, o, s);
  if (s === !0) return ms(i, [{ start: a, end: r, loop: o }], e, t);
  const l = r < a ? r + n : r,
    c = !!i._fullLoop && a === 0 && r === n - 1;
  return ms(i, tr(e, a, l, c), e, t);
}
function ms(i, t, e, s) {
...
class ar {
  constructor(t, e, s, n) {
    ...
    (this._active = !0),
      (this._fn = t.fn || or[t.type || typeof a]),
...
class Un {
  ...
  _animateOptions(t, e) {
    ...
    return (
      s.$shared &&
        rr(t.options.$animations, s).then(
          () => {
            t.options = s;
          },
          () => {}
...
const di = (i) => i === "reset" || i === "none",
  ...
  br = (i, t, e) =>
    i && !t.hidden && t._stacked && { keys: Kn(e, !0), values: null };
class rt {
  constructor(t, e) {
    (this.chart = t),
      (this._ctx = t.ctx),
  ...
  _destroy() {
    const t = this._cachedMeta;
    this._data && os(this._data, this), t._stacked && Zt(t);
  }
  _dataCheck() {
    const t = this.getDataset(),
      e = t.data || (t.data = []),
      s = this._data;
    if (A(e)) this._data = dr(e);
    else if (s !== e) {
      if (s) {
        os(s, this);
      ...
      e && Object.isExtensible(e) && ia(e, this),
        (this._syncList = []),
        (this._data = e);
    }
  }
  ...
  buildOrUpdateElements(t) {
    ...
    (e._stacked = vs(e.vScale, e)),
      ...
      (n || o !== e._stacked) && ks(this, e._parsed);
  }
  configure() {
  ...
  parseObjectData(t, e, s, n) {
    ...
    for (h = 0, d = n; h < d; ++h)
      (u = h + s),
        (f = e[u]),
        (c[h] = { x: o.parse(wt(f, r), u), y: a.parse(wt(f, l), u) });
    return c;
  }
  getParsed(t) {
  ...
  applyStack(t, e, s) {
    const n = this.chart,
      o = this._cachedMeta,
      a = e[t.axis],
      r = { keys: Kn(n, !0), values: e._stacks[t.axis]._visualValues };
    return ys(r, a, o.index, { mode: s });
  }
  updateRangeFromParsed(t, e, s, n) {
    const o = s[e.axis];
    let a = o === null ? NaN : o;
    const r = n && s._stacks[e.axis];
    n && r && ((n.values = r), (a = ys(n, o, this._cachedMeta.index))),
  ...
  _update(t) {
    ...
    this.update(t || "default"),
      (e._clip = hr(
        D(this.options.clip, cr(e.xScale, e.yScale, this.getMaxOverflow()))
      ));
  }
  update(t) {}
  draw() {
  ...
  getContext(t, e, s) {
    ...
    if (t >= 0 && t < this._cachedMeta.data.length) {
      ...
      (o = a.$context || (a.$context = mr(this.getContext(), t, a))),
      ...
      (o =
        this.$context ||
        (this.$context = pr(this.chart.getContext(), this.index))),
        (o.dataset = n),
  ...
  _resolveElementOptions(t, e = "default", s) {
    const n = e === "active",
      ...
      a = t + "-" + e,
      r = o[a],
      l = this.enableOptionSharing && nt(s);
    if (r) return ws(r, l);
    ...
    return p.$shared && ((p.$shared = l), (o[a] = Object.freeze(ws(p, l)))), p;
  }
...
S(rt, "defaults", {}),
  S(rt, "datasetElementType", null),
  S(rt, "dataElementType", null);
function xr(i, t) {
  if (!i._cache.$bar) {
...
function _r(i) {
  ...
  const l = () => {
    a === 32767 ||
      a === -32768 ||
      (nt(r) && (s = Math.min(s, Math.abs(a - r) || s)), (r = a));
  };
...
function qn(i, t, e, s) {
  return I(i) ? Mr(i, t, e, s) : (t[e.axis] = e.parse(i, s)), t;
}
function Ss(i, t, e, s) {
  const n = i.iScale,
    o = i.vScale,
...
function Sr(i, t, e, s) {
  ...
  const { start: a, end: r, reverse: l, top: c, bottom: h } = wr(i);
  n === "middle" &&
    e &&
...
function Ps(i, t, e, s) {
  return s ? ((i = Pr(i, t, e)), (i = Ds(i, e, t))) : (i = Ds(i, t, e)), i;
}
function Pr(i, t, e) {
...
function Dr(i, { inflateAmount: t }, e) {
...
class ze extends rt {
  ...
  updateElements(t, e, s, n) {
    ...
    for (let f = e; f < e + s; f++) {
      ...
      Sr(x, y, b, a), Dr(x, y, h.ratio), this.updateElement(t[f], f, x, n);
    }
  }
  _getStacks(t, e) {
  ...
  _calculateBarValuePixels(t) {
    ...
    if (b === e.getPixelForValue(r)) {
      const x = (dt(p) * e.getLineWidthForValue(r)) / 2;
      (b += x), (p -= x);
    }
  ...
  _calculateBarIndexPixels(t, e) {
    ...
    if (e.grouped) {
      const c = o ? this._getStackCount(t) : e.stackCount,
        h = n.barThickness === "flex" ? vr(t, e, n, c) : yr(t, e, n, c),
...
function Or(i, t, e) {
  ...
  if (t < z) {
    const r = i,
      ...
      d = Math.cos(l),
      u = Math.sin(l),
      f = (y, v, _) => (ge(y, r, l, !0) ? 1 : Math.max(v, v * e, _, _ * e)),
      g = (y, v, _) => (ge(y, r, l, !0) ? -1 : Math.min(v, v * e, _, _ * e)),
      p = f(0, c, d),
      m = f(N, h, u),
      b = g(V, c, d),
      x = g(V + N, h, u);
...
class Rt extends rt {
  ...
  update(t) {
    const e = this.chart,
      ...
      l = Math.min(Ho(this.options.cutout, r), 1),
      c = this._getRingWeight(this.index),
      { circumference: h, rotation: d } = this._getRotationExtents(),
      { ratioX: u, ratioY: f, offsetX: g, offsetY: p } = Or(d, h, l),
      m = (s.width - a) / u,
      b = (s.height - a) / f,
      x = Math.max(Math.min(m, b) / 2, 0),
      y = vn(this.options.radius, x),
      v = Math.max(y * l, 0),
  ...
  updateElements(t, e, s, n) {
    ...
    for (x = e; x < e + s; ++x) {
      ...
      m &&
        (_.options =
          p || this.resolveDataElementOptions(x, v.active ? "active" : n)),
        (b += y),
...
class Ve extends rt {
  ...
  updateElements(t, e, s, n) {
    const o = n === "reset",
      ...
      m = $t(g) ? g : Number.POSITIVE_INFINITY,
    ...
    for (let _ = 0; _ < y; ++_) {
      ...
      const w = this.getParsed(_),
        P = T(w[f]),
        O = (k[u] = a.getPixelForValue(w[u], _)),
        C = (k[f] =
          o || P
            ? r.getBasePixel()
            : r.getPixelForValue(l ? this.applyStack(r, w, l) : w[f], _));
      (k.skip = isNaN(O) || isNaN(C) || P),
        (k.stop = _ > 0 && Math.abs(w[u] - v[u]) > m),
...
class de extends rt {
  ...
  _computeAngle(t, e, s) {
    return this.chart.getDataVisibility(t)
      ? at(this.resolveDataElementOptions(t, e).angle || s)
      : 0;
  }
}
S(de, "id", "polarArea"),
...
class Ne extends rt {
  ...
  updateElements(t, e, s, n) {
    const o = n === "reset",
      ...
      b = $t(p) ? p : Number.POSITIVE_INFINITY,
    ...
    for (let v = e; v < e + s; ++v) {
      const _ = t[v],
        ...
        k = x ? _ : {},
        w = T(M[g]),
        P = (k[f] = a.getPixelForValue(M[f], v)),
        O = (k[g] =
          o || w
            ? r.getBasePixel()
            : r.getPixelForValue(l ? this.applyStack(r, M, l) : M[g], v));
      (k.skip = isNaN(P) || isNaN(O) || w),
        (k.stop = v > 0 && Math.abs(M[f] - y[f]) > b),
        m && ((k.parsed = M), (k.raw = c.data[v])),
        u &&
          (k.options =
            d || this.resolveDataElementOptions(v, _.active ? "active" : n)),
        x || this.updateElement(_, v, k, n),
        (y = M);
    }
...
function Tr(i, t, e, s) {
  ...
  if (r && t === r.axis && t !== "r" && a && o.length) {
    const l = r._reversePixels ? ta : xt;
    if (s) {
      if (n._sharedOptions) {
        const c = o[0],
...
function Rr(i, t, e, s) {
  ...
  function o(a, r, l) {
    const { startAngle: c, endAngle: h } = a.getProps(
      ...
      { angle: d } = wn(a, { x: t.x, y: t.y });
    ge(d, c, h) && n.push({ element: a, datasetIndex: r, index: l });
  }
  return Me(i, e, t, o), n;
}
...
function ne(i, t, e, s) {
  ...
  for (o = 0, a = i.length, c = 0; o < a; ++o) {
    (r = i[o]),
      (l = r.box),
      l.update(r.width || t.w, r.height || t.h, Hr(r.horizontal, t));
...
var q = {
  ...
  update(i, t, e, s) {
    ...
    ne(r.fullSize, f, d, g),
      ...
      Nr(f),
      Ts(r.leftAndTop, f, d, g),
      (f.x += f.w),
      (f.y += f.h),
      Ts(r.rightAndBottom, f, d, g),
      (i.chartArea = {
        left: f.left,
        top: f.top,
        right: f.left + f.w,
...
function Qr(i, t, e) {
  ...
  return a.observe(n), Zr(i, o), a;
}
function pi(i, t, e) {
  e && e.disconnect(), t === "resize" && Jr(i);
}
function tl(i, t, e) {
  const s = i.canvas,
    n = On((o) => {
...
class el extends Jn {
  ...
  addEventListener(t, e, s) {
    ...
    const n = t.$proxies || (t.$proxies = {}),
      a = { attach: qr, detach: Gr, resize: Qr }[e] || tl;
    n[e] = a(t, e, s);
  }
  removeEventListener(t, e) {
    const s = t.$proxies || (t.$proxies = {}),
      n = s[e];
    if (!n) return;
    (({ attach: pi, detach: pi, resize: pi }[e] || Ur)(t, e, n),
      (s[e] = void 0));
  }
  getDevicePixelRatio() {
...
function il(i) {
  return !Nn() || (typeof OffscreenCanvas < "u" && i instanceof OffscreenCanvas)
    ? jr
    : el;
}
class lt {
...
S(lt, "defaults", {}), S(lt, "defaultRoutes");
function sl(i, t) {
  const e = i.options.ticks,
    s = nl(i),
    n = Math.min(e.maxTicksLimit || s, s),
    o = e.major.enabled ? al(t) : [],
    a = o.length,
    r = o[0],
    l = o[a - 1],
    c = [];
  if (a > n) return rl(t, c, o, a / n), c;
  const h = ol(o, t, n);
  if (a > 0) {
    let d, u;
    const f = a > 1 ? Math.round((l - r) / (a - 1)) : null;
    for (Te(t, c, h, T(f) ? 0 : r - f, r), d = 0, u = a - 1; d < u; d++)
      Te(t, c, h, o[d], o[d + 1]);
    return Te(t, c, h, l, T(f) ? t.length : l + f), c;
  }
  return Te(t, c, h), c;
}
function nl(i) {
...
const cl = (i) => (i === "left" ? "right" : i === "right" ? "left" : i),
  Es = (i, t, e) => (t === "top" || t === "left" ? i[t] + e : i[t] - e),
  Fs = (i, t) => Math.min(t || i, i);
function Is(i, t) {
  const e = [],
    s = i.length / t,
    n = i.length;
...
function gl(i, t, e) {
  let s = Ni(i);
  return ((e && t !== "right") || (!e && t === "right")) && (s = cl(s)), s;
}
function pl(i, t, e, s) {
  ...
  if (i.isHorizontal()) {
    if (((f = K(s, o, r)), A(e))) {
      ...
      e === "center" ? (g = (c.bottom + c.top) / 2 + p - t) : (g = Es(i, e, t));
    u = r - o;
  } else {
    if (A(e)) {
      const b = Object.keys(e)[0],
      ...
      e === "center" ? (f = (c.left + c.right) / 2 - m + t) : (f = Es(i, e, t));
...
class Bt extends lt {
  ...
  update(t, e, s) {
    ...
    this.beforeUpdate(),
      ...
      this._dataLimitsCached ||
        ...
        (this._range = wa(this, o, n)),
        (this._dataLimitsCached = !0)),
      this.beforeBuildTicks(),
      (this.ticks = this.buildTicks() || []),
      this.afterBuildTicks();
    const l = r < this.ticks.length;
    this._convertTicksToLabels(l ? Is(this.ticks, r) : this.ticks),
      this.configure(),
  ...
  calculateLabelRotation() {
    const t = this.options,
      e = t.ticks,
      s = Fs(this.ticks.length, t.ticks.maxTicksLimit),
      n = e.minRotation || 0,
      o = e.maxRotation;
    let a = n,
      r,
  ...
  _computeLabelSizes(t, e, s) {
    ...
    for (d = 0; d < e; d += l) {
      if (
        ...
        (y = Ge(n, b.data, b.gc, y, g)), (v = x);
      else if (I(g))
        for (u = 0, f = g.length; u < f; ++u)
          (_ = g[u]),
            !T(_) && !I(_) && ((y = Ge(n, b.data, b.gc, y, _)), (v += x));
  ...
  getContext(t) {
    ...
    if (t >= 0 && t < e.length) {
      const s = e[t];
      return s.$context || (s.$context = fl(this.getContext(), t, s));
    }
  ...
  _computeGridLineItems(t) {
    ...
    for (y = 0; y < d; y += E) {
      const B = this.getContext(y),
        ...
        Kt = H.tickColor,
        qt = H.tickBorderDash || [],
        Gt = H.tickBorderDashOffset;
      (v = hl(this, y, l)),
        v !== void 0 &&
          ((_ = Ot(s, v, U)),
          c ? (M = w = O = L = _) : (k = P = C = X = _),
          f.push({
            tx1: M,
            ty1: k,
            tx2: w,
        ...
        ? ((_ = w),
          ...
          n === "top"
            ? c === "near" || p !== 0
              ? (L = -C * O + O / 2)
              : c === "center"
              ? (L = -Q.highest.height / 2 - B * O + O)
              : (L = -Q.highest.height + O / 2)
            : c === "near" || p !== 0
            ? (L = O / 2)
            : c === "center"
            ? (L = Q.highest.height / 2 - B * O)
            : (L = Q.highest.height - C * O),
          d && (L *= -1),
          p !== 0 && !E.showLabelBackdrop && (_ += (O / 2) * Math.sin(p)))
        : ((M = w), (L = ((1 - C) * O) / 2));
      let ke;
      if (E.showLabelBackdrop) {
        const Wt = G(E.backdropPadding),
          Ut = Q.heights[b],
          Kt = Q.widths[b];
        let qt = L - Wt.top,
          Gt = 0 - Wt.left;
...
function ml(i, t, e) {
  const s = fe(Object.create(null), [e ? j.get(e) : {}, j.get(t), i.defaults]);
  j.set(t, s),
    i.defaultRoutes && bl(t, i.defaultRoutes),
...
class _l {
  constructor() {
    (this.controllers = new Le(rt, "datasets", !0)),
      (this.elements = new Le(lt, "elements")),
      (this.plugins = new Le(Object, "plugins")),
      (this.scales = new Le(Bt, "scales")),
...
function kl(i, { plugins: t, localIds: e }, s, n) {
  ...
  for (const r of t) {
    ...
    c !== null &&
      o.push({
        plugin: r,
        options: wl(i.config, { plugin: r, local: e[l] }, c, a),
      });
  }
  return o;
}
function wl(i, { plugin: t, local: e }, s, n) {
...
function Qe(i, t) {
  if (
    ...
    i === "r" ||
    ((i =
      t.axis || Dl(t.position) || (i.length > 1 && Qe(i[0].toLowerCase(), t))),
    i)
  )
    return i;
  throw new Error(
...
function eo(i) {
  ...
  (t.plugins = D(t.plugins, {})), (t.scales = Ol(i, t));
}
function io(i) {
  return (
    (i = i || {}),
  ...
  getOptionScopes(t, e, s) {
    ...
    e.forEach((h) => {
      t && (l.add(t), h.forEach((d) => ee(l, t, d))),
        ...
        h.forEach((d) => ee(l, It[o] || {}, d)),
        h.forEach((d) => ee(l, j, d)),
        h.forEach((d) => ee(l, vi, d));
    });
    const c = Array.from(l);
    return (
      c.length === 0 && c.push(Object.create(null)), so.has(e) && a.set(e, c), c
    );
  }
  chartOptionScopes() {
    const { options: t, type: e } = this;
    return [t, It[e] || {}, j.datasets[e] || {}, { type: e }, j, vi];
  }
...
const Tl = (i) =>
  A(i) && Object.getOwnPropertyNames(i).reduce((t, e) => t || St(i[e]), !1);
function Ll(i, t) {
  const { isScriptable: e, isIndexable: s } = Fn(i);
  for (const n of t) {
    const o = e(n),
      a = s(n),
      r = (a || o) && i[n];
    if ((o && (St(r) || Tl(r))) || (a && I(r))) return !0;
  }
  return !1;
}
var Rl = "4.2.1";
...
class mt {
  ...
  constructor(t, e) {
    ...
    (this.platform = new (s.platform || il(n))()),
    ...
    if (
      ...
      (this.scales = {}),
      (this._plugins = new yl()),
      (this.$proxies = {}),
      (this._hiddenIndices = {}),
      (this.attached = !1),
      (this._animationsDisabled = void 0),
      (this.$context = void 0),
      (this._doResize = sa((d) => this.update(d), a.resizeDelay || 0)),
      (this._dataChanges = []),
      (je[this.id] = this),
      !r || !l)
    ) {
    ...
    ft.listen(this, "complete", Hs),
      ft.listen(this, "progress", Fl),
      this._initialize(),
  ...
  _initialize() {
    return (
      ...
      this.options.responsive
        ? this.resize()
        : fs(this, this.options.devicePixelRatio),
      this.bindEvents(),
    ...
    e &&
      ...
      R(o, (a) => {
        const r = a.options,
          ...
          c = Qe(l, r),
          h = D(r.type, a.dtype);
        (r.position === void 0 || Ws(r.position, c) !== Ws(a.dposition)) &&
    ...
    for (this._removeUnreferencedMetasets(), s = 0, n = e.length; s < n; s++) {
      ...
      if (
        ...
        const l = ht.getController(r),
          { datasetElementType: c, dataElementType: h } = j.datasets[r];
        Object.assign(l, {
  ...
  _checkEventBindings() {
    const t = this.options,
      ...
      s = new Set(t.events);
    (!es(e, s) || !!this._responsiveListeners !== t.responsive) &&
  ...
  _getUniformDataChanges() {
    ...
    const e = this.data.datasets.length,
      ...
      n = s(0);
    for (let o = 1; o < e; o++) if (!es(n, s(o))) return;
    return Array.from(n)
      .map((o) => o.split(","))
  ...
  _stop() {
    let t, e;
    for (
      this.stop(), ft.remove(this), t = 0, e = this.data.datasets.length;
      t < e;
      ++t
    )
...
function Nl(i, t, e, s) {
  const n = Wl(i.options.borderRadius),
    o = (e - t) / 2,
    a = Math.min(o, (s * t) / 2),
    r = (l) => {
...
function Hl(i, t, e, s, n) {
  ...
  return ti(i, t, e, s, l, n), i.fill(), l;
}
function jl(i, t, e, s, n) {
  ...
  d && Vl(i, t, u), o || (ti(i, t, e, s, u, n), i.stroke());
}
class $e extends lt {
  constructor(t) {
    super(),
  ...
  inRange(t, e, s) {
    const n = this.getProps(["x", "y"], s),
      { angle: o, distance: a } = wn(n, { x: t, y: e }),
      {
        startAngle: r,
        endAngle: l,
        innerRadius: c,
  ...
  draw(t) {
    ...
    const l = 1 - Math.sin(Math.min(V, s || 0)),
      c = n * l;
...
S($e, "id", "arc"),
  ...
  S($e, "defaultRoutes", { backgroundColor: "backgroundColor" });
function oo(i, t, e = t) {
...
function Xl(i, t, e, s) {
  const { points: n, options: o } = t,
    { count: a, start: r, loop: l, ilen: c } = ao(n, e, s),
    h = Yl(o);
...
function Ul(i, t, e, s) {
  const n = t.points,
    { count: o, start: a, ilen: r } = ao(n, e, s),
...
const Zl = typeof Path2D == "function";
function Jl(i, t, e, s) {
  Zl && !t.options.segment ? ql(i, t, e, s) : Gl(i, t, e, s);
}
class vt extends lt {
  constructor(t) {
    super(),
  ...
  updateControlPoints(t, e) {
    ...
    if (
      ...
      Wa(this._points, s, t, n, e), (this._pointsUpdated = !0);
    }
  }
  set points(t) {
    (this._points = t),
  ...
  interpolate(t, e) {
    const s = this.options,
      n = t[e],
      o = this.points,
      a = Xn(this, { property: e, start: n, end: n });
    if (!a.length) return;
    const r = [],
      l = Kl(s);
    let c, h;
  ...
  draw(t, e, s, n) {
    ...
    (this.points || []).length &&
      o.borderWidth &&
      (t.save(), Jl(t, this, s, n), t.restore()),
...
const Pi = [
  ...
  Xs = Pi.map((i) => i.replace("rgb(", "rgba(").replace(")", ", 0.5)"));
function lo(i) {
...
var hc = {
  ...
  beforeLayout(i, t, e) {
    ...
    const {
      ...
      { elements: o } = n;
    if (!e.forceOverride && (Us(s) || cc(n) || (o && Us(o)))) return;
    const a = lc(i);
    s.forEach(a);
  },
};
...
function fc(i, t) {
  ...
  return (
    l && (s = Y(xt(t, o.axis, a).lo, 0, e - 1)),
    c ? (n = Y(xt(t, o.axis, r).hi + 1, s, e) - s) : (n = e - s),
    { start: s, count: n }
  );
}
var gc = {
...
function uo(i, t) {
  let e = [],
    s = !1;
  return (
    I(i) ? ((s = !0), (e = i)) : (e = mc(i, t)),
    e.length
      ? new vt({ points: e, options: { tension: 0 }, _loop: s, _fullLoop: s })
      : null
  );
}
function Gs(i) {
...
function kc(i) {
  ...
  for (let l = 0; l < o.length; l++) {
    const c = o[l];
    for (let h = c.start; h <= c.end; h++) Sc(n, a[h], r);
  }
...
function Sc(i, t, e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const o = e[n],
      { first: a, last: r, point: l } = Pc(o, t, "x");
    if (!(!l || (a && r))) {
      if (a) s.unshift(l);
...
function Cc(i) {
  return (i.scale || {}).getPointPositionForValue ? Tc(i) : Ac(i);
}
function Ac(i) {
...
function Lc(i, t) {
  ...
  i.save(),
    l === "x" &&
      o !== n &&
      (Zs(i, s, a.top),
      Js(i, { line: e, target: s, color: n, scale: r, property: l }),
      i.restore(),
      i.save(),
      Zs(i, s, a.bottom)),
    Js(i, { line: e, target: s, color: o, scale: r, property: l }),
    i.restore();
}
function Zs(i, t, e) {
...
function Js(i, t) {
  ...
  for (const { source: l, target: c, start: h, end: d } of r) {
    const { style: { backgroundColor: u = o } = {} } = l,
      f = s !== !0;
    i.save(), (i.fillStyle = u), Rc(i, a, f && Di(n, h, d)), i.beginPath();
    const g = !!e.pathSegment(i, l);
    let p;
    if (f) {
      g ? i.closePath() : Qs(i, s, d, n);
...
var Ec = {
  ...
  afterDatasetsUpdate(i, t, e) {
    ...
    for (a = 0; a < s; ++a)
      (o = i.getDatasetMeta(a)),
        ...
        n.push(l);
    for (a = 0; a < s; ++a)
      (l = n[a]), !(!l || l.fill === !1) && (l.fill = bc(n, a, e.propagate));
  },
  beforeDraw(i, t, e) {
    ...
    for (let a = n.length - 1; a >= 0; --a) {
      const r = n[a].$filler;
      r &&
        (r.line.updateControlPoints(o, r.axis), s && r.fill && xi(i.ctx, r, o));
    }
  },
  beforeDatasetsDraw(i, t, e) {
    ...
    for (let n = s.length - 1; n >= 0; --n) {
      const o = s[n].$filler;
      Gs(o) && xi(i.ctx, o, i.chartArea);
    }
  },
  beforeDatasetDraw(i, t, e) {
    const s = t.meta.$filler;
    !Gs(s) || e.drawTime !== "beforeDatasetDraw" || xi(i.ctx, s, i.chartArea);
  },
...
class en extends lt {
  ...
  fit() {
    ...
    const s = t.labels,
      ...
      { boxWidth: r, itemHeight: l } = tn(s, o);
    let c, h;
    (e.font = n.string),
      this.isHorizontal()
  ...
  _fitCols(t, e, s, n) {
    ...
    return (
      this.legendItems.forEach((m, b) => {
        const { itemWidth: x, itemHeight: y } = Ic(s, e, o, m, n);
        b > 0 &&
          f + y + 2 * r > h &&
          ((d += u + r),
  ...
  _draw() {
    const { options: t, columnSizes: e, lineWidths: s, ctx: n } = this,
      { align: o, labels: a } = t,
      r = j.color,
      l = jt(t.rtl, this.left, this.width),
      c = $(a.font),
      { padding: h } = a,
      d = c.size,
      u = d / 2;
    ...
    this.drawTitle(),
      ...
      (n.lineWidth = 0.5),
      (n.font = c.string);
    const { boxWidth: g, boxHeight: p, itemHeight: m } = tn(a, d),
      b = function (M, k, w) {
        ...
        if (
          ...
          const O = {
            ...
            C = l.xPlus(M, g / 2),
            L = k + u;
          Rn(n, O, C, L, a.pointStyleWidth && g);
        } else {
          const O = k + Math.max((d - p) / 2, 0),
            C = l.leftForLtr(M, g),
            L = Et(w.borderRadius);
          n.beginPath(),
            Object.values(L).some((X) => X !== 0)
              ? me(n, { x: C, y: O, w: g, h: p, radius: L })
              : n.rect(C, O, g, p),
            n.fill(),
            P !== 0 && n.stroke();
        }
      ...
      l.setWidth(this.width),
        y
          ...
          : k > 0 &&
            ...
            f.line++,
            (L = f.y = K(o, this.top + v + h, this.bottom - e[f.line].height)));
      const X = l.x(C);
      if (
        (b(X, L, M),
        (C = na(P, C + g + u, y ? C + O : this.right, t.rtl)),
        x(l.x(C), L, M),
        y)
      )
        f.x += O + h;
  ...
  drawTitle() {
    const t = this.options,
      ...
      n = G(e.padding);
    if (!e.display) return;
    const o = jt(t.rtl, this.left, this.width),
      a = this.ctx,
      r = e.position,
      l = s.size / 2,
      c = n.top + l;
  ...
  _getLegendItemAt(t, e) {
    ...
    if (bt(t, this.left, this.right) && bt(e, this.top, this.bottom)) {
      for (o = this.legendHitBoxes, s = 0; s < o.length; ++s)
        if (
          ((n = o[s]),
          bt(t, n.left, n.left + n.width) && bt(e, n.top, n.top + n.height))
        )
  ...
  _drawArgs(t) {
    ...
    return (
      this.isHorizontal()
        ...
        : (a.position === "left"
            ? ((h = s + t), (d = K(r, n, e)), (l = V * -0.5))
            : ((h = o - t), (d = K(r, e, n)), (l = V * 0.5)),
          (c = n - e)),
...
function Nc(i, t) {
  const e = new qi({ ctx: i.ctx, options: t, chart: i });
...
var jc = {
  id: "subtitle",
  start(i, t, e) {
    const s = new qi({ ctx: i.ctx, options: e, chart: i });
...
function nn(i, t, e) {
  const s = e.yAlign || t.yAlign || Yc(i, e);
  return { xAlign: e.xAlign || t.xAlign || Uc(i, t, e, s), yAlign: s };
}
function Kc(i, t) {
  let { x: e, width: s } = i;
...
function on(i, t, e, s) {
  const { caretSize: n, caretPadding: o, cornerRadius: a } = i,
    { xAlign: r, yAlign: l } = e,
    c = n + o,
    { topLeft: h, topRight: d, bottomLeft: u, bottomRight: f } = Et(a);
  let g = Kc(t, r);
  const p = qc(t, l, c);
  return (
    l === "center"
...
class Oi extends lt {
  ...
  getContext() {
    return (
      this.$context ||
      (this.$context = Gc(this.chart.getContext(), this, this._tooltipItems))
    );
  }
  getTitle(t, e) {
    const { callbacks: s } = e,
    ...
    let r = [];
    return (r = ct(r, gt(n))), (r = ct(r, gt(o))), (r = ct(r, gt(a))), r;
  }
  getBeforeBody(t, e) {
    return an(Z(e.callbacks, "beforeBody", this, t));
  }
  getBody(t, e) {
    const { callbacks: s } = e,
      n = [];
    return (
      R(t, (o) => {
        const a = { before: [], lines: [], after: [] },
          r = rn(s, o);
        ct(a.before, gt(Z(r, "beforeLabel", this, o))),
          ct(a.lines, Z(r, "label", this, o)),
          ct(a.after, gt(Z(r, "afterLabel", this, o))),
          n.push(a);
      }),
      n
    );
  ...
  getAfterBody(t, e) {
    return an(Z(e.callbacks, "afterBody", this, t));
  }
  getFooter(t, e) {
    const { callbacks: s } = e,
  ...
  _createItems(t) {
    ...
    let r = [],
      l,
      c;
    for (l = 0, c = e.length; l < c; ++l) r.push($c(this.chart, e[l]));
    return (
  ...
  getCaretPosition(t, e, s) {
    const { xAlign: n, yAlign: o } = this,
      ...
      { topLeft: l, topRight: c, bottomLeft: h, bottomRight: d } = Et(r),
      { x: u, y: f } = t,
      { width: g, height: p } = e;
    let m, b, x, y, v, _;
    return (
      o === "center"
        ? ((v = f + p / 2),
          n === "left"
            ? ((m = u), (b = m - a), (y = v + a), (_ = v - a))
            : ((m = u + g), (b = m + a), (y = v - a), (_ = v + a)),
          (x = m))
        : (n === "left"
            ? (b = u + Math.max(l, h) + a)
            : n === "right"
            ...
            : (b = this.caretX),
          o === "top"
            ? ((y = f), (v = y - a), (m = b - a), (x = b + a))
            : ((y = f + p), (v = y + a), (m = b + a), (x = b - a)),
          (_ = y)),
  ...
  _drawColorBox(t, e, s, n, o) {
    ...
    if (o.usePointStyle) {
      ...
      Object.values(x).some((y) => y !== 0)
        ? (t.beginPath(),
          (t.fillStyle = o.multiKeyBackground),
          me(t, { x: m, y: p, w: c, h: l, radius: x }),
          t.fill(),
          t.stroke(),
          (t.fillStyle = a.backgroundColor),
          t.beginPath(),
          me(t, { x: b, y: p + 1, w: c - 2, h: l - 2, radius: x }),
          t.fill())
        : ((t.fillStyle = o.multiKeyBackground),
          t.fillRect(m, p, c, l),
  ...
  drawBody(t, e, s) {
    ...
    let u = d.lineHeight,
      f = 0;
    const g = jt(s.rtl, this.x, this.width),
      p = function (w) {
...
function th(i, t, e, s) {
  const n = i.indexOf(t);
  if (n === -1) return Qc(i, t, e, s);
  const o = i.lastIndexOf(t);
  return n !== o ? e : n;
}
const eh = (i, t) => (i === null ? null : Y(Math.round(i), 0, t));
function ln(i) {
...
class Ci extends Bt {
  ...
  parse(t, e) {
    ...
    return (
      (e =
        isFinite(e) && s[e] === t ? e : th(s, t, D(e, t), this._addedLabels)),
      eh(e, s.length - 1)
    );
  }
  determineDataLimits() {
...
S(Ci, "id", "category"), S(Ci, "defaults", { ticks: { callback: ln } });
function ih(i, t) {
  const e = [],
    {
      bounds: n,
  ...
  (P = Math.ceil(m / _) - Math.floor(p / _)),
    ...
    n === "ticks"
      ? ((k = Math.floor(p / _) * _), (w = Math.ceil(m / _) * _))
      : ((k = p), (w = m)),
    b && x && o && Zo((r - a) / o, _ / 1e3)
      ...
      : ((P = (w - k) / _),
        le(P, Math.round(P), _ / 1e3)
          ? (P = Math.round(P))
          : (P = Math.ceil(P)));
  const O = Math.max(ns(_), ns(k));
  (M = Math.pow(10, T(l) ? O : l)),
    (k = Math.round(k * M) / M),
    (w = Math.round(w * M) / M);
  let C = 0;
  for (
    ...
    (u && k !== a
      ? (e.push({ value: a }),
        k < a && C++,
        le(Math.round((k + C * _) * M) / M, a, cn(a, v, i)) && C++)
      : k < a && C++);
    C < P;
    ++C
  )
    e.push({ value: Math.round((k + C * _) * M) / M });
  return (
    x && u && w !== r
      ? e.length && le(e[e.length - 1].value, r, cn(r, v, i))
...
class ei extends Bt {
  ...
  buildTicks() {
    ...
    const n = {
      ...
      a = ih(n, o);
    return (
      t.bounds === "ticks" && kn(a, this, "value"),
      t.reverse
...
S(Ai, "id", "linear"),
  S(Ai, "defaults", { ticks: { callback: ii.formatters.numeric } });
const xe = (i) => Math.floor(yt(i)),
...
class Ti extends Bt {
  ...
  determineDataLimits() {
    ...
    (this.min = W(t) ? Math.max(0, t) : null),
      ...
      this._zero &&
        ...
        !W(this._userMin) &&
        (this.min = t === At(this.min, 0) ? At(this.min, -1) : At(this.min, 0)),
      this.handleTickRangeOptions();
  }
  handleTickRangeOptions() {
    const { minDefined: t, maxDefined: e } = this.getUserBounds();
    ...
    const o = (r) => (s = t ? s : r),
      a = (r) => (n = e ? n : r);
    s === n && (s <= 0 ? (o(1), a(10)) : (o(At(s, -1)), a(At(n, 1)))),
      s <= 0 && o(At(n, -1)),
      n <= 0 && a(At(s, 1)),
      (this.min = s),
      (this.max = n);
  ...
  buildTicks() {
    const t = this.options,
      ...
      s = nh(e, this);
    return (
      t.bounds === "ticks" && kn(s, this, "value"),
      t.reverse
...
S(Ti, "id", "logarithmic"),
  S(Ti, "defaults", {
    ticks: { callback: ii.formatters.logarithmic, major: { enabled: !0 } },
  });
function Li(i) {
  const t = i.ticks;
...
function oh(i, t, e) {
  return (
    (e = I(e) ? e : [e]), { w: ga(i, t.string, e), h: e.length * t.lineHeight }
  );
}
...
function uh(i, t) {
  ...
  for (let n = t - 1; n >= 0; n--) {
    const o = s.setContext(i.getPointLabelContext(n)),
      ...
      { backdropColor: g } = o;
    if (!T(g)) {
      const p = Et(o.borderRadius),
        m = G(o.backdropPadding);
      e.fillStyle = g;
      const b = h - m.left,
        x = d - m.top,
        y = u - h + m.width,
      ...
      Object.values(p).some((_) => _ !== 0)
        ? (e.beginPath(),
          me(e, { x: b, y: x, w: y, h: v, radius: p }),
          e.fill())
        : e.fillRect(b, x, y, v);
    }
    zt(e, i._pointLabels[n], r, l + a.lineHeight / 2, a, {
      color: o.color,
      textAlign: c,
      textBaseline: "middle",
    });
...
class ae extends ei {
  ...
  generateTickLabels(t) {
    ei.prototype.generateTickLabels.call(this, t),
  ...
  drawLabels() {
    ...
    t.save(),
      ...
      this.ticks.forEach((r, l) => {
        ...
        zt(t, r.label, 0, -o, h, { color: c.color });
      }),
      t.restore();
  }
  drawTitle() {}
}
S(ae, "id", "radialLinear"),
  S(ae, "defaults", {
    display: !0,
    animate: !0,
    position: "chartArea",
    ...
    grid: { circular: !1 },
    startAngle: 0,
    ticks: { showLabelBackdrop: !0, callback: ii.formatters.numeric },
    pointLabels: {
  ...
  S(ae, "descriptors", { angleLines: { _fallback: "grid" } });
const ai = {
...
class _e extends Bt {
  ...
  init(t, e = {}) {
    const s = t.time || (t.time = {}),
      n = (this._adapter = new Ar._date(t.adapters.date));
    n.init(e),
    ...
    return (
      (this._unit =
        ...
        (s.autoSkip
          ...
          : mh(this, r.length, e.minUnit, this.min, this.max))),
      (this._majorUnit =
        !s.major.enabled || this._unit === "year" ? void 0 : bh(this._unit)),
      this.initOffsets(n),
      t.reverse && r.reverse(),
      mn(this, r, this._majorUnit)
    );
  }
  afterAutoSkip() {
  ...
  _generate() {
    const t = this._adapter,
      ...
      n = this.options,
      o = n.time,
      a = o.unit || gn(o.minUnit, e, s, this._getLabelCapacity(e)),
    ...
    for (u = d, f = 0; u < s; u = +t.add(u, r, a), f++) pn(h, u, g);
    return (
      (u === s || n.bounds === "ticks" || f === 1) && pn(h, u, g),
      Object.keys(h)
        .sort((p, m) => p - m)
        .map((p) => +p)
    );
...
function Ie(i, t, e) {
  let s = 0,
    ...
    l;
  e
    ? (t >= i[s].pos && t <= i[n].pos && ({ lo: s, hi: n } = xt(i, "pos", t)),
      ({ pos: o, time: r } = i[s]),
      ({ pos: a, time: l } = i[n]))
    : (t >= i[s].time &&
        t <= i[n].time &&
        ({ lo: s, hi: n } = xt(i, "time", t)),
      ({ time: o, pos: r } = i[s]),
      ({ time: a, pos: l } = i[n]));
  const c = a - o;
...
S(Ri, "id", "timeseries"), S(Ri, "defaults", _e.defaults);
...
const yh = [Cr, nc, Jc, _h];
mt.register(...yh);
const it = new mt(document.getElementById("chart"), {
    data: { labels: [], datasets: [] },
  }),
  bn = (i) => {
    const t = i.active.map((s) => `feature=${s}`).join("&"),
      e = `${i.endpoint}?source=${i.source}&${t}`;
    return fetch(e, {
      headers: { "Content-Type": "application/json; charset=utf-8" },
      method: "POST",
      mode: "cors",
      body: JSON.stringify({ geometry: i.geometry }),
    }).then(function (s) {
      return s.json();
    });
  };
...
window.addEventListener("message", (i) => {
  i.data === "init" && ((Ei = i.ports[0]), (Ei.onmessage = vh));
});
const vh = (i) => {
    if (i.data.ts)
      switch (i.data.type) {
        case "getFoo":
          console.log(i.data.body),
            Ei.postMessage({ ts: i.data.ts, body: "foo bar" });
          break;
      }
    else
      switch (i.data.type) {
        case "setData":
          (it.data = i.data.body.data), it.update("none");
          break;
        case "setSignalsEndpoint":
          Mh(i.data.body.options);
          break;
        case "setSignalsData":
          (it.data = {
            datasets: Object.entries(i.data.body.data).map(([t, e]) => ({
              type: "line",
              label: t,
              data: e,
            })),
          ...
          break;
        case "setOptions":
          (it.options = i.data.body.options), it.update("none");
          break;
      }
  },
  Mh = (i) => {
    (it.options = {
      parsing: { xAxisKey: "date", yAxisKey: "basicStats.mean" },
      plugins: {
        legend: {
          position: "right",
          onClick: (t, e) => {
            e.hidden &&
              it.data.datasets[e.datasetIndex].data.length === 0 &&
              ((i.active = [e.text]),
              bn(i).then(function (s) {
                (it.data.datasets[e.datasetIndex].data = s[e.text]),
                  (it.data.datasets[e.datasetIndex].hidden = !1),
                  it.update("none");
              }));
          },
        },
      ...
      bn(i).then(function (t) {
        (it.data = {
          datasets: i.features.map((e) => ({
            type: "line",
            label: e,
            data: t[e] ? t[e] : [],
            hidden: !t[e],
