...
const it = {
  ...
  xi = [..."0123456789ABCDEF"],
  xo = (i) => xi[i & 15],
  _o = (i) => xi[(i & 240) >> 4] + xi[i & 15],
  ke = (i) => (i & 240) >> 4 === (i & 15),
  yo = (i) => ke(i.r) && ke(i.g) && ke(i.b) && ke(i.a);
function vo(i) {
  var t = i.length,
    e;
  return (
...
function To(i, t) {
  var e = Ei(i);
  (e[0] = xn(e[0] + t)), (e = Ii(e)), (i.r = e[0]), (i.g = e[1]), (i.b = e[2]);
}
function Lo(i) {
  if (!i) return;
  const t = Ei(i),
...
let we;
function Eo(i) {
  we || ((we = Ro()), (we.transparent = [0, 0, 0, 0]));
...
const Pe = (i) => i === 0 || i === 1,
  os = (i, t, e) => -(Math.pow(2, 10 * (i -= 1)) * Math.sin(((i - t) * z) / e)),
  as = (i, t, e) => Math.pow(2, -10 * i) * Math.sin(((i - t) * z) / e) + 1,
  le = {
    linear: (i) => i,
    easeInQuad: (i) => i * i,
    easeOutQuad: (i) => -i * (i - 2),
    ...
    easeInElastic: (i) => (Pe(i) ? i : os(i, 0.075, 0.3)),
    easeOutElastic: (i) => (Pe(i) ? i : as(i, 0.075, 0.3)),
    easeInOutElastic(i) {
      return Pe(i)
        ? i
        : i < 0.5
    ...
    easeInOutBounce: (i) =>
      i < 0.5
        ? le.easeInBounce(i * 2) * 0.5
        : le.easeOutBounce(i * 2 - 1) * 0.5 + 0.5,
  };
function An(i) {
...
function rs(i) {
  return An(i) ? i : new de(i);
}
function ri(i) {
  return An(i) ? i : new de(i).saturate(0.5).darken(0.1).hexString();
}
...
function fa(i, t, e, s) {
  ...
  let l, c, h, d, u;
  for (l = 0; l < r; l++)
    if (((d = e[l]), d != null && I(d) !== !0)) a = qe(i, n, o, a, d);
    else if (I(d))
...
function Rn(i) {
  return Ni(i, { top: "y", right: "x", bottom: "y", left: "x" });
}
function Rt(i) {
  return Ni(i, ["topLeft", "topRight", "bottomLeft", "bottomRight"]);
}
function G(i) {
  const t = Rn(i);
...
function $i(i, t, e, s) {
  ...
  return l === null ||
    (st(o) && o !== e && ((l = hs(r, a, o, l, s)), l === null))
    ? !1
    : Hi(Array.from(r), [""], n, o, () => Aa(t, e, s));
}
...
function Ta(i, t, e, s) {
  let n;
  for (const o of t)
    if (((n = zn(wa(o, i), e)), st(n))) return ji(i, n) ? $i(e, s, i, n) : n;
}
function zn(i, t) {
  for (const e of t) {
    if (!e) continue;
...
function Ya(i, t, e, s) {
  ...
  return (
    ...
    (c = Oe(Math.min(c, a, l.maxWidth))),
    (h = Oe(Math.min(h, r, l.maxHeight))),
    c && !h && (h = Oe(c / 2)),
    (t !== void 0 || e !== void 0) &&
      s &&
      l.height &&
      h > l.height &&
      ((h = l.height), (c = Oe(Math.floor(h * s)))),
    { width: c, height: h }
  );
}
function us(i, t, e) {
...
function jn(i) {
  return i === "angle"
    ? { between: fe, compare: Zo, normalize: et }
    ...
    (x = t[w % a]),
      !x.skip &&
        ...
        b !== y &&
          ...
          m !== null &&
            k() &&
            (g.push(gs({ start: m, end: w, loop: u, count: a, style: f })),
            (m = null)),
          (P = w),
          (y = b)));
  return (
    m !== null && g.push(gs({ start: m, end: d, loop: u, count: a, style: f })),
    g
  );
}
function Yn(i, t) {
...
function tr(i, t) {
  ...
  if (s === !0) return ps(i, [{ start: a, end: r, loop: o }], e, t);
  const l = r < a ? r + n : r,
    c = !!i._fullLoop && a === 0 && r === n - 1;
  return ps(i, Qa(e, a, l, c), e, t);
}
function ps(i, t, e, s) {
...
class at {
  ...
  _destroy() {
    const t = this._cachedMeta;
    this._data && ns(this._data, this), t._stacked && Gt(t);
  }
  _dataCheck() {
  ...
  applyStack(t, e, s) {
    ...
    return _s(r, a, o.index, { mode: s });
  }
  updateRangeFromParsed(t, e, s, n) {
    const o = s[e.axis];
    let a = o === null ? NaN : o;
    const r = n && s._stacks[e.axis];
    n && r && ((n.values = r), (a = _s(n, o, this._cachedMeta.index))),
    ...
    for (let f = e; f < e + s; f++) {
      const g = this.getParsed(f),
        ...
        x = {
          ...
          base: p.base,
          enableBorderRadius:
            !b || di(g._custom) || a === b._top || a === b._bottom,
          x: c ? p.head : m.center,
          y: c ? m.center : p.head,
...
function Dr(i, t, e) {
  ...
  if (t < z) {
    const r = i,
      ...
      d = Math.cos(l),
      u = Math.sin(l),
      f = (y, v, _) => (fe(y, r, l, !0) ? 1 : Math.max(v, v * e, _, _ * e)),
      g = (y, v, _) => (fe(y, r, l, !0) ? -1 : Math.min(v, v * e, _, _ * e)),
      p = f(0, c, d),
      m = f(N, h, u),
      b = g(V, c, d),
      x = g(V + N, h, u);
...
class Lt extends at {
  ...
  getLabelAndValue(t) {
    const e = this._cachedMeta,
      s = this.chart,
      n = s.data.labels || [],
      o = ye(e._parsed[t], s.options.locale);
...
class Be extends at {
  ...
  updateElements(t, e, s, n) {
    const o = n === "reset",
      ...
      m = jt(g) ? g : Number.POSITIVE_INFINITY,
...
class he extends at {
  ...
  getLabelAndValue(t) {
    const e = this._cachedMeta,
      s = this.chart,
      n = s.data.labels || [],
      o = ye(e._parsed[t].r, s.options.locale);
    return { label: n[t] || "", value: o };
  }
  parseObjectData(t, e, s, n) {
...
class We extends at {
  ...
  updateElements(t, e, s, n) {
    const o = n === "reset",
      ...
      b = jt(p) ? p : Number.POSITIVE_INFINITY,
...
function Lr(i, t, e, s) {
  ...
  function o(a, r, l) {
    ...
    fe(d, c, h) && n.push({ element: a, datasetIndex: r, index: l });
  }
  return ve(i, e, t, o), n;
}
...
function Vr(i, t, e, s) {
  ...
  const r = Math.max(0, t.outerWidth - Cs(a, i, "left", "right")),
    l = Math.max(0, t.outerHeight - Cs(a, i, "top", "bottom")),
    c = r !== i.w,
    h = l !== i.h;
  return (
    (i.w = r),
  ...
  for (const r of i) {
    ...
    if (r.horizontal) {
      ...
      st(c.start) && (a = c.start),
        l.fullSize
          ? Ce(l, n.left, a, e.outerWidth - n.right - n.left, u)
          : Ce(l, t.left + c.placed, a, d, u),
        (c.start = a),
        (c.placed += d),
        (a = l.bottom);
    } else {
...
var q = {
  ...
  update(i, t, e, s) {
    ...
    se(r.fullSize, f, d, g),
      ...
      Wr(f),
      As(r.leftAndTop, f, d, g),
      (f.x += f.w),
      (f.y += f.h),
      As(r.rightAndBottom, f, d, g),
      (i.chartArea = {
        left: f.left,
        top: f.top,
        right: f.left + f.w,
...
function Gr(i, t) {
  me.size || window.addEventListener("resize", Qn), me.set(i, t);
}
function Zr(i) {
  me.delete(i), me.size || window.removeEventListener("resize", Qn);
}
function Jr(i, t, e) {
  const s = i.canvas,
    n = s && Yi(s);
...
class tl extends Zn {
  ...
  removeEventListener(t, e) {
    const s = t.$proxies || (t.$proxies = {}),
      n = s[e];
    if (!n) return;
    (({ attach: gi, detach: gi, resize: gi }[e] || Xr)(t, e, n),
      (s[e] = void 0));
  }
  getDevicePixelRatio() {
...
const ll = (i) => (i === "left" ? "right" : i === "right" ? "left" : i),
  Rs = (i, t, e) => (t === "top" || t === "left" ? i[t] + e : i[t] - e),
    ...
    (r = t.offset ? this.maxWidth / s : f / (s - 1)),
      d + 6 > r &&
        ...
        (l =
          ...
          Qt(t.grid) -
          e.padding -
          Is(t.title, this.chart.options.font)),
        (c = Math.sqrt(d * d + u * u)),
        (a = Bi(
          Math.min(
    ...
    for (d = 0; d < e; d += l) {
      if (
        ...
        for (u = 0, f = g.length; u < f; ++u)
          (_ = g[u]),
            !T(_) && !I(_) && ((y = qe(n, b.data, b.gc, y, _)), (v += x));
...
function pl(i, t, e) {
  const s = ue(Object.create(null), [e ? j.get(e) : {}, j.get(t), i.defaults]);
  j.set(t, s),
...
class xl {
  constructor() {
    (this.controllers = new Te(at, "datasets", !0)),
      (this.elements = new Te(rt, "elements")),
      (this.plugins = new Te(Object, "plugins")),
      (this.scales = new Te(zt, "scales")),
...
function Je(i, t) {
  if (
    ...
    i === "r" ||
    ((i =
      t.axis || Pl(t.position) || (i.length > 1 && Je(i[0].toLowerCase(), t))),
    i)
  )
    return i;
  throw new Error(
  ...
  return (
    Object.keys(s).forEach((a) => {
      ...
      const l = Je(a, r),
        c = Sl(l, n),
        h = e.scales || {};
      o[a] = ae(Object.create(null), [{ axis: l }, r, h[l], h[c]]);
    }),
    i.data.datasets.forEach((a) => {
      ...
      Object.keys(h).forEach((d) => {
        ...
        (o[f] = o[f] || Object.create(null)),
          ae(o[f], [{ axis: u }, s[f], h[d]]);
      });
    }),
    Object.keys(o).forEach((a) => {
      const r = o[a];
      ae(r, [j.scales[r.type], j.scale]);
    }),
    o
  );
}
...
function Le(i, t) {
  let e = zs.get(i);
  return e || ((e = t()), zs.set(i, e), io.add(e)), e;
}
const te = (i, t, e) => {
  const s = kt(t, e);
  s !== void 0 && i.add(s);
...
class Cl {
  ...
  getOptionScopes(t, e, s) {
    ...
    e.forEach((h) => {
      t && (l.add(t), h.forEach((d) => te(l, t, d))),
        ...
        h.forEach((d) => te(l, Ft[o] || {}, d)),
        h.forEach((d) => te(l, j, d)),
  ...
  chartOptionScopes() {
    ...
    return [t, Ft[e] || {}, j.datasets[e] || {}, { type: e }, j, yi];
  }
...
class pt {
  ...
  _initialize() {
    return (
      ...
      this.options.responsive
        ? this.resize()
        : us(this, this.options.devicePixelRatio),
      this.bindEvents(),
    ...
    e &&
      ...
      R(o, (a) => {
        const r = a.options,
          ...
          c = Je(l, r),
          h = D(r.type, a.dtype);
        (r.position === void 0 || Vs(r.position, c) !== Vs(a.dposition)) &&
  ...
  _checkEventBindings() {
    const t = this.options,
      ...
      s = new Set(t.events);
    (!ts(e, s) || !!this._responsiveListeners !== t.responsive) &&
  ...
  _getUniformDataChanges() {
    ...
    const e = this.data.datasets.length,
      ...
      n = s(0);
    for (let o = 1; o < e; o++) if (!ts(n, s(o))) return;
    return Array.from(n)
      .map((o) => o.split(","))
...
function Vl(i) {
  return Ni(i, ["outerStart", "outerEnd", "innerStart", "innerEnd"]);
}
function Wl(i, t, e, s) {
...
S(je, "id", "arc"),
  ...
  S(je, "defaultRoutes", { backgroundColor: "backgroundColor" });
function no(i, t, e = t) {
...
const Si = [
  ...
  Ys = Si.map((i) => i.replace("rgb(", "rgba(").replace(")", ", 0.5)"));
function ro(i) {
...
var cc = {
  ...
  beforeLayout(i, t, e) {
    ...
    const {
      ...
      { elements: o } = n;
    if (!e.forceOverride && (Xs(s) || lc(n) || (o && Xs(o)))) return;
    const a = rc(i);
    s.forEach(a);
  },
};
    ...
    for (const u of d) {
      ...
      for (const p of g)
        a.push({
          source: p,
          target: u,
          start: { [e]: Ks(h, f, "start", Math.max) },
          end: { [e]: Ks(h, f, "end", Math.min) },
        });
    }
  }
  return a;
...
function Tc(i, t) {
  ...
  i.save(),
    l === "x" &&
      o !== n &&
      (Gs(i, s, a.top),
      Zs(i, { line: e, target: s, color: n, scale: r, property: l }),
      i.restore(),
      i.save(),
      Gs(i, s, a.bottom)),
    Zs(i, { line: e, target: s, color: o, scale: r, property: l }),
    i.restore();
}
function Gs(i, t, e) {
...
function Zs(i, t) {
  ...
  for (const { source: l, target: c, start: h, end: d } of r) {
    const { style: { backgroundColor: u = o } = {} } = l,
      f = s !== !0;
    i.save(), (i.fillStyle = u), Lc(i, a, f && Pi(n, h, d)), i.beginPath();
...
var Rc = {
  ...
  beforeDraw(i, t, e) {
    ...
    for (let a = n.length - 1; a >= 0; --a) {
      const r = n[a].$filler;
      r &&
        (r.line.updateControlPoints(o, r.axis), s && r.fill && bi(i.ctx, r, o));
    }
  },
...
class tn extends rt {
  ...
  fit() {
    ...
    const s = t.labels,
      ...
      { boxWidth: r, itemHeight: l } = Qs(s, o);
    let c, h;
    (e.font = n.string),
      this.isHorizontal()
  ...
  _draw() {
    const { options: t, columnSizes: e, lineWidths: s, ctx: n } = this,
      { align: o, labels: a } = t,
      r = j.color,
      l = Ht(t.rtl, this.left, this.width),
      c = $(a.font),
      { padding: h } = a,
      d = c.size,
      u = d / 2;
    ...
    this.drawTitle(),
      ...
      (n.lineWidth = 0.5),
      (n.font = c.string);
    const { boxWidth: g, boxHeight: p, itemHeight: m } = Qs(a, d),
      b = function (M, k, w) {
  ...
  drawTitle() {
    const t = this.options,
      ...
      n = G(e.padding);
    if (!e.display) return;
    const o = Ht(t.rtl, this.left, this.width),
      a = this.ctx,
      r = e.position,
      l = s.size / 2,
      c = n.top + l;
...
var Vc = {
  ...
  _element: tn,
  start(i, t, e) {
    const s = (i.legend = new tn({ ctx: i.ctx, options: e, chart: i }));
...
function Wc(i, t) {
  const e = new Ki({ ctx: i.ctx, options: t, chart: i });
...
var Hc = {
  id: "subtitle",
  start(i, t, e) {
    const s = new Ki({ ctx: i.ctx, options: e, chart: i });
...
class Di extends rt {
  ...
  getBeforeBody(t, e) {
    return on(Z(e.callbacks, "beforeBody", this, t));
  }
  getBody(t, e) {
    const { callbacks: s } = e,
      n = [];
  ...
  getAfterBody(t, e) {
    return on(Z(e.callbacks, "afterBody", this, t));
  }
  getFooter(t, e) {
    const { callbacks: s } = e,
  ...
  _drawColorBox(t, e, s, n, o) {
    ...
    if (o.usePointStyle) {
      ...
      Object.values(x).some((y) => y !== 0)
        ? (t.beginPath(),
          (t.fillStyle = o.multiKeyBackground),
          pe(t, { x: m, y: p, w: c, h: l, radius: x }),
          t.fill(),
          t.stroke(),
          (t.fillStyle = a.backgroundColor),
          t.beginPath(),
          pe(t, { x: b, y: p + 1, w: c - 2, h: l - 2, radius: x }),
          t.fill())
        : ((t.fillStyle = o.multiKeyBackground),
          t.fillRect(m, p, c, l),
  ...
  drawBody(t, e, s) {
    ...
    let u = d.lineHeight,
      f = 0;
    const g = Ht(s.rtl, this.x, this.width),
      p = function (w) {
...
var Gc = {
    ...
    positioners: ne,
    afterInit(i, t, e) {
      e && (i.tooltip = new Di({ chart: i, options: e }));
    },
    beforeUpdate(i, t, e) {
...
S(Oi, "id", "category"), S(Oi, "defaults", { ticks: { callback: rn } });
function eh(i, t) {
  const e = [],
    {
      bounds: n,
  ...
  (P = Math.ceil(m / _) - Math.floor(p / _)),
    ...
    b && x && o && Go((r - a) / o, _ / 1e3)
      ...
      : ((P = (w - k) / _),
        re(P, Math.round(P), _ / 1e3)
          ? (P = Math.round(P))
          : (P = Math.ceil(P)));
  const O = Math.max(ss(_), ss(k));
  ...
  for (
    ...
    (u && k !== a
      ? (e.push({ value: a }),
        k < a && C++,
        re(Math.round((k + C * _) * M) / M, a, ln(a, v, i)) && C++)
      : k < a && C++);
    C < P;
    ++C
  )
  ...
  return (
    x && u && w !== r
      ? e.length && re(e[e.length - 1].value, r, ln(r, v, i))
...
function ln(i, t, { horizontal: e, minRotation: s }) {
  const n = ot(s),
...
S(Ci, "id", "linear"),
  S(Ci, "defaults", { ticks: { callback: ei.formatters.numeric } });
const be = (i) => Math.floor(_t(i)),
  Ct = (i, t) => Math.pow(10, be(i) + t);
function cn(i) {
...
function sh(i, { min: t, max: e }) {
  ...
  for (; u < e; )
    s.push({ value: u, major: cn(u), significand: d }),
      d >= 10 ? (d = d < 15 ? 15 : 20) : d++,
      d >= 20 && (o++, (d = 2), (a = o >= 0 ? 1 : a)),
      (u = Math.round((l + h + d * Math.pow(10, o)) * a) / a);
  const f = tt(i.max, u);
  return s.push({ value: f, major: cn(f), significand: d }), s;
}
class Ai extends zt {
  constructor(t) {
    super(t),
...
class oe extends ti {
  ...
  setDimensions() {
    const t = (this._padding = G(Ti(this.options) / 2)),
...
S(oe, "id", "radialLinear"),
  ...
  S(oe, "descriptors", { angleLines: { _fallback: "grid" } });
const oi = {
...
class xe extends zt {
  ...
  _generate() {
    ...
    return (
      (u === s || n.bounds === "ticks" || f === 1) && gn(h, u, g),
      Object.keys(h)
        .sort((p, m) => p - m)
        .map((p) => +p)
    );
  ...
  _getLabelCapacity(t) {
    const e = this.options.time,
      ...
      o = this._tickFormatFunction(t, 0, pn(this, [t], this._majorUnit), n),
  ...
  getLabelTimestamps() {
    ...
    for (e = 0, s = n.length; e < s; ++e) t.push(un(this, n[e]));
...
class Li extends xe {
  ...
  initOffsets() {
    ...
    (this._minPos = Fe(e, this.min)),
      (this._tableRange = Fe(e, this.max) - this._minPos),
      super.initOffsets(t);
  }
  buildLookupTable(t) {
...
new pt("#chart", {
  type: "bar",
  data: {
    labels: mn.map((i) => i.year),
    datasets: [{ label: "Acquisitions by year", data: mn.map((i) => i.count) }],
  },
});
let Ri;
window.addEventListener("message", (i) => {
  i.data === "init" && ((Ri = i.ports[0]), (Ri.onmessage = yh));
});
const yh = (i) => {
  if (i.data.ts)
    switch (i.data.type) {
      case "getFoo":
        console.log(i.data.body),
          Ri.postMessage({ ts: i.data.ts, body: "foo bar" });
        break;
    }
  else
    switch (i.data.type) {
