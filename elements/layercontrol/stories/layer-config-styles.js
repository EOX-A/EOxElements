...
setTimeout(async () => {
  ...
  await document.querySelector("eox-map#config").registerProjectionFromCode(3035)
})
...
export default {
  ...
  render: () => html`
    ...
    <eox-map
      ...
      .layers=${[STORIES_LAYER_SEE, STORIES_LAYER_CROPOMHUSC2, STORIES_LAYER_TERRAIN_LIGHT]}
    >
    </eox-map>
  `,
};
