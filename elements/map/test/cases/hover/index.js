...
export { default as displayTooltipOnWMS } from "./display-wms-getFeatureInfo-tooltip";
export { default as displayTooltipCogWithCustomTooltip } from "./display-cog-tooltip-custom";
