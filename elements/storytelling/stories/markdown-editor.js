...
export const MarkdownEditor = {
  args: {
    markdown: `# Welcome to Storytelling <!--{ as="video" fullscreen="true" mode="hero" src="https://dlmultimedia.esa.int/download/public/videos/2023/06/010/2306_010_AR_EN.mp4" }-->
