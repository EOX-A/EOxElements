...
b.elementStyles = [], b.shadowRootOptions = { mode: "open" }, b[v("elementProperties")] = /* @__PURE__ */ new Map(), b[v("finalized")] = /* @__PURE__ */ new Map(), _?.({ ReactiveElement: b }), (m.reactiveElementVersions ??= []).push("2.1.1");
//#endregion
//#region ../../node_modules/lit-html/lit-html.js
var x = globalThis, S = x.trustedTypes, C = S ? S.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, ne = "$lit$", w = `lit$${Math.random().toFixed(9).slice(2)}$`, re = "?" + w, ie = `<${re}>`, T = document, E = () => T.createComment(""), D = (e) => e === null || typeof e != "object" && typeof e != "function", O = Array.isArray, ae = (e) => O(e) || typeof e?.[Symbol.iterator] == "function", k = "[ 	\n\f\r]", A = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, oe = /-->/g, se = />/g, j = RegExp(`>|${k}(?:([^\\s"'>=/]+)(${k}*=${k}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`, "g"), ce = /'/g, le = /"/g, ue = /^(?:script|style|textarea|title)$/i, de = ((e) => (t, ...n) => ({
	_$litType$: e,
	strings: t,
	values: n
}))(1), M = Symbol.for("lit-noChange"), N = Symbol.for("lit-nothing"), fe = /* @__PURE__ */ new WeakMap(), P = T.createTreeWalker(T, 129);
function pe(e, t) {
...
var me = (e, t) => {
	...
	for (let t = 0; t < n; t++) {
		...
		for (; u < n.length && (o.lastIndex = u, c = o.exec(n), c !== null);) u = o.lastIndex, o === A ? c[1] === "!--" ? o = oe : c[1] === void 0 ? c[2] === void 0 ? c[3] !== void 0 && (o = j) : (ue.test(c[2]) && (i = RegExp("</" + c[2], "g")), o = j) : o = se : o === j ? c[0] === ">" ? (o = i ?? A, l = -1) : c[1] === void 0 ? l = -2 : (l = o.lastIndex - c[2].length, s = c[1], o = c[3] === void 0 ? j : c[3] === "\"" ? le : ce) : o === le || o === ce ? o = j : o === oe || o === se ? o = A : (o = j, i = void 0);
		let d = o === j && e[t + 1].startsWith("/>") ? " " : "";
		a += o === A ? n + ie : l >= 0 ? (r.push(s), n.slice(0, l) + ne + n.slice(l) + w + d) : n + w + (l === -2 ? t : d);
	}
...
var he = class {
	...
	u(e) {
		...
		for (; s !== void 0;) {
			if (a === s.index) {
				let t;
				s.type === 2 ? t = new L(i, i.nextSibling, this, e) : s.type === 1 ? t = new s.ctor(i, s.name, s.strings, this, e) : s.type === 6 && (t = new ye(i, this, e)), this._$AV.push(t), s = n[++o];
			}
	...
	_$AI(e, t = this) {
		e = I(this, e, t), D(e) ? e === N || e == null || e === "" ? (this._$AH !== N && this._$AR(), this._$AH = N) : e !== this._$AH && e !== M && this._(e) : e._$litType$ === void 0 ? e.nodeType === void 0 ? ae(e) ? this.k(e) : this._(e) : this.T(e) : this.$(e);
	}
	O(e) {
...
}, be = x.litHtmlPolyfillSupport;
be?.(F, L), (x.litHtmlVersions ??= []).push("3.3.1");
var xe = (e, t, n) => {
...
var Se = z.litElementPolyfillSupport;
Se?.({ LitElement: B }), (z.litElementVersions ??= []).push("4.2.1");
//#endregion
//#region src/style.js
...
function W(e, t, n) {
	...
	for (let e of H) document.addEventListener(e, r, !0);
	U.set(e, r);
}
function G(e) {
	let t = U.get(e);
	if (t) {
		for (let e of H) document.removeEventListener(e, t, !0);
		U.delete(e);
	}
}
function Ee(e, t) {
...
function K(e, t, n) {
	let { align: r, side: i } = n, a = n.centered ? "over" : i, o = n.padding, s = Ee(e, n.offset), c = e.arrow.getBoundingClientRect(), l = t.getBoundingClientRect(), u = l.top - s.height, d = u >= 0, f = window.innerHeight - (l.bottom + s.height), p = f >= 0, m = l.left - s.width, h = m >= 0, g = window.innerWidth - (l.right + s.width), _ = g >= 0, v = !d && !p && !h && !_, y = a;
	if (a === "top" && d ? _ = h = p = !1 : a === "bottom" && p ? _ = h = d = !1 : a === "left" && h ? _ = d = p = !1 : a === "right" && _ && (h = d = p = !1), a === "over") {
		...
		let t = Math.min(m, window.innerWidth - s?.realWidth - c.width), n = De(r, {
			elementDimensions: l,
			popoverDimensions: s,
			popoverPadding: o,
		...
		let t = Math.min(g, window.innerWidth - s?.realWidth - c.width), n = De(r, {
			elementDimensions: l,
			popoverDimensions: s,
			popoverPadding: o,
			popoverArrowDimensions: c
		...
		let t = Math.min(u, window.innerHeight - s.realHeight - c.width), n = Oe(r, {
			elementDimensions: l,
			popoverDimensions: s,
			popoverPadding: o,
			popoverArrowDimensions: c
		...
		let t = Math.min(f, window.innerHeight - s?.realHeight - c.width), n = Oe(r, {
			elementDimensions: l,
			popoverDimensions: s,
			popoverPadding: o,
			popoverArrowDimensions: c
	...
	je(e, v ? "over" : y, r, t), [...e.wrapper.classList].filter((e) => e.startsWith("driver-popover-side-") || e.startsWith("driver-popover-align-")).forEach((t) => e.wrapper.classList.remove(t)), e.wrapper.classList.add(`driver-popover-side-${y}`), e.wrapper.classList.add(`driver-popover-align-${r}`);
}
function q(e, t, n, r, i, a = 10) {
	let o = r - n;
...
function je(e, t, n, r) {
	...
	let a = r.getBoundingClientRect(), o = e.wrapper.getBoundingClientRect(), s = Ae(t, a, o);
	i.classList.add(`driver-popover-arrow-side-${s}`);
	let c = i.getBoundingClientRect().width || 10;
	if (s === "left" || s === "right") {
		let e = q(a.top, a.bottom, o.top, o.bottom, n, c);
		i.style.top = `${ke(e, o.height, c)}px`;
	} else {
		let e = q(a.left, a.right, o.left, o.right, n, c);
		i.style.left = `${ke(e, o.width, c)}px`;
	}
}
function J(e) {
...
function ze(e, t) {
	...
	let p = n.arrow;
	p.className = "driver-popover-arrow", f.className = `driver-popover ${t.popoverClass || ""}`.trim(), W(n.wrapper, (e) => {
		let n = e.target;
	...
	}, (e) => n.description.contains(e) || n.title.contains(e) ? !1 : !!e.closest(".driver-popover-prev-btn, .driver-popover-next-btn, .driver-popover-close-btn")), t.onRender?.(n), K(n, e, t.position), Be(n, e, t.position), Pe(f, t.smoothScroll);
	let m = Ne([f, e]);
...
function He(e) {
	e && (G(e.wrapper), e.wrapper.parentElement?.removeChild(e.wrapper));
}
function Ue(e, t) {
...
function We(e, t, n, r, i) {
	...
	a = {
		x: Y(t, o.x, s.x - o.x, n),
		y: Y(t, o.y, s.y - o.y, n),
		width: Y(t, o.width, s.width - o.width, n),
		height: Y(t, o.height, s.height - o.height, n)
	}, Je(e, a), e.setState("__activeStagePosition", a);
}
function Ge(e, t) {
	if (!t) return;
	...
	e.setState("__activeStagePosition", r), Je(e, r);
}
function Ke(e) {
...
function qe(e, t) {
	let n = Xe(e, t);
	document.body.appendChild(n), W(n, (t) => {
...
function Xe(e, t) {
	...
	return a.setAttribute("d", Ue(t, Ye(e))), a.style.fill = e.getConfig("overlayColor") || "rgb(0,0,0)", a.style.opacity = `${e.getConfig("overlayOpacity")}`, a.style.pointerEvents = "auto", a.style.cursor = "auto", i.appendChild(a), i;
}
function Ze(e) {
	let t = e.getState("__overlaySvg");
	t && (G(t), t.remove());
}
var Qe = "{{current}} of {{total}}";
function $e(e, t) {
	return !(t.skipMissingElement ?? e.getConfig("skipMissingElement")) || !t.element ? !1 : !J(t.element);
}
function X(e, t, n) {
	let r = e.getConfig("steps") || [];
	for (let i = t; i >= 0 && i < r.length; i += n) if (!$e(e, r[i])) return i;
}
function Z(e, t) {
	let n = e.getState("activeIndex"), r = n !== void 0 && X(e, n + 1, 1) === void 0, i = t?.popover?.onDoneClick || e.getConfig("onDoneClick");
...
function nt(e, t, n) {
	let r = e.getConfig("steps") || [], i = r[t], a = i.popover || {}, o = X(e, t + 1, 1) !== void 0, s = X(e, t - 1, -1) !== void 0, c = a.doneBtnText || e.getConfig("doneBtnText") || "Done", l = e.getConfig("allowClose"), u = a.showProgress === void 0 ? e.getConfig("showProgress") : a.showProgress, d = (a.progressText || e.getConfig("progressText") || Qe).replace("{{current}}", `${t + 1}`).replace("{{total}}", `${r.length}`), f = a.showButtons || e.getConfig("showButtons"), p = [
		"next",
		"previous",
		...l ? ["close"] : []
...
function it(e, t, n) {
	let r = n.popover || {}, i = e.getState("activeIndex"), a = i !== void 0 && X(e, i + 1, 1) === void 0;
	return {
		title: r.title,
		...
		progressText: r.progressText ?? (e.getConfig("progressText") || Qe),
...
function at(e, t, n) {
	He(e.getState("popover")), ze(t, it(e, t, n));
}
function ot(e, t, n) {
...
function ut(e, t, n) {
	...
	let h = !s && u, g = !1;
	Re(e.getState("popover")), e.setState("previousStep", a), e.setState("previousElement", o), e.setState("activeStep", n), e.setState("activeElement", t);
	let _ = () => {
		if (e.getState("__transitionCallback") !== _) return;
		let s = Date.now() - i, l = r - s <= r / 2;
		n.popover && l && !g && h && (at(e, t, n), g = !0), e.getConfig("animate") && s < r ? We(e, s, r, o, t) : (Ge(e, t), f && f(c ? void 0 : t, n, e.getHookOpts()), e.setState("__transitionCallback", void 0), e.setState("__previousStep", a), e.setState("__previousElement", o), e.setState("__activeStep", n), e.setState("__activeElement", t)), window.requestAnimationFrame(_);
	};
	e.setState("__transitionCallback", _), window.requestAnimationFrame(_), Pe(t, e.getConfig("smoothScroll")), !h && n.popover && at(e, t, n), document.querySelectorAll(".driver-active-element-parent").forEach((e) => {
	...
	v && v !== document.body && (v.classList.add("driver-active-element-parent"), Me(v) && v.classList.add("driver-active-element-parent-no-scroll")), t.classList.add("driver-active-element"), t.setAttribute("aria-haspopup", "dialog"), t.setAttribute("aria-expanded", "true"), t.setAttribute("aria-controls", "driver-popover-content");
}
function dt() {
...
function Q(e) {
	...
	t && window.cancelAnimationFrame(t), e.setState("__resizeTimeout", window.requestAnimationFrame(() => lt(e)));
}
function ft(e, t) {
	if (!e.getState("isInitialized") || t.key !== "Tab" && t.keyCode !== 9) return;
	let n = e.getState("__activeElement"), r = e.getState("popover")?.wrapper, i = Ne([...r ? [r] : [], ...n ? [n] : []]), a = i[0], o = i[i.length - 1];
...
function ht(e) {
	let t = (t) => pt(e, t), n = (t) => ft(e, t), r = () => Q(e), i = () => Q(e), a = (t) => mt(e, t);
	e.setState("__events", {
		onKeyup: t,
		onKeydown: n,
		onResize: r,
...
function xt(e = {}) {
	...
	function r() {
		...
		if (e === "nextStep") {
			let e = t.getState("activeStep"), n = t.getState("activeElement"), r = Z(t, e);
			if (r) {
				r(n, e, t.getHookOpts());
				return;
			}
	...
	function s() {
		...
		let n = t.getState("__activeElement"), r = Z(t, e);
		if (r) {
			r(n, e, t.getHookOpts());
			return;
		}
	...
	function p(e = 0, n = !1) {
		...
		if (!n && a > 0 && i.element && !J(i.element)) {
			f(i, a, () => p(e, !0));
			return;
		}
		if ($e(t, i)) {
	...
	function m(e = !0) {
		...
		document.body.classList.remove("driver-active", "driver-fade", "driver-simple", "driver-no-scroll"), document.body.style.removeProperty("--driver-animation-duration"), d(), gt(t), He(t.getState("popover")), dt(), Ze(t), t.resetEmitter();
		let c = t.getState();
		if (t.resetState(), n && r) {
	...
	let h = {
		...
		isFirstStep: () => {
			...
			return e !== void 0 && X(t, e - 1, -1) === void 0;
		},
		isLastStep: () => {
			let e = t.getState("activeIndex");
			return e !== void 0 && X(t, e + 1, 1) === void 0;
...
function St(e) {
	...
	if (n === !0 || n && typeof n == "object" && n[e.id]) {
		if (typeof n == "boolean" && n === !0 && e.id) {
			localStorage.removeItem(e.TOUR_KEY), St(e);
			return;
		}
		return;
	}
...
var wt = class extends B {
	...
	updated(e) {
		e.has("config") && this.config && Ct(this);
	}
	start(e = 0) {
...
customElements.define("eox-tour", wt);
//#endregion
export { wt as EOxTour };
