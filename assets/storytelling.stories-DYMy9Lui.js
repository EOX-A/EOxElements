import{i as o}from"./iframe-DGGf7EFB.js";import"./preload-helper-PPVm8Dsz.js";const m={args:{markdown:"## Hello World, Welcome to EOxStoryTelling."},render:e=>o`
  ...
  `},u={args:{markdownURL:`${window.location.href.split("iframe.html")[0]}/sample.md`},render:e=>o`
    ...
    ></eox-storytelling>
  `},g={args:{markdown:"## Hello World, Markdown Inside Slot."},render:e=>o`
...
More features will be added soon, so feel free to follow progress at the [EOxElements GitHub repository](https://github.com/EOX-A/EOxElements).
    ...
    <eox-storytelling
      ...
      markdown=${e.markdown}
      @upload:file=${t=>{const h=t.detail,{file:l,update:c}=h;if(l.size>1024*1024){c(null,null,new Error("File size must be less than 1MB"));return}const d=new FileReader;d.onload=()=>{const p=d.result;c(p)},d.readAsDataURL(l)}}
    ></eox-storytelling>
  `};function y(e){if(e?.tagName==="EOX-MAP"){e.registerProjection("ESRI:53009","+proj=moll +lon_0=0 +x_0=0 +y_0=0 +a=6371000 +b=6371000 +units=m +no_defs");const t=e.getAttribute("projection");t&&e.setAttribute("projection",t)}}const f={args:{markdown:`## Map section <!--{as="eox-map" projection="ESRI:53009" style="width: 100%; height: 500px;" config='{ "controls": { "Zoom": {}, "Attribution": {}, "FullScreen": {}, "OverviewMap": { "layers": [ { "type": "Tile", "properties": { "id": "overviewMap" }, "source": { "type": "OSM" } } ] } }, "layers": [ { "type": "Tile", "properties": { "id": "overviewMap" }, "source": { "type": "TileWMS", "url": "https://ows.mundialis.de/services/service", "params": { "LAYERS": "TOPO-WMS" } } } ], "view": { "center": [15,48], "zoom": 1 } }'}-->
...
`},render:e=>o`
  ...
  `},b={title:"Elements/eox-storytelling",tags:["autodocs"],component:"eox-storytelling",decorators:[e=>o`${e()}
        ...
        </style>`]},i=m,r=u,s=g,a=w,n=f;i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"PrimaryStory",...i.parameters?.docs?.source},description:{story:"StoryTelling using basic markdownL.",...i.parameters?.docs?.description}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"MarkdownAsURLStory",...r.parameters?.docs?.source},description:{story:"StoryTelling using markdown URL.",...r.parameters?.docs?.description}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"MarkdownSlotStory",...s.parameters?.docs?.source},description:{story:"StoryTelling using markdown from the slot.",...s.parameters?.docs?.description}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"MarkdownEditorStory",...a.parameters?.docs?.source},description:{story:"StoryTelling with editor",...a.parameters?.docs?.description}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"MarkdownInitEventStory",...n.parameters?.docs?.source},description:{story:"StoryTelling with @init event",...n.parameters?.docs?.description}}};const S=["Primary","MarkdownAsURL","MarkdownInsideSlot","MarkdownWithEditor","MarkdownInitEvent"];export{r as MarkdownAsURL,n as MarkdownInitEvent,s as MarkdownInsideSlot,a as MarkdownWithEditor,i as Primary,S as __namedExportsOrder,b as default};
