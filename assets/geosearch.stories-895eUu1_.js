import{i as e}from"./preload-helper-DbRxMUml.js";import{Pt as t,kt as n}from"./iframe-CPr8F_1K.js";var r,i=e((()=>{n(),r={args:{endpoint:`/opencage-mock-data.json`,label:`Search`,style:`position: absolute; top: 36px; left: 32px; z-index: 12;`,storyAdditionalComponents:{"eox-map":{id:`geosearch-map-primary`,animationOptions:{duration:400,padding:[10,10,10,10]},config:{layers:[{type:`Tile`,source:{type:`OSM`}}],view:{center:[15,48],zoom:3}},style:`width: 100%; height: 500px;`}}},render:e=>t`
    ...
    `}})),s,c=e((()=>{n(),s={args:{endpoint:`/opencage-mock-data.json`,label:`Search`,style:`position: absolute; z-index: 12;`,small:!0,button:!0,storyAdditionalComponents:{"eox-map":{id:`geosearch-map-primary`,animationOptions:{duration:400,padding:[10,10,10,10]},config:{layers:[{type:`Tile`,source:{type:`OSM`}}],view:{center:[15,48],zoom:3}},style:`width: 100%; height: 600px;`}}},render:e=>{let n=`item => {
      ...
      <eox-map
        ...
        style="${e.storyAdditionalComponents[`eox-map`].style}"
      ></eox-map>
    `}}})),l,u=e((()=>{n(),l={args:{endpoint:`/opencage-mock-data.json`,label:`Search`,style:`position: absolute; top: 36px; left: 32px; z-index: 12;`,loaderSvg:`
      <svg
    ...
    `}})),d,f=e((()=>{n(),d={args:{endpoint:`/opencage-mock-data.json`,label:`Search`,style:`position: absolute; top: 36px; left: 32px; z-index: 12;`,button:!0,small:!0,extent:`-125.0,24.0,-66.0,49.0`,tooltip:`Search within North America`,tooltipDirection:`right`,storyAdditionalComponents:{"eox-map":{id:`geosearch-map-extent`,animationOptions:{duration:400,padding:[10,10,10,10]},config:{layers:[{type:`Tile`,source:{type:`OSM`}}],view:{center:[-95,38],zoom:4}},style:`width: 100%; height: 500px;`}}},render:e=>t`
      ...
      <eox-map
        ...
        style="${e.storyAdditionalComponents[`eox-map`].style}"
      ></eox-map>
    `}})),p,m=e((()=>{n(),i(),p={...r,args:{...r.args,params:{language:`en`,limit:5,countrycode:`us`},storyAdditionalComponents:{"eox-map":{id:`geosearch-map-primary`,animationOptions:{duration:400,padding:[10,10,10,10]},config:{layers:[{type:`Tile`,source:{type:`OSM`}}],view:{center:[15,48],zoom:3}},style:`width: 100%; height: 500px;`}}},render:e=>t`
      <eox-geosearch
        .endpoint="${e.endpoint}"
        .label="${e.label}"
        style="${e.style}"
