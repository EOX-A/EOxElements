import{i as e}from"./preload-helper-DbRxMUml.js";import{Pt as t,kt as n}from"./iframe-QBdQ4W2G.js";import{n as r,t as i}from"./taggedTemplateLiteral-CmccG7_q.js";var a,o=e((()=>{a={args:{for:`${window.location.href.split(`iframe.html`)[0]}/collection.json`,header:[`title`],tags:[`tags`],body:[`satellite`,`sensor`,`agency`,`extent`],featured:[`description`,`providers`,`assets`,`links`],footer:[`sci:citation`]}}})),s,c=e((()=>{s={args:{for:`${window.location.href.split(`iframe.html`)[0]}/collection.json`,body:[`description`]}}})),l,u=e((()=>{l={args:{for:`${window.location.href.split(`iframe.html`)[0]}/collection.json`,header:[`title`]}}})),d,f=e((()=>{d={args:{for:`${window.location.href.split(`iframe.html`)[0]}/collection.json`,tags:[`themes`]}}})),p,m=e((()=>{p={args:{for:`${window.location.href.split(`iframe.html`)[0]}/collection.json`,featured:[`description`,`extent`]}}})),h,g=e((()=>{h={args:{for:`${window.location.href.split(`iframe.html`)[0]}/collection.json`,footer:[`sci:citation`]}}})),_,v,y=e((()=>{n(),w(),r(),v={args:{...a.args,id:`slot`,storySlotContent:`
    ...
    <\/script>
  `]),e.id,e.for,e.header,e.body,e.featured,e.footer,e.unstyled)}})),b,x=e((()=>{w(),b={args:{...a.args,unstyled:!0}}})),S,C=e((()=>{S={args:{for:`${window.location.href.split(`iframe.html`)[0]}/ports_cars_aq/2020/Genoa.json`,header:[`id`,`title`],tags:[`platform`,`instruments`,`constellation`],body:[`description`,`sci:citation`,`processing:software`,`eopf:instrument_mode`,`eo:cloud_cover`,`view:sun_elevation`],featured:[{key:`assets`,filter:e=>e.type?.includes(`image/tiff`)},{key:`links`,filter:e=>e.type?.includes(`text/html`)}],footer:[`start_datetime`,`end_datetime`]}}})),w=e((()=>{o(),c(),u(),f(),m(),g(),y(),x(),C()})),T,E,D,O,k,A,j,M,N,P,F;e((()=>{n(),w(),T={title:`Elements/eox-stacinfo`,tags:[`autodocs`],component:`eox-stacinfo`,parameters:{componentSubtitle:`Automatically fetch & display properties of STAC files`,layout:`fullscreen`},render:e=>t`
      <eox-stacinfo
        for=${e.for}
        .header=${e.header}
        .tags="${e.tags}"
