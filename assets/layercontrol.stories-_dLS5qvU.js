 ...
 */const Mr=Gr(class extends Jr{constructor(o){if(super(o),o.type!==he.PROPERTY&&o.type!==he.ATTRIBUTE&&o.type!==he.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Kr(o))throw Error("`live` bindings can only contain a single expression")}render(o){return o}update(o,[e]){if(e===Ke||e===ge)return e;const t=o.element,r=o.name;if(o.type===he.PROPERTY){if(e===t[r])return Ke}else if(o.type===he.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(r))return Ke}else if(o.type===he.ATTRIBUTE&&t.getAttribute(r)===e+"")return Ke;return Qr(o),e}});var ke,Fe,xe,mt,Ir,gt,vt;class Vr extends ae{constructor(){super();O(this,mt);O(this,ke,{});O(this,Fe,null);O(this,xe,void 0);O(this,gt,"");O(this,vt,"");this.layer=null,this.unstyled=!1,this.noShadow=!0,this.layerConfig=null}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){return this.layerConfig?(Je(this,Fe,Vn(this.layer,this.layerConfig)),g`
      ...
      ></eox-jsonform>
    `):""}}ke=new WeakMap,Fe=new WeakMap,xe=new WeakMap,mt=new WeakSet,Ir=function(t){Je(this,ke,t.detail),this.layer.getSource().getTileUrlFunction()&&(_(this,xe)||Je(this,xe,this.layer.getSource().getTileUrlFunction()),this.layer.getSource().setTileUrlFunction((...r)=>Mn(_(this,xe).call(this,...r),_(this,ke))),this.layer.getSource().setKey(new Date)),this.requestUpdate()},gt=new WeakMap,vt=new WeakMap,V(Vr,"properties",{layer:{attribute:!1},unstyled:{type:Boolean},noShadow:{type:Boolean},layerConfig:{attribute:!1}});customElements.define("eox-layercontrol-layerconfig",Vr);var bt,xt;class Nr extends ae{constructor(){super();O(this,bt,`
    .tabbed figure {
      margin: 0;
    }
    .tabbed nav {
...
></eox-map>`,Kn={title:"Elements/eox-layercontrol",tags:["autodocs"],component:"eox-layercontrol",parameters:{componentSubtitle:"Manage and configure OpenLayers map layers",layout:"centered"}},Oe={args:{idProperty:"id",titleProperty:"title",unstyled:!1},render:o=>g`
...
source url parameters.`,...(Xo=(zo=Pe.parameters)==null?void 0:zo.docs)==null?void 0:Xo.description}}};var jo,ko,Fo,Wo,Uo;Me.parameters={...Me.parameters,docs:{...(jo=Me.parameters)==null?void 0:jo.docs,source:{originalSource:`{
  args: {},
  render: () => html\`
    <div style="display: flex">
      <eox-layercontrol for="eox-map#hidden"></eox-layercontrol>
  ...
  \`
}`,...(hr=(ur=Ne.parameters)==null?void 0:ur.docs)==null?void 0:hr.source},description:{story:"Unstyled version of the Element",...(yr=(fr=Ne.parameters)==null?void 0:fr.docs)==null?void 0:yr.description}}};const Qn=["Primary","ExclusiveLayers","OptionalLayers","ExpandedLayers","Tools","LayerConfig","HiddenLayers","SingleLayer","LayerList","Tabs","LayerZoomState","Unstyled"];export{$e as ExclusiveLayers,Le as ExpandedLayers,Me as HiddenLayers,Pe as LayerConfig,nt as LayerList,Ie as LayerZoomState,De as OptionalLayers,Oe as Primary,rt as SingleLayer,Ve as Tabs,Ae as Tools,Ne as Unstyled,Qn as __namedExportsOrder,Kn as default};
//# sourceMappingURL=layercontrol.stories-_dLS5qvU.js.map
