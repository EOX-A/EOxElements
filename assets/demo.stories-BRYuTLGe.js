import{h as fe,i as ye}from"./iframe-DNLaa3s4.js";import"./color-legend-element-CWto37Jc.js";import{i as ge}from"./testItems-BFT0QiSi.js";import"./preload-helper-Dp1pzeXC.js";const U=[];function J(){return window==null?void 0:window.matchMedia("(pointer: coarse)").matches}function he(){return window==null?void 0:window.matchMedia("(prefers-color-scheme: dark)").matches}async function X(e){await new Promise(t=>setTimeout(t,e))}function ve(){return"fxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,e=>{const t=Math.random()*16|0;return(e==="x"?t:t&3|8).toString(16)})}function g(e,t){try{return typeof e=="string"?(t??document).querySelector(e):e}catch{return null}}function c(e,t){try{return typeof e=="string"?(t??document).querySelectorAll(e):e??U}catch{return U}}function l(e,t){return(e==null?void 0:e.classList.contains(t))??!1}function f(e,t){var n;return((n=e==null?void 0:e.tagName)==null?void 0:n.toLowerCase())===t}function S(e,t){var n;return((n=e==null?void 0:e.type)==null?void 0:n.toLowerCase())===t}function y(e,t){if(e instanceof NodeList)for(let n=0;n<e.length;n++)e[n].classList.add(t);else e==null||e.classList.add(t)}function d(e,t){if(e instanceof NodeList)for(let n=0;n<e.length;n++)e[n].classList.remove(t);else e==null||e.classList.remove(t)}function i(e,t,n,o=!0){e!=null&&e.addEventListener&&e.addEventListener(t,n,o)}function M(e,t,n,o=!0){e!=null&&e.removeEventListener&&e.removeEventListener(t,n,o)}function xe(e,t){var n;(n=t==null?void 0:t.parentNode)==null||n.insertBefore(e,t)}function D(e){return e==null?void 0:e.previousElementSibling}function N(e){return e==null?void 0:e.nextElementSibling}function h(e){return e==null?void 0:e.parentElement}function be(e){const t=document.createElement("div");for(let n=0,o=Object.keys(e),s=o.length;n<s;n++){const a=o[n],r=e[a];t.setAttribute(a,r)}return t}function P(){var e;(e=document.activeElement)==null||e.blur()}function we(e){return c('[data-ui="#'+e+'"]')}function ke(e){return g('[data-ui="#'+e+'"]')}function $e(e){e.id&&l(e,"page")&&(e=ke(e.id)??e);const t=h(e);if(!l(t,"tabs")&&!l(t,"tabbed")&&!f(t,"nav"))return;const n=c("a",t);for(let o=0;o<n.length;o++)d(n[o],"active");!f(e,"button")&&!l(e,"button")&&!l(e,"chip")&&y(e,"active")}function Q(e){e.placeholder||(e.placeholder=" ")}function Se(e){const t=e.currentTarget,n=h(t),o=g("input:not([type=file], [type=checkbox], [type=radio]), select, textarea",n);o&&o.focus()}function G(e){const t=e.currentTarget;_(t)}function z(e){const t=e.currentTarget;_(t)}function _e(e){const t=e.currentTarget;V(t)}function Te(e){const t=e.currentTarget;W(t)}function Ae(e){const t=e.currentTarget;V(t,e)}function Ee(e){const t=e.currentTarget;W(t,e)}function Oe(e){const t=e.currentTarget;ee(t)}function Le(e){var t;const n=e.currentTarget,o=g("input",h(n));o&&(t=n.textContent)!=null&&t.includes("visibility")&&(o.type=o.type==="password"?"text":"password")}function Ie(){const e=c(".field > label");for(let t=0;t<e.length;t++)i(e[t],"click",Se)}function Ce(){const e=c(".field > input:not([type=file], [type=color], [type=range])");for(let t=0;t<e.length;t++)i(e[t],"focus",G),i(e[t],"blur",z),_(e[t])}function Me(){const e=c(".field > select");for(let t=0;t<e.length;t++)i(e[t],"focus",G),i(e[t],"blur",z)}function De(){const e=c(".field > input[type=file]");for(let t=0;t<e.length;t++)i(e[t],"change",_e),V(e[t])}function Ne(){const e=c(".field > input[type=color]");for(let t=0;t<e.length;t++)i(e[t],"change",Te),W(e[t])}function Pe(){const e=c(".field.textarea > textarea");for(let t=0;t<e.length;t++)i(e[t],"focus",G),i(e[t],"blur",z),i(e[t],"input",Oe),ee(e[t])}function Ge(){const e=c("input[type=password] ~ :is(i, a)");for(let t=0;t<e.length;t++)i(e[t],"click",Le)}function _(e){S(e,"number")&&!e.value&&(e.value=""),Q(e)}function V(e,t){if((t==null?void 0:t.key)==="Enter"){const o=D(e);if(!S(o,"file"))return;o.click();return}const n=N(e);S(n,"text")&&(n.value=e.files?Array.from(e.files).map(o=>o.name).join(", "):"",n.readOnly=!0,i(n,"keydown",Ae,!1),_(n))}function W(e,t){if((t==null?void 0:t.key)==="Enter"){const o=D(e);if(!S(o,"color"))return;o.click();return}const n=N(e);S(n,"text")&&(n.readOnly=!0,n.value=e.value,i(n,"keydown",Ee,!1),_(n))}function ee(e){Q(e);const t=h(e);t.removeAttribute("style"),l(t,"min")&&t.style.setProperty("--_size",`${Math.max(e.scrollHeight,t.offsetHeight)}px`)}function ze(){Ie(),Ce(),Me(),De(),Ne(),Pe(),Ge()}function B(e){const t=e.target;!f(t,"input")&&!f(t,"select")||(t.type==="range"?(t.focus(),ne(t)):te())}function Ve(e){if(!J())return;const t=e.target,n=h(t);l(n,"vertical")&&document.body.classList.add("no-scroll")}function We(e){if(!J())return;const t=e.target,n=h(t);l(n,"vertical")&&document.body.classList.remove("no-scroll")}function te(){const e=document.body,t=c(".slider > input[type=range]");t.length?i(e,"input",B,!1):M(e,"input",B,!1);for(let n=0;n<t.length;n++)ne(t[n])}function je(){const e=getComputedStyle(document.documentElement).getPropertyValue("--size")||"16px";return e.includes("%")?parseInt(e)*16/100:e.includes("em")?parseInt(e)*16:parseInt(e)}function ne(e){i(e,"focus",Ve),i(e,"blur",We);const t=h(e),n=g("span",t),o=c("input",t);if(!o.length||!n)return;const s=je(),a=l(t,"max")?0:.25*s*100/o[0].offsetWidth,r=[],u=[];for(let x=0,me=o.length;x<me;x++){const F=parseFloat(o[x].min)||0,pe=parseFloat(o[x].max)||100,R=parseFloat(o[x].value)||0,H=(R-F)*100/(pe-F),de=a/2-a*H/100;r.push(H+de),u.push(R)}let m=r[0],v=0,T=100-v-m,b=u[0],w=u[1]||0;o.length>1&&(m=Math.abs(r[1]-r[0]),v=r[1]>r[0]?r[0]:r[1],T=100-v-m,w>b&&(b=u[1]||0,w=u[0])),t.style.setProperty("--_start",`${v}%`),t.style.setProperty("--_end",`${T}%`),t.style.setProperty("--_value1",`'${b}'`),t.style.setProperty("--_value2",`'${w}'`)}function Fe(){te()}const p={light:"",dark:""};function C(){var e;return(e=document==null?void 0:document.body)!=null&&e.classList.contains("dark")?"dark":"light"}function Re(){if(p.light&&p.dark)return p;const e=document.body,t=document.createElement("body");t.className="light",e.appendChild(t);const n=document.createElement("body");n.className="dark",e.appendChild(n);const o=getComputedStyle(t),s=getComputedStyle(n),a=["--primary","--on-primary","--primary-container","--on-primary-container","--secondary","--on-secondary","--secondary-container","--on-secondary-container","--tertiary","--on-tertiary","--tertiary-container","--on-tertiary-container","--error","--on-error","--error-container","--on-error-container","--background","--on-background","--surface","--on-surface","--surface-variant","--on-surface-variant","--outline","--outline-variant","--shadow","--scrim","--inverse-surface","--inverse-on-surface","--inverse-primary","--surface-dim","--surface-bright","--surface-container-lowest","--surface-container-low","--surface-container","--surface-container-high","--surface-container-highest"];for(let r=0,u=a.length;r<u;r++)p.light+=a[r]+":"+o.getPropertyValue(a[r])+";",p.dark+=a[r]+":"+s.getPropertyValue(a[r])+";";return e.removeChild(t),e.removeChild(n),p}function He(e){const t=globalThis,n=document.body;if(!e||!t.materialDynamicColors)return Re();const o=C();return e.light&&e.dark?(p.light=e.light,p.dark=e.dark,n.setAttribute("style",e[o]),e):t.materialDynamicColors(e).then(s=>{const a=r=>{let u="";for(let m=0,v=Object.keys(r),T=v.length;m<T;m++){const b=v[m],w=r[b],x=b.replace(/([a-z0-9]|(?=[A-Z]))([A-Z])/g,"$1-$2").toLowerCase();u+="--"+x+":"+w+";"}return u};return p.light=a(s.light),p.dark=a(s.dark),n.setAttribute("style",p[o]),p})}function oe(e){const t=globalThis,n=document.body;if(!n)return e;if(!e)return C();e==="auto"&&(e=he()?"dark":"light"),n.classList.remove("light","dark"),n.classList.add(e);const o=e==="light"?p.light:p.dark;return t.materialDynamicColors&&n.setAttribute("style",o),C()}const E=[];function ie(e){if(e.key==="Escape"){const t=e.currentTarget;ae(t,t)}}function Ue(e){(g("[autofocus]",e)??e).focus()}function re(e,t){d(we(e.id),"active"),d(e,"active"),d(t,"active"),e.close(),E.pop();const n=E[E.length-1];n&&n.focus()}async function Be(e,t,n,o){!f(o,"button")&&!l(o,"button")&&!l(o,"chip")&&y(o,"active"),y(t,"active"),y(e,"active"),n?e.showModal():e.show(),await X(90),n||i(e,"keydown",ie,!1),E.push(e),Ue(e)}function qe(e){const t=e.currentTarget,n=N(t);f(n,"dialog")&&re(n,t)}async function ae(e,t){P();let n=D(t);const o=l(t,"active")||t.open,s=l(t,"modal");s||M(t,"keydown",ie,!1),l(n,"overlay")||(n=be({class:"overlay"}),xe(n,t),await X(90)),s||i(n,"click",qe,!1),o?re(t,n):Be(t,n,s,e)}let O;function le(e){M(document.body,"click",le);const t=e.target,n=c("menu.active");for(let o=0;o<n.length;o++)se(t,n[o],e)}function Ke(e){setTimeout(()=>{const t=g(".field > input",e);t?t.focus():e.focus()},90)}function se(e,t,n){O&&clearTimeout(O),O=setTimeout(()=>{i(document.body,"click",le),f(document.activeElement,"input")||P();const o=l(t,"active"),s=(n==null?void 0:n.target)===e,a=!!e.closest("menu");if(!o&&a||o&&s){d(t,"active");return}d(c("menu.active"),"active"),y(t,"active"),Ke(t)},90)}let k;function Ze(e){const t=e.currentTarget;d(t,"active"),k&&clearTimeout(k)}function Ye(e,t){P();const n=c(".snackbar.active");for(let o=0;o<n.length;o++)d(n[o],"active");y(e,"active"),i(e,"click",Ze),k&&clearTimeout(k),t!==-1&&(k=setTimeout(()=>{d(e,"active")},t??6e3))}function Je(e){const t=h(e);t&&d(c(":scope > .page",t),"active"),y(e,"active")}function Xe(e){Qe(e)}function Qe(e){const t=e.currentTarget,n=t.getBoundingClientRect(),o=Math.max(n.width,n.height),s=o/2,a=e.clientX-n.left-s,r=e.clientY-n.top-s,u=document.createElement("div");u.className="ripple-js";const m=document.createElement("div");m.style.inlineSize=m.style.blockSize=`${o}px`,m.style.left=`${a}px`,m.style.top=`${r}px`,m.addEventListener("animationend",()=>{u.remove()}),u.appendChild(m),t.appendChild(u)}function et(){const e=c(".slow-ripple, .ripple, .fast-ripple");for(let t=0;t<e.length;t++)i(e[t],"pointerdown",Xe)}const $=globalThis;let L,I;function q(){L&&clearTimeout(L),L=setTimeout(async()=>await ue(),180)}async function j(e,t,n,o){if(!t&&(t=g(e.getAttribute("data-ui")),!t)){e.classList.toggle("active");return}if($e(e),f(t,"dialog")){await ae(e,t);return}if(f(t,"menu")){se(e,t,o);return}if(l(t,"snackbar")){Ye(t,n);return}if(l(t,"page")){Je(t);return}if(l(t,"active")){d(e,"active"),d(t,"active");return}y(t,"active")}function tt(e){j(e.currentTarget,null,null,e)}function nt(e){e.key==="Enter"&&j(e.currentTarget,null,null,e)}function ce(){$.ui||I||!$.MutationObserver||(I=new MutationObserver(q),I.observe(document.body,{childList:!0,subtree:!0}),q())}function ot(){const e=c("[data-ui]");for(let t=0,n=e.length;t<n;t++)i(e[t],"click",tt),f(e[t],"a")&&!e[t].getAttribute("href")&&i(e[t],"keydown",nt)}function ue(e,t){if(e){if(e==="setup"){ce();return}if(e==="guid")return ve();if(e==="mode")return oe(t);if(e==="theme")return He(t);const n=g(e);if(!n)return;j(n,n,t)}ot(),ze(),Fe(),et()}function it(){var e;if($.ui)return;const t=(e=$.document)==null?void 0:e.body;t&&!t.classList.contains("dark")&&!t.classList.contains("light")&&oe("auto"),ce(),$.ui=ue}it();const ct={title:"Demo",parameters:{componentSubtitle:"Automatically fetch & display properties of STAC files",layout:"fullscreen"}},A={render:()=>ye`
  ...
  `};var K,Z,Y;A.parameters={...A.parameters,docs:{...(K=A.parameters)==null?void 0:K.docs,source:{originalSource:`{
  render: () => html\`
    <nav class="small-padding surface-container">
      <div class="max">
        <p>EOxElements Demo</p>
  ...
  \`
}`,...(Y=(Z=A.parameters)==null?void 0:Z.docs)==null?void 0:Y.source}}};const ut=["KitchenSink"];export{A as KitchenSink,ut as __namedExportsOrder,ct as default};
