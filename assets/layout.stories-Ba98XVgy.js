import{i as e}from"./preload-helper-DbRxMUml.js";import{Pt as t,kt as n}from"./iframe-DC96dTe3.js";import{n as r,t as i}from"./taggedTemplateLiteral-CmccG7_q.js";var a,o,s=e((()=>{a=`width: 100%; height: 400px;`,o=`background: lightgrey; border: 1px solid darkgrey; border-radius: 4px; padding: 4px 8px;`})),c=e((()=>{s()})),l,u=e((()=>{n(),c(),l={args:{style:a,storySlotContent:`
  ...
  `}})),d,f,p,m=e((()=>{n(),c(),r(),f=()=>{let e=[];for(let t=0;t<12;t++)for(let n=0;n<12;n++)e.push([t,n]);return e},p={args:{style:a,storyCodeAfter:`
  ...
  `]),e.storyCodeBefore,e.style,f().map(([e,n])=>t`<eox-layout-item x="${e}" y="${n}" w="1" h="1"
            >${e}/${n}</eox-layout-item
          >`),o)}})),h,g=e((()=>{n(),c(),h={args:{style:`${a}; border: 1px solid darkgrey;`,gap:`8`,storySlotContent:`
      <eox-layout-item x="0" y="0" w="3" h="2">
        x="0" y="0" w="3" h="2"
      </eox-layout-item>
      <eox-layout-item x="0" y="2" w="2" h="10">
  ...
  `}})),_,v=e((()=>{n(),c(),_={args:{gap:8,"row-height":`3rem`,style:a,storySlotContent:`
  ...
  `}})),y,b=e((()=>{n(),c(),y={args:{"fill-grid":!0,"row-height":`100px`,"column-width":`200px`,style:a,storySlotContent:`
  ...
  `}})),x,S=e((()=>{n(),c(),x={args:{gap:`8`,style:a,storySlotContent:`
