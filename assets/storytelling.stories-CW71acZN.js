import{i as e}from"./preload-helper-B45gAKPr.js";import{d as t,t as n}from"./lit-X6_6WslE.js";var r,i=e((()=>{n(),r={args:{markdown:`## Hello World, Welcome to EOxStoryTelling.`,id:`markdown-str`},render:e=>t`
    <!-- Render eox-storytelling with basic markdown. -->
    <eox-storytelling
      id=${e.id}
      markdown=${e.markdown}
    ></eox-storytelling>
  `}})),a,o=e((()=>{n(),a={args:{markdownURL:`${window.location.href.split(`iframe.html`)[0]}/sample.md`,id:`markdown-url`},render:e=>t`
    <eox-storytelling
      id=${e.id}
      markdown-url=${e.markdownURL}
    ></eox-storytelling>
  `}})),s,c=e((()=>{n(),s={args:{id:`markdown-slot`,storySlotContent:`## Hello World, this is some Markdown Inside the slot.`},render:e=>t`
    <eox-storytelling id=${e.id}
      >## Hello World, this is some Markdown Inside the slot.</eox-storytelling
    >
  `}})),l,u=e((()=>{n(),l={argTypes:{markdown:{table:{category:`properties`}}},args:{markdown:`# Hero Section <!--{ as="video" mode="hero" src="https://dlmultimedia.esa.int/download/public/videos/2023/06/010/2306_010_AR_EN.mp4" }-->
...
Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quos. Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quos. <!--{ style="opacity: 0.75; font-size: 1rem;" }-->`,id:`markdown-map`,showNav:!0},render:e=>t`
    <eox-storytelling
      ...
      markdown=${e.markdown}
    ></eox-storytelling>
  `}})),p,m=e((()=>{n(),p={argTypes:{markdown:{table:{category:`properties`}}},args:{markdown:`## Map Tour section <!--{ as="eox-map" class="overlay-br" mode="tour" }-->
...
To change individual parameters like zoom or center, or to change the map layers for a step, just set them using the HTML comment syntax. This changes the map setting for the current map`,id:`markdown-map-tour`,showNav:!0},render:e=>t`
    <eox-storytelling
      ...
      markdown=${e.markdown}
    ></eox-storytelling>
  `}})),h,g=e((()=>{n(),h={argTypes:{markdown:{table:{category:`properties`}}},args:{markdown:`## Image Tour section <!--{ as="img" mode="tour" }-->
...
![](https://placehold.co/200x100)`,id:`markdown-image-tour`,showNav:!0},render:e=>t`
    <eox-storytelling
      ...
      markdown=${e.markdown}
    ></eox-storytelling>
  `}})),_,v=e((()=>{n(),_={argTypes:{markdown:{table:{category:`properties`}}},args:{markdown:`# Welcome to Storytelling <!--{ as="video" mode="hero" src="https://dlmultimedia.esa.int/download/public/videos/2023/06/010/2306_010_AR_EN.mp4" }-->
#### An introduction on how to write interactive and multimedial stories using markdown. Scroll down to get started! <!--{ style="font-size:1rem;opacity:0.7;margin-top:1rem;" }-->
...
`,id:`markdown-init-event`,init:e=>y(e.detail),storyCodeBefore:`
    ...
    <eox-storytelling
      ...
      @init=${e.init}
    ></eox-storytelling>
  `}})),S=e((()=>{i(),o(),c(),u(),f(),m(),g(),v(),x()})),C,w,T,E,D,O,k,A,j,M,N;e((()=>{S(),n(),C={title:`Elements/eox-storytelling`,tags:[`autodocs`],component:`eox-storytelling`,decorators:[e=>t`${e()}
        <style>
