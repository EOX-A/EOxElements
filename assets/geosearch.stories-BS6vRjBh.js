import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{d as t,t as n}from"./lit-D8IuYOuz.js";var r;function i(){return(i=e((()=>{n(),r={args:{endpoint:`/opencage-mock-data.json`,label:`Search`,style:`position: absolute; top: 36px; left: 32px; z-index: 12;`,storyAdditionalComponents:{"eox-map":{id:`geosearch-map-primary`,animationOptions:{duration:400,padding:[10,10,10,10]},config:{layers:[{type:`Tile`,source:{type:`OSM`}}],view:{center:[15,48],zoom:3}},style:`width: 100%; height: 500px;`}}},render:e=>t`
    ...
    `}})))()}var s;function c(){return(c=e((()=>{n(),s={args:{endpoint:`/opencage-mock-data.json`,label:`Search`,style:`position: absolute; z-index: 12;`,small:!0,button:!0,storyAdditionalComponents:{"eox-map":{id:`geosearch-map-primary`,animationOptions:{duration:400,padding:[10,10,10,10]},config:{layers:[{type:`Tile`,source:{type:`OSM`}}],view:{center:[15,48],zoom:3}},style:`width: 100%; height: 600px;`}}},render:e=>{let n=`item => {
      ...
      <eox-map
        ...
        style="${e.storyAdditionalComponents[`eox-map`].style}"
      ></eox-map>
    `}}})))()}var l;function u(){return(u=e((()=>{n(),l={args:{endpoint:`/opencage-mock-data.json`,label:`Search`,style:`position: absolute; top: 36px; left: 32px; z-index: 12;`,loaderSvg:`
      <svg
    ...
    `,storyAdditionalComponents:{"eox-map":{id:`geosearch-map-primary`,animationOptions:{duration:400,padding:[10,10,10,10]},config:{layers:[{type:`Tile`,source:{type:`OSM`}}],view:{center:[15,48],zoom:3}},style:`width: 100%; height: 500px;`}}},render:e=>t`
      <eox-geosearch
        .endpoint="${e.endpoint}"
        .label="${e.label}"
        style="${e.style}"
    ...
    `}})))()}var d;function f(){return(f=e((()=>{n(),d={args:{endpoint:`/opencage-mock-data.json`,label:`Search`,style:`position: absolute; top: 36px; left: 32px; z-index: 12;`,button:!0,small:!0,extent:`-125.0,24.0,-66.0,49.0`,tooltip:`Search within North America`,tooltipDirection:`right`,storyAdditionalComponents:{"eox-map":{id:`geosearch-map-extent`,animationOptions:{duration:400,padding:[10,10,10,10]},config:{layers:[{type:`Tile`,source:{type:`OSM`}}],view:{center:[-95,38],zoom:4}},style:`width: 100%; height: 500px;`}}},render:e=>t`
      ...
      <eox-map
        ...
        style="${e.storyAdditionalComponents[`eox-map`].style}"
      ></eox-map>
    `}})))()}var p;function m(){return(m=e((()=>{n(),i(),p={...r,args:{...r.args,params:{language:`en`,limit:5,countrycode:`us`},storyAdditionalComponents:{"eox-map":{id:`geosearch-map-primary`,animationOptions:{duration:400,padding:[10,10,10,10]},config:{layers:[{type:`Tile`,source:{type:`OSM`}}],view:{center:[15,48],zoom:3}},style:`width: 100%; height: 500px;`}}},render:e=>t`
      <eox-geosearch
        .endpoint="${e.endpoint}"
        .label="${e.label}"
        style="${e.style}"
      ...
      <eox-map
        ...
        style="${e.storyAdditionalComponents[`eox-map`].style}"
      ></eox-map>
    `}})))()}function h(){return(h=e((()=>{i(),o(),c(),u(),f(),m()})))()}var g,_,v,y,b,x,S,C;function w(){return(w=e((()=>{h(),g={title:`Elements/eox-geosearch`,tags:[`autodocs`],component:`eox-geosearch`},_=r,v=a,y=s,b=l,x=d,S=p,C=[`Primary`,`ButtonMode`,`CustomAlignments`,`CustomLoader`,`ExtentLimit`,`AdditionalParameters`],_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`PrimaryStory`,..._.parameters?.docs?.source},description:{story:`Basic usage of eox-geosearch with a default OpenCage endpoint. The search bar is positioned on the map and interacts with the map to zoom to selected results.
