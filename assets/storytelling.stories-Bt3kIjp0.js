import{n as e}from"./rolldown-runtime-CMxvf4Kt.js";import{Ft as t,Vt as n}from"./iframe-D5xvUy4q.js";var r,i=e((()=>{t(),r={args:{markdown:`## Hello World, Welcome to EOxStoryTelling.`,id:`markdown-str`},render:e=>n`
    <!-- Render eox-storytelling with basic markdown. -->
    <eox-storytelling
      id=${e.id}
      markdown=${e.markdown}
    ></eox-storytelling>
  `}})),a,o=e((()=>{t(),a={args:{markdownURL:`${window.location.href.split(`iframe.html`)[0]}/sample.md`,id:`markdown-url`},render:e=>n`
    <eox-storytelling
      id=${e.id}
      markdown-url=${e.markdownURL}
    ></eox-storytelling>
  `}})),s,c=e((()=>{t(),s={args:{id:`markdown-slot`,storySlotContent:`## Hello World, this is some Markdown Inside the slot.`},render:e=>n`
    <eox-storytelling id=${e.id}
      >## Hello World, this is some Markdown Inside the slot.</eox-storytelling
    >
  `}})),l,u=e((()=>{t(),l={argTypes:{markdown:{table:{category:`properties`}}},args:{markdown:`# Hero Section <!--{ as="video" mode="hero" src="https://dlmultimedia.esa.int/download/public/videos/2023/06/010/2306_010_AR_EN.mp4" }-->
...
`,id:`markdown-hero`,showNav:!0,showHeroScrollIndicator:!0},render:e=>n`
    <eox-storytelling
      id=${e.id}
      ?show-nav=${e.showNav}
...
#### Third tour step.
To change individual parameters like zoom or center, or to change the map layers for a step, just set them using the HTML comment syntax. This changes the map setting for the current map`,id:`markdown-map-tour`,showNav:!0},render:e=>n`
    <eox-storytelling
      id=${e.id}
      ?show-nav=${e.showNav}
      markdown=${e.markdown}
    ></eox-storytelling>
  `}})),h,g=e((()=>{t(),h={argTypes:{markdown:{table:{category:`properties`}}},args:{markdown:`## Image Tour section <!--{ as="img" mode="tour" }-->
...
#### Third tour step.
![](https://placehold.co/200x100)`,id:`markdown-image-tour`,showNav:!0},render:e=>n`
    <eox-storytelling
      id=${e.id}
      ?show-nav=${e.showNav}
      markdown=${e.markdown}
    ></eox-storytelling>
  `}})),_,v=e((()=>{t(),_={argTypes:{markdown:{table:{category:`properties`}}},args:{markdown:`# Welcome to Storytelling <!--{ as="video" mode="hero" src="https://dlmultimedia.esa.int/download/public/videos/2023/06/010/2306_010_AR_EN.mp4" }-->
#### An introduction on how to write interactive and multimedial stories using markdown. Scroll down to get started! <!--{ style="font-size:1rem;opacity:0.7;margin-top:1rem;" }-->
...
More features will be added soon, so feel free to follow progress at the [EOxElements GitHub repository](https://github.com/EOX-A/EOxElements).
    `,id:`markdown-tour`,showNav:!0,showHeroScrollIndicator:!0},render:e=>n`
    <eox-storytelling
      id=${e.id}
      ?show-nav=${e.showNav}
      ?show-hero-scroll-indicator=${e.showHeroScrollIndicator}
...
`,id:`markdown-init-event`,init:e=>y(e.detail),storyCodeBefore:`
    ...
    <eox-storytelling
      ...
      @init=${e.init}
    ></eox-storytelling>
  `}})),S=e((()=>{i(),o(),c(),u(),f(),m(),g(),v(),x()})),C,w,T,E,D,O,k,A,j,M,N;e((()=>{S(),t(),C={title:`Elements/eox-storytelling`,tags:[`autodocs`],component:`eox-storytelling`,decorators:[e=>n`${e()}
        <style>
