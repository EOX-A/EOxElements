import{s as c,x as u}from"./lit-element-c29cbb6b.js";import"./main-ea9f3606.js";import{t as p,n as r,e as h}from"./query-assigned-elements-bec7f9a4.js";import"./toolcool-range-slider.min-b4f5b26b.js";import{b as y}from"./button-65098188.js";import"./templateElement-8d2f8dc8.js";import"./_commonjsHelpers-042e6b4d.js";import"./iframe-c395b1c2.js";import"../sb-preview/runtime.js";const d=`
:host {
  display: block;
}
`,g=`
...
`;var x=Object.defineProperty,_=Object.getOwnPropertyDescriptor,n=(e,a,s,o)=>{for(var t=o>1?void 0:o?_(a,s):a,l=e.length-1,m;l>=0;l--)(m=e[l])&&(t=(o?m(a,s,t):m(t))||t);return o&&t&&x(a,s,t),t};let i=class extends c{constructor(){super(...arguments),this.animationValues=[],this._newTimeIndex=0}next(){this._updateStep(1)}previous(){this._updateStep(-1)}playAnimation(e){e?this._animationInterval=setInterval(()=>this._updateStep(1),500):clearInterval(this._animationInterval),this._isAnimationPlaying=e,this.requestUpdate()}setConfig(e){this.layer=e.layer??this.layer,this.animationProperty=e.animationProperty??this.animationProperty,this.animationValues=e.animationValues??this.animationValues,this.requestUpdate(),this._updateStep(0)}_updateStep(e=1){this._newTimeIndex=this._newTimeIndex+e,this._newTimeIndex>this.animationValues.length-1&&(this._newTimeIndex=0),this._newTimeIndex<0&&(this._newTimeIndex=this.animationValues.length-1),this._animationSource.setTileUrlFunction((a,s,o)=>{const t=this._originalTileUrlFunction(a,s,o);if(this.urlFunction)return this.urlFunction(t);const l=new URLSearchParams(t.substring(t.indexOf("?")));return l.set(this.animationProperty,this.animationValues[this._newTimeIndex]),t.substring(0,t.indexOf("?")+1)+l.toString()}),this._animationSource.setKey(new Date),this._animationSource.changed(),this.requestUpdate()}render(){const e=document.querySelector(this.for),a=e.map||e;return a.once("loadend",()=>{if(!this._originalTileUrlFunction){const s=a.getLayers().getArray().find(o=>{var t;return o.get("id")===this.layer||((t=o.get("mapbox-layers"))==null?void 0:t.includes(this.layer))});this._animationSource=s.getSource(),this._originalTileUrlFunction=this._animationSource.getTileUrlFunction()}}),u`
    ...
    `}};n([r({attribute:"animation-property"})],i.prototype,"animationProperty",2);n([r({attribute:"animation-values",type:Array})],i.prototype,"animationValues",2);n([r()],i.prototype,"for",2);n([r()],i.prototype,"layer",2);n([r({type:Boolean})],i.prototype,"slider",2);n([r()],i.prototype,"urlFunction",2);n([r()],i.prototype,"_originalTileUrlFunction",2);n([p()],i.prototype,"_animationInterval",2);n([p()],i.prototype,"_animationSource",2);n([p()],i.prototype,"_isAnimationPlaying",2);n([p()],i.prototype,"_newTimeIndex",2);n([r({type:Boolean})],i.prototype,"unstyled",2);i=n([h("eox-timecontrol")],i);const C={title:"Elements/eox-timecontrol",tags:["autodocs"],component:"eox-timecontrol",render:()=>u`
    <eox-map
    ...
    ></eox-timecontrol>
  `},V={args:{}};export{V as Primary,C as default};
//# sourceMappingURL=stories-e9be8a5a.js.map
