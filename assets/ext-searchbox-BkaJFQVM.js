import{g as w}from"./index-DuuuSFPv.js";function B(d,b){for(var i=0;i<b.length;i++){const h=b[i];if(typeof h!="string"&&!Array.isArray(h)){for(const p in h)if(p!=="default"&&!(p in d)){const r=Object.getOwnPropertyDescriptor(h,p);r&&Object.defineProperty(d,p,r.get?r:{enumerable:!0,get:()=>h[p]})}}}return Object.freeze(Object.defineProperty(d,Symbol.toStringTag,{value:"Module"}))}var _={exports:{}},A;function $(){return A||(A=1,function(d,b){ace.define("ace/ext/searchbox-css",["require","exports","module"],function(i,h,p){p.exports=`
