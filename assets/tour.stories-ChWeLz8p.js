import{i as e}from"./preload-helper-DbRxMUml.js";import{Pt as t,kt as n}from"./iframe-DAx6OKtD.js";var r,i=e((()=>{n(),r={args:{config:{showButtons:[`next`,`previous`,`close`],showProgress:!0,steps:[{element:`#tour-target-1`,popover:{title:`Step 1`,description:`This is the first step of the tour.`,side:`bottom`,align:`start`}},{element:`#tour-target-2`,popover:{title:`Step 2`,description:`This is the second step of the tour.`,side:`top`,align:`start`}},{popover:{title:`Happy Coding`,description:`And that is all, go ahead and start adding tours to your applications.`}}]},preventAutoStart:!0,storyTemplateBefore:`
  ...
  `}})),a,o=e((()=>{n(),a={args:{config:{showButtons:[`next`,`previous`,`close`],showProgress:!0,steps:[{element:`#parent-target-1`,popover:{title:`Parent Start`}},{targetIframe:`#demo-iframe`,element:`#child-target-1`,popover:{title:`Child Step`,description:`Simply defined in the parent config array, rendered inside the iframe.`}},{element:`#parent-target-2`,popover:{title:`Parent Resume`}}]},storyTemplateBefore:`
    ...
    `}})),s,c=e((()=>{n(),s={args:{config:{showButtons:[`next`,`previous`,`close`],showProgress:!0,totalSteps:3,steps:[{element:`#parent-target-1`,popover:{title:`Parent Start`}},{element:`#demo-iframe`,popover:{title:`Handoff`,targetIframe:`#demo-iframe`,childStepIndex:0,backwardChildStepIndex:-1}},{element:`#parent-target-2`,popover:{title:`Parent Resume`}}]},storyTemplateBefore:`
    <div id="parent-target-1" style="padding: 20px; border: 1px solid #ccc;">
      Step 1 (Parent)
    </div>
    <iframe
    ...
    `}})),l,u=e((()=>{n(),l={args:{"show-every-time":!0,config:{showButtons:[`next`],steps:[{element:`#target-always`,popover:{title:`Persistent Tour`,description:`I start every time because of the <code>show-every-time</code> attribute.`,side:`bottom`,align:`start`}}]},storyTemplateBefore:`
