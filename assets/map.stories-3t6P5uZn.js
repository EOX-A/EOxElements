import{i as e}from"./preload-helper-B45gAKPr.js";import{d as t,t as n}from"./lit-X6_6WslE.js";import{_t as r}from"./proj-baYN4G8K.js";import{P as i,T as a,d as ee,h as te,m as ne}from"./iframe-s3sZnEQv.js";import{n as re,t as ie}from"./taggedTemplateLiteral-DwA8eoE9.js";var ae,oe=e((()=>{ae={args:{center:[15,48],layers:[{type:`Tile`,source:{type:`OSM`}}],zoom:7}}})),o,se=e((()=>{o={args:{layers:[{type:`Vector`,background:`#1366dd`,properties:{id:`regions`},source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`,attributions:`Regions: @ openlayers.org`},style:{"stroke-color":`#232323`,"stroke-width":1,"fill-color":[`string`,[`get`,`COLOR`],`#eee`]}}]}}})),s,ce=e((()=>{s={args:{center:[16.37,48.2],zoom:12,layers:[{type:`Tile`,properties:{id:`osm`},source:{type:`OSM`}},{type:`Vector`,properties:{id:`inlineGeojson`},source:{type:`Vector`,features:[{type:`Feature`,geometry:{type:`Point`,coordinates:[16.37,48.2]},properties:{name:`Vienna`}}]},style:{"circle-radius":10,"circle-fill-color":`red`,"circle-stroke-color":`white`,"circle-stroke-width":2}}]}}})),c,le=e((()=>{c={args:{layers:[{type:`VectorTile`,background:`#1a2b39`,declutter:!0,properties:{id:`countries`},source:{type:`VectorTile`,url:`https://ahocevar.com/geoserver/gwc/service/tms/1.0.0/ne:ne_10m_admin_0_countries@EPSG%3A900913@pbf/{z}/{x}/{-y}.pbf`,format:`MVT`,tileGrid:{}},style:{"fill-color":`yellow`,"stroke-color":`#232323`,"stroke-width":1}}]}}})),l,ue=e((()=>{l={args:{center:[-10997148,4569099],layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`TileWMS`,url:`https://ahocevar.com/geoserver/wms`,params:{LAYERS:`topp:states`,TILED:!0},ratio:1,serverType:`geoserver`}}],zoom:3}}})),u,de=e((()=>{u={args:{center:[20,40],layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`WMTSCapabilities`,url:`https://tiles.maps.eox.at/wmts/1.0.0/WMTSCapabilities.xml`,layer:`s2cloudless-2025`,attribution:`EOxCloudless <a href="https://cloudless.eox.at" target="_blank" rel="noreferrer">https://cloudless.eox.at</a> by <a href="https://eox.at" target="_blank">EOX IT Services GmbH</a> (Contains modified Copernicus Sentinel data 2025)`}}],zoom:5,storyCodeBefore:`import "@eox/map/src/plugins/advancedLayersAndSources"`}}})),d,fe=e((()=>{d={args:{center:[20,40],layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`WMTS`,url:`https://tiles.maps.eox.at/wmts`,layer:`s2cloudless-2025_3857`,attribution:`EOxCloudless <a href="https://cloudless.eox.at" target="_blank" rel="noreferrer">https://cloudless.eox.at</a> by <a href="https://eox.at" target="_blank">EOX IT Services GmbH</a> (Contains modified Copernicus Sentinel data 2025)`,style:`default`,matrixSet:`GoogleMapsCompatible`,tileGrid:{tileSize:[128,128]}}}],zoom:5}}})),f,pe=e((()=>{f={args:{center:[-10997148,4569099],layers:[{type:`Image`,properties:{id:`regions`},source:{type:`ImageStatic`,imageExtent:[-20037508.342789244,-15028131.257091934,20037508.342789244,15028131.257091934],url:`https://imgs.xkcd.com/comics/online_communities.png`}}],zoom:0}}})),me,he=e((()=>{me={args:{center:[-122.38,46.1],layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`OSM`}},{type:`STAC`,properties:{id:`stacLayer`},url:`https://s3.us-west-2.amazonaws.com/sentinel-cogs/sentinel-s2-l2a-cogs/10/T/ES/2022/7/S2A_10TES_20220726_0_L2A/S2A_10TES_20220726_0_L2A.json`}],zoom:7,storyCodeBefore:`import "@eox/map/src/plugins/advancedLayersAndSources"`}}})),ge,_e=e((()=>{ge={args:{center:[0,0],layers:[{type:`MapboxStyle`,properties:{id:`mapboxStyleGroup`,title:`mapboxStyleGroup`,mapboxStyle:{version:8,sources:{osm:{type:`raster`,tiles:[`https://a.tile.openstreetmap.org/{z}/{x}/{y}.png`],tileSize:256,attribution:`© OpenStreetMap contributors`},pointSource:{type:`geojson`,data:{type:`FeatureCollection`,features:[{type:`Feature`,geometry:{type:`Point`,coordinates:[0,0]},properties:{}}]}}},layers:[{id:`osm-base`,type:`raster`,source:`osm`,minzoom:0,maxzoom:19},{id:`point-halo`,type:`circle`,source:`pointSource`,paint:{"circle-radius":10,"circle-color":`#0000ff`,"circle-opacity":.5}},{id:`point-main`,type:`circle`,source:`pointSource`,paint:{"circle-radius":5,"circle-color":`#ff0000`}}]}}}],zoom:0,storyCodeBefore:`import "@eox/map/src/plugins/advancedLayersAndSources"`}}})),ve,ye=e((()=>{ve={args:{center:[3737055,1886786],layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`OSM`}},{type:`WebGLTile`,properties:{id:`geotiffLayer`},source:{type:`GeoTIFF`,sources:[{url:`https://sentinel-cogs.s3.us-west-2.amazonaws.com/sentinel-s2-l2a-cogs/36/Q/WD/2020/7/S2A_36QWD_20200701_0_L2A/TCI.tif`}]}}],zoom:8,storyCodeBefore:`import "@eox/map/src/plugins/advancedLayersAndSources"`}}})),be,xe=e((()=>{be={args:{center:[1407372,5701616],layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`OSM`}},{type:`WebGLTile`,properties:{id:`sentinel-2-l2a`,title:`Surface Reflectance`},source:{type:`GeoZarr`,url:`https://s3.explorer.eopf.copernicus.eu/esa-zarr-sentinel-explorer-fra/tests-output/sentinel-2-l2a/S2C_MSIL2A_20260716T100601_N0512_R022_T32TQR_20260716T154011.zarr/measurements/reflectance`,bands:[`b04`,`b03`,`b02`]},style:{gamma:1.5,color:[`color`,[`interpolate`,[`linear`],[`band`,1],0,0,.5,255],[`interpolate`,[`linear`],[`band`,2],0,0,.5,255],[`interpolate`,[`linear`],[`band`,3],0,0,.5,255]]}}],zoom:9,storyCodeBefore:`import "@eox/map/src/plugins/advancedLayersAndSources"`}}})),Se,Ce=e((()=>{Se={args:{layers:[{type:`Group`,properties:{id:`group`},layers:[{type:`Group`,properties:{id:`groupLayerInsideGroup`},layers:[{type:`Tile`,properties:{id:`layerInsideGroupInsideGroup`},source:{type:`OSM`}}]},{type:`Vector`,properties:{id:`regions`},source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`}}]}]}}})),we,Te=e((()=>{n(),a(),we={args:{storyStyle:`
      .custom-btn {
...
`,controls:{FullScreen:{position:`top-right`,target:`fs-attribution`,orientation:`vertical`},Attribution:{position:`bottom-right`,target:`zoom-hz`,orientation:`horizontal`,collapsible:!0},Zoom:{position:`bottom-right`,target:`zoom-hz`,orientation:`horizontal`},Rotate:{position:`bottom-center`,target:`bottom-tools`,orientation:`horizontal`},GlobeSwitcher:{position:`bottom-center`,target:`bottom-tools`,orientation:`horizontal`},ScaleLine:{position:`bottom-left`,target:`scale-line`,orientation:`horizontal`},MousePosition:{position:`bottom-left`,target:`scale-line`,orientation:`horizontal`},OverviewMap:{position:`top-left`,collapsed:!1,layers:[{type:`Tile`,source:{type:`OSM`}}]}},layers:[{type:`Tile`,source:{type:`XYZ`,url:`https://tiles.maps.eox.at/wmts/1.0.0/s2cloudless-2025_3857/default/g/{z}/{y}/{x}.jpg`,attributions:`EOxCloudless <a href="https://cloudless.eox.at" target="_blank" rel="noreferrer">https://cloudless.eox.at</a> by <a href="https://eox.at" target="_blank">EOX IT Services GmbH</a> (Contains modified Copernicus Sentinel data 2025)`}}],zoom:4,center:[10,50]},render:e=>t`
    ...
    >
      ${i(e.storySlotContent)}
    </eox-map>
  `}})),Ee,De=e((()=>{Ee={args:{controls:{GlobeSwitcher:{},Zoom:{},Attribution:{},FullScreen:{},Rotate:{},OverviewMap:{layers:[{type:`Tile`,properties:{id:`overviewMap`},source:{type:`OSM`}}]},MousePosition:{},ScaleLine:{},Geolocation:{}},layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`OSM`}}]}}})),Oe,ke=e((()=>{Oe={args:{zoom:7,controls:{Geolocation:{tracking:!0,trackHeading:!0,centerWhenReady:!1,highAccuracy:!0,trackAccuracy:!0,style:{"circle-radius":10,"circle-fill-color":`red`,"circle-stroke-color":`white`,"circle-stroke-width":2}}},layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`OSM`}}]}}})),Ae,je=e((()=>{Ae={args:{zoom:9,center:[0,51.5],controls:{LoadingIndicator:{},Zoom:{}},layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`OSM`}}]}}})),Me,Ne=e((()=>{Me={args:{zoom:9,center:[0,51.5],controls:{LoadingIndicator:{type:`fullscreen`,opacity:.2,spinnerSvg:`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" width="50" height="50" style="shape-rendering: auto; display: block; background: transparent;" xmlns:xlink="http://www.w3.org/1999/xlink"><g><circle stroke-dasharray="120 50" r="30" stroke-width="22" stroke="#cd4609" fill="none" cy="50" cx="50">
        <animateTransform keyTimes="0;1" values="0 50 50;360 50 50" dur="0.4s" repeatCount="indefinite" type="rotate" attributeName="transform"></animateTransform>
            </circle><g></g></g></svg>`},Zoom:{}},layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`OSM`}}]}}})),Pe,Fe=e((()=>{Pe={args:{layers:[{type:`Vector`,source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`},interactions:[{type:`select`,options:{id:`selectInteraction`,condition:`pointermove`,layer:{type:`Vector`,properties:{id:`selectLayer`},source:{type:`Vector`},style:{"stroke-color":`red`,"stroke-width":3}}}}]}]}}})),Ie,Le=e((()=>{Ie={args:{layers:[{type:`Vector`,background:`#1366dd`,properties:{id:`regions`},source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`,attributions:`Regions: @ openlayers.org`},style:{"stroke-color":`black`,"stroke-width":1,"fill-color":`red`},interactions:[{type:`select`,options:{id:`selectInteraction`,condition:`click`,style:{"stroke-color":`white`,"stroke-width":3}}}]}]}}})),Re,ze=e((()=>{Re={args:{controls:{Attribution:{}},layers:[{type:`Tile`,properties:{id:`OSM`},source:{type:`OSM`}},{type:`Vector`,properties:{id:`clusterLayer`},interactions:[{type:`clusterExplode`,options:{id:`clusterExplodeInteraction`,maxZoom:10,fitOptions:{duration:300},style:{"circle-radius":12,"circle-fill-color":`#FFD700`,"circle-stroke-color":`rgba(255, 255, 255, 0.7)`,"circle-stroke-width":2,"text-font":`normal 16px`,"text-value":[`get`,`NAME`],"text-fill-color":`#000`,"text-offset-y":1}}}],style:[{filter:[`>`,[`get`,`features`,`length`],1],style:{"text-value":[`to-string`,[`get`,`features`,`length`]],"circle-radius":12,"circle-fill-color":`#FFD700`,"circle-stroke-color":`rgba(255, 255, 255, 0.7)`,"circle-stroke-width":2,"text-font":`normal 16px`,"text-fill-color":`#000`,"text-offset-y":1}},{else:!0,style:{"circle-radius":12,"circle-fill-color":`#FFD700`,"circle-stroke-color":`rgba(255, 255, 255, 0.7)`,"circle-stroke-width":2,"text-font":`normal 16px`,"text-value":[`get`,`NAME`],"text-fill-color":`#000`,"text-offset-y":1,"fill-color":`#FFD700`,"fill-opacity":.5,"stroke-color":`#eeeeee`,"stroke-width":2}}],source:{type:`Cluster`,distance:55,attributions:`Map data © <a href="https://www.naturalearthdata.com">Natural Earth</a> | City points via <a href="https://github.com/drei01/geojson-world-cities">geojson-world-cities</a>`,source:{type:`Vector`,url:`https://raw.githubusercontent.com/drei01/geojson-world-cities/refs/heads/master/cities.geojson`,format:`GeoJSON`}}}],storyCodeBefore:`import "@eox/map/src/plugins/advancedLayersAndSources"`}}})),Be,Ve=e((()=>{n(),Be={args:{layers:[{type:`Vector`,source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`},interactions:[{type:`select`,options:{id:`selectInteraction`,condition:`pointermove`,style:{"stroke-color":`red`,"stroke-width":3}}}]}],center:[15,48],zoom:4,storySlotContent:`<eox-map-tooltip></eox-map-tooltip>`},render:e=>t`
    <eox-map
      .center=${e.center}
      .controls=${e.controls}
      .layers=${e.layers}
  ...
  `}})),He,Ue=e((()=>{n(),He={args:{layers:[{type:`Vector`,source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`},interactions:[{type:`select`,options:{id:`selectInteraction`,condition:`pointermove`,style:{"stroke-color":`red`,"stroke-width":3}}}]}],center:[15,48],zoom:4,storyAdditionalComponents:{"eox-map-tooltip":{storyImport:!1,storySlot:!0,propertyTransform:e=>{if(e.key.includes(`COLOR`))return{key:e.key.toLowerCase(),value:e.value}}}}},render:e=>t`
    <eox-map
      .center=${e.center}
      .controls=${e.controls}
      .layers=${e.layers}
  ...
  `}})),We,Ge=e((()=>{n(),We={args:{id:`highlightAndAnimate`,config:{layers:[{type:`Vector`,background:`lightgrey`,properties:{id:`regions`},source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`,attributions:`Regions: @ openlayers.org`},style:{"stroke-color":`black`,"stroke-width":1,"fill-color":`darkgrey`},interactions:[{type:`select`,options:{id:`selectInteraction`,condition:`click`,style:{"stroke-color":`white`,"stroke-width":3}}}]}]},loadend:()=>{document.querySelector(`eox-map#highlightAndAnimate`).selectInteractions.selectInteraction.highlightById([664,795,789],{duration:400,padding:[50,50,50,50]})}},render:e=>t`
    <eox-map
      id=${e.id}
      .config=${e.config}
      @loadend=${e.loadend}
    ></eox-map>
  `}})),Ke,qe=e((()=>{n(),Ke={args:{id:`a`,layers:[{type:`Tile`,properties:{id:`osm`,title:`Background`},source:{type:`OSM`}}],storyAdditionalComponents:{"eox-map":{id:`b`,sync:`#a`,layers:[{type:`Tile`,properties:{id:`osm`,title:`Background`},source:{type:`OSM`}}]}}},render:e=>t`
    <style>
      eox-map {
        width: 50%;
      }
  ...
  `}})),Xe,Ze=e((()=>{n(),Xe={args:{config:{controls:{Zoom:{}},layers:[{type:`Tile`,source:{type:`OSM`}}],view:{center:[16.8,48.2],zoom:9}}},render:e=>t`
    <eox-map .config=${e.config}></eox-map>
  `}})),Qe,$e=e((()=>{n(),Qe={args:{layers:[{type:`Tile`,properties:{id:`osm`,title:`Background`},source:{type:`OSM`}},{type:`Vector`,source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`}}],center:[16.8,48.2],zoom:7,projection:`EPSG:3857`},render:e=>t`
    <eox-map
      .center=${e.center}
      .controls=${e.controls}
      .layers=${e.layers}
  ...
  `}})),et,tt=e((()=>{n(),et={args:{layers:[{type:`Tile`,properties:{id:`osm`,title:`Background`},source:{type:`OSM`}}],animationOptions:{duration:500},center:[16.8,48.2],zoom:7},render:e=>t`
    <eox-map
      .center=${e.center}
      .layers=${e.layers}
      .zoom=${e.zoom}
 ...
 customElements.define(
    ...
    )`,layers:[{type:`Vector`,source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`},interactions:[{type:`select`,options:{id:`selectInteraction`,condition:`pointermove`,style:{"stroke-color":`red`,"stroke-width":3}}}]}],center:[15,48],zoom:4},render:e=>t(ct||=ie([`
    <script>
      `,`;
    <\/script>
    <eox-map
  ...
  `]),e.storyCodeBefore,e.center,e.controls,e.layers,e.zoom)}})),dt,ft=e((()=>{n(),dt={args:{layers:[{type:`Tile`,properties:{title:`Terrain Light`,id:`terrain-light`},source:{type:`XYZ`,url:`//tiles.maps.eox.at/wmts/1.0.0/terrain-light_3857/default/g/{z}/{y}/{x}.jpg`}},{type:`Tile`,properties:{id:`wmsLayer`},source:{type:`TileWMS`,url:`https://ahocevar.com/geoserver/wms`,params:{LAYERS:`topp:states`,TILED:!0},ratio:1,serverType:`geoserver`},interactions:[{type:`select`,options:{id:`selectInteraction`,condition:`click`}}]}],center:[-10997148,4569099],zoom:4,storySlotContent:`<eox-map-tooltip></eox-map-tooltip>`},render:e=>t`
    <eox-map
      .center=${e.center}
      .controls=${e.controls}
      .layers=${e.layers}
  ...
  `}})),p,pt,mt,ht,gt=e((()=>{n(),customElements.define(`custom-coordinates-tooltip`,class extends HTMLElement{constructor(){super()}set feature(e){this.innerHTML=`
