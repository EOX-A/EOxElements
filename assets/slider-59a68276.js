import{w as i,T as a}from"./lit-element-10b89e96.js";import{e as p,i as s,t as r}from"./unsafe-html-786c6b69.js";import{f as d,m as l}from"./directive-helpers-4f2bc21b.js";/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const h=p(class extends s{constructor(e){if(super(e),e.type!==r.PROPERTY&&e.type!==r.ATTRIBUTE&&e.type!==r.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!d(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===i||t===a)return t;const n=e.element,o=e.name;if(e.type===r.PROPERTY){if(t===n[o])return i}else if(e.type===r.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(o))return i}else if(e.type===r.ATTRIBUTE&&n.getAttribute(o)===t+"")return i;return l(e),t}}),x=`
input[type=radio] {
  appearance: none;
...
`;export{b as c,h as l,x as r,m as s};
//# sourceMappingURL=slider-59a68276.js.map
