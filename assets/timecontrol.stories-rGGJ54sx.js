var $=Object.freeze,I=Object.defineProperty;var f=(e,w)=>$(I(e,"raw",{value:$(w||e.slice())}));import{Q as t,x as o}from"./iframe-Cxb-w6dD.js";import"./preload-helper-PPVm8Dsz.js";const v={args:{for:"eox-map#only-date",storyAdditionalComponents:{"eox-map":{id:"only-date",zoom:t.zoom,center:t.center,layers:t.layers},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,format:t.format}}},render:e=>o`
    <eox-map
  ...
  `},D={args:{layerIdKey:t.layerIdKey,for:"eox-map#date-with-navigation",storyAdditionalComponents:{"eox-map":{id:"date-with-navigation",zoom:t.zoom,center:t.center,layers:t.layers},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,format:t.format,navigation:!0}}},render:e=>o`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents["eox-map"].id}
      .zoom=${e.storyAdditionalComponents["eox-map"].zoom}
  ...
  `},A={args:{layerIdKey:t.layerIdKey,for:"eox-map#date-picker-popup",select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-map":{id:"date-picker-popup",zoom:t.zoom,center:t.center,layers:t.layers},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,format:t.format,navigation:!0},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,format:t.format,showDots:!0,popup:!0}}},render:e=>o`
    <style>
      eox-map {
        width: 100%;
        height: 500px;
  ...
  `},K={args:{layerIdKey:t.layerIdKey,for:"eox-map#timeline",select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-map":{id:"timeline",zoom:t.zoom,center:t.center,layers:t.layers},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,navigation:!0},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,showDots:!0,popup:!0,showItems:!0}}},render:e=>o`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents["eox-map"].id}
      .zoom=${e.storyAdditionalComponents["eox-map"].zoom}
  ...
  `};var S;const M={args:{layerIdKey:t.layerIdKey,titleKey:t.titleKey,externalMapRendering:!0,animate:!0,for:"eox-map#external-map-rendering-mosaic",select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-map":{id:"external-map-rendering-mosaic",zoom:10,center:[12,42]},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,navigation:!0},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,range:!0,showDots:!0,showItems:!0,popup:!0}}},render:e=>o(S||(S=f([`
    ...
    <script>
      ...
      externalStorySetup();
    <\/script>
  `])),e.storyAdditionalComponents["eox-map"].id,e.storyAdditionalComponents["eox-map"].zoom,e.storyAdditionalComponents["eox-map"].center,e.for,e.layerIdKey,e.titleKey,e.filters,e.externalMapRendering,e.select,e.storyAdditionalComponents["eox-timecontrol-date"].navigation,e.storyAdditionalComponents["eox-timecontrol-picker"].range,e.storyAdditionalComponents["eox-timecontrol-picker"].showDots,e.storyAdditionalComponents["eox-timecontrol-picker"].showItems,e.storyAdditionalComponents["eox-timecontrol-picker"].popup)};var g;const T={args:{layerIdKey:t.layerIdKey,titleKey:t.titleKey,filters:t.filters,externalMapRendering:!0,animate:!0,for:"eox-map#external-map-rendering-mosaic",select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-map":{id:"external-map-rendering-mosaic",zoom:10,center:[12,42]},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,navigation:!0},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,range:!0,showDots:!0,popup:!0},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0},"eox-itemfilter":{storySlot:!0}}},render:e=>o(g||(g=f([`
    <eox-map
      style="width: 100%; height: 500px;"
      id=`,`
      .zoom=`,`
  ...
  `},O={args:{layerIdKey:t.layerIdKey,titleKey:t.titleKey,filters:t.filters,navigation:!0,popup:!0,position:["bottom","left"],select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-timecontrol-date":{storyImport:!1,storySlot:!0,format:t.format,navigation:!0},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,format:t.format,showDots:!0,popup:!0,position:["bottom","left"]},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0},"eox-timecontrol-slider":{storyImport:!1,storySlot:!0},"eox-itemfilter":{storyImport:!1,storySlot:!0}}},render:e=>o`
    <eox-timecontrol
      ...
      .titleKey=${e.titleKey}
      .filters=${e.filters}
      .controlValues=${t.layers.map(w=>w.properties)}
      @select=${e.select}
    >
      <div style="display: flex; gap: 10px;align-items: center;">
        <eox-timecontrol-date
  ...
  `},E={args:{for:"eox-map#date-with-init-date",initDate:["2021-02-28"],storyAdditionalComponents:{"eox-map":{id:"date-with-init-date",zoom:t.zoom,center:t.center,layers:t.layers},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,format:"D. MMMM YYYY"}},select:e=>{console.log(e.detail)}},render:e=>o`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents["eox-map"].id}
      .zoom=${e.storyAdditionalComponents["eox-map"].zoom}
  ...
  `},B={title:"Elements/eox-timecontrol",tags:["autodocs"],component:"eox-timecontrol",render:e=>o`
    <eox-timecontrol
      .for=${e.for}
      .layerIdKey=${e.layerIdKey}
      .titleKey=${e.titleKey}
...
the map layers.`,...m.parameters?.docs?.description}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:"TimelineStory",...p.parameters?.docs?.source},description:{story:`Timeline visualization using vis-timeline with date picker and calendar integration
...
comprehensive time navigation interface.`,...p.parameters?.docs?.description}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:"ExternalMapRenderingStory",...c.parameters?.docs?.source},description:{story:`External map rendering mode for timelapse export with custom map rendering logic
...
time step, or when using map rendering services that require special handling.`,...c.parameters?.docs?.description}}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:"DateFilterStory",...y.parameters?.docs?.source},description:{story:`Date filtering using eox-itemfilter for filtering timeline items by metadata properties
...
The event is dispatched with the start and end dates of the view range.`,...x.parameters?.docs?.description}}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:"NoMapStory",...u.parameters?.docs?.source},description:{story:"No map story\n\nThis example demonstrates the timecontrol component without a map. The component can be used\nstandalone by providing `controlValues` directly instead of linking to a map via the `for` attribute.\nThis is useful when you want to use timecontrol for date selection without map integration.",...u.parameters?.docs?.description}}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:"ExpertStory",...h.parameters?.docs?.source},description:{story:`Expert example showcasing all timecontrol features together
...
multiple interaction methods and visualization options.`,...h.parameters?.docs?.description}}};const N=["OnlyDate","DateWithInitDate","DateWithNavigation","DatePickerPopup","DatePickerPopupItems","DateInUTC","DatePickerStandalone","Slider","Timeline","ExternalMapRendering","DateFilter","UpdateView","NoMap","Expert"];export{y as DateFilter,l as DateInUTC,a as DatePickerPopup,s as DatePickerPopupItems,d as DatePickerStandalone,r as DateWithInitDate,n as DateWithNavigation,h as Expert,c as ExternalMapRendering,u as NoMap,i as OnlyDate,m as Slider,p as Timeline,x as UpdateView,N as __namedExportsOrder,B as default};
