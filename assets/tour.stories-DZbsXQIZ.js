import{x as n}from"./iframe-DvEstiAz.js";import"./preload-helper-PPVm8Dsz.js";const p={args:{config:{showButtons:["next","previous","close"],showProgress:!0,steps:[{element:"#tour-target-1",popover:{title:"Step 1",description:"This is the first step of the tour.",side:"bottom",align:"start"}},{element:"#tour-target-2",popover:{title:"Step 2",description:"This is the second step of the tour.",side:"top",align:"start"}},{popover:{title:"Happy Coding",description:"And that is all, go ahead and start adding tours to your applications."}}]},preventAutoStart:!0,storyTemplateBefore:`
