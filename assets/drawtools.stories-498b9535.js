var y=(e,r,t)=>{if(!r.has(e))throw TypeError("Cannot "+t)};var o=(e,r,t)=>(y(e,r,"read from private field"),t?t.call(e):r.get(e)),u=(e,r,t)=>{if(r.has(e))throw TypeError("Cannot add the same private member more than once");r instanceof WeakSet?r.add(e):r.set(e,t)},p=(e,r,t,s)=>(y(e,r,"write to private field"),s?s.call(e,t):r.set(e,t),t);import{s as H,x as c,A as w}from"./lit-element-c29cbb6b.js";import"./main-c8b0bdfa.js";import{b}from"./button-f0c29825.js";import"./query-assigned-elements-bec7f9a4.js";import"./templateElement-8d2f8dc8.js";import"./_commonjsHelpers-de833af9.js";import"./iframe-631d84e9.js";import"../sb-preview/runtime.js";const D=`
:host {
  display: block;
}
`,v=`
...
`;var a,n;class F extends H{constructor(){super();u(this,a,void 0);u(this,n,void 0);this.for="eox-map",this.currentlyDrawing=!1,this.draw=null,this.drawLayer=null,this.drawnFeatures=[],this.layer="draw",this.modify=null,this.multipleFeatures=!1,this.unstyled=!1}static get properties(){return{for:{type:String},currentlyDrawing:{attribute:!1,state:!0,type:Boolean},draw:{attribute:!1,state:!0},drawLayer:{attribute:!1,state:!0},drawnFeatures:{attribute:!1,state:!0,type:Array},layer:{type:String},modify:{attribute:!1,state:!0},multipleFeatures:{attribute:"multiple-features",type:Boolean},unstyled:{type:Boolean}}}startDrawing(){var t,s;o(this,a).addDraw(this.layer,{id:"drawInteraction",type:"Polygon",stopClick:!0}),this.draw=o(this,a).interactions.drawInteraction,this.modify=o(this,a).interactions.drawInteractionmodify,(t=this.draw)==null||t.on("drawend",i=>this.onDrawEnd(i)),(s=this.modify)==null||s.on("modifyend",i=>this.onModifyEnd(i)),this.currentlyDrawing=!0,this.requestUpdate()}discardDrawing(){this.drawnFeatures=[],o(this,a).removeInteraction("drawInteraction"),this.drawLayer.getSource().clear(),this.currentlyDrawing=!1,this.requestUpdate()}onDrawEnd(t){console.log(t.target),this.emitDrawnFeatures(),o(this,a).removeInteraction("drawInteraction"),this.currentlyDrawing=!1,this.requestUpdate()}onModifyEnd(t){console.log(t),this.emitDrawnFeatures()}emitDrawnFeatures(){setTimeout(()=>{this.drawnFeatures=this.drawLayer.getSource().getFeatures(),this.requestUpdate();const t=new CustomEvent("drawupdate",{detail:this.drawnFeatures});this.dispatchEvent(t)},0)}render(){var s,i;const t=document.querySelector(this.for);return p(this,a,t),p(this,n,o(this,a).map),this.drawLayer=o(this,n).getLayers().getArray().find(E=>E.get("id")===this.layer),this.requestUpdate(),c`
    ...
    `}}a=new WeakMap,n=new WeakMap;customElements.define("eox-drawtools",F);const T={title:"Elements/eox-drawtools",tags:["autodocs"],component:"eox-drawtools"},l={render:()=>c` <eox-map
      id="primary"
    ...
    ></eox-map>
    <eox-drawtools for="eox-map#primary" layer="draw"></eox-drawtools>`},d={render:()=>c` <eox-map
      id="multi"
      style="width: 400px; height: 300px;"
      layers='[
      {"type": "Vector","id": "draw","source": {"type": "Vector"}},
    ...
    <eox-drawtools
      ...
      layer="draw"
      multiple-features
    ></eox-drawtools>`};var h,m,g;l.parameters={...l.parameters,docs:{...(h=l.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: () => html\` <eox-map
      id="primary"
      style="width: 400px; height: 300px;"
      layers='[
...
}`,...(g=(m=l.parameters)==null?void 0:m.docs)==null?void 0:g.source}}};var x,f,V;d.parameters={...d.parameters,docs:{...(x=d.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: () => html\` <eox-map
      id="multi"
      style="width: 400px; height: 300px;"
      layers='[
    ...
    <eox-drawtools
      ...
      multiple-features
    ></eox-drawtools>\`
}`,...(V=(f=d.parameters)==null?void 0:f.docs)==null?void 0:V.source}}};const A=["Primary","MultiPolygon"];export{d as MultiPolygon,l as Primary,A as __namedExportsOrder,T as default};
//# sourceMappingURL=drawtools.stories-498b9535.js.map
