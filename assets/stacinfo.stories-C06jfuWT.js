var l=Object.freeze,g=Object.defineProperty;var m=(e,f)=>l(g(e,"raw",{value:l(f||e.slice())}));import{x as y}from"./iframe-GSzPMi6U.js";import"./preload-helper-PPVm8Dsz.js";const p={args:{for:`${window.location.href.split("iframe.html")[0]}/collection.json`,header:["title"],tags:["tags"],body:["satellite","sensor","agency","extent"],featured:["description","providers","assets","links"],footer:["sci:citation"]}},h={args:{for:`${window.location.href.split("iframe.html")[0]}/collection.json`,body:["description"]}},S={args:{for:`${window.location.href.split("iframe.html")[0]}/collection.json`,header:["title"]}},b={args:{for:`${window.location.href.split("iframe.html")[0]}/collection.json`,tags:["themes"]}},w={args:{for:`${window.location.href.split("iframe.html")[0]}/collection.json`,featured:["description","extent"]}},x={args:{for:`${window.location.href.split("iframe.html")[0]}/collection.json`,footer:["sci:citation"]}};var u;const T={args:{...p.args,id:"slot",storySlotContent:`
      <div
        slot="agency"
    ...
    <\/script>
  `])),e.id,e.for,e.header,e.body,e.featured,e.footer,e.unstyled)},$={args:{...p.args,unstyled:!0}},v={args:{for:`${window.location.href.split("iframe.html")[0]}/ports_cars_aq/2020/Genoa.json`,header:["id","title"],tags:["platform","instruments","constellation"],body:["description","sci:citation","processing:software","eopf:instrument_mode","eo:cloud_cover","view:sun_elevation"],featured:[{key:"assets",filter:e=>e.type?.includes("image/tiff")},{key:"links",filter:e=>e.type?.includes("text/html")}],footer:["start_datetime","end_datetime"]}},F={title:"Elements/eox-stacinfo",tags:["autodocs"],component:"eox-stacinfo",parameters:{componentSubtitle:"Automatically fetch & display properties of STAC files",layout:"fullscreen"},render:e=>y`
      <eox-stacinfo
        for=${e.for}
        .header=${e.header}
        .tags="${e.tags}"
