import{f as x,u as $,T as A,x as T,b as y,i as E,r as C}from"./lit-element-L04JKUcP.js";import{s as F,l as S,i as b,q as _,t as L,o as R,e as D,a as z,b as U,p as I,f as O}from"./directive-BHgxrErO.js";/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const v=D(class extends z{constructor(o){var t;if(super(o),o.type!==U.ATTRIBUTE||o.name!=="class"||((t=o.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(o){return" "+Object.keys(o).filter(t=>o[t]).join(" ")+" "}update(o,[t]){var r,s;if(this.st===void 0){this.st=new Set,o.strings!==void 0&&(this.nt=new Set(o.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in t)t[i]&&!((r=this.nt)!=null&&r.has(i))&&this.st.add(i);return this.render(t)}const e=o.element.classList;for(const i of this.st)i in t||(e.remove(i),this.st.delete(i));for(const i in t){const c=!!t[i];c===this.st.has(i)||(s=this.nt)!=null&&s.has(i)||(c?(e.add(i),this.st.add(i)):(e.remove(i),this.st.delete(i)))}return A}});class G{constructor(t){this.cle=t}render(){const t=this.cle.titleText?T`<p class="legend-title">${this.cle.titleText}</p>`:"",e={hidden:this.cle.scaleType==="categorical"},r={hidden:this.cle.scaleType!=="categorical","categorical-container":!0};return T`<div
      class="cle-container"
    ...
    >
      ...
      <slot name="footer"></slot>
        ...
        >
          ${i}
        </li>`)}`}renderContinuous(){var d;if(this.cle.scaleType!=="continuous"||this.cle.colorScale===null)return"";const{colorScale:t,marginTop:e,marginLeft:r,marginRight:s,tickSize:i,width:c,range:l}=this.cle,m=this.cle.marginBottom+i,p=this.cle.height+i,u=((d=t.interpolator)==null?void 0:d.call(t))||I(b,l);return y`<image
      x=${r}
      y=${e}
      width=${c-s-r}
      height=${p-e-m}
