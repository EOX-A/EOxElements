var g=Object.freeze,I=Object.defineProperty;var f=(e,h)=>g(I(e,"raw",{value:g(h||e.slice())}));import{Q as t,x as o}from"./iframe-Bz2XZnv4.js";import"./preload-helper-PPVm8Dsz.js";const C={args:{layerIdKey:t.layerIdKey,titleKey:t.titleKey,filters:t.filters,externalMapRendering:t.externalMapRendering,for:"eox-map#only-date",storyAdditionalComponents:{"eox-map":{id:"only-date",zoom:t.zoom,center:t.center,layers:t.layers},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,format:t.format}}},render:e=>o`
    <eox-map
  ...
  `},v={args:{layerIdKey:t.layerIdKey,titleKey:t.titleKey,filters:t.filters,externalMapRendering:t.externalMapRendering,navigation:!0,for:"eox-map#date-with-navigation",storyAdditionalComponents:{"eox-map":{id:"date-with-navigation",zoom:t.zoom,center:t.center,layers:t.layers},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,format:t.format,navigation:!0}}},render:e=>o`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents["eox-map"].id}
      .zoom=${e.storyAdditionalComponents["eox-map"].zoom}
  ...
  `},K={args:{layerIdKey:t.layerIdKey,titleKey:t.titleKey,filters:t.filters,externalMapRendering:t.externalMapRendering,popup:!0,for:"eox-map#date-picker-standalone",select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-map":{id:"date-picker-standalone",zoom:t.zoom,center:t.center,layers:t.layers},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,format:t.format,showDots:!0}}},render:e=>o`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents["eox-map"].id}
      .zoom=${e.storyAdditionalComponents["eox-map"].zoom}
  ...
  `},A={args:{layerIdKey:t.layerIdKey,titleKey:t.titleKey,filters:t.filters,externalMapRendering:t.externalMapRendering,for:"eox-map#timeline",select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-map":{id:"timeline",zoom:t.zoom,center:t.center,layers:t.layers},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,navigation:!0},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,showDots:!0,popup:!0}}},render:e=>o`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents["eox-map"].id}
      .zoom=${e.storyAdditionalComponents["eox-map"].zoom}
  ...
  `};var w;const M={args:{layerIdKey:t.layerIdKey,titleKey:t.titleKey,filters:t.filters,externalMapRendering:!0,animate:!0,for:"eox-map#external-map-rendering-mosaic",select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-map":{id:"external-map-rendering-mosaic",zoom:10,center:[12,42]},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,navigation:!0},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,range:!0,showDots:!0,showItems:!0,popup:!0}}},render:e=>o(w||(w=f([`
    <eox-map
      style="width: 100%; height: 500px;"
      id=`,`
      .zoom=`,`
    ...
    <\/script>
  `])),e.storyAdditionalComponents["eox-map"].id,e.storyAdditionalComponents["eox-map"].zoom,e.storyAdditionalComponents["eox-map"].center,e.for,e.layerIdKey,e.titleKey,e.filters,e.externalMapRendering,e.select,e.storyAdditionalComponents["eox-timecontrol-date"].navigation,e.storyAdditionalComponents["eox-timecontrol-picker"].range,e.storyAdditionalComponents["eox-timecontrol-picker"].showDots,e.storyAdditionalComponents["eox-timecontrol-picker"].showItems,e.storyAdditionalComponents["eox-timecontrol-picker"].popup)};var $;const k={args:{layerIdKey:t.layerIdKey,titleKey:t.titleKey,filters:t.filters,externalMapRendering:!0,animate:!0,for:"eox-map#external-map-rendering-mosaic",select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-map":{id:"external-map-rendering-mosaic",zoom:10,center:[12,42]},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,navigation:!0},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,range:!0,showDots:!0,popup:!0},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0},"eox-itemfilter":{storySlot:!0}}},render:e=>o($||($=f([`
    <eox-map
      style="width: 100%; height: 500px;"
      id=`,`
      .zoom=`,`
  ...
  `},L={args:{layerIdKey:t.layerIdKey,titleKey:t.titleKey,filters:t.filters,navigation:!0,popup:!0,position:["bottom","left"],select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-timecontrol-date":{storyImport:!1,storySlot:!0,format:t.format,navigation:!0},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,format:t.format,showDots:!0,popup:!0,position:["bottom","left"]},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0},"eox-timecontrol-slider":{storyImport:!1,storySlot:!0},"eox-itemfilter":{storyImport:!1,storySlot:!0}}},render:e=>o`
    <eox-timecontrol
      ...
      .titleKey=${e.titleKey}
      .filters=${e.filters}
      .controlValues=${t.layers.map(h=>h.properties)}
      @select=${e.select}
    >
      <div style="display: flex; gap: 10px;align-items: center;">
        <eox-timecontrol-date
  ...
  `},O={args:{layerIdKey:t.layerIdKey,titleKey:t.titleKey,filters:t.filters,externalMapRendering:t.externalMapRendering,for:"eox-map#date-with-init-date",initDate:["2021-02-28"],storyAdditionalComponents:{"eox-map":{id:"date-with-init-date",zoom:t.zoom,center:t.center,layers:t.layers},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,format:t.format}},select:e=>{console.log(e.detail)}},render:e=>o`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents["eox-map"].id}
      .zoom=${e.storyAdditionalComponents["eox-map"].zoom}
