import{s as E,x as g,b as _}from"./lit-element-Qm8PRmVu.js";import"./main-kXl3LMo4.js";import{r as u,n as p,t as O}from"./state-ncEgtE_C.js";import"./toolcool-range-slider.min-8Vg52R7B.js";import{b as U}from"./button-KPw86qfe.js";import{d as w}from"./dayjs.min-Sgxub5UU.js";import{c as k,g as P}from"./_commonjsHelpers-4gQjN7DL.js";import"./index-EySAwWXj.js";import"./iframe-QYjMoz6a.js";import"../sb-preview/runtime.js";const Y=`
:host {
  display: block;
}
`,N=`
...
`;var C={exports:{}};(function(t,r){(function(i,e){t.exports=e()})(k,function(){return function(i,e,n){e.prototype.dayOfYear=function(a){var m=Math.round((n(this).startOf("day")-n(this).startOf("year"))/864e5)+1;return a==null?m:this.add(a-m,"day")}}})})(C);var F=C.exports;const R=P(F);var L={exports:{}};(function(t,r){(function(i,e){t.exports=e()})(k,function(){var i="day";return function(e,n,a){var m=function(l){return l.add(4-l.isoWeekday(),i)},y=n.prototype;y.isoWeekYear=function(){return m(this).year()},y.isoWeek=function(l){if(!this.$utils().u(l))return this.add(7*(l-this.isoWeek()),i);var h,x,d,$,M=m(this),z=(h=this.isoWeekYear(),x=this.$u,d=(x?a.utc:a)().year(h).startOf("year"),$=4-d.isoWeekday(),d.isoWeekday()>4&&($+=7),d.add($,i));return M.diff(z,"week")+1},y.isoWeekday=function(l){return this.$utils().u(l)?this.day()||7:this.day(this.day()%7?l:l-7)};var W=y.startOf;y.startOf=function(l,h){var x=this.$utils(),d=!!x.u(h)||h;return x.p(l)==="isoweek"?d?this.date(this.date()-(this.isoWeekday()-1)).startOf("day"):this.date(this.date()-1-(this.isoWeekday()-1)+7).endOf("day"):W.bind(this)(l,h)}}})})(L);var B=L.exports;const q=P(B);var j=Object.defineProperty,H=Object.getOwnPropertyDescriptor,s=(t,r,i,e)=>{for(var n=e>1?void 0:e?H(r,i):r,a=t.length-1,m;a>=0;a--)(m=t[a])&&(n=(e?m(r,i,n):m(n))||n);return e&&n&&j(r,i,n),n};w.extend(R);w.extend(q);let o=class extends E{constructor(){super(...arguments),this.animationValues=[],this._newTimeIndex=0}next(){this._updateStep(1)}previous(){this._updateStep(-1)}playAnimation(t){t?this._animationInterval=setInterval(()=>this._updateStep(1),500):clearInterval(this._animationInterval),this._isAnimationPlaying=t,this.requestUpdate()}setConfig(t){this.layer=t.layer??this.layer,this.animationProperty=t.animationProperty??this.animationProperty,this.animationValues=t.animationValues??this.animationValues,this.requestUpdate(),this._updateStep(0)}_updateStep(t=1){this._newTimeIndex=this._newTimeIndex+t,this._newTimeIndex>this.animationValues.length-1&&(this._newTimeIndex=0),this._newTimeIndex<0&&(this._newTimeIndex=this.animationValues.length-1),this._animationSource.setTileUrlFunction((r,i,e)=>{const n=this._originalTileUrlFunction(r,i,e);if(this.urlFunction)return this.urlFunction(n);const a=new URLSearchParams(n.substring(n.indexOf("?")));return a.set(this.animationProperty,this.animationValues[this._newTimeIndex]),n.substring(0,n.indexOf("?")+1)+a.toString()}),this._animationSource.setKey(new Date),this._animationSource.changed(),this.requestUpdate()}render(){const t=document.querySelector(this.for),r=t.map||t;return r.once("loadend",()=>{if(!this._originalTileUrlFunction){const i=r.getLayers().getArray().find(e=>e.get("id")===this.layer);this._animationSource=i.getSource(),this._originalTileUrlFunction=this._animationSource.getTileUrlFunction()}}),g`
    ...
    `}};s([p({type:Number})],c.prototype,"width",2);s([p({type:Array})],c.prototype,"times",2);s([u()],c.prototype,"height",2);s([u()],c.prototype,"svgWidth",2);c=s([O("eox-sliderticks")],c);const nt={title:"Elements/eox-timecontrol",tags:["autodocs"],component:"eox-timecontrol"},f={args:{for:"eox-map#primary",layer:"AWS_NO2-VISUALISATION",animationProperty:"TIME",animationValues:["2022-12-05","2022-12-12","2022-12-19","2022-12-26","2023-01-16","2023-01-23","2023-01-30","2023-02-06","2023-02-13","2023-02-27","2023-03-06","2023-03-13","2023-03-20","2023-03-27","2023-04-03","2023-04-10","2023-04-17","2023-04-24"],layers:[{type:"Tile",properties:{id:"AWS_NO2-VISUALISATION"},source:{type:"TileWMS",url:"https://services.sentinel-hub.com/ogc/wms/0635c213-17a1-48ee-aef7-9d1731695a54",params:{LAYERS:"AWS_NO2-VISUALISATION"}}},{type:"Tile",source:{type:"OSM"}}],center:[1e6,6e6],zoom:3},render:t=>g`
    <eox-map
      id="primary"
  ...
  render: args => html\`
    ...
    ></eox-timecontrol>
  \`
}`,...(V=(T=v.parameters)==null?void 0:T.docs)==null?void 0:V.source}}};const rt=["Primary","Slider"];export{f as Primary,v as Slider,rt as __namedExportsOrder,nt as default};
