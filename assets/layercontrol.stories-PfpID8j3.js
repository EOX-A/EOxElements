...
></eox-map>`,ka={title:"Elements/eox-layercontrol",tags:["autodocs"],component:"eox-layercontrol",parameters:{componentSubtitle:"Manage and configure OpenLayers map layers",layout:"centered"}},Fe={args:{idProperty:"id",titleProperty:"title",unstyled:!1},render:t=>m`
...
source url parameters.`,...(wo=(xo=ke.parameters)==null?void 0:xo.docs)==null?void 0:wo.description}}};var So,Eo,Co,To,_o;We.parameters={...We.parameters,docs:{...(So=We.parameters)==null?void 0:So.docs,source:{originalSource:`{
  ...
  \`
}`,...(Go=(qo=Ke.parameters)==null?void 0:qo.docs)==null?void 0:Go.source},description:{story:"Unstyled version of the Element",...(Ko=(Jo=Ke.parameters)==null?void 0:Jo.docs)==null?void 0:Ko.description}}};const Wa=["Primary","ExclusiveLayers","OptionalLayers","ExpandedLayers","Tools","LayerConfig","HiddenLayers","SingleLayer","LayerList","Tabs","AddExternalLayer","LayerZoomState","Unstyled"];export{Ge as AddExternalLayer,Ye as ExclusiveLayers,ze as ExpandedLayers,We as HiddenLayers,ke as LayerConfig,wt as LayerList,Je as LayerZoomState,je as OptionalLayers,Fe as Primary,xt as SingleLayer,qe as Tabs,Xe as Tools,Ke as Unstyled,Wa as __namedExportsOrder,ka as default};
