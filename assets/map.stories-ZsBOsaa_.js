import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{d as t,t as n}from"./lit-D8IuYOuz.js";import{G as r,W as i}from"./helpers-KQm0dl2p.js";import{at as a,nt as ee,t as te}from"./main-Bfw8ppmQ.js";import{vt as ne}from"./proj4-nB31zbHv.js";import{t as re}from"./taggedTemplateLiteral-D3OAzLWD.js";var ie;function ae(){return(ae=e((()=>{ie={args:{center:[15,48],layers:[{type:`Tile`,source:{type:`OSM`}}],zoom:7}}})))()}var oe;function se(){return(se=e((()=>{oe={args:{layers:[{type:`Vector`,background:`#1366dd`,properties:{id:`regions`},source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`,attributions:`Regions: @ openlayers.org`},style:{"stroke-color":`#232323`,"stroke-width":1,"fill-color":[`string`,[`get`,`COLOR`],`#eee`]}}]}}})))()}var ce;function le(){return(le=e((()=>{ce={args:{center:[16.37,48.2],zoom:12,layers:[{type:`Tile`,properties:{id:`osm`},source:{type:`OSM`}},{type:`Vector`,properties:{id:`inlineGeojson`},source:{type:`Vector`,features:[{type:`Feature`,geometry:{type:`Point`,coordinates:[16.37,48.2]},properties:{name:`Vienna`}}]},style:{"circle-radius":10,"circle-fill-color":`red`,"circle-stroke-color":`white`,"circle-stroke-width":2}}]}}})))()}var ue;function de(){return(de=e((()=>{ue={args:{layers:[{type:`VectorTile`,background:`#1a2b39`,declutter:!0,properties:{id:`countries`},source:{type:`VectorTile`,url:`https://ahocevar.com/geoserver/gwc/service/tms/1.0.0/ne:ne_10m_admin_0_countries@EPSG%3A900913@pbf/{z}/{x}/{-y}.pbf`,format:`MVT`,tileGrid:{}},style:{"fill-color":`yellow`,"stroke-color":`#232323`,"stroke-width":1}}]}}})))()}var fe;function pe(){return(pe=e((()=>{fe={args:{center:[-10997148,4569099],layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`TileWMS`,url:`https://ahocevar.com/geoserver/wms`,params:{LAYERS:`topp:states`,TILED:!0},ratio:1,serverType:`geoserver`}}],zoom:3}}})))()}var me;function he(){return(he=e((()=>{me={args:{center:[20,40],layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`WMTSCapabilities`,url:`https://tiles.maps.eox.at/wmts/1.0.0/WMTSCapabilities.xml`,layer:`s2cloudless-2025`,attribution:`EOxCloudless <a href="https://cloudless.eox.at" target="_blank" rel="noreferrer">https://cloudless.eox.at</a> by <a href="https://eox.at" target="_blank">EOX IT Services GmbH</a> (Contains modified Copernicus Sentinel data 2025)`}}],zoom:5,storyCodeBefore:`import "@eox/map/src/plugins/advancedLayersAndSources"`}}})))()}var ge;function _e(){return(_e=e((()=>{ge={args:{center:[20,40],layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`WMTS`,url:`https://tiles.maps.eox.at/wmts`,layer:`s2cloudless-2025_3857`,attribution:`EOxCloudless <a href="https://cloudless.eox.at" target="_blank" rel="noreferrer">https://cloudless.eox.at</a> by <a href="https://eox.at" target="_blank">EOX IT Services GmbH</a> (Contains modified Copernicus Sentinel data 2025)`,style:`default`,matrixSet:`GoogleMapsCompatible`,tileGrid:{tileSize:[128,128]}}}],zoom:5}}})))()}var ve;function ye(){return(ye=e((()=>{ve={args:{center:[-10997148,4569099],layers:[{type:`Image`,properties:{id:`regions`},source:{type:`ImageStatic`,imageExtent:[-20037508.342789244,-15028131.257091934,20037508.342789244,15028131.257091934],url:`https://imgs.xkcd.com/comics/online_communities.png`}}],zoom:0}}})))()}var be;function xe(){return(xe=e((()=>{be={args:{center:[-122.38,46.1],layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`OSM`}},{type:`STAC`,properties:{id:`stacLayer`},url:`https://s3.us-west-2.amazonaws.com/sentinel-cogs/sentinel-s2-l2a-cogs/10/T/ES/2022/7/S2A_10TES_20220726_0_L2A/S2A_10TES_20220726_0_L2A.json`}],zoom:7,storyCodeBefore:`import "@eox/map/src/plugins/advancedLayersAndSources"`}}})))()}var Se;function Ce(){return(Ce=e((()=>{Se={args:{center:[0,0],layers:[{type:`MapboxStyle`,properties:{id:`mapboxStyleGroup`,title:`mapboxStyleGroup`,mapboxStyle:{version:8,sources:{osm:{type:`raster`,tiles:[`https://a.tile.openstreetmap.org/{z}/{x}/{y}.png`],tileSize:256,attribution:`© OpenStreetMap contributors`},pointSource:{type:`geojson`,data:{type:`FeatureCollection`,features:[{type:`Feature`,geometry:{type:`Point`,coordinates:[0,0]},properties:{}}]}}},layers:[{id:`osm-base`,type:`raster`,source:`osm`,minzoom:0,maxzoom:19},{id:`point-halo`,type:`circle`,source:`pointSource`,paint:{"circle-radius":10,"circle-color":`#0000ff`,"circle-opacity":.5}},{id:`point-main`,type:`circle`,source:`pointSource`,paint:{"circle-radius":5,"circle-color":`#ff0000`}}]}}}],zoom:0,storyCodeBefore:`import "@eox/map/src/plugins/advancedLayersAndSources"`}}})))()}var we;function Te(){return(Te=e((()=>{we={args:{center:[3737055,1886786],layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`OSM`}},{type:`WebGLTile`,properties:{id:`geotiffLayer`},source:{type:`GeoTIFF`,sources:[{url:`https://sentinel-cogs.s3.us-west-2.amazonaws.com/sentinel-s2-l2a-cogs/36/Q/WD/2020/7/S2A_36QWD_20200701_0_L2A/TCI.tif`}]}}],zoom:8,storyCodeBefore:`import "@eox/map/src/plugins/advancedLayersAndSources"`}}})))()}var Ee;function De(){return(De=e((()=>{Ee={args:{center:[1407372,5701616],layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`OSM`}},{type:`WebGLTile`,properties:{id:`sentinel-2-l2a`,title:`Surface Reflectance`},source:{type:`GeoZarr`,url:`https://s3.explorer.eopf.copernicus.eu/esa-zarr-sentinel-explorer-fra/tests-output/sentinel-2-l2a/S2C_MSIL2A_20260716T100601_N0512_R022_T32TQR_20260716T154011.zarr/measurements/reflectance`,bands:[`b04`,`b03`,`b02`]},style:{gamma:1.5,color:[`color`,[`interpolate`,[`linear`],[`band`,1],0,0,.5,255],[`interpolate`,[`linear`],[`band`,2],0,0,.5,255],[`interpolate`,[`linear`],[`band`,3],0,0,.5,255]]}}],zoom:9,storyCodeBefore:`import "@eox/map/src/plugins/advancedLayersAndSources"`}}})))()}var Oe;function ke(){return(ke=e((()=>{Oe={args:{layers:[{type:`Group`,properties:{id:`group`},layers:[{type:`Group`,properties:{id:`groupLayerInsideGroup`},layers:[{type:`Tile`,properties:{id:`layerInsideGroupInsideGroup`},source:{type:`OSM`}}]},{type:`Vector`,properties:{id:`regions`},source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`}}]}]}}})))()}var Ae;function je(){return(je=e((()=>{n(),ee(),Ae={args:{storyStyle:`
      .custom-btn {
...
`,controls:{FullScreen:{position:`top-right`,target:`fs-attribution`,orientation:`vertical`},Attribution:{position:`bottom-right`,target:`zoom-hz`,orientation:`horizontal`,collapsible:!0},Zoom:{position:`bottom-right`,target:`zoom-hz`,orientation:`horizontal`},Rotate:{position:`bottom-center`,target:`bottom-tools`,orientation:`horizontal`},GlobeSwitcher:{position:`bottom-center`,target:`bottom-tools`,orientation:`horizontal`},ScaleLine:{position:`bottom-left`,target:`scale-line`,orientation:`horizontal`},MousePosition:{position:`bottom-left`,target:`scale-line`,orientation:`horizontal`},OverviewMap:{position:`top-left`,collapsed:!1,layers:[{type:`Tile`,source:{type:`OSM`}}]}},layers:[{type:`Tile`,source:{type:`XYZ`,url:`https://tiles.maps.eox.at/wmts/1.0.0/s2cloudless-2025_3857/default/g/{z}/{y}/{x}.jpg`,attributions:`EOxCloudless <a href="https://cloudless.eox.at" target="_blank" rel="noreferrer">https://cloudless.eox.at</a> by <a href="https://eox.at" target="_blank">EOX IT Services GmbH</a> (Contains modified Copernicus Sentinel data 2025)`}}],zoom:4,center:[10,50]},render:e=>t`
    ...
    >
      ${a(e.storySlotContent)}
    </eox-map>
  `}})))()}var Me;function Ne(){return(Ne=e((()=>{Me={args:{controls:{GlobeSwitcher:{},Zoom:{},Attribution:{},FullScreen:{},Rotate:{},OverviewMap:{layers:[{type:`Tile`,properties:{id:`overviewMap`},source:{type:`OSM`}}]},MousePosition:{},ScaleLine:{},Geolocation:{}},layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`OSM`}}]}}})))()}var Pe;function Fe(){return(Fe=e((()=>{Pe={args:{zoom:7,controls:{Geolocation:{tracking:!0,trackHeading:!0,centerWhenReady:!1,highAccuracy:!0,trackAccuracy:!0,style:{"circle-radius":10,"circle-fill-color":`red`,"circle-stroke-color":`white`,"circle-stroke-width":2}}},layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`OSM`}}]}}})))()}var Ie;function Le(){return(Le=e((()=>{Ie={args:{zoom:9,center:[0,51.5],controls:{LoadingIndicator:{},Zoom:{}},layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`OSM`}}]}}})))()}var Re;function ze(){return(ze=e((()=>{Re={args:{zoom:9,center:[0,51.5],controls:{LoadingIndicator:{type:`fullscreen`,opacity:.2,spinnerSvg:`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" width="50" height="50" style="shape-rendering: auto; display: block; background: transparent;" xmlns:xlink="http://www.w3.org/1999/xlink"><g><circle stroke-dasharray="120 50" r="30" stroke-width="22" stroke="#cd4609" fill="none" cy="50" cx="50">
        <animateTransform keyTimes="0;1" values="0 50 50;360 50 50" dur="0.4s" repeatCount="indefinite" type="rotate" attributeName="transform"></animateTransform>
            </circle><g></g></g></svg>`},Zoom:{}},layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`OSM`}}]}}})))()}var o;function s(){return(s=e((()=>{o={args:{layers:[{type:`Vector`,source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`},interactions:[{type:`select`,options:{id:`selectInteraction`,condition:`pointermove`,layer:{type:`Vector`,properties:{id:`selectLayer`},source:{type:`Vector`},style:{"stroke-color":`red`,"stroke-width":3}}}}]}]}}})))()}var c;function l(){return(l=e((()=>{c={args:{layers:[{type:`Vector`,background:`#1366dd`,properties:{id:`regions`},source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`,attributions:`Regions: @ openlayers.org`},style:{"stroke-color":`black`,"stroke-width":1,"fill-color":`red`},interactions:[{type:`select`,options:{id:`selectInteraction`,condition:`click`,style:{"stroke-color":`white`,"stroke-width":3}}}]}]}}})))()}var u;function d(){return(d=e((()=>{u={args:{controls:{Attribution:{}},layers:[{type:`Tile`,properties:{id:`OSM`},source:{type:`OSM`}},{type:`Vector`,properties:{id:`clusterLayer`},interactions:[{type:`clusterExplode`,options:{id:`clusterExplodeInteraction`,maxZoom:10,fitOptions:{duration:300},style:{"circle-radius":12,"circle-fill-color":`#FFD700`,"circle-stroke-color":`rgba(255, 255, 255, 0.7)`,"circle-stroke-width":2,"text-font":`normal 16px`,"text-value":[`get`,`NAME`],"text-fill-color":`#000`,"text-offset-y":1}}}],style:[{filter:[`>`,[`get`,`features`,`length`],1],style:{"text-value":[`to-string`,[`get`,`features`,`length`]],"circle-radius":12,"circle-fill-color":`#FFD700`,"circle-stroke-color":`rgba(255, 255, 255, 0.7)`,"circle-stroke-width":2,"text-font":`normal 16px`,"text-fill-color":`#000`,"text-offset-y":1}},{else:!0,style:{"circle-radius":12,"circle-fill-color":`#FFD700`,"circle-stroke-color":`rgba(255, 255, 255, 0.7)`,"circle-stroke-width":2,"text-font":`normal 16px`,"text-value":[`get`,`NAME`],"text-fill-color":`#000`,"text-offset-y":1,"fill-color":`#FFD700`,"fill-opacity":.5,"stroke-color":`#eeeeee`,"stroke-width":2}}],source:{type:`Cluster`,distance:55,attributions:`Map data © <a href="https://www.naturalearthdata.com">Natural Earth</a> | City points via <a href="https://github.com/drei01/geojson-world-cities">geojson-world-cities</a>`,source:{type:`Vector`,url:`https://raw.githubusercontent.com/drei01/geojson-world-cities/refs/heads/master/cities.geojson`,format:`GeoJSON`}}}],storyCodeBefore:`import "@eox/map/src/plugins/advancedLayersAndSources"`}}})))()}var f;function p(){return(p=e((()=>{n(),f={args:{layers:[{type:`Vector`,source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`},interactions:[{type:`select`,options:{id:`selectInteraction`,condition:`pointermove`,style:{"stroke-color":`red`,"stroke-width":3}}}]}],center:[15,48],zoom:4,storySlotContent:`<eox-map-tooltip></eox-map-tooltip>`},render:e=>t`
    <eox-map
      .center=${e.center}
      .controls=${e.controls}
      .layers=${e.layers}
  ...
  `}})))()}var m;function Be(){return(Be=e((()=>{n(),m={args:{layers:[{type:`Vector`,source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`},interactions:[{type:`select`,options:{id:`selectInteraction`,condition:`pointermove`,style:{"stroke-color":`red`,"stroke-width":3}}}]}],center:[15,48],zoom:4,storyAdditionalComponents:{"eox-map-tooltip":{storyImport:!1,storySlot:!0,propertyTransform:e=>{if(e.key.includes(`COLOR`))return{key:e.key.toLowerCase(),value:e.value}}}}},render:e=>t`
    <eox-map
      .center=${e.center}
      .controls=${e.controls}
      .layers=${e.layers}
  ...
  `}})))()}var Ve;function He(){return(He=e((()=>{n(),Ve={args:{id:`highlightAndAnimate`,config:{layers:[{type:`Vector`,background:`lightgrey`,properties:{id:`regions`},source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`,attributions:`Regions: @ openlayers.org`},style:{"stroke-color":`black`,"stroke-width":1,"fill-color":`darkgrey`},interactions:[{type:`select`,options:{id:`selectInteraction`,condition:`click`,style:{"stroke-color":`white`,"stroke-width":3}}}]}]},loadend:()=>{document.querySelector(`eox-map#highlightAndAnimate`).selectInteractions.selectInteraction.highlightById([664,795,789],{duration:400,padding:[50,50,50,50]})}},render:e=>t`
    <eox-map
      id=${e.id}
      .config=${e.config}
      @loadend=${e.loadend}
    ></eox-map>
  `}})))()}var Ue;function We(){return(We=e((()=>{n(),Ue={args:{id:`a`,layers:[{type:`Tile`,properties:{id:`osm`,title:`Background`},source:{type:`OSM`}}],storyAdditionalComponents:{"eox-map":{id:`b`,sync:`#a`,layers:[{type:`Tile`,properties:{id:`osm`,title:`Background`},source:{type:`OSM`}}]}}},render:e=>t`
    <style>
      eox-map {
        width: 50%;
      }
  ...
  `}})))()}var qe;function Je(){return(Je=e((()=>{n(),qe={args:{config:{controls:{Zoom:{}},layers:[{type:`Tile`,source:{type:`OSM`}}],view:{center:[16.8,48.2],zoom:9}}},render:e=>t`
    <eox-map .config=${e.config}></eox-map>
  `}})))()}var Ye;function Xe(){return(Xe=e((()=>{n(),Ye={args:{layers:[{type:`Tile`,properties:{id:`osm`,title:`Background`},source:{type:`OSM`}},{type:`Vector`,source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`}}],center:[16.8,48.2],zoom:7,projection:`EPSG:3857`},render:e=>t`
    <eox-map
      .center=${e.center}
      .controls=${e.controls}
      .layers=${e.layers}
  ...
  `}})))()}var Ze;function Qe(){return(Qe=e((()=>{n(),Ze={args:{layers:[{type:`Tile`,properties:{id:`osm`,title:`Background`},source:{type:`OSM`}}],animationOptions:{duration:500},center:[16.8,48.2],zoom:7},render:e=>t`
    <eox-map
      .center=${e.center}
      .layers=${e.layers}
      .zoom=${e.zoom}
  ...
  `}})))()}var $e;function et(){return(et=e((()=>{n(),$e={args:{config:{controls:{Zoom:{}},layers:[{type:`Tile`,source:{type:`OSM`}}],view:{center:[16.8,48.2],zoom:9},preventScroll:!0}},render:e=>t`
    <eox-map .config=${e.config}></eox-map>
  `}})))()}var tt;function nt(){return(nt=e((()=>{tt={args:{center:[16.346,48.182],zoom:12.5,layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`OSM`}},{type:`Vector`,properties:{id:`FlatGeoBufLayer`,minZoom:12},source:{type:`FlatGeoBuf`,url:`https://eox-gtif-public.s3.eu-central-1.amazonaws.com/admin_borders/STATISTIK_AUSTRIA_GEM_20220101.fgb`}}],storyCodeBefore:`import "@eox/map/src/plugins/advancedLayersAndSources"`}}})))()}var h;function rt(){return(rt=e((()=>{h={args:{center:[-30,64],zoom:3,layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`OSM`}},{type:`Vector`,properties:{id:`FlatGeoBufLayer`},source:{type:`FlatGeoBuf`,url:[`https://eox-gtif-public.s3.eu-central-1.amazonaws.com/test_data_polartep/202602041015_CentralWest_RIC.fgb`,`https://eox-gtif-public.s3.eu-central-1.amazonaws.com/test_data_polartep/202602040840_SouthEast_RIC.fgb`]}}],storyCodeBefore:`import "@eox/map/src/plugins/advancedLayersAndSources"`}}})))()}var it,at;function ot(){return(ot=e((()=>{n(),at={args:{storySlotContent:`<custom-tooltip is="eox-map-tooltip"></custom-tooltip>`,storyCodeBefore:`// Create custom-tooltip element 
 customElements.define(
    ...
    )`,layers:[{type:`Vector`,source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`},interactions:[{type:`select`,options:{id:`selectInteraction`,condition:`pointermove`,style:{"stroke-color":`red`,"stroke-width":3}}}]}],center:[15,48],zoom:4},render:e=>t(it||=re([`
    <script>
      `,`;
    <\/script>
    <eox-map
  ...
  `]),e.storyCodeBefore,e.center,e.controls,e.layers,e.zoom)}})))()}var st;function ct(){return(ct=e((()=>{n(),st={args:{layers:[{type:`Tile`,properties:{title:`Terrain Light`,id:`terrain-light`},source:{type:`XYZ`,url:`//tiles.maps.eox.at/wmts/1.0.0/terrain-light_3857/default/g/{z}/{y}/{x}.jpg`}},{type:`Tile`,properties:{id:`wmsLayer`},source:{type:`TileWMS`,url:`https://ahocevar.com/geoserver/wms`,params:{LAYERS:`topp:states`,TILED:!0},ratio:1,serverType:`geoserver`},interactions:[{type:`select`,options:{id:`selectInteraction`,condition:`click`}}]}],center:[-10997148,4569099],zoom:4,storySlotContent:`<eox-map-tooltip></eox-map-tooltip>`},render:e=>t`
    <eox-map
      .center=${e.center}
      .controls=${e.controls}
      .layers=${e.layers}
  ...
  `}})))()}var g,lt,ut,dt;function ft(){return(ft=e((()=>{n(),customElements.define(`custom-coordinates-tooltip`,class extends HTMLElement{constructor(){super()}set feature(e){this.innerHTML=`
...
eoxMap.addEventListener("loadend", () => {
  ...
  `]),e.layers,e.storyCodeAfter)}})))()}var gt;function _t(){return(_t=e((()=>{gt={args:{center:[15,48],projection:`globe`,globeConfig:{terrain:!0,useHighLOD:!0},layers:[{type:`Tile`,properties:{id:`cloudless`,title:`Sentinel-2 Cloudless 2025`},source:{type:`XYZ`,url:`https://tiles.maps.eox.at/wmts/1.0.0/s2cloudless-2025_3857/default/g/{z}/{y}/{x}.jpg`,attribution:`EOxCloudless <a href="https://cloudless.eox.at" target="_blank" rel="noreferrer">https://cloudless.eox.at</a> by <a href="https://eox.at" target="_blank">EOX IT Services GmbH</a> (Contains modified Copernicus Sentinel data 2025)`,crossOrigin:`anonymous`}},{type:`WebGLTile`,style:{variables:{vmin:2,vmax:5,settlementDistance:0},color:[`case`,[`all`,[`>`,[`band`,1],1],[`>=`,[`band`,2],[`var`,`settlementDistance`]]],[`interpolate`,[`linear`],[`/`,[`-`,[`band`,1],[`var`,`vmin`]],[`-`,[`var`,`vmax`],[`var`,`vmin`]]],0,[68,1,84,1],.067,[70,23,103,1],.133,[71,44,122,1],.2,[65,63,131,1],.266,[59,81,139,1],.333,[52,97,141,1],.4,[44,113,142,1],.467,[39,129,142,1],.533,[33,144,141,1],.6,[39,173,129,1],.666,[66,187,114,1],.733,[92,200,99,1],.8,[131,210,75,1],.867,[170,220,50,1],.933,[212,226,44,1],1,[253,231,37,1]],[`color`,0,0,0,0]]},properties:{id:`tile`,title:`Solar Energy COG Example`,layerConfig:{type:`style`,legend:{title:`Global horizontal irradiation`,range:[`rgba(253, 231, 37, 1)`,`rgba(33, 144, 141, 1)`,`rgba(68, 1, 84, 1)`],domainProperties:[`vmin`,`vmax`]},schema:{type:`object`,title:`Data configuration`,properties:{settlementDistance:{type:`number`,minimum:0,maximum:5e3,format:`range`,default:0},vminmax:{title:`Global horizontal irradiation`,description:`[kWh/m²/day]`,type:`object`,properties:{vmin:{type:`number`,minimum:0,maximum:5,format:`range`,default:2},vmax:{type:`number`,minimum:0,maximum:5,format:`range`,default:5}},format:`minmax`}}}}},source:{type:`GeoTIFF`,normalize:!1,sources:[{url:`https://eox-gtif-public.s3.eu-central-1.amazonaws.com/DHI/v2/SolarPowerPotential_Annual_COG_clipped_3857_fixed.tif`},{url:`https://eox-gtif-public.s3.eu-central-1.amazonaws.com/DHI/WSF_EucDist_Austria_3857_COG_fix.tif`}]}}],zoom:4}}})))()}function vt(){return(vt=e((()=>{ae(),se(),le(),de(),pe(),he(),_e(),ye(),xe(),Ce(),Te(),De(),ke(),je(),Ne(),Fe(),Le(),ze(),s(),l(),d(),p(),Be(),He(),We(),Ke(),Je(),Xe(),Qe(),et(),nt(),rt(),ot(),ct(),ft(),ht(),_t()})))()}var yt,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$,bt;function xt(){return(xt=e((()=>{n(),vt(),yt={title:`Elements/eox-map`,tags:[`autodocs`],component:`eox-map`,render:e=>t`
    ...
    ></eox-map>
  `},_=ie,v=qe,y=oe,b=ce,x=ue,S=fe,C=me,w=tt,T=h,E=ge,D=ve,O=be,k=Se,A=we,j=Ee,M=Oe,N=Me,P=Ae,F=Pe,I=Ie,L=Re,R=o,z=c,B=u,V=f,H=st,U=m,W=at,G=dt,K=Ve,q=Ue,J=Ge,Y=Ye,X=Ze,Z=$e,Q=mt,$=gt,bt=`Primary.ConfigObject.VectorLayer.VectorLayerInlineGeojson.VectorTileLayer.WMSLayer.WMTSCapabilitiesLayer.FlatGeoBuf.FlatGeoBufTwoUrls.WMTSTileGrid.StaticImage.STACLayer.MapboxStyleLayer.GeoTIFFLayer.GeoZarrLayer.GroupLayer.Controls.ControlsLayout.Geolocation.StandardLoadingIndicator.CustomFullScreenLoadingIndicator.HoverSelect.ClickSelect.ClusterExplode.Tooltip.GetFeatureInfoTooltip.TooltipWithPropertyTransform.CustomTooltip.CoordinatesCustomTooltips.HighlightFeaturesAndAnimate.MapSync.ABCompare.Projection.Animations.PreventScroll.HelperMethods.Globe`.split(`.`),_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`PrimaryStory`,..._.parameters?.docs?.source},description:{story:'Basic map rendered using `eox-map` configuration\n\nThis renders a map centered on Austria (`lon` of `15`, and `lat` of `48`), with a `zoom` of `7`. The `layers` property allows creating one or multiple layers, in this case it is creating one layer of type `Tile` (analog to OpenLayers `Tile` layer), with a source of type `OSM`(analog to Openlayers `OSM` source).\n\nNote that `properties.id` has been set. It is strongly recommended to always set a `properties.id` so that `eox-map` can perform smart layer updates (in essence, checking if the layer type is compatible, then keep it and switch out the source, or replacing the entire layer if the id is the same, or discarding the layer if the id is not present any longer after a property update).\n\nThe `properties` passed in this object are passed along to the OpenLayers layer, so they are available there via the `get("<property>")` syntax, e.g. `eoxMap.map.getLayers().getArray()[0].get("id")`. `eox-map` also offers a helper function to get a layer by id: `eoxMap.getLayerById("<id>")`; this helper function also works recursively, so it finds layers inside groups as well.\n\nNotice that the `eox-map` DOM element has a property `map` which stores a reference to the actual OpenLayers map instance, so one could do e.g. `eoxMap.map.getView().getCenter()`, and other native OpenLayers things.',..._.parameters?.docs?.description}}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`ConfigObjectStory`,...v.parameters?.docs?.source},description:{story:`Instead of passing each property individually, one can also pass a \`config\` property:
