import{x as o}from"./lit-element-CIht5NN8.js";const a=[{type:"Tile",source:{type:"OSM"}}],Oe=[{type:"Vector",background:"lightgrey",properties:{id:"regions"},source:{type:"Vector",url:"https://openlayers.org/data/vector/ecoregions.json",format:"GeoJSON",attributions:"Regions: @ openlayers.org"},style:{"stroke-color":"black","stroke-width":1,"fill-color":"darkgrey"}}],r="width: 400px; height: 300px;",Te=[{id:"box",type:"Box"},{id:"point",type:"Point"},{id:"circle",type:"Circle"},{id:"linestring",type:"LineString"}],ke={args:{allowModify:!1,multipleFeatures:!1,type:"Polygon"},render:e=>o`
  ...
  `},ze={args:{multipleFeatures:!1,type:"Polygon",layerId:"regions",drawUpdate:e=>{console.log(" drawUpdate: ",e.detail)}},render:e=>o`
    ...
    />
  `},_e={args:{allowModify:!1,multipleFeatures:!0,type:"Box",layerId:"regions",showList:!0,featureName:"Selection",featureStyles:{layer:{"fill-color":"#16A105A0","stroke-color":"#16A105","stroke-width":2.5},hover:{"fill-color":"#19B806A0","stroke-color":"#19B806","stroke-width":2.5}},drawUpdate:e=>{console.log("drawUpdate:",e.detail)}},render:e=>o`
