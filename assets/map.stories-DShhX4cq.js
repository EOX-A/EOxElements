...
`,controls:{FullScreen:{position:`top-right`,target:`fs-attribution`,orientation:`vertical`},Attribution:{position:`bottom-right`,target:`zoom-hz`,orientation:`horizontal`,collapsible:!0},Zoom:{position:`bottom-right`,target:`zoom-hz`,orientation:`horizontal`},Rotate:{position:`bottom-center`,target:`bottom-tools`,orientation:`horizontal`},GlobeSwitcher:{position:`bottom-center`,target:`bottom-tools`,orientation:`horizontal`},ScaleLine:{position:`bottom-left`,target:`scale-line`,orientation:`horizontal`},MousePosition:{position:`bottom-left`,target:`scale-line`,orientation:`horizontal`},OverviewMap:{position:`top-left`,collapsed:!1,layers:[{type:`Tile`,source:{type:`OSM`}}]}},layers:[{type:`Tile`,source:{type:`XYZ`,url:`https://tiles.maps.eox.at/wmts/1.0.0/s2cloudless-2024_3857/default/g/{z}/{y}/{x}.jpg`,attributions:`<a xmlns:dct="http://purl.org/dc/terms/" href="https://s2maps.eu" property="dct:title">Sentinel-2 cloudless - https://s2maps.eu</a> by <a xmlns:cc="http://creativecommons.org/ns#" href="https://eox.at" property="cc:attributionName" rel="cc:attributionURL">EOX IT Services GmbH</a> (Contains modified Copernicus Sentinel data 2024) released under <a rel="license" href="https://creativecommons.org/licenses/by-nc-sa/4.0/">Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License</a>. For commercial usage please see <a href="https://cloudless.eox.at">https://cloudless.eox.at</a>`}}],zoom:4,center:[10,50]},render:e=>t`
  ...
  `}})),He,Ue=e((()=>{r(),He={args:{layers:[{type:`Vector`,source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`},interactions:[{type:`select`,options:{id:`selectInteraction`,condition:`pointermove`,style:{"stroke-color":`red`,"stroke-width":3}}}]}],center:[15,48],zoom:4,storyAdditionalComponents:{"eox-map-tooltip":{storyImport:!1,storySlot:!0,propertyTransform:e=>{if(e.key.includes(`COLOR`))return{key:e.key.toLowerCase(),value:e.value}}}}},render:e=>t`
    <eox-map
      .center=${e.center}
      .controls=${e.controls}
      .layers=${e.layers}
  ...
  `}})),We,Ge=e((()=>{r(),We={args:{id:`highlightAndAnimate`,config:{layers:[{type:`Vector`,background:`lightgrey`,properties:{id:`regions`},source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`,attributions:`Regions: @ openlayers.org`},style:{"stroke-color":`black`,"stroke-width":1,"fill-color":`darkgrey`},interactions:[{type:`select`,options:{id:`selectInteraction`,condition:`click`,style:{"stroke-color":`white`,"stroke-width":3}}}]}]},loadend:()=>{document.querySelector(`eox-map#highlightAndAnimate`).selectInteractions.selectInteraction.highlightById([664,795,789],{duration:400,padding:[50,50,50,50]})}},render:e=>t`
    <eox-map
      id=${e.id}
      .config=${e.config}
      @loadend=${e.loadend}
    ></eox-map>
  `}})),Ke,qe=e((()=>{r(),Ke={args:{id:`a`,layers:[{type:`Tile`,properties:{id:`osm`,title:`Background`},source:{type:`OSM`}}],storyAdditionalComponents:{"eox-map":{id:`b`,sync:`#a`,layers:[{type:`Tile`,properties:{id:`osm`,title:`Background`},source:{type:`OSM`}}]}}},render:e=>t`
    <style>
      eox-map {
        width: 50%;
      }
  ...
  `}})),Xe,Ze=e((()=>{r(),Xe={args:{config:{controls:{Zoom:{}},layers:[{type:`Tile`,source:{type:`OSM`}}],view:{center:[16.8,48.2],zoom:9}}},render:e=>t`
    <eox-map .config=${e.config}></eox-map>
  `}})),Qe,$e=e((()=>{r(),Qe={args:{layers:[{type:`Tile`,properties:{id:`osm`,title:`Background`},source:{type:`OSM`}},{type:`Vector`,source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`}}],center:[16.8,48.2],zoom:7,projection:`EPSG:3857`},render:e=>t`
    <eox-map
      .center=${e.center}
      .controls=${e.controls}
      .layers=${e.layers}
  ...
  `}})),et,tt=e((()=>{r(),et={args:{layers:[{type:`Tile`,properties:{id:`osm`,title:`Background`},source:{type:`OSM`}}],animationOptions:{duration:500},center:[16.8,48.2],zoom:7},render:e=>t`
    <eox-map
      .center=${e.center}
      .layers=${e.layers}
      .zoom=${e.zoom}
 ...
 customElements.define(
  ...
  `]),e.storyCodeBefore,e.center,e.controls,e.layers,e.zoom)}})),dt,ft=e((()=>{r(),dt={args:{layers:[{type:`Tile`,properties:{title:`Terrain Light`,id:`terrain-light`},source:{type:`XYZ`,url:`//tiles.maps.eox.at/wmts/1.0.0/terrain-light_3857/default/g/{z}/{y}/{x}.jpg`}},{type:`Tile`,properties:{id:`wmsLayer`},source:{type:`TileWMS`,url:`https://ahocevar.com/geoserver/wms`,params:{LAYERS:`topp:states`,TILED:!0},ratio:1,serverType:`geoserver`},interactions:[{type:`select`,options:{id:`selectInteraction`,condition:`click`}}]}],center:[-10997148,4569099],zoom:4,storySlotContent:`<eox-map-tooltip></eox-map-tooltip>`},render:e=>t`
    <eox-map
      .center=${e.center}
      .controls=${e.controls}
      .layers=${e.layers}
  ...
  `}})),p,pt,mt,ht,gt=e((()=>{r(),customElements.define(`custom-coordinates-tooltip`,class extends HTMLElement{constructor(){super()}set feature(e){this.innerHTML=`
