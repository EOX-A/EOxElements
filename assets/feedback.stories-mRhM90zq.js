import{n as e}from"./chunk-jRWAZmH_.js";import{gt as t,xt as n}from"./iframe-BdHgfv7L.js";var r,i=e((()=>{t(),r={args:{endpoint:`/fake/endpoint`,style:`position: relative !important; height: 250px;`,unstyled:void 0,submit:e=>console.log(`Feedback submitted`,e.detail),close:()=>console.log(`Feedback closed`)},render:e=>n`
    <div style="${e.style}">
      <eox-feedback
        endpoint="${e.endpoint}"
        ?unstyled="${e.unstyled}"
