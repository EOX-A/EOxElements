import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{d as t,t as n}from"./lit-D8IuYOuz.js";var r;function i(){return(i=e((()=>{n(),r={args:{config:{showButtons:[`next`,`previous`,`close`],showProgress:!0,steps:[{element:`#tour-target-1`,popover:{title:`Step 1`,description:`This is the first step of the tour.`,side:`bottom`,align:`start`}},{element:`#tour-target-2`,popover:{title:`Step 2`,description:`This is the second step of the tour.`,side:`top`,align:`start`}},{popover:{title:`Happy Coding`,description:`And that is all, go ahead and start adding tours to your applications.`}}]},preventAutoStart:!0,storyTemplateBefore:`
  ...
  `}})))()}var a;function o(){return(o=e((()=>{n(),a={args:{config:{showButtons:[`next`,`previous`,`close`],showProgress:!0,steps:[{element:`#parent-target-1`,popover:{title:`Parent Start`}},{targetIframe:`#demo-iframe`,element:`#child-target-1`,popover:{title:`Child Step`,description:`Simply defined in the parent config array, rendered inside the iframe.`}},{element:`#parent-target-2`,popover:{title:`Parent Resume`}}]},storyTemplateBefore:`
    ...
    `}}})))()}var l;function u(){return(u=e((()=>{n(),l={args:{"show-every-time":!0,config:{showButtons:[`next`],steps:[{element:`#target-always`,popover:{title:`Persistent Tour`,description:`I start every time because of the <code>show-every-time</code> attribute.`,side:`bottom`,align:`start`}}]},storyTemplateBefore:`
