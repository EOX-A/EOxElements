 ...
 */const Mr=Gr(class extends Jr{constructor(o){if(super(o),o.type!==he.PROPERTY&&o.type!==he.ATTRIBUTE&&o.type!==he.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Kr(o))throw Error("`live` bindings can only contain a single expression")}render(o){return o}update(o,[e]){if(e===Ke||e===ge)return e;const t=o.element,r=o.name;if(o.type===he.PROPERTY){if(e===t[r])return Ke}else if(o.type===he.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(r))return Ke}else if(o.type===he.ATTRIBUTE&&t.getAttribute(r)===e+"")return Ke;return Qr(o),e}});var je,Fe,xe,mt,Ir,gt,vt;class Vr extends ae{constructor(){super();$(this,mt);$(this,je,{});$(this,Fe,null);$(this,xe,void 0);$(this,gt,"");$(this,vt,"");this.layer=null,this.unstyled=!1,this.noShadow=!0,this.layerConfig=null}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){return this.layerConfig?(Je(this,Fe,In(this.layer,this.layerConfig)),g`
  ...
  `);this.actions=[],this.selectedTab=0,this.tabs=[],this.unstyled=!1,this.noShadow=!0}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){return g`
    ...
    `}}bt=new WeakMap,xt=new WeakMap,V(Hr,"properties",{actions:{attribute:!1},selectedTab:{state:!0},tabs:{attribute:!1},unstyled:{type:Boolean},noShadow:{type:Boolean}});customElements.define("eox-layercontrol-tabs",Hr);var wt,Et;class Nr extends ae{constructor(){super();V(this,"_parseActions",t=>t==null?void 0:t.filter(r=>["remove","sort"].filter(n=>{var i;return(i=this.layer)!=null&&i.get("layerControlDisable")?n!=="sort":!0}).includes(r)));V(this,"_parseTools",t=>t==null?void 0:t.filter(r=>{let n=!0;return["remove","sort"].includes(r)&&(n=!1),r==="info"&&(n=this.layer.get("description")),r==="config"&&(n=this.layer.get("layerConfig")),n}));V(this,"_removeButton",g`
    <button
  ...
  `);this.layer=null,this.tools=[],this.unstyled=!1,this.noShadow=!0}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){var t,r;return g`
      ...
      ${K(((t=this._parseActions(this.tools))==null?void 0:t.length)+((r=this._parseTools(this.tools))==null?void 0:r.length)>0,()=>{var n,i;return g`
          ${K(((n=this._parseActions(this.tools))==null?void 0:n.length)===1&&((i=this._parseTools(this.tools))==null?void 0:i.length)===0,()=>g`
            ...
            `})}
        `})}
    `}}wt=new WeakMap,Et=new WeakMap,V(Nr,"properties",{layer:{attribute:!1},tools:{attribute:!1},unstyled:{type:Boolean},noShadow:{type:Boolean}});customElements.define("eox-layercontrol-layer-tools",Nr);var St,Ct;class Rr extends ae{constructor(){super();V(this,"currLayerVisibilityBasedOnZoom",!0);$(this,St,"");$(this,Ct,`
    ${mr}
  ...
  `);this.group=null,this.idProperty="id",this.map=null,this.titleProperty="title",this.showLayerZoomState=!1,this.tools=[],this.unstyled=!1,this.noShadow=!0}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){return g`
      ...
      ${K(this.group,()=>g`
        ...
        `)}
    `}}_t=new WeakMap,Tt=new WeakMap,V(Zr,"properties",{group:{attribute:!1},idProperty:{attribute:"id-property"},map:{attribute:!1,state:!0},titleProperty:{attribute:"title-property",type:String},showLayerZoomState:{attribute:"show-layer-zoom-state",type:Boolean},tools:{attribute:!1},unstyled:{type:Boolean},noShadow:{type:Boolean}});customElements.define("eox-layercontrol-layer-group",Zr);var We,$t,Ot,Dt;class Br extends ae{constructor(){super();$(this,We,()=>{_(this,$t).call(this)});$(this,$t,Ur(()=>{this.requestUpdate(),this.dispatchEvent(new CustomEvent("changed",{bubbles:!0}))},50));$(this,Ot,"");$(this,Dt,`
    ul {
      padding: 0;
    }
    ul ul {
  ...
  `);this.idProperty="id",this.layers=null,this.map=null,this.tools=void 0,this.titleProperty="title",this.showLayerZoomState=!1,this.unstyled=!1,this.noShadow=!0}firstUpdated(){this.layers&&(An(this.layers,this.idProperty,this.titleProperty),Ln(this.renderRoot.querySelector("ul"),this.layers,this.idProperty,this))}updated(){var t;this.layers&&(this.layers.hasListener("change:length")&&((t=this.layers)==null||t.un("change:length",_(this,We))),this.layers.on("change:length",_(this,We)))}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){return g`
    ...
    `}}V(Yr,"properties",{idProperty:{attribute:"id-property"},layers:{attribute:!1},titleProperty:{attribute:"title-property",type:String},unstyled:{type:Boolean},noShadow:{type:Boolean}});customElements.define("eox-layercontrol-optional-list",Yr);var Lt,At;class zr extends ae{constructor(){super();$(this,Lt,"");$(this,At,`
    * {
...
></eox-map>`,Qn={title:"Elements/eox-layercontrol",tags:["autodocs"],component:"eox-layercontrol",parameters:{componentSubtitle:"Manage and configure OpenLayers map layers",layout:"centered"}},$e={args:{idProperty:"id",titleProperty:"title",unstyled:!1},render:o=>g`
  ...
  `};var uo;const rt={args:{idProperty:"id",titleProperty:"title",unstyled:!1,noShadow:!1},render:o=>g(uo||(uo=Vt([`
    ...
    <\/script>
  `])),o.noShadow,o.idProperty,o.titleProperty,o.unstyled,[{type:"Tile",properties:{id:"osm",title:"Open Street Map"},visible:!0,opacity:.5,source:{type:"OSM"}}])};var ho;const nt={args:{unstyled:!1,noShadow:!1},render:o=>g(ho||(ho=Vt([`
    <div style="display: flex">
      <eox-layercontrol-layer-list
        .noShadow=`,`
        .unstyled=`,`
    ...
    <\/script>
  `])),o.noShadow,o.unstyled,[{type:"Tile",opacity:.5,visible:!1,properties:{id:"wind",title:"WIND"},source:{type:"TileWMS",url:"https://services.sentinel-hub.com/ogc/wms/0635c213-17a1-48ee-aef7-9d1731695a54",params:{LAYERS:"AWS_VIS_WIND_V_10M"}}},{type:"Tile",properties:{id:"osm",title:"Open Street Map"},visible:!0,source:{type:"OSM"}},{type:"Tile",properties:{id:"osm2",title:"Another OSM"},visible:!0,source:{type:"OSM"}}])},Ve={render:()=>g`
    <eox-layercontrol-tabs
      .noShadow=${!1}
      .actions=${["delete"]}
  ...
  `};var fo,yo,mo,go,vo;$e.parameters={...$e.parameters,docs:{...(fo=$e.parameters)==null?void 0:fo.docs,source:{originalSource:`{
  args: {
    idProperty: "id",
    titleProperty: "title",
    unstyled: false
  ...
  \`
}`,...(mo=(yo=$e.parameters)==null?void 0:yo.docs)==null?void 0:mo.source},description:{story:"Basic layercontrol setup.",...(vo=(go=$e.parameters)==null?void 0:go.docs)==null?void 0:vo.description}}};var bo,xo,wo,Eo,So;Oe.parameters={...Oe.parameters,docs:{...(bo=Oe.parameters)==null?void 0:bo.docs,source:{originalSource:`{
  args: {},
  render: () => html\`
    <div style="display: flex">
      <eox-layercontrol for="eox-map#exclusive"></eox-layercontrol>
  ...
  \`
}`,...(wo=(xo=Oe.parameters)==null?void 0:xo.docs)==null?void 0:wo.source},description:{story:"By adding the `layerControlExclusive` property to map layers,\nonly one of them at a time can be visualized.",...(So=(Eo=Oe.parameters)==null?void 0:Eo.docs)==null?void 0:So.description}}};var Co,_o,To,$o,Oo;De.parameters={...De.parameters,docs:{...(Co=De.parameters)==null?void 0:Co.docs,source:{originalSource:`{
  args: {},
  render: () => html\`
    <div style="display: flex">
      <eox-layercontrol for="eox-map#optional"></eox-layercontrol>
...
Removing a layer puts it back into the optional list.`,...(Oo=($o=De.parameters)==null?void 0:$o.docs)==null?void 0:Oo.description}}};var Do,Lo,Ao,Po,Mo;Le.parameters={...Le.parameters,docs:{...(Do=Le.parameters)==null?void 0:Do.docs,source:{originalSource:`{
  args: {},
  render: () => html\`
    <div style="display: flex">
      <eox-layercontrol for="eox-map#expanded"></eox-layercontrol>
  ...
  \`
}`,...(Ao=(Lo=Le.parameters)==null?void 0:Lo.docs)==null?void 0:Ao.source},description:{story:"By adding the `layerControlExpand` property to map layers,\nthey render in the layer control as opened.",...(Mo=(Po=Le.parameters)==null?void 0:Po.docs)==null?void 0:Mo.description}}};var Vo,Io,Ho,No,Ro;Ae.parameters={...Ae.parameters,docs:{...(Vo=Ae.parameters)==null?void 0:Vo.docs,source:{originalSource:`{
  args: {},
  render: () => html\`
    <p>Default tools: info, opacity, config, remove, sort</p>
    <eox-layercontrol for="eox-map#tools"></eox-layercontrol>
  ...
  \`
}`,...(Ho=(Io=Ae.parameters)==null?void 0:Io.docs)==null?void 0:Ho.source},description:{story:`The layer control accepts a "tools" array, which enable
extra functionalities for layers`,...(Ro=(No=Ae.parameters)==null?void 0:No.docs)==null?void 0:Ro.description}}};var Zo,Bo,Yo,zo,Xo;Pe.parameters={...Pe.parameters,docs:{...(Zo=Pe.parameters)==null?void 0:Zo.docs,source:{originalSource:`{
  args: {},
  render: () => html\`
    <eox-layercontrol
      .tools=\${["config"]}
...
source url parameters.`,...(Xo=(zo=Pe.parameters)==null?void 0:zo.docs)==null?void 0:Xo.description}}};var ko,jo,Fo,Wo,Uo;Me.parameters={...Me.parameters,docs:{...(ko=Me.parameters)==null?void 0:ko.docs,source:{originalSource:`{
  ...
  \`
}`,...(lr=(sr=Ie.parameters)==null?void 0:sr.docs)==null?void 0:lr.source},description:{story:"Zoom layer state based on `minZoom` and `maxZoom`.\nThe color change state only visible when `showLayerZoomState` is set inside layer properties.",...(pr=(dr=Ie.parameters)==null?void 0:dr.docs)==null?void 0:pr.description}}};var cr,ur,hr,fr,yr;He.parameters={...He.parameters,docs:{...(cr=He.parameters)==null?void 0:cr.docs,source:{originalSource:`{
  args: {
    unstyled: true
  },
  render: args => html\`
  ...
  \`
}`,...(hr=(ur=He.parameters)==null?void 0:ur.docs)==null?void 0:hr.source},description:{story:"Unstyled version of the Element",...(yr=(fr=He.parameters)==null?void 0:fr.docs)==null?void 0:yr.description}}};const ei=["Primary","ExclusiveLayers","OptionalLayers","ExpandedLayers","Tools","LayerConfig","HiddenLayers","SingleLayer","LayerList","Tabs","LayerZoomState","Unstyled"];export{Oe as ExclusiveLayers,Le as ExpandedLayers,Me as HiddenLayers,Pe as LayerConfig,nt as LayerList,Ie as LayerZoomState,De as OptionalLayers,$e as Primary,rt as SingleLayer,Ve as Tabs,Ae as Tools,He as Unstyled,ei as __namedExportsOrder,Qn as default};
