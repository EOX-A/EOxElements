import{i as e}from"./preload-helper-DbRxMUml.js";import{Dt as t,Mt as n,n as r,t as i}from"./iframe-BbZhVCFh.js";import{n as a,t as o}from"./taggedTemplateLiteral-CmccG7_q.js";var s,c=e((()=>{t(),r(),s={args:{for:`eox-map#only-date`,storyAdditionalComponents:{"eox-map":{id:`only-date`,zoom:i.zoom,center:i.center,layers:i.layers},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,format:i.format}}},render:e=>n`
    <eox-map
  ...
  `}})),l,u=e((()=>{t(),r(),l={args:{layerIdKey:i.layerIdKey,for:`eox-map#date-with-navigation`,storyAdditionalComponents:{"eox-map":{id:`date-with-navigation`,zoom:i.zoom,center:i.center,layers:i.layers},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,format:i.format,navigation:!0}}},render:e=>n`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents[`eox-map`].id}
      .zoom=${e.storyAdditionalComponents[`eox-map`].zoom}
  ...
  `}})),d,f=e((()=>{t(),r(),d={args:{layerIdKey:i.layerIdKey,for:`eox-map#date-picker-popup`,select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-map":{id:`date-picker-popup`,zoom:i.zoom,center:i.center,layers:i.layers},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,format:i.format,navigation:!0},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,format:i.format,showDots:!0,popup:!0}}},render:e=>n`
    <style>
      eox-map {
        width: 100%;
        height: 500px;
  ...
  `}})),p,m=e((()=>{t(),r(),p={args:{layerIdKey:i.layerIdKey,for:`eox-map#date-picker-standalone`,select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-map":{id:`date-picker-standalone`,zoom:i.zoom,center:i.center,layers:i.layers},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,format:i.format,showDots:!0}}},render:e=>n`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents[`eox-map`].id}
      .zoom=${e.storyAdditionalComponents[`eox-map`].zoom}
  ...
  `}})),h,g=e((()=>{t(),r(),h={args:{layerIdKey:i.layerIdKey,for:`eox-map#timeline`,select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-map":{id:`timeline`,zoom:i.zoom,center:i.center,layers:i.layers},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,navigation:!0},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,showDots:!0,popup:!0,showItems:!0}}},render:e=>n`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents[`eox-map`].id}
      .zoom=${e.storyAdditionalComponents[`eox-map`].zoom}
  ...
  `}})),ee,_,te=e((()=>{t(),r(),a(),_={args:{layerIdKey:i.layerIdKey,titleKey:i.titleKey,externalMapRendering:!0,animate:!0,for:`eox-map#external-map-rendering-mosaic`,select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-map":{id:`external-map-rendering-mosaic`,zoom:10,center:[12,42]},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,navigation:!0},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,range:!0,showDots:!0,showItems:!0,popup:!0}}},render:e=>n(ee||=o([`
    <eox-map
      style="width: 100%; height: 500px;"
      id=`,`
      .zoom=`,`
    ...
    <script>
      ...
      externalStorySetup();
    <\/script>
  `]),e.storyAdditionalComponents[`eox-map`].id,e.storyAdditionalComponents[`eox-map`].zoom,e.storyAdditionalComponents[`eox-map`].center,e.for,e.layerIdKey,e.titleKey,e.filters,e.externalMapRendering,e.select,e.storyAdditionalComponents[`eox-timecontrol-date`].navigation,e.storyAdditionalComponents[`eox-timecontrol-picker`].range,e.storyAdditionalComponents[`eox-timecontrol-picker`].showDots,e.storyAdditionalComponents[`eox-timecontrol-picker`].showItems,e.storyAdditionalComponents[`eox-timecontrol-picker`].popup)}})),ne,v,re=e((()=>{t(),r(),a(),v={args:{layerIdKey:i.layerIdKey,titleKey:i.titleKey,filters:i.filters,externalMapRendering:!0,animate:!0,for:`eox-map#external-map-rendering-mosaic`,select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-map":{id:`external-map-rendering-mosaic`,zoom:10,center:[12,42]},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,navigation:!0},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,range:!0,showDots:!0,popup:!0},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0},"eox-itemfilter":{storySlot:!0}}},render:e=>n(ne||=o([`
    <eox-map
      style="width: 100%; height: 500px;"
      id=`,`
      .zoom=`,`
    ...
    <\/script>
  `]),e.storyAdditionalComponents[`eox-map`].id,e.storyAdditionalComponents[`eox-map`].zoom,e.storyAdditionalComponents[`eox-map`].center,e.for,e.layerIdKey,e.titleKey,e.externalMapRendering,e.select,e.storyAdditionalComponents[`eox-timecontrol-date`].navigation,e.storyAdditionalComponents[`eox-timecontrol-picker`].range,e.storyAdditionalComponents[`eox-timecontrol-picker`].showDots,e.storyAdditionalComponents[`eox-timecontrol-picker`].popup,!0,`id`,!1,e.filters)}})),ie,y,b=e((()=>{t(),r(),a(),y={args:{layerIdKey:i.layerIdKey,titleKey:i.titleKey,filters:i.filters,externalMapRendering:!0,animate:!0,for:`eox-map#external-map-rendering-mosaic`,select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-map":{id:`external-map-rendering-mosaic`,zoom:10,center:[12,42]},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,navigation:!0},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,range:!0,showDots:!0,popup:!0},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0},"eox-timecontrol-timelapse":{storyImport:!1,storySlot:!0},"eox-itemfilter":{storySlot:!0}}},render:e=>n(ie||=o([`
    <eox-map
      style="width: 100%; height: 500px;"
      id=`,`
      .zoom=`,`
  ...
  `}})),D,O=e((()=>{t(),r(),D={args:{layerIdKey:i.layerIdKey,titleKey:i.titleKey,filters:i.filters,navigation:!0,popup:!0,position:[`bottom`,`left`],select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-timecontrol-date":{storyImport:!1,storySlot:!0,format:i.format,navigation:!0},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,format:i.format,showDots:!0,popup:!0,position:[`bottom`,`left`]},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0},"eox-timecontrol-slider":{storyImport:!1,storySlot:!0},"eox-itemfilter":{storyImport:!1,storySlot:!0}}},render:e=>n`
    <eox-timecontrol
      .layerIdKey=${e.layerIdKey}
      .titleKey=${e.titleKey}
      .filters=${e.filters}
  ...
  `}})),k,A=e((()=>{t(),r(),k={args:{for:`eox-map#date-with-init-date`,initDate:[`2021-02-28`],storyAdditionalComponents:{"eox-map":{id:`date-with-init-date`,zoom:i.zoom,center:i.center,layers:i.layers},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,format:`D. MMMM YYYY`}},select:e=>{console.log(e.detail)}},render:e=>n`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents[`eox-map`].id}
      .zoom=${e.storyAdditionalComponents[`eox-map`].zoom}
  ...
  `}})),N,ae=e((()=>{t(),r(),N={args:{layerIdKey:i.layerIdKey,for:`eox-map#timeline-selection-duration`,storyAdditionalComponents:{"eox-map":{id:`timeline-selection-duration`,zoom:i.zoom,center:i.center,layers:i.layers},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0,selectionDuration:{months:1}}}},render:e=>n`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents[`eox-map`].id}
      .zoom=${e.storyAdditionalComponents[`eox-map`].zoom}
  ...
  `}})),P,oe=e((()=>{t(),r(),P={args:{layerIdKey:i.layerIdKey,for:`eox-map#timeline-selection-resizable`,storyAdditionalComponents:{"eox-map":{id:`timeline-selection-resizable`,zoom:i.zoom,center:i.center,layers:i.layers},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0,selectionDuration:{months:1},selectionResizable:!1}}},render:e=>n`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents[`eox-map`].id}
      .zoom=${e.storyAdditionalComponents[`eox-map`].zoom}
  ...
  `}})),F=e((()=>{c(),u(),f(),m(),g(),te(),re(),b(),S(),w(),E(),O(),A(),M(),ae(),oe()})),I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{t(),F(),I={title:`Elements/eox-timecontrol`,tags:[`autodocs`],component:`eox-timecontrol`,render:e=>n`
    <eox-timecontrol
      .for=${e.for}
      .layerIdKey=${e.layerIdKey}
      .titleKey=${e.titleKey}
