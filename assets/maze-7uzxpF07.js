import{g as c}from"./index-DuuuSFPv.js";function u(n,s){for(var t=0;t<s.length;t++){const e=s[t];if(typeof e!="string"&&!Array.isArray(e)){for(const r in e)if(r!=="default"&&!(r in n)){const o=Object.getOwnPropertyDescriptor(e,r);o&&Object.defineProperty(n,r,o.get?o:{enumerable:!0,get:()=>e[r]})}}}return Object.freeze(Object.defineProperty(n,Symbol.toStringTag,{value:"Module"}))}var p={exports:{}},i;function f(){return i||(i=1,function(n,s){ace.define("ace/snippets/maze.snippets",["require","exports","module"],function(t,e,r){r.exports=`snippet >
