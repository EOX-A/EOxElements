var C=Object.freeze,v=Object.defineProperty;var w=(e,S)=>C(v(e,"raw",{value:C(S||e.slice())}));import{V as t,x as o}from"./iframe-BZyiZ5id.js";import"./preload-helper-PPVm8Dsz.js";const A={args:{for:"eox-map#only-date",storyAdditionalComponents:{"eox-map":{id:"only-date",zoom:t.zoom,center:t.center,layers:t.layers},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,format:t.format}}},render:e=>o`
    <eox-map
  ...
  `},k={args:{layerIdKey:t.layerIdKey,for:"eox-map#date-with-navigation",storyAdditionalComponents:{"eox-map":{id:"date-with-navigation",zoom:t.zoom,center:t.center,layers:t.layers},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,format:t.format,navigation:!0}}},render:e=>o`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents["eox-map"].id}
      .zoom=${e.storyAdditionalComponents["eox-map"].zoom}
  ...
  `},K={args:{layerIdKey:t.layerIdKey,for:"eox-map#date-picker-popup",select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-map":{id:"date-picker-popup",zoom:t.zoom,center:t.center,layers:t.layers},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,format:t.format,navigation:!0},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,format:t.format,showDots:!0,popup:!0}}},render:e=>o`
    <style>
      eox-map {
        width: 100%;
        height: 500px;
  ...
  `},M={args:{layerIdKey:t.layerIdKey,for:"eox-map#date-picker-standalone",select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-map":{id:"date-picker-standalone",zoom:t.zoom,center:t.center,layers:t.layers},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,format:t.format,showDots:!0}}},render:e=>o`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents["eox-map"].id}
      .zoom=${e.storyAdditionalComponents["eox-map"].zoom}
  ...
  `},T={args:{layerIdKey:t.layerIdKey,for:"eox-map#timeline",select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-map":{id:"timeline",zoom:t.zoom,center:t.center,layers:t.layers},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,navigation:!0},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,showDots:!0,popup:!0,showItems:!0}}},render:e=>o`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents["eox-map"].id}
      .zoom=${e.storyAdditionalComponents["eox-map"].zoom}
  ...
  `};var g;const R={args:{layerIdKey:t.layerIdKey,titleKey:t.titleKey,externalMapRendering:!0,animate:!0,for:"eox-map#external-map-rendering-mosaic",select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-map":{id:"external-map-rendering-mosaic",zoom:10,center:[12,42]},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,navigation:!0},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,range:!0,showDots:!0,showItems:!0,popup:!0}}},render:e=>o(g||(g=w([`
    ...
    <script>
      ...
      externalStorySetup();
    <\/script>
  `])),e.storyAdditionalComponents["eox-map"].id,e.storyAdditionalComponents["eox-map"].zoom,e.storyAdditionalComponents["eox-map"].center,e.for,e.layerIdKey,e.titleKey,e.filters,e.externalMapRendering,e.select,e.storyAdditionalComponents["eox-timecontrol-date"].navigation,e.storyAdditionalComponents["eox-timecontrol-picker"].range,e.storyAdditionalComponents["eox-timecontrol-picker"].showDots,e.storyAdditionalComponents["eox-timecontrol-picker"].showItems,e.storyAdditionalComponents["eox-timecontrol-picker"].popup)};var I;const z={args:{layerIdKey:t.layerIdKey,titleKey:t.titleKey,filters:t.filters,externalMapRendering:!0,animate:!0,for:"eox-map#external-map-rendering-mosaic",select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-map":{id:"external-map-rendering-mosaic",zoom:10,center:[12,42]},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,navigation:!0},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,range:!0,showDots:!0,popup:!0},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0},"eox-itemfilter":{storySlot:!0}}},render:e=>o(I||(I=w([`
    <eox-map
      style="width: 100%; height: 500px;"
      id=`,`
      .zoom=`,`
  ...
  `},J={args:{for:"eox-map#date-with-init-date",initDate:["2021-02-28"],storyAdditionalComponents:{"eox-map":{id:"date-with-init-date",zoom:t.zoom,center:t.center,layers:t.layers},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,format:"D. MMMM YYYY"}},select:e=>{console.log(e.detail)}},render:e=>o`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents["eox-map"].id}
      .zoom=${e.storyAdditionalComponents["eox-map"].zoom}
  ...
  `},j={args:{layerIdKey:t.layerIdKey,for:"eox-map#date-in-utc",showUTC:!0,select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-map":{id:"date-in-utc",zoom:t.zoom,center:t.center,layers:t.layers},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,format:"YYYY-MM-DDTHH:mm:ss",navigation:!0},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,format:t.format,showDots:!0,popup:!0}}},render:e=>o`
    <style>
      eox-map {
        width: 100%;
        height: 500px;
  ...
  `},U={args:{layerIdKey:t.layerIdKey,for:"eox-map#timeline-selection-duration",storyAdditionalComponents:{"eox-map":{id:"timeline-selection-duration",zoom:t.zoom,center:t.center,layers:t.layers},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0,selectionDuration:{months:1}}}},render:e=>o`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents["eox-map"].id}
      .zoom=${e.storyAdditionalComponents["eox-map"].zoom}
  ...
  `},B={args:{layerIdKey:t.layerIdKey,for:"eox-map#timeline-selection-resizable",storyAdditionalComponents:{"eox-map":{id:"timeline-selection-resizable",zoom:t.zoom,center:t.center,layers:t.layers},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0,selectionDuration:{months:1},selectionResizable:!1}}},render:e=>o`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents["eox-map"].id}
      .zoom=${e.storyAdditionalComponents["eox-map"].zoom}
  ...
  `},Y={title:"Elements/eox-timecontrol",tags:["autodocs"],component:"eox-timecontrol",render:e=>o`
    <eox-timecontrol
      .for=${e.for}
      .layerIdKey=${e.layerIdKey}
      .titleKey=${e.titleKey}
...
the map layers.`,...d.parameters?.docs?.description}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:"TimelineStory",...p.parameters?.docs?.source},description:{story:`Timeline visualization using vis-timeline with date picker and calendar integration
...
comprehensive time navigation interface.`,...p.parameters?.docs?.description}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:"TimelineSelectionDurationStory",...c.parameters?.docs?.source},description:{story:'Timeline visualization with custom selection duration\n\nThis example demonstrates the `selectionDuration` property, which allows defining the\ndefault selection duration (if no item is clicked).\nIt strictly supports native dayjs duration formats (e.g., `{ months: 1 }`, `"P1M"`, or `100` for milliseconds).',...c.parameters?.docs?.description}}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:"TimelineSelectionResizableStory",...y.parameters?.docs?.source},description:{story:`Timeline visualization with non-resizable selection
...
modify the range.`,...y.parameters?.docs?.description}}};x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:"ExternalMapRenderingStory",...x.parameters?.docs?.source},description:{story:`External map rendering mode for timelapse export with custom map rendering logic
...
time step, or when using map rendering services that require special handling.`,...x.parameters?.docs?.description}}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:"DateFilterStory",...u.parameters?.docs?.source},description:{story:`Date filtering using eox-itemfilter for filtering timeline items by metadata properties
...
matching the current filter criteria. Filtered-out dates are displayed with reduced opacity.`,...u.parameters?.docs?.description}}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:"UpdateViewStory",...h.parameters?.docs?.source},description:{story:`Update view event story

This example demonstrates the \`update:view\` event, which is dispatched when the view range of the timeline changes.
The event is dispatched with the start and end dates of the view range.`,...h.parameters?.docs?.description}}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:"NoMapStory",...f.parameters?.docs?.source},description:{story:"No map story\n\nThis example demonstrates the timecontrol component without a map. The component can be used\nstandalone by providing `controlValues` directly instead of linking to a map via the `for` attribute.\nThis is useful when you want to use timecontrol for date selection without map integration.",...f.parameters?.docs?.description}}};$.parameters={...$.parameters,docs:{...$.parameters?.docs,source:{originalSource:"ExpertStory",...$.parameters?.docs?.source},description:{story:`Expert example showcasing all timecontrol features together
...
multiple interaction methods and visualization options.`,...$.parameters?.docs?.description}}};const _=["OnlyDate","DateWithInitDate","DateWithNavigation","DatePickerPopup","DatePickerPopupItems","DateInUTC","DatePickerStandalone","Slider","Timeline","TimelineSelectionDuration","TimelineSelectionResizable","ExternalMapRendering","DateFilter","UpdateView","NoMap","Expert"];export{u as DateFilter,l as DateInUTC,a as DatePickerPopup,s as DatePickerPopupItems,m as DatePickerStandalone,n as DateWithInitDate,r as DateWithNavigation,$ as Expert,x as ExternalMapRendering,f as NoMap,i as OnlyDate,d as Slider,p as Timeline,c as TimelineSelectionDuration,y as TimelineSelectionResizable,h as UpdateView,_ as __namedExportsOrder,Y as default};
