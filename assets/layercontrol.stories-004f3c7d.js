 ...
 */const zt=Ar(class extends Mr{constructor(o){if(super(o),o.type!==he.PROPERTY&&o.type!==he.ATTRIBUTE&&o.type!==he.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Vr(o))throw Error("`live` bindings can only contain a single expression")}render(o){return o}update(o,[e]){if(e===We||e===me)return e;const t=o.element,r=o.name;if(o.type===he.PROPERTY){if(e===t[r])return We}else if(o.type===he.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(r))return We}else if(o.type===he.ATTRIBUTE&&t.getAttribute(r)===e+"")return We;return Nr(o),e}});var pt,ut;class mr extends ae{constructor(){super();A(this,pt,"");A(this,ut,"");this.layer=null,this.unstyled=!1,this.noShadow=!0}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){var t;return g`
      ...
      <input
        ...
        max="1"
        step="0.01"
        value=${zt((t=this.layer)==null?void 0:t.getOpacity())}
    ...
    `}}pt=new WeakMap,ut=new WeakMap,V(mr,"properties",{layer:{attribute:!1},unstyled:{type:Boolean},noShadow:{type:Boolean}});customElements.define("eox-layercontrol-layerconfig",mr);var ct,ht;class vr extends ae{constructor(){super();A(this,ct,`
    .tabbed figure {
      margin: 0;
    }
    .tabbed nav {
  ...
  `);this.actions=[],this.selectedTab=0,this.tabs=[],this.unstyled=!1,this.noShadow=!0}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){return g`
    ...
    `}}ct=new WeakMap,ht=new WeakMap,V(vr,"properties",{actions:{attribute:!1},selectedTab:{state:!0},tabs:{attribute:!1},unstyled:{type:Boolean},noShadow:{type:Boolean}});customElements.define("eox-layercontrol-tabs",vr);var ft,yt;class br extends ae{constructor(){super();V(this,"_parseActions",t=>t==null?void 0:t.filter(r=>["remove","sort"].filter(n=>{var i;return(i=this.layer)!=null&&i.get("layerControlDisable")?n!=="sort":!0}).includes(r)));V(this,"_parseTools",t=>t==null?void 0:t.filter(r=>{var i;let n=!0;return["remove","sort"].includes(r)&&(n=!1),r==="info"&&(n=this.layer.get("description")),r==="config"&&(n=(i=this.layer.style_)==null?void 0:i.color),n}));V(this,"_removeButton",g`
    <button
      ...
      ${K(((t=this._parseActions(this.tools))==null?void 0:t.length)+((r=this._parseTools(this.tools))==null?void 0:r.length)>0,()=>{var n,i;return g`
          ${K(((n=this._parseActions(this.tools))==null?void 0:n.length)===1&&((i=this._parseTools(this.tools))==null?void 0:i.length)===0,()=>g`
            ...
            `,()=>{var a;return g`
              <details
                class="tools"
                open=${this.layer.get("layerControlToolsExpand")||me}
              >
                <summary>
                  <button
                ...
                >
                  ...
                  <div slot="opacity-content">
                    <input
                      ...
                      max="1"
                      step="0.01"
                      value=${zt((a=this.layer)==null?void 0:a.getOpacity())}
            ...
            `})}
        `})}
    `}}ft=new WeakMap,yt=new WeakMap,V(br,"properties",{layer:{attribute:!1},tools:{attribute:!1},unstyled:{type:Boolean},noShadow:{type:Boolean}});customElements.define("eox-layercontrol-layer-tools",br);var gt,mt;class xr extends ae{constructor(){super();V(this,"currLayerVisibilityBasedOnZoom",!0);A(this,gt,"");A(this,mt,`
    ${or}
          ...
          >
            ...
            >
              <input
                ...
                .checked=${zt(this.layer.getVisible())}
  ...
  `);this.group=null,this.idProperty="id",this.map=null,this.titleProperty="title",this.showLayerZoomState=!1,this.tools=[],this.unstyled=!1,this.noShadow=!0}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){return g`
      ...
      ${K(this.group,()=>g`
          <details open=${this.group.get("layerControlExpand")||me}>
            <summary>
              <eox-layercontrol-layer
                .noShadow=${!0}
                .layer=${this.group}
        ...
        `)}
    `}}vt=new WeakMap,bt=new WeakMap,V(wr,"properties",{group:{attribute:!1},idProperty:{attribute:"id-property"},map:{attribute:!1,state:!0},titleProperty:{attribute:"title-property",type:String},showLayerZoomState:{attribute:"show-layer-zoom-state",type:Boolean},tools:{attribute:!1},unstyled:{type:Boolean},noShadow:{type:Boolean}});customElements.define("eox-layercontrol-layer-group",wr);var xt,wt;class Er extends ae{constructor(){super();A(this,xt,"");A(this,wt,`
    ul {
      padding: 0;
    }
    ul ul {
  ...
  `);this.idProperty="id",this.layers=null,this.map=null,this.tools=void 0,this.titleProperty="title",this.showLayerZoomState=!1,this.unstyled=!1,this.noShadow=!0}updated(){this.layers&&(this.layers.on("change:length",()=>{this.requestUpdate(),this.dispatchEvent(new CustomEvent("changed",{bubbles:!0}))}),cn(this.renderRoot.querySelector("ul"),this.layers,this))}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){return g`
      ...
      <ul>
        ${K(this.layers,()=>g`
            ${this.layers.getArray().filter(t=>!t.get("layerControlHide")&&!t.get("layerControlOptional")).reverse().map(t=>Pr(t.get(this.idProperty),g`
                    <li
    ...
    `}}V(Sr,"properties",{idProperty:{attribute:"id-property"},layers:{attribute:!1},titleProperty:{attribute:"title-property",type:String},unstyled:{type:Boolean},noShadow:{type:Boolean}});customElements.define("eox-layercontrol-optional-list",Sr);var Et,St;class Cr extends ae{constructor(){super();A(this,Et,"");A(this,St,`
    * {
      font-family: Roboto, sans-serif;
    }
  `);this.for="eox-map",this.idProperty="id",this.map=null,this.titleProperty="title",this.showLayerZoomState=!1,this.tools=["info","opacity","remove","sort"],this.unstyled=!1,this.styleOverride=""}updated(){const t=document.querySelector(this.for);t&&(this.map=t.map)}render(){var t;return g`
      <style>
        ${P(this,Et)}
...
></eox-map>`,Dn={title:"Elements/eox-layercontrol",tags:["autodocs"],component:"eox-layercontrol",parameters:{componentSubtitle:"Manage and configure OpenLayers map layers",layout:"centered"}},Te={args:{idProperty:"id",titleProperty:"title",unstyled:!1},render:o=>g`
  ...
  `])),o.noShadow,o.unstyled)},Ae={render:()=>g`
    ...
    ></eox-layercontrol-tabs>
  `},Me={args:{showLayerZoomState:!0},render:o=>g`
    <div style="display: flex">
      <eox-layercontrol
...
extra functionalities for layers`,...(Do=($o=Le.parameters)==null?void 0:$o.docs)==null?void 0:Do.description}}};var Lo,Po,Ao,Mo,Vo;Pe.parameters={...Pe.parameters,docs:{...(Lo=Pe.parameters)==null?void 0:Lo.docs,source:{originalSource:`{
  ...
  render: args => html\`
    ...
    <\/script>
  \`
}`,...(Bo=(Zo=Ke.parameters)==null?void 0:Zo.docs)==null?void 0:Bo.source}}};var Xo,Yo,zo,ko,Fo;Ae.parameters={...Ae.parameters,docs:{...(Xo=Ae.parameters)==null?void 0:Xo.docs,source:{originalSource:`{
  render: () => html\`
    <eox-layercontrol-tabs
      .noShadow=\${false}
      .actions=\${["delete"]}
    ...
    ></eox-layercontrol-tabs>
  \`
}`,...(zo=(Yo=Ae.parameters)==null?void 0:Yo.docs)==null?void 0:zo.source},description:{story:"Layer control tabs",...(Fo=(ko=Ae.parameters)==null?void 0:ko.docs)==null?void 0:Fo.description}}};var Wo,jo,qo,Go,Uo;Me.parameters={...Me.parameters,docs:{...(Wo=Me.parameters)==null?void 0:Wo.docs,source:{originalSource:`{
  args: {
  ...
  \`
}`,...(qo=(jo=Me.parameters)==null?void 0:jo.docs)==null?void 0:qo.source},description:{story:"Zoom layer state based on `minZoom` and `maxZoom`.\nThe color change state only visible when `showLayerZoomState` is set inside layer properties.",...(Uo=(Go=Me.parameters)==null?void 0:Go.docs)==null?void 0:Uo.description}}};var Jo,Ko,Qo,er,tr;Ve.parameters={...Ve.parameters,docs:{...(Jo=Ve.parameters)==null?void 0:Jo.docs,source:{originalSource:`{
  args: {
    unstyled: true
  },
  render: args => html\`
  ...
  \`
}`,...(Qo=(Ko=Ve.parameters)==null?void 0:Ko.docs)==null?void 0:Qo.source},description:{story:"Unstyled version of the Element",...(tr=(er=Ve.parameters)==null?void 0:er.docs)==null?void 0:tr.description}}};const Ln=["Primary","ExclusiveLayers","OptionalLayers","ExpandedLayers","Tools","HiddenLayers","SingleLayer","LayerList","Tabs","LayerZoomState","Unstyled"];export{Oe as ExclusiveLayers,De as ExpandedLayers,Pe as HiddenLayers,Ke as LayerList,Me as LayerZoomState,$e as OptionalLayers,Te as Primary,Je as SingleLayer,Ae as Tabs,Le as Tools,Ve as Unstyled,Ln as __namedExportsOrder,Dn as default};
//# sourceMappingURL=layercontrol.stories-004f3c7d.js.map
