import{i as e}from"./preload-helper-B45gAKPr.js";import{c as t,d as n,f as r,h as i,l as a,m as o,n as s,o as c,p as l,t as u}from"./lit-X6_6WslE.js";import{G as d,H as f,J as ee,Q as p,U as te,V as m,W as ne,X as h,at as re,dt as ie,et as g,lt as ae,nt as _,ot as v,q as oe,rt as y,ut as b}from"./iframe-s3sZnEQv.js";var x,S=e((()=>{x=e=>(t,n)=>{n===void 0?customElements.define(e,t):n.addInitializer((()=>{customElements.define(e,t)}))}}));function C(e){return(t,n)=>typeof n==`object`?T(e,t,n):((e,t,n)=>{let r=t.hasOwnProperty(n);return t.constructor.createProperty(n,e),r?Object.getOwnPropertyDescriptor(t,n):void 0})(e,t,n)}var w,T,E=e((()=>{l(),w={attribute:!0,type:String,converter:o,reflect:!1,hasChanged:r},T=(e=w,t,n)=>{let{kind:r,metadata:i}=n,a=globalThis.litPropertyMetadata.get(i);if(a===void 0&&globalThis.litPropertyMetadata.set(i,a=new Map),r===`setter`&&((e=Object.create(e)).wrapped=!0),a.set(n.name,e),r===`accessor`){let{name:r}=n;return{set(n){let i=t.get.call(this);t.set.call(this,n),this.requestUpdate(r,i,e)},init(t){return t!==void 0&&this.C(r,void 0,e,t),t}}}if(r===`setter`){let{name:r}=n;return function(n){let i=this[r];t.call(this,n),this.requestUpdate(r,i,e)}}throw Error(`Unsupported decorator location: `+r)}}));function D(e){return C({...e,state:!0,attribute:!1})}var O=e((()=>{E()})),k=e((()=>{})),A,se=e((()=>{A=(e,t,n)=>(n.configurable=!0,n.enumerable=!0,Reflect.decorate&&typeof t!=`object`&&Object.defineProperty(e,t,n),n)}));function j(e,t){return(n,r,i)=>{let a=t=>t.renderRoot?.querySelector(e)??null;if(t){let{get:e,set:t}=typeof r==`object`?n:i??(()=>{let e=Symbol();return{get(){return this[e]},set(t){this[e]=t}}})();return A(n,r,{get(){let n=e.call(this);return n===void 0&&(n=a(this),(n!==null||this.hasUpdated)&&t.call(this,n)),n}})}return A(n,r,{get(){return a(this)}})}}var M=e((()=>{se()})),ce=e((()=>{})),N=e((()=>{})),le=e((()=>{})),ue=e((()=>{})),P=e((()=>{S(),E(),O(),k(),M(),ce(),N(),le(),ue()})),F,I=e((()=>{d(),y(),F=class{constructor(e){this.cle=e}setColorScale(){switch(this.cle.scaleType){case`continuous`:this.setContinousColorScale();break;case`log10`:this.setLogColorScale();break;case`discrete`:this.setDiscreteColorScale();break;case`threshold`:this.setThresholdColorScale();break;case`categorical`:this.setCategoricalColorScale();break;default:this.invalidScaleType(this.cle.scaleType)}}setContinousColorScale(){let{interpolator:e,domain:t,range:n}=this.cle;this.colorScale=e?oe(e).domain(t):_().range(n).domain(t).interpolate(v)}setLogColorScale(){let{interpolator:e,domain:t,range:n}=this.cle;this.colorScale=e?ee(e).domain(t):g().range(n).domain(t).interpolate(v)}setDiscreteColorScale(){this.colorScale=p().domain(this.cle.domain).range(this.cle.range)}setThresholdColorScale(){let e=this.cle.domain;this.colorScale=h().domain(e.slice(1,e.length-1)).range(this.cle.range)}setCategoricalColorScale(){this.colorScale=ae().domain(this.cle.domain).range(this.cle.range)}invalidScaleType(e){throw Error(`invalid property scaletype: ${e}.
      Must be one of "categorical", "continuous", "discrete", "threshold".`)}}})),L,R=e((()=>{a(),te(),L=m(class extends f{constructor(e){if(super(e),e.type!==ne.ATTRIBUTE||e.name!==`class`||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return` `+Object.keys(e).filter((t=>e[t])).join(` `)+` `}update(e,[t]){if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(` `).split(/\s/).filter((e=>e!==``))));for(let e in t)t[e]&&!this.nt?.has(e)&&this.st.add(e);return this.render(t)}let n=e.element.classList;for(let e of this.st)e in t||(n.remove(e),this.st.delete(e));for(let e in t){let r=!!t[e];r===this.st.has(e)||this.nt?.has(e)||(r?(n.add(e),this.st.add(e)):(n.remove(e),this.st.delete(e)))}return c}})})),z=e((()=>{R()})),B,V=e((()=>{u(),z(),y(),B=class{constructor(e){this.cle=e}render(){let e=this.cle.titleText?n`<p class="legend-title">${this.cle.titleText}</p>`:``,t={hidden:this.cle.scaleType===`categorical`},r={hidden:this.cle.scaleType!==`categorical`,"categorical-container":!0};return n`<div
      class="cle-container"
    ...
    >
      ...
      <slot name="footer"></slot>
        ...
        >
          ${e}
        </li>`)}`}renderContinuous(){if(this.cle.scaleType!==`continuous`&&this.cle.scaleType!==`log10`||this.cle.colorScale===null)return``;let{colorScale:e,marginTop:n,marginLeft:r,marginRight:i,tickSize:a,width:o,range:s}=this.cle,c=this.cle.marginBottom+a,l=this.cle.height+a,u=e.interpolator?.()||re(v,s);return t`<image
      x=${r}
      y=${n}
      width=${o-i-r}
      height=${l-n-c}
