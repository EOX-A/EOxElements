import{x as i}from"./iframe-Cwt5eWl4.js";import"./preload-helper-PPVm8Dsz.js";const r={args:{endpoint:"/fake/endpoint",style:"position: relative !important; height: 250px;",unstyled:void 0,submit:e=>console.log("Feedback submitted",e.detail),close:()=>console.log("Feedback closed")},render:e=>i`
    <div style="${e.style}">
      <eox-feedback
        endpoint="${e.endpoint}"
        ?unstyled="${e.unstyled}"
