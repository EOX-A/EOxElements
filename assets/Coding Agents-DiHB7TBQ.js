import{u as l,j as e}from"./iframe-C8-LeTJQ.js";import"./preload-helper-PPVm8Dsz.js";function n(t){const s={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",ul:"ul",...l(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.h1,{id:"coding-agents",children:"Coding Agents"}),`
...
The `,e.jsx(s.code,{children:"@eox/elements-mcp-server"})," will start on ",e.jsx(s.code,{children:"http://localhost:3000/mcp"})," and a compatible coding agent will be able to discover and use the tools from that endpoint."]}),`
...
`]})]})}function o(t={}){const{wrapper:s}={...l(),...t.components};return s?e.jsx(s,{...t,children:e.jsx(n,{...t})}):n(t)}export{o as default};
