import{g as i}from"./index-DuuuSFPv.js";function l(o,c){for(var n=0;n<c.length;n++){const e=c[n];if(typeof e!="string"&&!Array.isArray(e)){for(const r in e)if(r!=="default"&&!(r in o)){const a=Object.getOwnPropertyDescriptor(e,r);a&&Object.defineProperty(o,r,a.get?a:{enumerable:!0,get:()=>e[r]})}}}return Object.freeze(Object.defineProperty(o,Symbol.toStringTag,{value:"Module"}))}var t={exports:{}},u;function s(){return u||(u=1,function(o,c){ace.define("ace/theme/gruvbox-css",["require","exports","module"],function(n,e,r){r.exports=`.ace-gruvbox .ace_gutter-active-line {
