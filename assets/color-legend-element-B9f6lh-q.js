import{n as e}from"./rolldown-runtime-BM3Ffeng.js";import{A as t,C as n,Ct as r,D as i,Dt as a,E as o,Et as s,F as c,I as l,L as u,M as d,N as f,O as ee,Ot as te,P as p,R as ne,St as m,T as re,Tt as h,bt as g,j as _,k as v,kt as y,w as b,wt as x,xt as ie,z as ae}from"./iframe-CuSMZxLA.js";var S,C=e((()=>{S=e=>(t,n)=>{n===void 0?customElements.define(e,t):n.addInitializer((()=>{customElements.define(e,t)}))}}));function w(e){return(t,n)=>typeof n==`object`?E(e,t,n):((e,t,n)=>{let r=t.hasOwnProperty(n);return t.constructor.createProperty(n,e),r?Object.getOwnPropertyDescriptor(t,n):void 0})(e,t,n)}var T,E,D=e((()=>{a(),T={attribute:!0,type:String,converter:te,reflect:!1,hasChanged:s},E=(e=T,t,n)=>{let{kind:r,metadata:i}=n,a=globalThis.litPropertyMetadata.get(i);if(a===void 0&&globalThis.litPropertyMetadata.set(i,a=new Map),r===`setter`&&((e=Object.create(e)).wrapped=!0),a.set(n.name,e),r===`accessor`){let{name:r}=n;return{set(n){let i=t.get.call(this);t.set.call(this,n),this.requestUpdate(r,i,e)},init(t){return t!==void 0&&this.C(r,void 0,e,t),t}}}if(r===`setter`){let{name:r}=n;return function(n){let i=this[r];t.call(this,n),this.requestUpdate(r,i,e)}}throw Error(`Unsupported decorator location: `+r)}})),oe=e((()=>{D()})),se=e((()=>{})),O,ce=e((()=>{O=(e,t,n)=>(n.configurable=!0,n.enumerable=!0,Reflect.decorate&&typeof t!=`object`&&Object.defineProperty(e,t,n),n)}));function le(e,t){return(n,r,i)=>{let a=t=>t.renderRoot?.querySelector(e)??null;if(t){let{get:e,set:t}=typeof r==`object`?n:i??(()=>{let e=Symbol();return{get(){return this[e]},set(t){this[e]=t}}})();return O(n,r,{get(){let n=e.call(this);return n===void 0&&(n=a(this),(n!==null||this.hasUpdated)&&t.call(this,n)),n}})}return O(n,r,{get(){return a(this)}})}}var k=e((()=>{ce()})),A=e((()=>{})),j=e((()=>{})),M=e((()=>{})),N=e((()=>{})),P=e((()=>{C(),D(),oe(),se(),k(),A(),j(),M(),N()})),F,I=e((()=>{i(),p(),F=class{constructor(e){this.cle=e}setColorScale(){switch(this.cle.scaleType){case`continuous`:this.setContinousColorScale();break;case`log10`:this.setLogColorScale();break;case`discrete`:this.setDiscreteColorScale();break;case`threshold`:this.setThresholdColorScale();break;case`categorical`:this.setCategoricalColorScale();break;default:this.invalidScaleType(this.cle.scaleType)}}setContinousColorScale(){let{interpolator:e,domain:t,range:n}=this.cle;this.colorScale=e?ee(e).domain(t):f().range(n).domain(t).interpolate(l)}setLogColorScale(){let{interpolator:e,domain:t,range:n}=this.cle;this.colorScale=e?v(e).domain(t):d().range(n).domain(t).interpolate(l)}setDiscreteColorScale(){this.colorScale=_().domain(this.cle.domain).range(this.cle.range)}setThresholdColorScale(){let e=this.cle.domain;this.colorScale=t().domain(e.slice(1,e.length-1)).range(this.cle.range)}setCategoricalColorScale(){this.colorScale=u().domain(this.cle.domain).range(this.cle.range)}invalidScaleType(e){throw Error(`invalid property scaletype: ${e}.
      Must be one of "categorical", "continuous", "discrete", "threshold".`)}}})),L,R=e((()=>{x(),re(),L=n(class extends b{constructor(e){if(super(e),e.type!==o.ATTRIBUTE||e.name!==`class`||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return` `+Object.keys(e).filter((t=>e[t])).join(` `)+` `}update(e,[t]){if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(` `).split(/\s/).filter((e=>e!==``))));for(let e in t)t[e]&&!this.nt?.has(e)&&this.st.add(e);return this.render(t)}let n=e.element.classList;for(let e of this.st)e in t||(n.remove(e),this.st.delete(e));for(let e in t){let r=!!t[e];r===this.st.has(e)||this.nt?.has(e)||(r?(n.add(e),this.st.add(e)):(n.remove(e),this.st.delete(e)))}return m}})})),z=e((()=>{R()})),B,V=e((()=>{g(),z(),p(),B=class{constructor(e){this.cle=e}render(){let e=this.cle.titleText?h`<p class="legend-title">${this.cle.titleText}</p>`:``,t={hidden:this.cle.scaleType===`categorical`},n={hidden:this.cle.scaleType!==`categorical`,"categorical-container":!0};return h`<div
      class="cle-container"
    ...
    >
      ...
      <slot name="footer"></slot>
        ...
        >
          ${e}
        </li>`)}`}renderContinuous(){if(this.cle.scaleType!==`continuous`&&this.cle.scaleType!==`log10`||this.cle.colorScale===null)return``;let{colorScale:e,marginTop:t,marginLeft:n,marginRight:i,tickSize:a,width:o,range:s}=this.cle,u=this.cle.marginBottom+a,d=this.cle.height+a,f=e.interpolator?.()||c(l,s);return r`<image
      x=${n}
      y=${t}
      width=${o-i-n}
      height=${d-t-u}
