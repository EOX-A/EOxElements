import{n as e}from"./chunk-jRWAZmH_.js";import{t,u as n}from"./lit-BtOHfmSb.js";import{_t as r}from"./proj-DcOwt1-_.js";import{_ as i,c as a,g as ee,l as te,u as ne}from"./iframe-B7exoYAm.js";import{n as re,t as ie}from"./taggedTemplateLiteral-S0ilIrS4.js";var ae,oe=e((()=>{ae={args:{center:[15,48],layers:[{type:`Tile`,source:{type:`OSM`}}],zoom:7}}})),se,ce=e((()=>{se={args:{layers:[{type:`Vector`,background:`#1366dd`,properties:{id:`regions`},source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`,attributions:`Regions: @ openlayers.org`},style:{"stroke-color":`#232323`,"stroke-width":1,"fill-color":[`string`,[`get`,`COLOR`],`#eee`]}}]}}})),le,ue=e((()=>{le={args:{layers:[{type:`VectorTile`,background:`#1a2b39`,declutter:!0,properties:{id:`countries`},source:{type:`VectorTile`,url:`https://ahocevar.com/geoserver/gwc/service/tms/1.0.0/ne:ne_10m_admin_0_countries@EPSG%3A900913@pbf/{z}/{x}/{-y}.pbf`,format:`MVT`,tileGrid:{}},style:{"fill-color":`yellow`,"stroke-color":`#232323`,"stroke-width":1}}]}}})),de,fe=e((()=>{de={args:{center:[-10997148,4569099],layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`TileWMS`,url:`https://ahocevar.com/geoserver/wms`,params:{LAYERS:`topp:states`,TILED:!0},ratio:1,serverType:`geoserver`}}],zoom:3}}})),pe,me=e((()=>{pe={args:{center:[20,40],layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`WMTSCapabilities`,url:`https://tiles.maps.eox.at/wmts/1.0.0/WMTSCapabilities.xml`,layer:`s2cloudless-2017`}}],zoom:5,storyCodeBefore:`import "@eox/map/src/plugins/advancedLayersAndSources"`}}})),he,ge=e((()=>{he={args:{center:[20,40],layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`WMTS`,url:`https://tiles.maps.eox.at/wmts`,layer:`s2cloudless-2017_3857`,style:`default`,matrixSet:`GoogleMapsCompatible`,tileGrid:{tileSize:[128,128]}}}],zoom:5}}})),_e,ve=e((()=>{_e={args:{center:[-10997148,4569099],layers:[{type:`Image`,properties:{id:`regions`},source:{type:`ImageStatic`,imageExtent:[-20037508.342789244,-15028131.257091934,20037508.342789244,15028131.257091934],url:`https://imgs.xkcd.com/comics/online_communities.png`}}],zoom:0}}})),ye,be=e((()=>{ye={args:{center:[-122.38,46.1],layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`OSM`}},{type:`STAC`,properties:{id:`stacLayer`},url:`https://s3.us-west-2.amazonaws.com/sentinel-cogs/sentinel-s2-l2a-cogs/10/T/ES/2022/7/S2A_10TES_20220726_0_L2A/S2A_10TES_20220726_0_L2A.json`}],zoom:7,storyCodeBefore:`import "@eox/map/src/plugins/advancedLayersAndSources"`}}})),xe,Se=e((()=>{xe={args:{center:[0,0],layers:[{type:`MapboxStyle`,properties:{id:`mapboxStyleGroup`,title:`mapboxStyleGroup`,mapboxStyle:{version:8,sources:{osm:{type:`raster`,tiles:[`https://a.tile.openstreetmap.org/{z}/{x}/{y}.png`],tileSize:256,attribution:`© OpenStreetMap contributors`},pointSource:{type:`geojson`,data:{type:`FeatureCollection`,features:[{type:`Feature`,geometry:{type:`Point`,coordinates:[0,0]},properties:{}}]}}},layers:[{id:`osm-base`,type:`raster`,source:`osm`,minzoom:0,maxzoom:19},{id:`point-halo`,type:`circle`,source:`pointSource`,paint:{"circle-radius":10,"circle-color":`#0000ff`,"circle-opacity":.5}},{id:`point-main`,type:`circle`,source:`pointSource`,paint:{"circle-radius":5,"circle-color":`#ff0000`}}]}}}],zoom:0,storyCodeBefore:`import "@eox/map/src/plugins/advancedLayersAndSources"`}}})),Ce,we=e((()=>{Ce={args:{center:[3737055,1886786],layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`OSM`}},{type:`WebGLTile`,properties:{id:`geotiffLayer`},source:{type:`GeoTIFF`,sources:[{url:`https://sentinel-cogs.s3.us-west-2.amazonaws.com/sentinel-s2-l2a-cogs/36/Q/WD/2020/7/S2A_36QWD_20200701_0_L2A/TCI.tif`}]}}],zoom:8,storyCodeBefore:`import "@eox/map/src/plugins/advancedLayersAndSources"`}}})),Te,Ee=e((()=>{Te={args:{center:[1407372,5701616],layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`OSM`}},{type:`WebGLTile`,properties:{id:`geozarrLayer`},source:{type:`GeoZarr`,url:`https://s3.explorer.eopf.copernicus.eu/esa-zarr-sentinel-explorer-fra/tests-output/sentinel-2-l2a/S2A_MSIL2A_20251107T100231_N0511_R122_T32TQR_20251107T115310.zarr`,group:`measurements/reflectance`,bands:[`b04`,`b03`,`b02`,`b05`]},style:{gamma:1.5,color:[`color`,[`interpolate`,[`linear`],[`band`,1],0,0,.5,255],[`interpolate`,[`linear`],[`band`,2],0,0,.5,255],[`interpolate`,[`linear`],[`band`,3],0,0,.5,255],[`case`,[`==`,[`+`,[`band`,1],[`band`,2],[`band`,3]],0],0,1]]}}],zoom:9,storyCodeBefore:`import "@eox/map/src/plugins/advancedLayersAndSources"`}}})),De,Oe=e((()=>{De={args:{layers:[{type:`Group`,properties:{id:`group`},layers:[{type:`Group`,properties:{id:`groupLayerInsideGroup`},layers:[{type:`Tile`,properties:{id:`layerInsideGroupInsideGroup`},source:{type:`OSM`}}]},{type:`Vector`,properties:{id:`regions`},source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`}}]}]}}})),ke,Ae=e((()=>{t(),ee(),ke={args:{storyStyle:`
      .custom-btn {
...
`,controls:{FullScreen:{position:`top-right`,target:`fs-attribution`,orientation:`vertical`},Attribution:{position:`bottom-right`,target:`zoom-hz`,orientation:`horizontal`,collapsible:!0},Zoom:{position:`bottom-right`,target:`zoom-hz`,orientation:`horizontal`},Rotate:{position:`bottom-center`,target:`bottom-tools`,orientation:`horizontal`},GlobeSwitcher:{position:`bottom-center`,target:`bottom-tools`,orientation:`horizontal`},ScaleLine:{position:`bottom-left`,target:`scale-line`,orientation:`horizontal`},MousePosition:{position:`bottom-left`,target:`scale-line`,orientation:`horizontal`},OverviewMap:{position:`top-left`,collapsed:!1,layers:[{type:`Tile`,source:{type:`OSM`}}]}},layers:[{type:`Tile`,source:{type:`XYZ`,url:`https://tiles.maps.eox.at/wmts/1.0.0/s2cloudless-2024_3857/default/g/{z}/{y}/{x}.jpg`,attributions:`<a xmlns:dct="http://purl.org/dc/terms/" href="https://s2maps.eu" property="dct:title">Sentinel-2 cloudless - https://s2maps.eu</a> by <a xmlns:cc="http://creativecommons.org/ns#" href="https://eox.at" property="cc:attributionName" rel="cc:attributionURL">EOX IT Services GmbH</a> (Contains modified Copernicus Sentinel data 2024) released under <a rel="license" href="https://creativecommons.org/licenses/by-nc-sa/4.0/">Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License</a>. For commercial usage please see <a href="https://cloudless.eox.at">https://cloudless.eox.at</a>`}}],zoom:4,center:[10,50]},render:e=>n`
  ...
  `}})),je,Me=e((()=>{je={args:{controls:{GlobeSwitcher:{},Zoom:{},Attribution:{},FullScreen:{},Rotate:{},OverviewMap:{layers:[{type:`Tile`,properties:{id:`overviewMap`},source:{type:`OSM`}}]},MousePosition:{},ScaleLine:{},Geolocation:{}},layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`OSM`}}]}}})),Ne,Pe=e((()=>{Ne={args:{zoom:7,controls:{Geolocation:{tracking:!0,trackHeading:!0,centerWhenReady:!1,highAccuracy:!0,trackAccuracy:!0,style:{"circle-radius":10,"circle-fill-color":`red`,"circle-stroke-color":`white`,"circle-stroke-width":2}}},layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`OSM`}}]}}})),Fe,Ie=e((()=>{Fe={args:{zoom:9,center:[0,51.5],controls:{LoadingIndicator:{},Zoom:{}},layers:[{type:`Tile`,properties:{id:`customId`},source:{type:`OSM`}}]}}})),Le,Re=e((()=>{Le={args:{zoom:9,center:[0,51.5],controls:{LoadingIndicator:{type:`fullscreen`,opacity:.2,spinnerSvg:`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" width="50" height="50" style="shape-rendering: auto; display: block; background: transparent;" xmlns:xlink="http://www.w3.org/1999/xlink"><g><circle stroke-dasharray="120 50" r="30" stroke-width="22" stroke="#cd4609" fill="none" cy="50" cx="50">
  ...
  `}})),l,We=e((()=>{t(),l={args:{layers:[{type:`Vector`,source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`},interactions:[{type:`select`,options:{id:`selectInteraction`,condition:`pointermove`,style:{"stroke-color":`red`,"stroke-width":3}}}]}],center:[15,48],zoom:4,storyAdditionalComponents:{"eox-map-tooltip":{storyImport:!1,storySlot:!0,propertyTransform:e=>{if(e.key.includes(`COLOR`))return{key:e.key.toLowerCase(),value:e.value}}}}},render:e=>n`
    <eox-map
      .center=${e.center}
      .controls=${e.controls}
      .layers=${e.layers}
  ...
  `}})),u,Ge=e((()=>{t(),u={args:{id:`highlightAndAnimate`,config:{layers:[{type:`Vector`,background:`lightgrey`,properties:{id:`regions`},source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`,attributions:`Regions: @ openlayers.org`},style:{"stroke-color":`black`,"stroke-width":1,"fill-color":`darkgrey`},interactions:[{type:`select`,options:{id:`selectInteraction`,condition:`click`,style:{"stroke-color":`white`,"stroke-width":3}}}]}]},loadend:()=>{document.querySelector(`eox-map#highlightAndAnimate`).selectInteractions.selectInteraction.highlightById([664,795,789],{duration:400,padding:[50,50,50,50]})}},render:e=>n`
    <eox-map
      id=${e.id}
      .config=${e.config}
      @loadend=${e.loadend}
    ></eox-map>
  `}})),d,Ke=e((()=>{t(),d={args:{id:`a`,layers:[{type:`Tile`,properties:{id:`osm`,title:`Background`},source:{type:`OSM`}}],storyAdditionalComponents:{"eox-map":{id:`b`,sync:`#a`,layers:[{type:`Tile`,properties:{id:`osm`,title:`Background`},source:{type:`OSM`}}]}}},render:e=>n`
    <style>
      eox-map {
        width: 50%;
      }
  ...
  `}})),p,Je=e((()=>{t(),p={args:{config:{controls:{Zoom:{}},layers:[{type:`Tile`,source:{type:`OSM`}}],view:{center:[16.8,48.2],zoom:9}}},render:e=>n`
    <eox-map .config=${e.config}></eox-map>
  `}})),m,Ye=e((()=>{t(),m={args:{layers:[{type:`Tile`,properties:{id:`osm`,title:`Background`},source:{type:`OSM`}},{type:`Vector`,source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`}}],center:[16.8,48.2],zoom:7,projection:`EPSG:3857`},render:e=>n`
    <eox-map
      .center=${e.center}
      .controls=${e.controls}
      .layers=${e.layers}
  ...
  `}})),h,Xe=e((()=>{t(),h={args:{layers:[{type:`Tile`,properties:{id:`osm`,title:`Background`},source:{type:`OSM`}}],animationOptions:{duration:500},center:[16.8,48.2],zoom:7},render:e=>n`
    <eox-map
      .center=${e.center}
      .layers=${e.layers}
      .zoom=${e.zoom}
 ...
 customElements.define(
    ...
    )`,layers:[{type:`Vector`,source:{type:`Vector`,url:`https://openlayers.org/data/vector/ecoregions.json`,format:`GeoJSON`},interactions:[{type:`select`,options:{id:`selectInteraction`,condition:`pointermove`,style:{"stroke-color":`red`,"stroke-width":3}}}]}],center:[15,48],zoom:4},render:e=>n(rt||=ie([`
    <script>
      `,`;
    <\/script>
    <eox-map
  ...
  `]),e.storyCodeBefore,e.center,e.controls,e.layers,e.zoom)}})),ot,st=e((()=>{t(),ot={args:{layers:[{type:`Tile`,properties:{title:`Terrain Light`,id:`terrain-light`},source:{type:`XYZ`,url:`//tiles.maps.eox.at/wmts/1.0.0/terrain-light_3857/default/g/{z}/{y}/{x}.jpg`}},{type:`Tile`,properties:{id:`wmsLayer`},source:{type:`TileWMS`,url:`https://ahocevar.com/geoserver/wms`,params:{LAYERS:`topp:states`,TILED:!0},ratio:1,serverType:`geoserver`},interactions:[{type:`select`,options:{id:`selectInteraction`,condition:`click`}}]}],center:[-10997148,4569099],zoom:4,storySlotContent:`<eox-map-tooltip></eox-map-tooltip>`},render:e=>n`
    <eox-map
      .center=${e.center}
      .controls=${e.controls}
      .layers=${e.layers}
  ...
  `}})),g,ct,lt,ut,dt=e((()=>{t(),customElements.define(`custom-coordinates-tooltip`,class extends HTMLElement{constructor(){super()}set feature(e){this.innerHTML=`
