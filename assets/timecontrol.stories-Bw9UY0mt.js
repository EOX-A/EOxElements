import{i as e}from"./preload-helper-DbRxMUml.js";import{Pt as t,kt as n,n as r,t as i}from"./iframe-UIO7A50g.js";import{n as a,t as o}from"./taggedTemplateLiteral-CmccG7_q.js";var s,c=e((()=>{n(),r(),s={args:{for:`eox-map#only-date`,storyAdditionalComponents:{"eox-map":{id:`only-date`,zoom:i.zoom,center:i.center,layers:i.layers},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,format:i.format}}},render:e=>t`
  ...
  `}})),h,g=e((()=>{n(),r(),h={args:{layerIdKey:i.layerIdKey,for:`eox-map#timeline`,select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-map":{id:`timeline`,zoom:i.zoom,center:i.center,layers:i.layers},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,navigation:!0},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,showDots:!0,popup:!0,showItems:!0}}},render:e=>t`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents[`eox-map`].id}
      .zoom=${e.storyAdditionalComponents[`eox-map`].zoom}
  ...
  `}})),ee,_,te=e((()=>{n(),r(),a(),_={args:{layerIdKey:i.layerIdKey,titleKey:i.titleKey,externalMapRendering:!0,animate:!0,for:`eox-map#external-map-rendering-mosaic`,select:e=>{console.log(e.detail)},storyAdditionalComponents:{"eox-map":{id:`external-map-rendering-mosaic`,zoom:10,center:[12,42]},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,navigation:!0},"eox-timecontrol-picker":{storyImport:!1,storySlot:!0,range:!0,showDots:!0,showItems:!0,popup:!0}}},render:e=>t(ee||=o([`
    <eox-map
      style="width: 100%; height: 500px;"
      id=`,`
      .zoom=`,`
  ...
  `}})),k,A=e((()=>{n(),r(),k={args:{for:`eox-map#date-with-init-date`,initDate:[`2021-02-28`],storyAdditionalComponents:{"eox-map":{id:`date-with-init-date`,zoom:i.zoom,center:i.center,layers:i.layers},"eox-timecontrol-date":{storyImport:!1,storySlot:!0,format:`D. MMMM YYYY`}},select:e=>{console.log(e.detail)}},render:e=>t`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents[`eox-map`].id}
      .zoom=${e.storyAdditionalComponents[`eox-map`].zoom}
  ...
  `}})),N,ae=e((()=>{n(),r(),N={args:{layerIdKey:i.layerIdKey,for:`eox-map#timeline-selection-duration`,storyAdditionalComponents:{"eox-map":{id:`timeline-selection-duration`,zoom:i.zoom,center:i.center,layers:i.layers},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0,selectionDuration:{months:1}}}},render:e=>t`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents[`eox-map`].id}
      .zoom=${e.storyAdditionalComponents[`eox-map`].zoom}
  ...
  `}})),P,oe=e((()=>{n(),r(),P={args:{layerIdKey:i.layerIdKey,for:`eox-map#timeline-selection-resizable`,storyAdditionalComponents:{"eox-map":{id:`timeline-selection-resizable`,zoom:i.zoom,center:i.center,layers:i.layers},"eox-timecontrol-timeline":{storyImport:!1,storySlot:!0,selectionDuration:{months:1},selectionResizable:!1}}},render:e=>t`
    <eox-map
      style="width: 100%; height: 500px;"
      id=${e.storyAdditionalComponents[`eox-map`].id}
      .zoom=${e.storyAdditionalComponents[`eox-map`].zoom}
  ...
  `}})),F=e((()=>{c(),u(),f(),m(),g(),te(),re(),b(),S(),w(),E(),O(),A(),M(),ae(),oe()})),I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{n(),F(),I={title:`Elements/eox-timecontrol`,tags:[`autodocs`],component:`eox-timecontrol`,render:e=>t`
    <eox-timecontrol
      .for=${e.for}
      .layerIdKey=${e.layerIdKey}
      .titleKey=${e.titleKey}
