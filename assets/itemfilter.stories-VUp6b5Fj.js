import{s as T,x as y,T as O}from"./lit-element-uhisBW42.js";import{n as v,t as C,r as z}from"./state-729Pchtv.js";import{n as S}from"./when-fh6s5Pmf.js";import{o as Se}from"./map-K4dZiwsf.js";import{c as or,_ as lr}from"./index-EJ4ljtJk.js";import{o as Lt}from"./unsafe-html-rU-ujVzY.js";import{n as je,i as fe}from"./static-u60TZvxB.js";import"./toolcool-range-slider.min-8Vg52R7B.js";import{d as pe}from"./dayjs.min-Sgxub5UU.js";import{r as zr,T as Vr}from"./main--0l0WmPb.js";import{b as ft}from"./button--cdmXcoW.js";import{c as Kr,r as Gr,s as Qr}from"./slider-MCblB636.js";import{a as Ve,g as Xr}from"./_commonjsHelpers-4gQjN7DL.js";import"./directive-helpers-qkjFCehB.js";import"./index-EySAwWXj.js";const pt=`
:host {
  display: flex;
...
eox-itemfilter-expandcontainer button.reset-icon:before {
  ...
  `;var Yr=Object.defineProperty,Jr=Object.getOwnPropertyDescriptor,mt=(e,t,r,i)=>{for(var s=i>1?void 0:i?Jr(t,r):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&Yr(t,r,s),s};let Ne=class extends T{handleDetailsToggle(e){this.dispatchEvent(new CustomEvent("details-toggled",{detail:e,bubbles:!0,composed:!0}))}_resetFilter(){this.querySelector("[slot='filter']").reset()}render(){return y`
      <style>
        ${pt}
        ${!this.unstyled&&gt}
      </style>
    ...
    `}};mt([v({attribute:!1})],Ne.prototype,"filterObject",2);mt([v()],Ne.prototype,"unstyled",2);Ne=mt([C("eox-itemfilter-expandcontainer")],Ne);const xe=e=>{if(!e.dirty)return null;switch(e.type){case"multiselect":for(const r in e.state)e.state[r]=!1;break;case"range":e.state.min=e.min,e.state.max=e.max;break;case"select":for(const r in e.state)e.state[r]=!1;break;case"spatial":e.state.geometry=void 0;break;case"text":e.keys.forEach(r=>{e.state[r]=void 0});break}return delete e.stringifiedState,delete e.dirty,e},tt=Math.min,ge=Math.max,De=Math.round,Ae=Math.floor,te=e=>({x:e,y:e});function ar(e){return e.split("-")[0]}function Zr(e){return e.split("-")[1]}function ei(e){return e==="x"?"y":"x"}function ti(e){return e==="y"?"height":"width"}function cr(e){return["top","bottom"].includes(ar(e))?"y":"x"}function ri(e){return ei(cr(e))}function ur(e){return{...e,top:e.y,left:e.x,right:e.x+e.width,bottom:e.y+e.height}}function At(e,t,r){let{reference:i,floating:s}=e;const n=cr(t),o=ri(t),a=ti(o),l=ar(t),c=n==="y",u=i.x+i.width/2-s.width/2,h=i.y+i.height/2-s.height/2,f=i[a]/2-s[a]/2;let d;switch(l){case"top":d={x:u,y:i.y-s.height};break;case"bottom":d={x:u,y:i.y+i.height};break;case"right":d={x:i.x+i.width,y:h};break;case"left":d={x:i.x-s.width,y:h};break;default:d={x:i.x,y:i.y}}switch(Zr(t)){case"start":d[o]-=f*(r&&c?-1:1);break;case"end":d[o]+=f*(r&&c?-1:1);break}return d}const ii=async(e,t,r)=>{const{placement:i="bottom",strategy:s="absolute",middleware:n=[],platform:o}=r,a=n.filter(Boolean),l=await(o.isRTL==null?void 0:o.isRTL(t));let c=await o.getElementRects({reference:e,floating:t,strategy:s}),{x:u,y:h}=At(c,i,l),f=i,d={},p=0;for(let g=0;g<a.length;g++){const{name:x,fn:b}=a[g],{x:E,y:w,data:$,reset:_}=await b({x:u,y:h,initialPlacement:i,placement:f,strategy:s,middlewareData:d,rects:c,platform:o,elements:{reference:e,floating:t}});u=E??u,h=w??h,d={...d,[x]:{...d[x],...$}},_&&p<=50&&(p++,typeof _=="object"&&(_.placement&&(f=_.placement),_.rects&&(c=_.rects===!0?await o.getElementRects({reference:e,floating:t,strategy:s}):_.rects),{x:u,y:h}=At(c,f,l)),g=-1)}return{x:u,y:h,placement:f,strategy:s,middlewareData:d}};function re(e){return hr(e)?(e.nodeName||"").toLowerCase():"#document"}function M(e){var t;return(e==null||(t=e.ownerDocument)==null?void 0:t.defaultView)||window}function Y(e){var t;return(t=(hr(e)?e.ownerDocument:e.document)||window.document)==null?void 0:t.documentElement}function hr(e){return e instanceof Node||e instanceof M(e).Node}function G(e){return e instanceof Element||e instanceof M(e).Element}function W(e){return e instanceof HTMLElement||e instanceof M(e).HTMLElement}function kt(e){return typeof ShadowRoot>"u"?!1:e instanceof ShadowRoot||e instanceof M(e).ShadowRoot}function Me(e){const{overflow:t,overflowX:r,overflowY:i,display:s}=k(e);return/auto|scroll|overlay|hidden|clip/.test(t+i+r)&&!["inline","contents"].includes(s)}function si(e){return["table","td","th"].includes(re(e))}function yt(e){const t=vt(),r=k(e);return r.transform!=="none"||r.perspective!=="none"||(r.containerType?r.containerType!=="normal":!1)||!t&&(r.backdropFilter?r.backdropFilter!=="none":!1)||!t&&(r.filter?r.filter!=="none":!1)||["transform","perspective","filter"].some(i=>(r.willChange||"").includes(i))||["paint","layout","strict","content"].some(i=>(r.contain||"").includes(i))}function ni(e){let t=ye(e);for(;W(t)&&!Ke(t);){if(yt(t))return t;t=ye(t)}return null}function vt(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}function Ke(e){return["html","body","#document"].includes(re(e))}function k(e){return M(e).getComputedStyle(e)}function Ge(e){return G(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.pageXOffset,scrollTop:e.pageYOffset}}function ye(e){if(re(e)==="html")return e;const t=e.assignedSlot||e.parentNode||kt(e)&&e.host||Y(e);return kt(t)?t.host:t}function dr(e){const t=ye(e);return Ke(t)?e.ownerDocument?e.ownerDocument.body:e.body:W(t)&&Me(t)?t:dr(t)}function _e(e,t,r){var i;t===void 0&&(t=[]),r===void 0&&(r=!0);const s=dr(e),n=s===((i=e.ownerDocument)==null?void 0:i.body),o=M(s);return n?t.concat(o,o.visualViewport||[],Me(s)?s:[],o.frameElement&&r?_e(o.frameElement):[]):t.concat(s,_e(s,[],r))}function fr(e){const t=k(e);let r=parseFloat(t.width)||0,i=parseFloat(t.height)||0;const s=W(e),n=s?e.offsetWidth:r,o=s?e.offsetHeight:i,a=De(r)!==n||De(i)!==o;return a&&(r=n,i=o),{width:r,height:i,$:a}}function bt(e){return G(e)?e:e.contextElement}function me(e){const t=bt(e);if(!W(t))return te(1);const r=t.getBoundingClientRect(),{width:i,height:s,$:n}=fr(t);let o=(n?De(r.width):r.width)/i,a=(n?De(r.height):r.height)/s;return(!o||!Number.isFinite(o))&&(o=1),(!a||!Number.isFinite(a))&&(a=1),{x:o,y:a}}const oi=te(0);function pr(e){const t=M(e);return!vt()||!t.visualViewport?oi:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function li(e,t,r){return t===void 0&&(t=!1),!r||t&&r!==M(e)?!1:t}function ae(e,t,r,i){t===void 0&&(t=!1),r===void 0&&(r=!1);const s=e.getBoundingClientRect(),n=bt(e);let o=te(1);t&&(i?G(i)&&(o=me(i)):o=me(e));const a=li(n,r,i)?pr(n):te(0);let l=(s.left+a.x)/o.x,c=(s.top+a.y)/o.y,u=s.width/o.x,h=s.height/o.y;if(n){const f=M(n),d=i&&G(i)?M(i):i;let p=f,g=p.frameElement;for(;g&&i&&d!==p;){const x=me(g),b=g.getBoundingClientRect(),E=k(g),w=b.left+(g.clientLeft+parseFloat(E.paddingLeft))*x.x,$=b.top+(g.clientTop+parseFloat(E.paddingTop))*x.y;l*=x.x,c*=x.y,u*=x.x,h*=x.y,l+=w,c+=$,p=M(g),g=p.frameElement}}return ur({width:u,height:h,x:l,y:c})}const ai=[":popover-open",":modal"];function gr(e){return ai.some(t=>{try{return e.matches(t)}catch{return!1}})}function ci(e){let{elements:t,rect:r,offsetParent:i,strategy:s}=e;const n=s==="fixed",o=Y(i),a=t?gr(t.floating):!1;if(i===o||a&&n)return r;let l={scrollLeft:0,scrollTop:0},c=te(1);const u=te(0),h=W(i);if((h||!h&&!n)&&((re(i)!=="body"||Me(o))&&(l=Ge(i)),W(i))){const f=ae(i);c=me(i),u.x=f.x+i.clientLeft,u.y=f.y+i.clientTop}return{width:r.width*c.x,height:r.height*c.y,x:r.x*c.x-l.scrollLeft*c.x+u.x,y:r.y*c.y-l.scrollTop*c.y+u.y}}function ui(e){return Array.from(e.getClientRects())}function mr(e){return ae(Y(e)).left+Ge(e).scrollLeft}function hi(e){const t=Y(e),r=Ge(e),i=e.ownerDocument.body,s=ge(t.scrollWidth,t.clientWidth,i.scrollWidth,i.clientWidth),n=ge(t.scrollHeight,t.clientHeight,i.scrollHeight,i.clientHeight);let o=-r.scrollLeft+mr(e);const a=-r.scrollTop;return k(i).direction==="rtl"&&(o+=ge(t.clientWidth,i.clientWidth)-s),{width:s,height:n,x:o,y:a}}function di(e,t){const r=M(e),i=Y(e),s=r.visualViewport;let n=i.clientWidth,o=i.clientHeight,a=0,l=0;if(s){n=s.width,o=s.height;const c=vt();(!c||c&&t==="fixed")&&(a=s.offsetLeft,l=s.offsetTop)}return{width:n,height:o,x:a,y:l}}function fi(e,t){const r=ae(e,!0,t==="fixed"),i=r.top+e.clientTop,s=r.left+e.clientLeft,n=W(e)?me(e):te(1),o=e.clientWidth*n.x,a=e.clientHeight*n.y,l=s*n.x,c=i*n.y;return{width:o,height:a,x:l,y:c}}function It(e,t,r){let i;if(t==="viewport")i=di(e,r);else if(t==="document")i=hi(Y(e));else if(G(t))i=fi(t,r);else{const s=pr(e);i={...t,x:t.x-s.x,y:t.y-s.y}}return ur(i)}function yr(e,t){const r=ye(e);return r===t||!G(r)||Ke(r)?!1:k(r).position==="fixed"||yr(r,t)}function pi(e,t){const r=t.get(e);if(r)return r;let i=_e(e,[],!1).filter(a=>G(a)&&re(a)!=="body"),s=null;const n=k(e).position==="fixed";let o=n?ye(e):e;for(;G(o)&&!Ke(o);){const a=k(o),l=yt(o);!l&&a.position==="fixed"&&(s=null),(n?!l&&!s:!l&&a.position==="static"&&!!s&&["absolute","fixed"].includes(s.position)||Me(o)&&!l&&yr(e,o))?i=i.filter(u=>u!==o):s=a,o=ye(o)}return t.set(e,i),i}function gi(e){let{element:t,boundary:r,rootBoundary:i,strategy:s}=e;const o=[...r==="clippingAncestors"?pi(t,this._c):[].concat(r),i],a=o[0],l=o.reduce((c,u)=>{const h=It(t,u,s);return c.top=ge(h.top,c.top),c.right=tt(h.right,c.right),c.bottom=tt(h.bottom,c.bottom),c.left=ge(h.left,c.left),c},It(t,a,s));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}}function mi(e){const{width:t,height:r}=fr(e);return{width:t,height:r}}function yi(e,t,r){const i=W(t),s=Y(t),n=r==="fixed",o=ae(e,!0,n,t);let a={scrollLeft:0,scrollTop:0};const l=te(0);if(i||!i&&!n)if((re(t)!=="body"||Me(s))&&(a=Ge(t)),i){const h=ae(t,!0,n,t);l.x=h.x+t.clientLeft,l.y=h.y+t.clientTop}else s&&(l.x=mr(s));const c=o.left+a.scrollLeft-l.x,u=o.top+a.scrollTop-l.y;return{x:c,y:u,width:o.width,height:o.height}}function Tt(e,t){return!W(e)||k(e).position==="fixed"?null:t?t(e):e.offsetParent}function vr(e,t){const r=M(e);if(!W(e)||gr(e))return r;let i=Tt(e,t);for(;i&&si(i)&&k(i).position==="static";)i=Tt(i,t);return i&&(re(i)==="html"||re(i)==="body"&&k(i).position==="static"&&!yt(i))?r:i||ni(e)||r}const vi=async function(e){const t=this.getOffsetParent||vr,r=this.getDimensions;return{reference:yi(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,...await r(e.floating)}}};function bi(e){return k(e).direction==="rtl"}const xi={convertOffsetParentRelativeRectToViewportRelativeRect:ci,getDocumentElement:Y,getClippingRect:gi,getOffsetParent:vr,getElementRects:vi,getClientRects:ui,getDimensions:mi,getScale:me,isElement:G,isRTL:bi};function wi(e,t){let r=null,i;const s=Y(e);function n(){var a;clearTimeout(i),(a=r)==null||a.disconnect(),r=null}function o(a,l){a===void 0&&(a=!1),l===void 0&&(l=1),n();const{left:c,top:u,width:h,height:f}=e.getBoundingClientRect();if(a||t(),!h||!f)return;const d=Ae(u),p=Ae(s.clientWidth-(c+h)),g=Ae(s.clientHeight-(u+f)),x=Ae(c),E={rootMargin:-d+"px "+-p+"px "+-g+"px "+-x+"px",threshold:ge(0,tt(1,l))||1};let w=!0;function $(_){const oe=_[0].intersectionRatio;if(oe!==l){if(!w)return o();oe?o(!1,oe):i=setTimeout(()=>{o(!1,1e-7)},100)}w=!1}try{r=new IntersectionObserver($,{...E,root:s.ownerDocument})}catch{r=new IntersectionObserver($,E)}r.observe(e)}return o(!0),n}function Ei(e,t,r,i){i===void 0&&(i={});const{ancestorScroll:s=!0,ancestorResize:n=!0,elementResize:o=typeof ResizeObserver=="function",layoutShift:a=typeof IntersectionObserver=="function",animationFrame:l=!1}=i,c=bt(e),u=s||n?[...c?_e(c):[],..._e(t)]:[];u.forEach(b=>{s&&b.addEventListener("scroll",r,{passive:!0}),n&&b.addEventListener("resize",r)});const h=c&&a?wi(c,r):null;let f=-1,d=null;o&&(d=new ResizeObserver(b=>{let[E]=b;E&&E.target===c&&d&&(d.unobserve(t),cancelAnimationFrame(f),f=requestAnimationFrame(()=>{var w;(w=d)==null||w.observe(t)})),r()}),c&&!l&&d.observe(c),d.observe(t));let p,g=l?ae(e):null;l&&x();function x(){const b=ae(e);g&&(b.x!==g.x||b.y!==g.y||b.width!==g.width||b.height!==g.height)&&r(),g=b,p=requestAnimationFrame(x)}return r(),()=>{var b;u.forEach(E=>{s&&E.removeEventListener("scroll",r),n&&E.removeEventListener("resize",r)}),h==null||h(),(b=d)==null||b.disconnect(),d=null,l&&cancelAnimationFrame(p)}}const Si=(e,t,r)=>{const i=new Map,s={platform:xi,...r},n={...s.platform,_c:i};return ii(e,t,{...s,platform:n})};var _i=Object.defineProperty,$i=Object.getOwnPropertyDescriptor,Qe=(e,t,r,i)=>{for(var s=i>1?void 0:i?$i(t,r):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&_i(t,r,s),s};let $e=class extends T{constructor(){super(...arguments),this.open=!1,this.parent=null,this.unstyled=!1,this._clickEventListener=()=>{this.open=!1},this._keyboardEventListener=e=>{const{code:t}=e;["Escape"].includes(t)&&this._handleKeyboard(t)}}_handleKeyboard(e){this.clientHeight}_overlayCleanup(){}connectedCallback(){super.connectedCallback(),this.unstyled||setTimeout(()=>{const e=this.parent||this.renderRoot.querySelector("[name=trigger]").assignedNodes()[0],t=this.renderRoot.querySelector("#dropdown"),r=()=>{t.classList.contains("open")&&Si(e,t,{strategy:"fixed"}).then(({x:i,y:s})=>{Object.assign(t.style,{left:`${i}px`,top:`${s}px`,width:`${e.getBoundingClientRect().width}px`})})};this._overlayCleanup=Ei(e,t,r)})}disconnectedCallback(){super.disconnectedCallback(),this._overlayCleanup(),this.getRootNode().removeEventListener("keydown",this._keyboardEventListener),window.removeEventListener("click",this._clickEventListener)}render(){return y`
      <style>
        #dropdown {
          display: none;
        }
    ...
    `}};K([v()],N.prototype,"filter",2);K([v()],N.prototype,"idProperty",2);K([v()],N.prototype,"items",2);K([v()],N.prototype,"titleProperty",2);K([v({type:Boolean})],N.prototype,"multiple",2);K([v()],N.prototype,"selectedItems",2);K([v({type:Boolean})],N.prototype,"unstyled",2);K([v({type:Boolean})],N.prototype,"noShadow",2);K([z()],N.prototype,"_currentHighlight",2);N=K([C("eox-selectionlist")],N);var Ai=Object.defineProperty,ki=Object.getOwnPropertyDescriptor,Ye=(e,t,r,i)=>{for(var s=i>1?void 0:i?ki(t,r):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&Ai(t,r,s),s};let Oe=class extends T{constructor(){super(...arguments),this.inline=!1,this.unstyled=!1}reset(){this.renderRoot.querySelectorAll("input[type='checkbox']").forEach(e=>{e instanceof HTMLInputElement&&(e.checked=!1)}),xe(this.filterObject),this.requestUpdate()}createRenderRoot(){return this}_getItems(){const e="sort"in this.filterObject?this.filterObject.sort:(t,r)=>t.localeCompare(r);return Object.keys(this.filterObject.state).sort(e).map(t=>({id:t,title:t.replace(/^./,t[0].toUpperCase())}))}_getSelectedItems(){return Object.keys(this.filterObject.state).filter(e=>this.filterObject.state[e]).map(e=>({id:e,title:e.replace(/^./,e[0].toUpperCase())}))}_handleSelected(e){var t;Object.keys(this.filterObject.state).forEach(r=>{this.filterObject.state[r]=e.map(i=>i.id).includes(r)}),this.filterObject.stringifiedState=Object.keys(this.filterObject.state).filter(r=>this.filterObject.state[r]).join(", "),((t=this.filterObject.stringifiedState)==null?void 0:t.length)>0&&(this.filterObject.dirty=!0),this.dispatchEvent(new CustomEvent("filter"))}render(){return S(this.filterObject,()=>y`
        ${S(this.inline||Object.keys(this.filterObject.state).length>10,()=>y`
          ...
          `,()=>y`
            ...
            ></eox-selectionlist>
          `)}
      `)}};Ye([v()],Oe.prototype,"filterObject",2);Ye([v({type:Boolean})],Oe.prototype,"inline",2);Ye([v({type:Boolean})],Oe.prototype,"unstyled",2);Oe=Ye([C("eox-itemfilter-multiselect")],Oe);var Ii=Object.defineProperty,Ti=Object.getOwnPropertyDescriptor,br=(e,t,r,i)=>{for(var s=i>1?void 0:i?Ti(t,r):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&Ii(t,r,s),s};let rt=class extends T{constructor(){super(...arguments),this.inputHandler=e=>{const[t,r]=e.detail.values;(t!==this.filterObject.state.min||r!=this.filterObject.state.max)&&([this.filterObject.state.min,this.filterObject.state.max]=[t,r],this.filterObject.dirty=!0),this.filterObject.dirty&&(this.filterObject.stringifiedState=`${pe(t)} - ${pe(r)}`),this.dispatchEvent(new CustomEvent("filter")),this.requestUpdate()},this.debouncedInputHandler=lr(this.inputHandler,0,{leading:!0})}reset(){xe(this.filterObject),this.requestUpdate()}createRenderRoot(){return this}render(){return S(this.filterObject,()=>y`
                              ...
                              <ul>
                                    ...
                                    >
                                      <label>
                                        ...
                                        ${S(this.hasTemplate("result"),()=>this.renderTemplate("result",t,`result-${t.id}`),()=>y`
                                            <span class="title"
                                              >${Lt(t[this._config.titleProperty])}</span
                                            >
                                          `)}
                                      </label>
                                    </li>
                                ...
                                <label>
                                  ...
                                  ${S(this.hasTemplate("result"),()=>this.renderTemplate("result",e,`result-${e.id}`),()=>y`
                                      <span class="title"
                                        >${Lt(e[this._config.titleProperty])}</span
                                      >
                                    `)}
                                </label>
                              </li>`)}
...
}`,...(nr=(sr=qe.parameters)==null?void 0:sr.docs)==null?void 0:nr.source}}};const oo=["Primary","MultiSelect","SortedMultiSelect","InlineMode"];export{qe as InlineMode,Te as MultiSelect,Ie as Primary,Fe as SortedMultiSelect,oo as __namedExportsOrder,no as default};
