import{n as e}from"./rolldown-runtime-BM3Ffeng.js";import{Tt as t,bt as n}from"./iframe-DfvrSIZk.js";var r,i=e((()=>{n(),r={args:{endpoint:`/fake/endpoint`,style:`position: relative !important; height: 250px;`,unstyled:void 0,submit:e=>console.log(`Feedback submitted`,e.detail),close:()=>console.log(`Feedback closed`)},render:e=>t`
    <div style="${e.style}">
      <eox-feedback
        endpoint="${e.endpoint}"
        ?unstyled="${e.unstyled}"
