import{T as dr,s as de,x as L,A as ee}from"./lit-element-c29cbb6b.js";import{n as Y,e as ae,t as Se}from"./query-assigned-elements-bec7f9a4.js";import{e as mr,i as pr,t as gr,o as ye,n as pe,a as gt}from"./unsafe-html-c0e6b744.js";import{m as yr,f as ue,c as Oe,p as He,a as vr}from"./directive-helpers-2720686e.js";import{n as We,o as Pe}from"./static-9a3d301b.js";import"./toolcool-range-slider.min-a799c142.js";import{c as Ee,g as st,a as Ne}from"./_commonjsHelpers-de833af9.js";import{r as br,T as xr}from"./templateElement-8d2f8dc8.js";import{b as wr}from"./button-60c82d2c.js";import{c as $r,r as Mr,s as Or,l as Er}from"./slider-5ac648d2.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const yt=(t,e,r)=>{const i=new Map;for(let n=e;n<=r;n++)i.set(t[n],n);return i},Sr=mr(class extends pr{constructor(t){if(super(t),t.type!==gr.CHILD)throw Error("repeat() can only be used in text expressions")}ct(t,e,r){let i;r===void 0?r=e:e!==void 0&&(i=e);const n=[],s=[];let a=0;for(const l of t)n[a]=i?i(l,a):a,s[a]=r(l,a),a++;return{values:s,keys:n}}render(t,e,r){return this.ct(t,e,r).values}update(t,[e,r,i]){var n;const s=yr(t),{values:a,keys:l}=this.ct(e,r,i);if(!Array.isArray(s))return this.ut=l,a;const o=(n=this.ut)!==null&&n!==void 0?n:this.ut=[],c=[];let u,f,d=0,h=s.length-1,m=0,x=a.length-1;for(;d<=h&&m<=x;)if(s[d]===null)d++;else if(s[h]===null)h--;else if(o[d]===l[m])c[m]=ue(s[d],a[m]),d++,m++;else if(o[h]===l[x])c[x]=ue(s[h],a[x]),h--,x--;else if(o[d]===l[x])c[x]=ue(s[d],a[x]),Oe(t,c[x+1],s[d]),d++,x--;else if(o[h]===l[m])c[m]=ue(s[h],a[m]),Oe(t,s[d],s[h]),h--,m++;else if(u===void 0&&(u=yt(l,m,x),f=yt(o,d,h)),u.has(o[d]))if(u.has(o[h])){const _=f.get(l[m]),S=_!==void 0?s[_]:null;if(S===null){const I=Oe(t,s[d]);ue(I,a[m]),c[m]=I}else c[m]=ue(S,a[m]),Oe(t,s[d],S),s[_]=null;m++}else He(s[h]),h--;else He(s[d]),d++;for(;m<=x;){const _=Oe(t,c[x+1]);ue(_,a[m]),c[m++]=_}for(;d<=h;){const _=s[d++];_!==null&&He(_)}return this.ut=l,vr(t,c),dr}});var Rt={exports:{}};(function(t,e){(function(r,i){t.exports=i()})(Ee,function(){var r=1e3,i=6e4,n=36e5,s="millisecond",a="second",l="minute",o="hour",c="day",u="week",f="month",d="quarter",h="year",m="date",x="Invalid Date",_=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,S=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,I={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_"),ordinal:function(v){var g=["th","st","nd","rd"],p=v%100;return"["+v+(g[(p-20)%10]||g[p]||g[0])+"]"}},P=function(v,g,p){var b=String(v);return!b||b.length>=g?v:""+Array(g+1-b.length).join(p)+v},D={s:P,z:function(v){var g=-v.utcOffset(),p=Math.abs(g),b=Math.floor(p/60),y=p%60;return(g<=0?"+":"-")+P(b,2,"0")+":"+P(y,2,"0")},m:function v(g,p){if(g.date()<p.date())return-v(p,g);var b=12*(p.year()-g.year())+(p.month()-g.month()),y=g.clone().add(b,f),$=p-y<0,M=g.clone().add(b+($?-1:1),f);return+(-(b+(p-y)/($?y-M:M-y))||0)},a:function(v){return v<0?Math.ceil(v)||0:Math.floor(v)},p:function(v){return{M:f,y:h,w:u,d:c,D:m,h:o,m:l,s:a,ms:s,Q:d}[v]||String(v||"").toLowerCase().replace(/s$/,"")},u:function(v){return v===void 0}},R="en",E={};E[R]=I;var k="$isDayjsObject",j=function(v){return v instanceof U||!(!v||!v[k])},N=function v(g,p,b){var y;if(!g)return R;if(typeof g=="string"){var $=g.toLowerCase();E[$]&&(y=$),p&&(E[$]=p,y=$);var M=g.split("-");if(!y&&M.length>1)return v(M[0])}else{var A=g.name;E[A]=g,y=A}return!b&&y&&(R=y),y||!b&&R},C=function(v,g){if(j(v))return v.clone();var p=typeof g=="object"?g:{};return p.date=v,p.args=arguments,new U(p)},O=D;O.l=N,O.i=j,O.w=function(v,g){return C(v,{locale:g.$L,utc:g.$u,x:g.$x,$offset:g.$offset})};var U=function(){function v(p){this.$L=N(p.locale,null,!0),this.parse(p),this.$x=this.$x||p.x||{},this[k]=!0}var g=v.prototype;return g.parse=function(p){this.$d=function(b){var y=b.date,$=b.utc;if(y===null)return new Date(NaN);if(O.u(y))return new Date;if(y instanceof Date)return new Date(y);if(typeof y=="string"&&!/Z$/i.test(y)){var M=y.match(_);if(M){var A=M[2]-1||0,T=(M[7]||"0").substring(0,3);return $?new Date(Date.UTC(M[1],A,M[3]||1,M[4]||0,M[5]||0,M[6]||0,T)):new Date(M[1],A,M[3]||1,M[4]||0,M[5]||0,M[6]||0,T)}}return new Date(y)}(p),this.init()},g.init=function(){var p=this.$d;this.$y=p.getFullYear(),this.$M=p.getMonth(),this.$D=p.getDate(),this.$W=p.getDay(),this.$H=p.getHours(),this.$m=p.getMinutes(),this.$s=p.getSeconds(),this.$ms=p.getMilliseconds()},g.$utils=function(){return O},g.isValid=function(){return this.$d.toString()!==x},g.isSame=function(p,b){var y=C(p);return this.startOf(b)<=y&&y<=this.endOf(b)},g.isAfter=function(p,b){return C(p)<this.startOf(b)},g.isBefore=function(p,b){return this.endOf(b)<C(p)},g.$g=function(p,b,y){return O.u(p)?this[b]:this.set(y,p)},g.unix=function(){return Math.floor(this.valueOf()/1e3)},g.valueOf=function(){return this.$d.getTime()},g.startOf=function(p,b){var y=this,$=!!O.u(b)||b,M=O.p(p),A=function(ce,W){var ne=O.w(y.$u?Date.UTC(y.$y,W,ce):new Date(y.$y,W,ce),y);return $?ne:ne.endOf(c)},T=function(ce,W){return O.w(y.toDate()[ce].apply(y.toDate("s"),($?[0,0,0,0]:[23,59,59,999]).slice(W)),y)},F=this.$W,B=this.$M,G=this.$D,me="set"+(this.$u?"UTC":"");switch(M){case h:return $?A(1,0):A(31,11);case f:return $?A(1,B):A(0,B+1);case u:var le=this.$locale().weekStart||0,$e=(F<le?F+7:F)-le;return A($?G-$e:G+(6-$e),B);case c:case m:return T(me+"Hours",0);case o:return T(me+"Minutes",1);case l:return T(me+"Seconds",2);case a:return T(me+"Milliseconds",3);default:return this.clone()}},g.endOf=function(p){return this.startOf(p,!1)},g.$set=function(p,b){var y,$=O.p(p),M="set"+(this.$u?"UTC":""),A=(y={},y[c]=M+"Date",y[m]=M+"Date",y[f]=M+"Month",y[h]=M+"FullYear",y[o]=M+"Hours",y[l]=M+"Minutes",y[a]=M+"Seconds",y[s]=M+"Milliseconds",y)[$],T=$===c?this.$D+(b-this.$W):b;if($===f||$===h){var F=this.clone().set(m,1);F.$d[A](T),F.init(),this.$d=F.set(m,Math.min(this.$D,F.daysInMonth())).$d}else A&&this.$d[A](T);return this.init(),this},g.set=function(p,b){return this.clone().$set(p,b)},g.get=function(p){return this[O.p(p)]()},g.add=function(p,b){var y,$=this;p=Number(p);var M=O.p(b),A=function(B){var G=C($);return O.w(G.date(G.date()+Math.round(B*p)),$)};if(M===f)return this.set(f,this.$M+p);if(M===h)return this.set(h,this.$y+p);if(M===c)return A(1);if(M===u)return A(7);var T=(y={},y[l]=i,y[o]=n,y[a]=r,y)[M]||1,F=this.$d.getTime()+p*T;return O.w(F,this)},g.subtract=function(p,b){return this.add(-1*p,b)},g.format=function(p){var b=this,y=this.$locale();if(!this.isValid())return y.invalidDate||x;var $=p||"YYYY-MM-DDTHH:mm:ssZ",M=O.z(this),A=this.$H,T=this.$m,F=this.$M,B=y.weekdays,G=y.months,me=y.meridiem,le=function(W,ne,Me,Ae){return W&&(W[ne]||W(b,$))||Me[ne].slice(0,Ae)},$e=function(W){return O.s(A%12||12,W,"0")},ce=me||function(W,ne,Me){var Ae=W<12?"AM":"PM";return Me?Ae.toLowerCase():Ae};return $.replace(S,function(W,ne){return ne||function(Me){switch(Me){case"YY":return String(b.$y).slice(-2);case"YYYY":return O.s(b.$y,4,"0");case"M":return F+1;case"MM":return O.s(F+1,2,"0");case"MMM":return le(y.monthsShort,F,G,3);case"MMMM":return le(G,F);case"D":return b.$D;case"DD":return O.s(b.$D,2,"0");case"d":return String(b.$W);case"dd":return le(y.weekdaysMin,b.$W,B,2);case"ddd":return le(y.weekdaysShort,b.$W,B,3);case"dddd":return B[b.$W];case"H":return String(A);case"HH":return O.s(A,2,"0");case"h":return $e(1);case"hh":return $e(2);case"a":return ce(A,T,!0);case"A":return ce(A,T,!1);case"m":return String(T);case"mm":return O.s(T,2,"0");case"s":return String(b.$s);case"ss":return O.s(b.$s,2,"0");case"SSS":return O.s(b.$ms,3,"0");case"Z":return M}return null}(W)||M.replace(":","")})},g.utcOffset=function(){return 15*-Math.round(this.$d.getTimezoneOffset()/15)},g.diff=function(p,b,y){var $,M=this,A=O.p(b),T=C(p),F=(T.utcOffset()-this.utcOffset())*i,B=this-T,G=function(){return O.m(M,T)};switch(A){case h:$=G()/12;break;case f:$=G();break;case d:$=G()/3;break;case u:$=(B-F)/6048e5;break;case c:$=(B-F)/864e5;break;case o:$=B/n;break;case l:$=B/i;break;case a:$=B/r;break;default:$=B}return y?$:O.a($)},g.daysInMonth=function(){return this.endOf(f).$D},g.$locale=function(){return E[this.$L]},g.locale=function(p,b){if(!p)return this.$L;var y=this.clone(),$=N(p,b,!0);return $&&(y.$L=$),y},g.clone=function(){return O.w(this.$d,this)},g.toDate=function(){return new Date(this.valueOf())},g.toJSON=function(){return this.isValid()?this.toISOString():null},g.toISOString=function(){return this.$d.toISOString()},g.toString=function(){return this.$d.toUTCString()},v}(),Be=U.prototype;return C.prototype=Be,[["$ms",s],["$s",a],["$m",l],["$H",o],["$W",c],["$M",f],["$y",h],["$D",m]].forEach(function(v){Be[v[1]]=function(g){return this.$g(g,v[0],v[1])}}),C.extend=function(v,g){return v.$i||(v(g,U,C),v.$i=!0),C},C.locale=N,C.isDayjs=j,C.unix=function(v){return C(1e3*v)},C.en=E[R],C.Ls=E,C.p={},C})})(Rt);var _r=Rt.exports;const Te=st(_r),jt=`
:host {
  display: flex;
...
`;var Ar=Object.defineProperty,Pr=Object.getOwnPropertyDescriptor,at=(t,e,r,i)=>{for(var n=i>1?void 0:i?Pr(e,r):e,s=t.length-1,a;s>=0;s--)(a=t[s])&&(n=(i?a(e,r,n):a(n))||n);return i&&n&&Ar(e,r,n),n};let Le=class extends de{handleDetailsToggle(t){this.dispatchEvent(new CustomEvent("details-toggled",{detail:t,bubbles:!0,composed:!0}))}render(){return L`
      <style>
        ${jt}
        ${!this.unstyled&&Ft}
      </style>
    ...
    `}};at([Y({attribute:!1})],Le.prototype,"filterObject",2);at([Y()],Le.prototype,"unstyled",2);Le=at([ae("eox-itemfilter-expandcontainer")],Le);var kr=Object.defineProperty,Cr=Object.getOwnPropertyDescriptor,Dt=(t,e,r,i)=>{for(var n=i>1?void 0:i?Cr(e,r):e,s=t.length-1,a;s>=0;s--)(a=t[s])&&(n=(i?a(e,r,n):a(n))||n);return i&&n&&kr(e,r,n),n};let Ve=class extends de{reset(){this.renderRoot.querySelectorAll("input[type='checkbox']").forEach(t=>{t instanceof HTMLInputElement&&(t.checked=!1)});for(const t in this.filterObject.state)this.filterObject.state[t]=!1;delete this.filterObject.dirty,this.requestUpdate()}createRenderRoot(){return this}render(){return L`
      <ul>
        ${ye(Object.keys(this.filterObject.state).sort((t,e)=>t.localeCompare(e)),t=>L`
            <li class=${this.filterObject.state[t]?"highlighted":ee}>
              <label>
                <input
                  ...
                  id=${t}
                  checked="${this.filterObject.state[t]||ee}"
    ...
    `}};Dt([Y()],Ve.prototype,"filterObject",2);Ve=Dt([ae("eox-itemfilter-multiselect")],Ve);var Tr="Expected a function",vt=0/0,Lr="[object Symbol]",Ir=/^\s+|\s+$/g,Rr=/^[-+]0x[0-9a-f]+$/i,jr=/^0b[01]+$/i,Fr=/^0o[0-7]+$/i,Dr=parseInt,Nr=typeof Ee=="object"&&Ee&&Ee.Object===Object&&Ee,Br=typeof self=="object"&&self&&self.Object===Object&&self,Hr=Nr||Br||Function("return this")(),Wr=Object.prototype,qr=Wr.toString,Gr=Math.max,Vr=Math.min,qe=function(){return Hr.Date.now()};function zr(t,e,r){var i,n,s,a,l,o,c=0,u=!1,f=!1,d=!0;if(typeof t!="function")throw new TypeError(Tr);e=bt(e)||0,ze(r)&&(u=!!r.leading,f="maxWait"in r,s=f?Gr(bt(r.maxWait)||0,e):s,d="trailing"in r?!!r.trailing:d);function h(E){var k=i,j=n;return i=n=void 0,c=E,a=t.apply(j,k),a}function m(E){return c=E,l=setTimeout(S,e),u?h(E):a}function x(E){var k=E-o,j=E-c,N=e-k;return f?Vr(N,s-j):N}function _(E){var k=E-o,j=E-c;return o===void 0||k>=e||k<0||f&&j>=s}function S(){var E=qe();if(_(E))return I(E);l=setTimeout(S,x(E))}function I(E){return l=void 0,d&&i?h(E):(i=n=void 0,a)}function P(){l!==void 0&&clearTimeout(l),c=0,i=o=n=l=void 0}function D(){return l===void 0?a:I(qe())}function R(){var E=qe(),k=_(E);if(i=arguments,n=this,o=E,k){if(l===void 0)return m(o);if(f)return l=setTimeout(S,e),h(o)}return l===void 0&&(l=setTimeout(S,e)),a}return R.cancel=P,R.flush=D,R}function ze(t){var e=typeof t;return!!t&&(e=="object"||e=="function")}function Yr(t){return!!t&&typeof t=="object"}function Ur(t){return typeof t=="symbol"||Yr(t)&&qr.call(t)==Lr}function bt(t){if(typeof t=="number")return t;if(Ur(t))return vt;if(ze(t)){var e=typeof t.valueOf=="function"?t.valueOf():t;t=ze(e)?e+"":e}if(typeof t!="string")return t===0?t:+t;t=t.replace(Ir,"");var r=jr.test(t);return r||Fr.test(t)?Dr(t.slice(2),r?2:8):Rr.test(t)?vt:+t}var Qr=zr;const Nt=st(Qr);var Jr=Object.defineProperty,Kr=Object.getOwnPropertyDescriptor,Bt=(t,e,r,i)=>{for(var n=i>1?void 0:i?Kr(e,r):e,s=t.length-1,a;s>=0;s--)(a=t[s])&&(n=(i?a(e,r,n):a(n))||n);return i&&n&&Jr(e,r,n),n};let Ye=class extends de{constructor(){super(...arguments),this.inputHandler=t=>{let e,r;[e,r]=t.detail.values,(e!==this.filterObject.state.min||r!=this.filterObject.state.max)&&([this.filterObject.state.min,this.filterObject.state.max]=[e,r],this.filterObject.dirty=!0),this.dispatchEvent(new CustomEvent("filter")),this.requestUpdate()},this.debouncedInputHandler=Nt(this.inputHandler,0,{leading:!0})}reset(){this.filterObject.state.min=this.filterObject.min,this.filterObject.state.max=this.filterObject.max,delete this.filterObject.dirty,this.requestUpdate()}createRenderRoot(){return this}render(){return L`
    ...
    `}};rr([Y()],Xe.prototype,"filterObject",2);Xe=rr([ae("eox-itemfilter-text")],Xe);function re(t){return Array.isArray?Array.isArray(t):sr(t)==="[object Array]"}const un=1/0;function fn(t){if(typeof t=="string")return t;let e=t+"";return e=="0"&&1/t==-un?"-0":e}function hn(t){return t==null?"":fn(t)}function Z(t){return typeof t=="string"}function ir(t){return typeof t=="number"}function dn(t){return t===!0||t===!1||mn(t)&&sr(t)=="[object Boolean]"}function nr(t){return typeof t=="object"}function mn(t){return nr(t)&&t!==null}function q(t){return t!=null}function Ge(t){return!t.trim().length}function sr(t){return t==null?t===void 0?"[object Undefined]":"[object Null]":Object.prototype.toString.call(t)}const pn="Incorrect 'index' type",gn=t=>`Invalid value for key ${t}`,yn=t=>`Pattern length exceeds max of ${t}.`,vn=t=>`Missing ${t} property in key`,bn=t=>`Property 'weight' in key '${t}' must be a positive integer`,St=Object.prototype.hasOwnProperty;class xn{constructor(e){this._keys=[],this._keyMap={};let r=0;e.forEach(i=>{let n=ar(i);r+=n.weight,this._keys.push(n),this._keyMap[n.id]=n,r+=n.weight}),this._keys.forEach(i=>{i.weight/=r})}get(e){return this._keyMap[e]}keys(){return this._keys}toJSON(){return JSON.stringify(this._keys)}}function ar(t){let e=null,r=null,i=null,n=1,s=null;if(Z(t)||re(t))i=t,e=_t(t),r=Ze(t);else{if(!St.call(t,"name"))throw new Error(vn("name"));const a=t.name;if(i=a,St.call(t,"weight")&&(n=t.weight,n<=0))throw new Error(bn(a));e=_t(a),r=Ze(a),s=t.getFn}return{path:e,id:r,weight:n,src:i,getFn:s}}function _t(t){return re(t)?t:t.split(".")}function Ze(t){return re(t)?t.join("."):t}function wn(t,e){let r=[],i=!1;const n=(s,a,l)=>{if(q(s))if(!a[l])r.push(s);else{let o=a[l];const c=s[o];if(!q(c))return;if(l===a.length-1&&(Z(c)||ir(c)||dn(c)))r.push(hn(c));else if(re(c)){i=!0;for(let u=0,f=c.length;u<f;u+=1)n(c[u],a,l+1)}else a.length&&n(c,a,l+1)}};return n(t,Z(e)?e.split("."):e,0),i?r:r[0]}const $n={includeMatches:!1,findAllMatches:!1,minMatchCharLength:1},Mn={isCaseSensitive:!1,includeScore:!1,keys:[],shouldSort:!0,sortFn:(t,e)=>t.score===e.score?t.idx<e.idx?-1:1:t.score<e.score?-1:1},On={location:0,threshold:.6,distance:100},En={useExtendedSearch:!1,getFn:wn,ignoreLocation:!1,ignoreFieldNorm:!1,fieldNormWeight:1};var w={...Mn,...$n,...On,...En};const Sn=/[^ ]+/g;function _n(t=1,e=3){const r=new Map,i=Math.pow(10,e);return{get(n){const s=n.match(Sn).length;if(r.has(s))return r.get(s);const a=1/Math.pow(s,.5*t),l=parseFloat(Math.round(a*i)/i);return r.set(s,l),l},clear(){r.clear()}}}class pt{constructor({getFn:e=w.getFn,fieldNormWeight:r=w.fieldNormWeight}={}){this.norm=_n(r,3),this.getFn=e,this.isCreated=!1,this.setIndexRecords()}setSources(e=[]){this.docs=e}setIndexRecords(e=[]){this.records=e}setKeys(e=[]){this.keys=e,this._keysMap={},e.forEach((r,i)=>{this._keysMap[r.id]=i})}create(){this.isCreated||!this.docs.length||(this.isCreated=!0,Z(this.docs[0])?this.docs.forEach((e,r)=>{this._addString(e,r)}):this.docs.forEach((e,r)=>{this._addObject(e,r)}),this.norm.clear())}add(e){const r=this.size();Z(e)?this._addString(e,r):this._addObject(e,r)}removeAt(e){this.records.splice(e,1);for(let r=e,i=this.size();r<i;r+=1)this.records[r].i-=1}getValueForItemAtKeyId(e,r){return e[this._keysMap[r]]}size(){return this.records.length}_addString(e,r){if(!q(e)||Ge(e))return;let i={v:e,i:r,n:this.norm.get(e)};this.records.push(i)}_addObject(e,r){let i={i:r,$:{}};this.keys.forEach((n,s)=>{let a=n.getFn?n.getFn(e):this.getFn(e,n.path);if(q(a)){if(re(a)){let l=[];const o=[{nestedArrIndex:-1,value:a}];for(;o.length;){const{nestedArrIndex:c,value:u}=o.pop();if(q(u))if(Z(u)&&!Ge(u)){let f={v:u,i:c,n:this.norm.get(u)};l.push(f)}else re(u)&&u.forEach((f,d)=>{o.push({nestedArrIndex:d,value:f})})}i.$[s]=l}else if(Z(a)&&!Ge(a)){let l={v:a,n:this.norm.get(a)};i.$[s]=l}}}),this.records.push(i)}toJSON(){return{keys:this.keys,records:this.records}}}function or(t,e,{getFn:r=w.getFn,fieldNormWeight:i=w.fieldNormWeight}={}){const n=new pt({getFn:r,fieldNormWeight:i});return n.setKeys(t.map(ar)),n.setSources(e),n.create(),n}function An(t,{getFn:e=w.getFn,fieldNormWeight:r=w.fieldNormWeight}={}){const{keys:i,records:n}=t,s=new pt({getFn:e,fieldNormWeight:r});return s.setKeys(i),s.setIndexRecords(n),s}function ke(t,{errors:e=0,currentLocation:r=0,expectedLocation:i=0,distance:n=w.distance,ignoreLocation:s=w.ignoreLocation}={}){const a=e/t.length;if(s)return a;const l=Math.abs(i-r);return n?a+l/n:l?1:a}function Pn(t=[],e=w.minMatchCharLength){let r=[],i=-1,n=-1,s=0;for(let a=t.length;s<a;s+=1){let l=t[s];l&&i===-1?i=s:!l&&i!==-1&&(n=s-1,n-i+1>=e&&r.push([i,n]),i=-1)}return t[s-1]&&s-i>=e&&r.push([i,s-1]),r}const fe=32;function kn(t,e,r,{location:i=w.location,distance:n=w.distance,threshold:s=w.threshold,findAllMatches:a=w.findAllMatches,minMatchCharLength:l=w.minMatchCharLength,includeMatches:o=w.includeMatches,ignoreLocation:c=w.ignoreLocation}={}){if(e.length>fe)throw new Error(yn(fe));const u=e.length,f=t.length,d=Math.max(0,Math.min(i,f));let h=s,m=d;const x=l>1||o,_=x?Array(f):[];let S;for(;(S=t.indexOf(e,m))>-1;){let k=ke(e,{currentLocation:S,expectedLocation:d,distance:n,ignoreLocation:c});if(h=Math.min(k,h),m=S+u,x){let j=0;for(;j<u;)_[S+j]=1,j+=1}}m=-1;let I=[],P=1,D=u+f;const R=1<<u-1;for(let k=0;k<u;k+=1){let j=0,N=D;for(;j<N;)ke(e,{errors:k,currentLocation:d+N,expectedLocation:d,distance:n,ignoreLocation:c})<=h?j=N:D=N,N=Math.floor((D-j)/2+j);D=N;let C=Math.max(1,d-N+1),O=a?f:Math.min(d+N,f)+u,U=Array(O+2);U[O+1]=(1<<k)-1;for(let v=O;v>=C;v-=1){let g=v-1,p=r[t.charAt(g)];if(x&&(_[g]=+!!p),U[v]=(U[v+1]<<1|1)&p,k&&(U[v]|=(I[v+1]|I[v])<<1|1|I[v+1]),U[v]&R&&(P=ke(e,{errors:k,currentLocation:g,expectedLocation:d,distance:n,ignoreLocation:c}),P<=h)){if(h=P,m=g,m<=d)break;C=Math.max(1,2*d-m)}}if(ke(e,{errors:k+1,currentLocation:d,expectedLocation:d,distance:n,ignoreLocation:c})>h)break;I=U}const E={isMatch:m>=0,score:Math.max(.001,P)};if(x){const k=Pn(_,l);k.length?o&&(E.indices=k):E.isMatch=!1}return E}function Cn(t){let e={};for(let r=0,i=t.length;r<i;r+=1){const n=t.charAt(r);e[n]=(e[n]||0)|1<<i-r-1}return e}class lr{constructor(e,{location:r=w.location,threshold:i=w.threshold,distance:n=w.distance,includeMatches:s=w.includeMatches,findAllMatches:a=w.findAllMatches,minMatchCharLength:l=w.minMatchCharLength,isCaseSensitive:o=w.isCaseSensitive,ignoreLocation:c=w.ignoreLocation}={}){if(this.options={location:r,threshold:i,distance:n,includeMatches:s,findAllMatches:a,minMatchCharLength:l,isCaseSensitive:o,ignoreLocation:c},this.pattern=o?e:e.toLowerCase(),this.chunks=[],!this.pattern.length)return;const u=(d,h)=>{this.chunks.push({pattern:d,alphabet:Cn(d),startIndex:h})},f=this.pattern.length;if(f>fe){let d=0;const h=f%fe,m=f-h;for(;d<m;)u(this.pattern.substr(d,fe),d),d+=fe;if(h){const x=f-fe;u(this.pattern.substr(x),x)}}else u(this.pattern,0)}searchIn(e){const{isCaseSensitive:r,includeMatches:i}=this.options;if(r||(e=e.toLowerCase()),this.pattern===e){let m={isMatch:!0,score:0};return i&&(m.indices=[[0,e.length-1]]),m}const{location:n,distance:s,threshold:a,findAllMatches:l,minMatchCharLength:o,ignoreLocation:c}=this.options;let u=[],f=0,d=!1;this.chunks.forEach(({pattern:m,alphabet:x,startIndex:_})=>{const{isMatch:S,score:I,indices:P}=kn(e,m,x,{location:n+_,distance:s,threshold:a,findAllMatches:l,minMatchCharLength:o,includeMatches:i,ignoreLocation:c});S&&(d=!0),f+=I,S&&P&&(u=[...u,...P])});let h={isMatch:d,score:d?f/this.chunks.length:1};return d&&i&&(h.indices=u),h}}class oe{constructor(e){this.pattern=e}static isMultiMatch(e){return At(e,this.multiRegex)}static isSingleMatch(e){return At(e,this.singleRegex)}search(){}}function At(t,e){const r=t.match(e);return r?r[1]:null}class Tn extends oe{constructor(e){super(e)}static get type(){return"exact"}static get multiRegex(){return/^="(.*)"$/}static get singleRegex(){return/^=(.*)$/}search(e){const r=e===this.pattern;return{isMatch:r,score:r?0:1,indices:[0,this.pattern.length-1]}}}class Ln extends oe{constructor(e){super(e)}static get type(){return"inverse-exact"}static get multiRegex(){return/^!"(.*)"$/}static get singleRegex(){return/^!(.*)$/}search(e){const i=e.indexOf(this.pattern)===-1;return{isMatch:i,score:i?0:1,indices:[0,e.length-1]}}}class In extends oe{constructor(e){super(e)}static get type(){return"prefix-exact"}static get multiRegex(){return/^\^"(.*)"$/}static get singleRegex(){return/^\^(.*)$/}search(e){const r=e.startsWith(this.pattern);return{isMatch:r,score:r?0:1,indices:[0,this.pattern.length-1]}}}class Rn extends oe{constructor(e){super(e)}static get type(){return"inverse-prefix-exact"}static get multiRegex(){return/^!\^"(.*)"$/}static get singleRegex(){return/^!\^(.*)$/}search(e){const r=!e.startsWith(this.pattern);return{isMatch:r,score:r?0:1,indices:[0,e.length-1]}}}class jn extends oe{constructor(e){super(e)}static get type(){return"suffix-exact"}static get multiRegex(){return/^"(.*)"\$$/}static get singleRegex(){return/^(.*)\$$/}search(e){const r=e.endsWith(this.pattern);return{isMatch:r,score:r?0:1,indices:[e.length-this.pattern.length,e.length-1]}}}class Fn extends oe{constructor(e){super(e)}static get type(){return"inverse-suffix-exact"}static get multiRegex(){return/^!"(.*)"\$$/}static get singleRegex(){return/^!(.*)\$$/}search(e){const r=!e.endsWith(this.pattern);return{isMatch:r,score:r?0:1,indices:[0,e.length-1]}}}class cr extends oe{constructor(e,{location:r=w.location,threshold:i=w.threshold,distance:n=w.distance,includeMatches:s=w.includeMatches,findAllMatches:a=w.findAllMatches,minMatchCharLength:l=w.minMatchCharLength,isCaseSensitive:o=w.isCaseSensitive,ignoreLocation:c=w.ignoreLocation}={}){super(e),this._bitapSearch=new lr(e,{location:r,threshold:i,distance:n,includeMatches:s,findAllMatches:a,minMatchCharLength:l,isCaseSensitive:o,ignoreLocation:c})}static get type(){return"fuzzy"}static get multiRegex(){return/^"(.*)"$/}static get singleRegex(){return/^(.*)$/}search(e){return this._bitapSearch.searchIn(e)}}class ur extends oe{constructor(e){super(e)}static get type(){return"include"}static get multiRegex(){return/^'"(.*)"$/}static get singleRegex(){return/^'(.*)$/}search(e){let r=0,i;const n=[],s=this.pattern.length;for(;(i=e.indexOf(this.pattern,r))>-1;)r=i+s,n.push([i,r-1]);const a=!!n.length;return{isMatch:a,score:a?0:1,indices:n}}}const et=[Tn,ur,In,Rn,Fn,jn,Ln,cr],Pt=et.length,Dn=/ +(?=(?:[^\"]*\"[^\"]*\")*[^\"]*$)/,Nn="|";function Bn(t,e={}){return t.split(Nn).map(r=>{let i=r.trim().split(Dn).filter(s=>s&&!!s.trim()),n=[];for(let s=0,a=i.length;s<a;s+=1){const l=i[s];let o=!1,c=-1;for(;!o&&++c<Pt;){const u=et[c];let f=u.isMultiMatch(l);f&&(n.push(new u(f,e)),o=!0)}if(!o)for(c=-1;++c<Pt;){const u=et[c];let f=u.isSingleMatch(l);if(f){n.push(new u(f,e));break}}}return n})}const Hn=new Set([cr.type,ur.type]);class Wn{constructor(e,{isCaseSensitive:r=w.isCaseSensitive,includeMatches:i=w.includeMatches,minMatchCharLength:n=w.minMatchCharLength,ignoreLocation:s=w.ignoreLocation,findAllMatches:a=w.findAllMatches,location:l=w.location,threshold:o=w.threshold,distance:c=w.distance}={}){this.query=null,this.options={isCaseSensitive:r,includeMatches:i,minMatchCharLength:n,findAllMatches:a,ignoreLocation:s,location:l,threshold:o,distance:c},this.pattern=r?e:e.toLowerCase(),this.query=Bn(this.pattern,this.options)}static condition(e,r){return r.useExtendedSearch}searchIn(e){const r=this.query;if(!r)return{isMatch:!1,score:1};const{includeMatches:i,isCaseSensitive:n}=this.options;e=n?e:e.toLowerCase();let s=0,a=[],l=0;for(let o=0,c=r.length;o<c;o+=1){const u=r[o];a.length=0,s=0;for(let f=0,d=u.length;f<d;f+=1){const h=u[f],{isMatch:m,indices:x,score:_}=h.search(e);if(m){if(s+=1,l+=_,i){const S=h.constructor.type;Hn.has(S)?a=[...a,...x]:a.push(x)}}else{l=0,s=0,a.length=0;break}}if(s){let f={isMatch:!0,score:l/s};return i&&(f.indices=a),f}}return{isMatch:!1,score:1}}}const tt=[];function qn(...t){tt.push(...t)}function rt(t,e){for(let r=0,i=tt.length;r<i;r+=1){let n=tt[r];if(n.condition(t,e))return new n(t,e)}return new lr(t,e)}const De={AND:"$and",OR:"$or"},it={PATH:"$path",PATTERN:"$val"},nt=t=>!!(t[De.AND]||t[De.OR]),Gn=t=>!!t[it.PATH],Vn=t=>!re(t)&&nr(t)&&!nt(t),kt=t=>({[De.AND]:Object.keys(t).map(e=>({[e]:t[e]}))});function fr(t,e,{auto:r=!0}={}){const i=n=>{let s=Object.keys(n);const a=Gn(n);if(!a&&s.length>1&&!nt(n))return i(kt(n));if(Vn(n)){const o=a?n[it.PATH]:s[0],c=a?n[it.PATTERN]:n[o];if(!Z(c))throw new Error(gn(o));const u={keyId:Ze(o),pattern:c};return r&&(u.searcher=rt(c,e)),u}let l={children:[],operator:s[0]};return s.forEach(o=>{const c=n[o];re(c)&&c.forEach(u=>{l.children.push(i(u))})}),l};return nt(t)||(t=kt(t)),i(t)}function zn(t,{ignoreFieldNorm:e=w.ignoreFieldNorm}){t.forEach(r=>{let i=1;r.matches.forEach(({key:n,norm:s,score:a})=>{const l=n?n.weight:null;i*=Math.pow(a===0&&l?Number.EPSILON:a,(l||1)*(e?1:s))}),r.score=i})}function Yn(t,e){const r=t.matches;e.matches=[],q(r)&&r.forEach(i=>{if(!q(i.indices)||!i.indices.length)return;const{indices:n,value:s}=i;let a={indices:n,value:s};i.key&&(a.key=i.key.src),i.idx>-1&&(a.refIndex=i.idx),e.matches.push(a)})}function Un(t,e){e.score=t.score}function Qn(t,e,{includeMatches:r=w.includeMatches,includeScore:i=w.includeScore}={}){const n=[];return r&&n.push(Yn),i&&n.push(Un),t.map(s=>{const{idx:a}=s,l={item:e[a],refIndex:a};return n.length&&n.forEach(o=>{o(s,l)}),l})}class we{constructor(e,r={},i){this.options={...w,...r},this.options.useExtendedSearch,this._keyStore=new xn(this.options.keys),this.setCollection(e,i)}setCollection(e,r){if(this._docs=e,r&&!(r instanceof pt))throw new Error(pn);this._myIndex=r||or(this.options.keys,this._docs,{getFn:this.options.getFn,fieldNormWeight:this.options.fieldNormWeight})}add(e){q(e)&&(this._docs.push(e),this._myIndex.add(e))}remove(e=()=>!1){const r=[];for(let i=0,n=this._docs.length;i<n;i+=1){const s=this._docs[i];e(s,i)&&(this.removeAt(i),i-=1,n-=1,r.push(s))}return r}removeAt(e){this._docs.splice(e,1),this._myIndex.removeAt(e)}getIndex(){return this._myIndex}search(e,{limit:r=-1}={}){const{includeMatches:i,includeScore:n,shouldSort:s,sortFn:a,ignoreFieldNorm:l}=this.options;let o=Z(e)?Z(this._docs[0])?this._searchStringList(e):this._searchObjectList(e):this._searchLogical(e);return zn(o,{ignoreFieldNorm:l}),s&&o.sort(a),ir(r)&&r>-1&&(o=o.slice(0,r)),Qn(o,this._docs,{includeMatches:i,includeScore:n})}_searchStringList(e){const r=rt(e,this.options),{records:i}=this._myIndex,n=[];return i.forEach(({v:s,i:a,n:l})=>{if(!q(s))return;const{isMatch:o,score:c,indices:u}=r.searchIn(s);o&&n.push({item:s,idx:a,matches:[{score:c,value:s,norm:l,indices:u}]})}),n}_searchLogical(e){const r=fr(e,this.options),i=(l,o,c)=>{if(!l.children){const{keyId:f,searcher:d}=l,h=this._findMatches({key:this._keyStore.get(f),value:this._myIndex.getValueForItemAtKeyId(o,f),searcher:d});return h&&h.length?[{idx:c,item:o,matches:h}]:[]}const u=[];for(let f=0,d=l.children.length;f<d;f+=1){const h=l.children[f],m=i(h,o,c);if(m.length)u.push(...m);else if(l.operator===De.AND)return[]}return u},n=this._myIndex.records,s={},a=[];return n.forEach(({$:l,i:o})=>{if(q(l)){let c=i(r,l,o);c.length&&(s[o]||(s[o]={idx:o,item:l,matches:[]},a.push(s[o])),c.forEach(({matches:u})=>{s[o].matches.push(...u)}))}}),a}_searchObjectList(e){const r=rt(e,this.options),{keys:i,records:n}=this._myIndex,s=[];return n.forEach(({$:a,i:l})=>{if(!q(a))return;let o=[];i.forEach((c,u)=>{o.push(...this._findMatches({key:c,value:a[u],searcher:r}))}),o.length&&s.push({idx:l,item:a,matches:o})}),s}_findMatches({key:e,value:r,searcher:i}){if(!q(r))return[];let n=[];if(re(r))r.forEach(({v:s,i:a,n:l})=>{if(!q(s))return;const{isMatch:o,score:c,indices:u}=i.searchIn(s);o&&n.push({score:c,key:e,value:s,idx:a,norm:l,indices:u})});else{const{v:s,n:a}=r,{isMatch:l,score:o,indices:c}=i.searchIn(s);l&&n.push({score:o,key:e,value:s,norm:a,indices:c})}return n}}we.version="6.6.2";we.createIndex=or;we.parseIndex=An;we.config=w;we.parseQuery=fr;qn(Wn);const Jn=(t,e="highlight",r="title")=>{const i=(s,a,l)=>{const o=a.split(".");let c;for(c=0;c<o.length-1;c++)s=s[o[c]];s[o[c]]=l},n=(s,a=[])=>{let l="",o=0;return a.forEach(c=>{const u=c[1]+1;l+=[s.substring(o,c[0]),`<mark class="${e}">`,s.substring(c[0],u),"</mark>"].join(""),o=u}),l+=s.substring(o),l};return t.filter(({matches:s})=>s&&s.length).map(({item:s,matches:a})=>{const l={...s};return a.forEach(o=>{o.key===r&&i(l,o.key,n(o.value,o.indices))}),l})};let hr;const Kn=(t,e)=>{hr=new we(t,{threshold:.4,distance:50,includeMatches:!0,useExtendedSearch:!0,...e})},Xn=async(t,e,r)=>{const i=Object.entries(e).filter(([l,o])=>o.type==="text"||o.type==="select"||o.type==="multiselect").reduce((l,[o,c])=>{const u="$or",f=[],d=(h,m)=>{const x={};c.type==="text"?x[h]=`${m}`:x[o]=`="${h}"`,f.push(x)};return Object.entries(c.state).filter(([h,m])=>m).forEach(([h,m])=>d(h,m)),f.length>0&&l.push({[u]:f}),l},[]);let n;if(!(i.length>0)&&r.matchAllWhenEmpty!==!1)n=t;else{const l={$and:[...i]},o=hr.search(l);n=r.enableHighlighting?Jn(o,"highlight",r.titleProperty):o.map(c=>c.item)}const s=Object.entries(e).filter(([l,o])=>o.type==="range").reduce((l,[o,c])=>(l[o]={min:c.state.min,max:c.state.max,format:c.format},l),{});if(Object.keys(s).length>0){const l=[];for(let o=0;o<n.length;o++){const c={};for(const[u,f]of Object.entries(s)){const d=h=>f.format==="date"?Te(h).unix():h;n[o].hasOwnProperty(u)?Array.isArray(n[o][u])?c[u]=s[u].min<=d(n[o][u][1])&&d(n[o][u][0])<=s[u].max:d(n[o][u])>=s[u].min&&d(n[o][u])<=s[u].max?c[u]=!0:c[u]=!1:c[u]=!0}Object.values(c).every(u=>!!u)&&l.push(n[o])}n=[...l]}const a=Object.entries(e).filter(([l,o])=>o.type==="spatial").reduce((l,[o,c])=>(l[o]={geometry:c.state.geometry,mode:c.state.mode},l),{});if(Object.values(a).map(l=>l.geometry).filter(l=>!!l).length>0){const l=[];for(let o=0;o<n.length;o++){const c={};for(const u of Object.keys(a)){const f=a[u].mode||"within";n[o].hasOwnProperty(u)&&(f==="within"?on(n[o][u],a[u].geometry):an(n[o][u],a[u].geometry))?c[u]=!0:c[u]=!1}Object.values(c).every(u=>!!u)&&l.push(n[o])}n=[...l]}return n},Zn=async(t,e,r)=>(await(await fetch(`${r.externalFilter(t,e)}`)).json()).features;var es=Object.defineProperty,ts=Object.getOwnPropertyDescriptor,ie=(t,e,r,i)=>{for(var n=i>1?void 0:i?ts(e,r):e,s=t.length-1,a;s>=0;s--)(a=t[s])&&(n=(i?a(e,r,n):a(n))||n);return i&&n&&es(e,r,n),n};class Ct{constructor(){this.aggregateResults=void 0,this.enableHighlighting=!1,this.filterProperties=[],this.inlineMode=!1,this.matchAllWhenEmpty=!0,this.onFilter=()=>{},this.onSelect=()=>{},this.showResults=!0,this.titleProperty="title",this.expandMultipleFilters=!0,this.expandMultipleResults=!0}}let J=class extends xr{constructor(){super(...arguments),this._resultAggregation=[],this.filters={},this.items=[],this._config=new Ct,this.apply=t=>{this.items=t.map((r,i)=>({id:`item-${i}`,...r})),this._config.filterProperties.length&&this._config.filterProperties.forEach(r=>{const i={},n=s=>r.format==="date"?Te(s).unix():parseInt(s);this.items.forEach(s=>{if(r.type==="range"){if(Array.isArray(s[r.key])){const a=[n(s[r.key][0]),n(s[r.key][1])];i.min=i.min!==void 0?Math.min(i.min,a[0]):a[0],i.max=i.max!==void 0?Math.max(i.max,a[1]):a[1]}else{const a=n(s[r.key]);i.min=i.min!==void 0?Math.min(i.min,a):a,i.max=i.max!==void 0?Math.max(i.max,a):a}return}Array.isArray(s[r.key])?s[r.key].forEach(a=>{i[a]=void 0}):r.type==="spatial"?(i.geometry=void 0,i.mode=r.mode||"intersects"):i[s[r.key]]=void 0}),this.filters[r.key||r.keys.join("|")]={...r,type:r.type||"multiselect",state:{...i,...r.state},...r.state&&{dirty:!0},...r.type==="range"&&{min:i.min,max:i.max,format:r.format}}}),this._config.matchAllWhenEmpty!==!1&&(this.results=this.sortResults(this.items),this.requestUpdate()),this._config.aggregateResults&&(this._resultAggregation=[...new Set(this.items.reduce((r,i)=>r.concat(i[this._config.aggregateResults]),[]))].sort((r,i)=>r.localeCompare(i)));const e=[];Object.values(this.filters).forEach(r=>{r.type==="text"?r.keys.forEach(i=>{e.includes(i)||e.push(i)}):(r.type==="select"||r.type==="multiselect")&&(e.includes(r.key)||e.push(r.key))}),Kn(this.items,{keys:e,...this._config.fuseConfig}),this.search()}}set config(t){const e=this._config;this._config={...new Ct,...t},this.requestUpdate("config",e)}get config(){return this._config}async search(){let t;this.config.externalFilter?t=await Zn(this.items,this.filters,this._config):t=await Xn(this.items,this.filters,this._config),this.results=this.sortResults(t),this._config.onFilter(this.results,this.filters)}aggregateResults(t,e){return t.filter(r=>{const i=r[this._config.aggregateResults];let n;return this.filters[this._config.aggregateResults]&&(n=Object.keys(this.filters[this._config.aggregateResults]).filter(a=>this.filters[this._config.aggregateResults].state[a])),(n!=null&&n.length?n.includes(e):!0)&&Array.isArray(i)?i.includes(e):i===e})}sortResults(t){return[...t].sort((e,r)=>e[this._config.titleProperty].localeCompare(r[this._config.titleProperty]))}resetFilters(){this.renderRoot.querySelectorAll("[data-type='filter']").forEach(t=>{t.reset()}),this.search()}toggleAccordion(t){let e;if(t.detail?e=t.detail.target:e=t.target,e.classList.contains("details-filter")){if(!e.open||this.config.expandMultipleFilters)return;this.shadowRoot.querySelectorAll("eox-itemfilter-expandcontainer").forEach(r=>{const i=r.shadowRoot.querySelector(".details-filter");i&&i!==e&&i.removeAttribute("open")})}else{if(!e.open||this.config.expandMultipleResults)return;this.shadowRoot.querySelectorAll("details").forEach(r=>{r!==e&&r.removeAttribute("open")})}}render(){return L`
      ...
      >
        ${pe(this._config.filterProperties.length,()=>L`
            <section class="${this.config.inlineMode?"inline":ee}">
              ${pe(!this.config.inlineMode,()=>L`
              ...
              ${pe(this._config.filterProperties&&Object.values(this.filters).map(t=>t.dirty).filter(t=>t).length>0,()=>L`
                  <button
                    id="filter-reset"
                    class="outline small"
          ...
          `)}
        ${pe(this.config.showResults&&this.results,()=>L`
            <section id="section-results">
              ...
              <div id="container-results" class="scroll">
                ${this.results.length<1?L` <small class="no-results">No matching items</small> `:ee}
                        ...
                        >
                          ...
                          <ul>
                            ${Sr(this.aggregateResults(this.results,t),e=>e.id,e=>{var r,i;return L`
                                <li
                                  class=${((r=this.selectedResult)==null?void 0:r[this._config.titleProperty])===e[this._config.titleProperty]?"highlighted":ee}
                                >
                                  <label>
                                    <input
                                      ...
                                      name="result"
                                      id="${e.id}"
                                      checked=${((i=this.selectedResult)==null?void 0:i[this._config.titleProperty])===e[this._config.titleProperty]||ee}
                                      @click=${()=>{this.selectedResult=e,this._config.onSelect(e)}}
                                    />
                                    ${pe(this.hasTemplate("result"),()=>this.renderTemplate("result",e,`result-${e.id}`),()=>L`
                                        <span class="title"
                            ...
                            <label>
                              ...
                              />
                              ${pe(this.hasTemplate("result"),()=>this.renderTemplate("result",t,`result-${t.id}`),()=>L`
                                  <span class="title"
...
}`,...(It=(Lt=Ce.parameters)==null?void 0:Lt.docs)==null?void 0:It.source}}};const ms=["Primary"];export{Ce as Primary,ms as __namedExportsOrder,ds as default};
//# sourceMappingURL=itemfilter.stories-e3e3bef4.js.map
