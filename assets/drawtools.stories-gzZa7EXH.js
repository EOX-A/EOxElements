var G=Object.defineProperty;var Q=(t,r,e)=>r in t?G(t,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[r]=e;var n=(t,r,e)=>(Q(t,typeof r!="symbol"?r+"":r,e),e),b=(t,r,e)=>{if(!r.has(t))throw TypeError("Cannot "+e)};var a=(t,r,e)=>(b(t,r,"read from private field"),e?e.call(t):r.get(t)),f=(t,r,e)=>{if(r.has(t))throw TypeError("Cannot add the same private member more than once");r instanceof WeakSet?r.add(t):r.set(t,e)},g=(t,r,e,i)=>(b(t,r,"write to private field"),i?i.call(t,e):r.set(t,e),e);import{T as d,s as N,x as l}from"./lit-element-Qm8PRmVu.js";import"./main-IFDcvcwI.js";import{e as R,i as X}from"./directive-xgBC_cM0.js";import{m as K}from"./directive-helpers-k6EzVOeb.js";import{b as Y}from"./button-KPw86qfe.js";import"./state-ncEgtE_C.js";import"./index-EySAwWXj.js";import"./_commonjsHelpers-4gQjN7DL.js";import"./iframe-LgyYUIKx.js";import"../sb-preview/runtime.js";/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ee=R(class extends X{constructor(){super(...arguments),this.key=d}render(t,r){return this.key=t,r}update(t,[r,e]){return r!==this.key&&(K(t),this.key=r),e}}),W=`
  * {
...
`;class Z extends N{constructor(){super();n(this,"hoverInteraction");n(this,"clickInteraction");n(this,"hoverId");n(this,"clickId");this.eoxMap=null,this.olMap=null,this.draw=null,this.layer="draw",this.drawLayer=null,this.drawnFeatures=[],this.modify=null,this.unstyled=!1}_handleDelete(e){e.stopPropagation();const i=e.target.getAttribute("index"),o=this.drawnFeatures[i];this.drawLayer.getSource().removeFeature(o),this.drawnFeatures.splice(i,1),this.requestUpdate()}_handleFeatureSelectAndDeselect(e){const i=e.get("id");if(this.clickId===i){const o=this.drawLayer.getSource().getExtent();this.olMap.getView().fit(o,{duration:750}),this.clickInteraction.highlightById([])}else this.clickInteraction.highlightById([i]),this.olMap.getView().fit(e.getGeometry().getExtent(),{duration:750});this.requestUpdate()}firstUpdated(){this.hoverInteraction=this.eoxMap.selectInteractions.selectHover,this.clickInteraction=this.eoxMap.selectInteractions.selectClick,this.hoverInteraction.selectStyleLayer.on("change",()=>this.requestUpdate()),this.clickInteraction.selectStyleLayer.on("change",()=>this.requestUpdate())}render(){var e,i;return this.hoverId=(e=this.hoverInteraction)==null?void 0:e.selectedFids[0],this.clickId=(i=this.clickInteraction)==null?void 0:i.selectedFids[0],l`
      ...
      <ul>
        ${this.drawnFeatures.map((o,x)=>{const c=o.get("id"),j=this.hoverId===c||this.clickId===c;return ee(x+1,l`
              <li
                class="${j?"selected":d}"
...
`;var s,p;class re extends N{constructor(){super();f(this,s,void 0);f(this,p,void 0);this.allowModify=!1,this.for="eox-map",this.currentlyDrawing=!1,this.draw=null,this.drawLayer=null,this.drawnFeatures=[],this.modify=null,this.multipleFeatures=!1,this.showList=!1,this.type="Polygon",this.unstyled=!1}static get properties(){return{allowModify:{attribute:"allow-modify",type:Boolean},for:{type:String},currentlyDrawing:{attribute:!1,state:!0,type:Boolean},draw:{attribute:!1,state:!0},drawLayer:{attribute:!1,state:!0},drawnFeatures:{attribute:!1,state:!0,type:Array},modify:{attribute:!1,state:!0},multipleFeatures:{attribute:"multiple-features",type:Boolean},showList:{attribute:"show-list",type:Boolean},type:{type:String},unstyled:{type:Boolean}}}initDrawLayer(){var i,o;const e=document.querySelector(this.for);g(this,s,e),g(this,p,a(this,s).map),this.drawLayer=a(this,s).addOrUpdateLayer({type:"Vector",properties:{id:"drawLayer",layerControlHide:!0},source:{type:"Vector"},...a(this,s).interactions.drawInteraction?{}:{interactions:[{type:"draw",options:{active:!1,id:"drawInteraction",type:this.type,modify:this.allowModify,stopClick:!0}},{type:"select",options:{id:"selectHover",condition:"pointermove",style:{"fill-color":"rgba(51, 153, 204,0.5)","stroke-color":"#3399CC","stroke-width":2.5}}},{type:"select",options:{id:"selectClick",condition:"click",panIn:!0,style:{"fill-color":"rgba(51, 153, 204,0.5)","stroke-color":"#3399CC","stroke-width":2.5}}}]}}),this.draw=a(this,s).interactions.drawInteraction,this.modify=a(this,s).interactions.drawInteractionmodify,(i=this.draw)==null||i.on("drawend",()=>this.onDrawEnd()),(o=this.modify)==null||o.on("modifyend",()=>this.onModifyEnd())}startDrawing(){this.initDrawLayer(),this.draw.setActive(!0),this.currentlyDrawing=!0,this.requestUpdate()}discardDrawing(){this.drawnFeatures=[],this.draw.setActive(!1),this.drawLayer.getSource().clear(),a(this,s).removeInteraction("drawInteraction"),a(this,p).removeLayer(this.drawLayer),this.emitDrawnFeatures(),this.currentlyDrawing=!1,this.requestUpdate()}onDrawEnd(){this.emitDrawnFeatures(),this.draw.setActive(!1),this.currentlyDrawing=!1,this.requestUpdate()}onModifyEnd(){this.emitDrawnFeatures()}emitDrawnFeatures(){setTimeout(()=>{this.drawnFeatures=this.drawLayer.getSource().getFeatures(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("drawupdate",{detail:this.drawnFeatures}))},0)}render(){var e,i,o;return l`
      ...
      <div>
        ...
        <button
          data-cy="drawBtn"
          class="polygon icon"
          disabled="${!this.multipleFeatures&&((e=this.drawnFeatures)==null?void 0:e.length)>0||this.currentlyDrawing||d}"
        ...
        <button
          data-cy="discardBtn"
          class="discard icon"
          disabled="${!((i=this.drawnFeatures)!=null&&i.length)&&!this.currentlyDrawing||d}"
    ...
    `}}s=new WeakMap,p=new WeakMap;customElements.define("eox-drawtools",re);const he={title:"Elements/eox-drawtools",tags:["autodocs"],component:"eox-drawtools"},w={args:{allowModify:!1,multipleFeatures:!1,type:"Polygon"},render:t=>l` <eox-map
      id="primary"
    ...
    <eox-drawtools
      ...
      .type=${t.type}
    >
    </eox-drawtools>`},u={render:()=>l` <eox-map
      id="multi"
      style="width: 400px; height: 300px;"
      layers='[
      {"type":"Tile","source":{"type":"OSM"}}
    ...
    <eox-drawtools
      ...
      multiple-features
      allow-modify
    ></eox-drawtools>`},h={render:()=>l` <div style="display: flex">
    <div>
      <eox-map
        id="box"
        style="width: 400px; height: 300px;"
...
}`,...(F=(M=w.parameters)==null?void 0:M.docs)==null?void 0:F.source}}};var S,I,L,$,k;u.parameters={...u.parameters,docs:{...(S=u.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => html\` <eox-map
      id="multi"
      style="width: 400px; height: 300px;"
      layers='[
...
}`,...(L=(I=u.parameters)==null?void 0:I.docs)==null?void 0:L.source},description:{story:"By setting the `multiple-features` attribute or `multipleFeatures` property to `true`,\nmultiple polygons can be drawn.",...(k=($=u.parameters)==null?void 0:$.docs)==null?void 0:k.description}}};var D,E,V,H,C;y.parameters={...y.parameters,docs:{...(D=y.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: () => html\` <eox-map
      id="modify"
      style="width: 400px; height: 300px;"
      layers='[
    ...
    <eox-drawtools
      ...
      allow-modify
    ></eox-drawtools>\`
}`,...(V=(E=y.parameters)==null?void 0:E.docs)==null?void 0:V.source},description:{story:"By setting the `allow-modify` attribute or `allowModify` property,\nthe user can modify features after drawing",...(C=(H=y.parameters)==null?void 0:H.docs)==null?void 0:C.description}}};var O,T,B,P,U;h.parameters={...h.parameters,docs:{...(O=h.parameters)==null?void 0:O.docs,source:{originalSource:`{
...
}`,...(B=(T=h.parameters)==null?void 0:T.docs)==null?void 0:B.source},description:{story:'The `type` attribute/property controls which drawing type is enabled\n(defaults to "Polygon")',...(U=(P=h.parameters)==null?void 0:P.docs)==null?void 0:U.description}}};var q,A,_,z,J;m.parameters={...m.parameters,docs:{...(q=m.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: flex">
      <eox-map
        id="list"
  ...
  \`
}`,...(_=(A=m.parameters)==null?void 0:A.docs)==null?void 0:_.source},description:{story:"By setting the `show-list` attribute or `showList` property to `true`,\nList of features will be visible",...(J=(z=m.parameters)==null?void 0:z.docs)==null?void 0:J.description}}};const me=["Primary","MultiPolygon","ModifyFeatures","DrawType","MultiPolygonWithList"];export{h as DrawType,y as ModifyFeatures,u as MultiPolygon,m as MultiPolygonWithList,w as Primary,me as __namedExportsOrder,he as default};
//# sourceMappingURL=drawtools.stories-gzZa7EXH.js.map
