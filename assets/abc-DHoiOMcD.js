import{g as c}from"./index-DuuuSFPv.js";function f(o,p){for(var t=0;t<p.length;t++){const e=p[t];if(typeof e!="string"&&!Array.isArray(e)){for(const n in e)if(n!=="default"&&!(n in o)){const s=Object.getOwnPropertyDescriptor(e,n);s&&Object.defineProperty(o,n,s.get?s:{enumerable:!0,get:()=>e[n]})}}}return Object.freeze(Object.defineProperty(o,Symbol.toStringTag,{value:"Module"}))}var r={exports:{}},i;function u(){return i||(i=1,function(o,p){ace.define("ace/snippets/abc.snippets",["require","exports","module"],function(t,e,n){n.exports=`
