import{m as x,n as $,s as A,o as S,p as b,q as E,t as C,v as F,w as _,y as L,z as R,T as D,i as T,A as z,B as y,C as U,D as O,E as I}from"./iframe-D-j6AcC8.js";const N=r=>(t,e)=>{e!==void 0?e.addInitializer((()=>{customElements.define(r,t)})):customElements.define(r,t)};const M={attribute:!0,type:String,converter:$,reflect:!1,hasChanged:x},P=(r=M,t,e)=>{const{kind:i,metadata:s}=e;let o=globalThis.litPropertyMetadata.get(s);if(o===void 0&&globalThis.litPropertyMetadata.set(s,o=new Map),i==="setter"&&((r=Object.create(r)).wrapped=!0),o.set(e.name,r),i==="accessor"){const{name:c}=e;return{set(a){const d=t.get.call(this);t.set.call(this,a),this.requestUpdate(c,d,r)},init(a){return a!==void 0&&this.C(c,void 0,r,a),a}}}if(i==="setter"){const{name:c}=e;return function(a){const d=this[c];t.call(this,a),this.requestUpdate(c,d,r)}}throw Error("Unsupported decorator location: "+i)};function h(r){return(t,e)=>typeof e=="object"?P(r,t,e):((i,s,o)=>{const c=s.hasOwnProperty(o);return s.constructor.createProperty(o,i),c?Object.getOwnPropertyDescriptor(s,o):void 0})(r,t,e)}const B=(r,t,e)=>(e.configurable=!0,e.enumerable=!0,Reflect.decorate&&typeof t!="object"&&Object.defineProperty(r,t,e),e);function j(r,t){return(e,i,s)=>{const o=c=>c.renderRoot?.querySelector(r)??null;return B(e,i,{get(){return o(this)}})}}class q{constructor(t){this.cle=t}setColorScale(){switch(this.cle.scaleType){case"continuous":this.setContinousColorScale();break;case"discrete":this.setDiscreteColorScale();break;case"threshold":this.setThresholdColorScale();break;case"categorical":this.setCategoricalColorScale();break;default:this.invalidScaleType(this.cle.scaleType)}}setContinousColorScale(){const{interpolator:t,domain:e,range:i}=this.cle;this.colorScale=t?A(t).domain(e):S().range(i).domain(e).interpolate(b)}setDiscreteColorScale(){this.colorScale=E().domain(this.cle.domain).range(this.cle.range)}setThresholdColorScale(){const t=this.cle.domain;this.colorScale=C().domain(t.slice(1,t.length-1)).range(this.cle.range)}setCategoricalColorScale(){this.colorScale=F().domain(this.cle.domain).range(this.cle.range)}invalidScaleType(t){throw new Error(`invalid property scaletype: ${t}.
