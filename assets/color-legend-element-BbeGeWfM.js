import{k as x,l as $,s as A,m as S,n as b,q as E,t as C,o as F,p as _,v as L,w as R,T as z,b as T,y as D,z as y,A as U,B as I,C as O}from"./iframe-C2nh80JA.js";/**
 * @license
 ...
 */const v=_(class extends L{constructor(o){var t;if(super(o),o.type!==R.ATTRIBUTE||o.name!=="class"||((t=o.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(o){return" "+Object.keys(o).filter(t=>o[t]).join(" ")+" "}update(o,[t]){var r,s;if(this.st===void 0){this.st=new Set,o.strings!==void 0&&(this.nt=new Set(o.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in t)t[i]&&!((r=this.nt)!=null&&r.has(i))&&this.st.add(i);return this.render(t)}const e=o.element.classList;for(const i of this.st)i in t||(e.remove(i),this.st.delete(i));for(const i in t){const c=!!t[i];c===this.st.has(i)||(s=this.nt)!=null&&s.has(i)||(c?(e.add(i),this.st.add(i)):(e.remove(i),this.st.delete(i)))}return z}});class G{constructor(t){this.cle=t}render(){const t=this.cle.titleText?T`<p class="legend-title">${this.cle.titleText}</p>`:"",e={hidden:this.cle.scaleType==="categorical"},r={hidden:this.cle.scaleType!=="categorical","categorical-container":!0};return T`<div
    ...
    >
      ...
      <slot name="footer"></slot>
        ...
        >
          ${i}
        </li>`)}`}renderContinuous(){var d;if(this.cle.scaleType!=="continuous"||this.cle.colorScale===null)return"";const{colorScale:t,marginTop:e,marginLeft:r,marginRight:s,tickSize:i,width:c,range:l}=this.cle,m=this.cle.marginBottom+i,g=this.cle.height+i,u=((d=t.interpolator)==null?void 0:d.call(t))||D(b,l);return y`<image
      x=${r}
      y=${e}
      width=${c-s-r}
      height=${g-e-m}
