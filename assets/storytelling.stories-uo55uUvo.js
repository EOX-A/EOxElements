import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{d as t,t as n}from"./lit-D8IuYOuz.js";var r;function i(){return(i=e((()=>{n(),r={args:{markdown:`## Hello World, Welcome to EOxStoryTelling.`,id:`markdown-str`},render:e=>t`
    <!-- Render eox-storytelling with basic markdown. -->
    <eox-storytelling
      id=${e.id}
      markdown=${e.markdown}
    ></eox-storytelling>
  `}})))()}var a;function o(){return(o=e((()=>{n(),a={args:{markdownURL:`${window.location.href.split(`iframe.html`)[0]}/sample.md`,id:`markdown-url`},render:e=>t`
    <eox-storytelling
      id=${e.id}
      markdown-url=${e.markdownURL}
    ></eox-storytelling>
  `}})))()}var s;function c(){return(c=e((()=>{n(),s={args:{id:`markdown-slot`,storySlotContent:`## Hello World, this is some Markdown Inside the slot.`},render:e=>t`
    <eox-storytelling id=${e.id}
      >## Hello World, this is some Markdown Inside the slot.</eox-storytelling
    >
  `}})))()}var l;function u(){return(u=e((()=>{n(),l={argTypes:{markdown:{table:{category:`properties`}}},args:{markdown:`# Hero Section <!--{ as="video" mode="hero" src="https://dlmultimedia.esa.int/download/public/videos/2023/06/010/2306_010_AR_EN.mp4" }-->
...
`,id:`markdown-hero`,showNav:!0,showHeroScrollIndicator:!0},render:e=>t`
    <eox-storytelling
      id=${e.id}
      ?show-nav=${e.showNav}
      ...
      markdown=${e.markdown}
    ></eox-storytelling>
  `}})))()}var d;function f(){return(f=e((()=>{n(),d={argTypes:{markdown:{table:{category:`properties`}}},args:{markdown:`## Map section <!--{as="eox-map" class="overlay-br" style="width: 100%; height: 500px;" config='{ "controls": { "Zoom": {}, "Attribution": {}, "FullScreen": {}, "OverviewMap": { "layers": [ { "type": "Tile", "properties": { "id": "overviewMap" }, "source": { "type": "OSM" } } ] } }, "layers": [ { "type": "Tile", "properties": { "id": "overviewMap" }, "source": { "type": "TileWMS", "url": "https://ows.mundialis.de/services/service", "params": { "LAYERS": "TOPO-WMS" } } } ], "view": { "center": [15,48], "zoom": 1 } }'}-->
### Some title for map <!--{ style="color: white; font-size: 1.25rem;" }-->
Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quos. Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quos. <!--{ style="opacity: 0.75; font-size: 1rem;" }-->`,id:`markdown-map`,showNav:!0},render:e=>t`
    <eox-storytelling
      id=${e.id}
      ?show-nav=${e.showNav}
      markdown=${e.markdown}
    ></eox-storytelling>
  `}})))()}var p;function m(){return(m=e((()=>{n(),p={argTypes:{markdown:{table:{category:`properties`}}},args:{markdown:`## Map Tour section <!--{ as="eox-map" class="overlay-br" mode="tour" }-->
...
### <!--{ layers='[{"type":"Tile","properties":{"id":"osm"},"source":{"type":"OSM"}},{"type":"Tile","properties":{"id":"customId"},"source":{"type":"WMTSCapabilities","url":"https://tiles.maps.eox.at/wmts/1.0.0/WMTSCapabilities.xml","layer":"s2cloudless-2025"}}]' center=[12.46,41.89] zoom="10" }-->
#### Second tour step.
Each tour step is described as an *h3* (*###*) heading.

### <!--{ layers='[{"type":"Tile","properties":{"id":"osm"},"source":{"type":"OSM"}},{"type":"Tile","properties":{"id":"customId"},"source":{"type":"WMTSCapabilities","url":"https://tiles.maps.eox.at/wmts/1.0.0/WMTSCapabilities.xml","layer":"s2cloudless-2025"}}]' center="[16.36,48.2]" zoom="10" animationOptions="{duration:500}" }-->
#### Third tour step.
To change individual parameters like zoom or center, or to change the map layers for a step, just set them using the HTML comment syntax. This changes the map setting for the current map`,id:`markdown-map-tour`,showNav:!0},render:e=>t`
    <eox-storytelling
      id=${e.id}
      ?show-nav=${e.showNav}
      markdown=${e.markdown}
    ></eox-storytelling>
  `}})))()}var h;function g(){return(g=e((()=>{n(),h={argTypes:{markdown:{table:{category:`properties`}}},args:{markdown:`## Image Tour section <!--{ as="img" mode="tour" }-->
...
#### Third tour step.
![](https://placehold.co/200x100)`,id:`markdown-image-tour`,showNav:!0},render:e=>t`
    <eox-storytelling
      id=${e.id}
      ?show-nav=${e.showNav}
      markdown=${e.markdown}
    ></eox-storytelling>
  `}})))()}var _;function v(){return(v=e((()=>{n(),_={argTypes:{markdown:{table:{category:`properties`}}},args:{markdown:`# Welcome to Storytelling <!--{ as="video" mode="hero" src="https://dlmultimedia.esa.int/download/public/videos/2023/06/010/2306_010_AR_EN.mp4" }-->
#### An introduction on how to write interactive and multimedial stories using markdown. Scroll down to get started! <!--{ style="font-size:1rem;opacity:0.7;margin-top:1rem;" }-->
...
More features will be added soon, so feel free to follow progress at the [EOxElements GitHub repository](https://github.com/EOX-A/EOxElements).
    `,id:`markdown-tour`,showNav:!0,showHeroScrollIndicator:!0,showMapLoadingIndicator:!0},render:e=>t`
    <eox-storytelling
      id=${e.id}
      ?show-nav=${e.showNav}
      ?show-hero-scroll-indicator=${e.showHeroScrollIndicator}
      ?show-map-loading-indicator=${e.showMapLoadingIndicator}
      markdown=${e.markdown}
    ></eox-storytelling>
  `}})))()}function y(e){if(e?.tagName===`EOX-MAP`){e.registerProjection(`ESRI:53009`,`+proj=moll +lon_0=0 +x_0=0 +y_0=0 +a=6371000 +b=6371000 +units=m +no_defs`);let t=e.getAttribute(`projection`);t&&e.setAttribute(`projection`,t)}}var b;function x(){return(x=e((()=>{n(),b={argTypes:{markdown:{table:{category:`properties`}}},args:{markdown:`## Map section <!--{as="eox-map" projection="ESRI:53009" style="width: 100%; height: 500px;" config='{ "controls": { "Zoom": {}, "Attribution": {}, "FullScreen": {}, "OverviewMap": { "layers": [ { "type": "Tile", "properties": { "id": "overviewMap" }, "source": { "type": "OSM" } } ] } }, "layers": [ { "type": "Tile", "properties": { "id": "overviewMap" }, "source": { "type": "TileWMS", "url": "https://ows.mundialis.de/services/service", "params": { "LAYERS": "TOPO-WMS" } } } ], "view": { "center": [15,48], "zoom": 1 } }'}-->
...
#### EPSG:4326
`,id:`markdown-init-event`,init:e=>y(e.detail),storyCodeBefore:`
    ...
    <eox-storytelling
      ...
      @init=${e.init}
    ></eox-storytelling>
  `}})))()}function S(){return(S=e((()=>{i(),o(),c(),u(),f(),m(),g(),v(),x()})))()}var C,w,T,E,D,O,k,A,j,M,N;function P(){return(P=e((()=>{S(),n(),C={title:`Elements/eox-storytelling`,tags:[`autodocs`],component:`eox-storytelling`,decorators:[e=>t`${e()}
        <style>
          .sb-show-main.sb-main-padded {
            padding: 0;
          }
        </style>`]},w=r,T=a,E=s,D=l,O=d,k=p,A=h,j=b,M=_,w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`PrimaryStory`,...w.parameters?.docs?.source},description:{story:"Basic usage of eox-storytelling. Renders a simple Markdown string as a story.\nUse standard markdown like `# Header`, `## Subheader`, `**bold**`, `*italic*`, `[link](url)`.",...w.parameters?.docs?.description}}},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`MarkdownAsURLStory`,...T.parameters?.docs?.source},description:{story:"Loads Markdown content from a remote URL and displays it in the storytelling component.\nUseful for dynamic or externally managed story content. Pass the URL to the \\`markdown-url\\` attribute.",...T.parameters?.docs?.description}}},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`MarkdownSlotStory`,...E.parameters?.docs?.source},description:{story:`Renders Markdown content provided via the slot, demonstrating slot-based story input.
Just place your raw Markdown inside the \`<eox-storytelling>\` tags.

**NOTE:** Beware of indentation! Leading spaces will be included in the markdown string and might affect rendering.`,...E.parameters?.docs?.description}}},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`MarkdownHeroStory`,...D.parameters?.docs?.source},description:{story:'Hero Section story.\nDemonstrates how to create a full-screen hero section at the start of a story.\nUse an h1 (\\`#\\`) followed by an HTML comment to configure the hero media:\n`# Title <!--{ as="video" mode="hero" src="..." }-->` or\n`# Title <!--{ as="img" mode="hero" src="..." }-->`.',...D.parameters?.docs?.description}}},O.parameters={...O.parameters,docs:{...O.parameters?.docs,source:{originalSource:`MarkdownMapStory`,...O.parameters?.docs?.source},description:{story:`Map Section story.
Demonstrates how to embed a map in the story using EOxMap.
Use an h2 (\`##\`) followed by an HTML comment to configure the map:
\`## Map section <!--{ as="eox-map" style="width: 100%; height: 500px;" config='{ "layers": [...], "view": {"center": [15,48], "zoom": 1} }' }-->\`.`,...O.parameters?.docs?.description}}},k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`MarkdownMapTourStory`,...k.parameters?.docs?.source},description:{story:'Map Tour story.\nDemonstrates how to create a scroll-driven map tour (scrollytelling) where the map state changes as you scroll.\n1. Define the base map tour section with an h2: `## Map Tour <!--{ as="eox-map" mode="tour" }-->`\n2. Define each step in the tour with an h3 (`###`) and a configuration comment overriding the map\'s state for that step:\n`### <!--{ center=[12.46,41.89] zoom="5" animationOptions="{duration:500}" }-->`.',...k.parameters?.docs?.description}}},A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`MarkdownImageTourStory`,...A.parameters?.docs?.source},description:{story:'Image Tour story.\nDemonstrates how to create a scroll-driven image tour where the image changes as you scroll.\n1. Define the base image tour section with an h2: `## Image Tour <!--{ as="img" mode="tour" }-->`\n2. Define each step in the tour with an h3 (`###`) and a configuration comment providing the new image source:\n`### <!--{ src="https://picsum.photos/800/600" }-->`.',...A.parameters?.docs?.description}}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`MarkdownInitEventStory`,...j.parameters?.docs?.source},description:{story:`* Demonstrates the @init event, allowing custom initialization logic (e.g., map projection setup) when the story or embedded elements are initialized.`,...j.parameters?.docs?.description}}},M.parameters={...M.parameters,docs:{...M.parameters?.docs,source:{originalSource:`MarkdownShowcaseStory`,...M.parameters?.docs?.source},description:{story:`* Storytelling Showcase.
A comprehensive example combining a hero section, standard markdown with configuration, a map section, a map tour, and an image tour all in one story.`,...M.parameters?.docs?.description}}},N=[`Primary`,`MarkdownAsURL`,`MarkdownInsideSlot`,`MarkdownHero`,`MarkdownMap`,`MarkdownMapTour`,`MarkdownImageTour`,`MarkdownInitEvent`,`MarkdownShowcase`]})))()}P();export{T as MarkdownAsURL,D as MarkdownHero,A as MarkdownImageTour,j as MarkdownInitEvent,E as MarkdownInsideSlot,O as MarkdownMap,k as MarkdownMapTour,M as MarkdownShowcase,w as Primary,N as __namedExportsOrder,C as default};